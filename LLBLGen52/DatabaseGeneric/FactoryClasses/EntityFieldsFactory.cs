...
namespace AdventureWorks.Dal.Adapter.v52.FactoryClasses
{
	...
	{
		private static readonly Dictionary<AdventureWorks.Dal.Adapter.v52.EntityType, string> _entityTypeNamesCache = new Dictionary<AdventureWorks.Dal.Adapter.v52.EntityType, string>();

		/// <summary>static ctor which initializes the static entity type cache.</summary>
		static EntityFieldsFactory()
		{
			foreach(AdventureWorks.Dal.Adapter.v52.EntityType value in Enum.GetValues(typeof(AdventureWorks.Dal.Adapter.v52.EntityType)))
			{
				_entityTypeNamesCache.Add(value, Enum.GetName(typeof(AdventureWorks.Dal.Adapter.v52.EntityType), value));
			}
		}	
		...
		public static IEntityFields2 CreateEntityFieldsObject(AdventureWorks.Dal.Adapter.v52.EntityType relatedEntityType)
		{
