...
namespace AdventureWorks.Dal.Adapter.v52.FactoryClasses
{
	...
	public partial class QueryFactory
	{
		...
		public DynamicQuery<AdventureWorks.Dal.Adapter.v52.TypedViewClasses.SohQuerySpecPocoRow> SohQuerySpecPoco
		{
			get { return this.Create().Select<AdventureWorks.Dal.Adapter.v52.TypedViewClasses.SohQuerySpecPocoRow, AdventureWorks.Dal.Adapter.v52.HelperClasses.SohQuerySpecPocoFields>(); }
		}
