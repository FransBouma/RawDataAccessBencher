...
namespace AdventureWorks.Dal.Adapter.v52.TypedViewClasses
{
	/// <summary>Class which represents a row in the typed view 'SohLinqPoco'.</summary>
	/// <remarks>This class is a result class for a query, which is produced with the method <see cref="AdventureWorks.Dal.Adapter.v52.Linq.LinqMetaData.GetSohLinqPocoTypedView"/>.
	/// Custom Properties: <br/>
	/// </remarks>
	[Serializable]
	public partial class SohLinqPocoRow 
	{
		#region Extensibility Method Definitions
		partial void OnCreated();
		#endregion
		
		/// <summary>Initializes a new instance of the <see cref="SohLinqPocoRow"/> class.</summary>
		public SohLinqPocoRow()
		{
			OnCreated();
		}
