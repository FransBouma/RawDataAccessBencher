...
namespace AdventureWorks.Dal.Adapter.v52.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			this.PerformDesetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", AdventureWorks.Dal.Adapter.v52.RelationClasses.StaticWorkOrderRelations.ProductEntityUsingProductIdStatic, true, signalRelatedEntity, "WorkOrders", resetFKFields, new int[] { (int)WorkOrderFieldIndex.ProductId } );
			_product = null;
		}
		...
		private void SetupSyncProduct(IEntityCore relatedEntity)
		{
			if(_product!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", AdventureWorks.Dal.Adapter.v52.RelationClasses.StaticWorkOrderRelations.ProductEntityUsingProductIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _scrapReason, new PropertyChangedEventHandler( OnScrapReasonPropertyChanged ), "ScrapReason", AdventureWorks.Dal.Adapter.v52.RelationClasses.StaticWorkOrderRelations.ScrapReasonEntityUsingScrapReasonIdStatic, true, signalRelatedEntity, "WorkOrders", resetFKFields, new int[] { (int)WorkOrderFieldIndex.ScrapReasonId } );
			_scrapReason = null;
		}
		...
		private void SetupSyncScrapReason(IEntityCore relatedEntity)
		{
			if(_scrapReason!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _scrapReason, new PropertyChangedEventHandler( OnScrapReasonPropertyChanged ), "ScrapReason", AdventureWorks.Dal.Adapter.v52.RelationClasses.StaticWorkOrderRelations.ScrapReasonEntityUsingScrapReasonIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<WorkOrderRoutingEntity>(EntityFactoryCache2.GetEntityFactory(typeof(WorkOrderRoutingEntityFactory))), (IEntityRelation)GetRelationsForField("WorkOrderRoutings")[0], (int)AdventureWorks.Dal.Adapter.v52.EntityType.WorkOrderEntity, (int)AdventureWorks.Dal.Adapter.v52.EntityType.WorkOrderRoutingEntity, 0, null, null, null, null, "WorkOrderRoutings", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))),	(IEntityRelation)GetRelationsForField("Product")[0], (int)AdventureWorks.Dal.Adapter.v52.EntityType.WorkOrderEntity, (int)AdventureWorks.Dal.Adapter.v52.EntityType.ProductEntity, 0, null, null, null, null, "Product", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ScrapReasonEntityFactory))),	(IEntityRelation)GetRelationsForField("ScrapReason")[0], (int)AdventureWorks.Dal.Adapter.v52.EntityType.WorkOrderEntity, (int)AdventureWorks.Dal.Adapter.v52.EntityType.ScrapReasonEntity, 0, null, null, null, null, "ScrapReason", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v52.EntityType.WorkOrderEntity; }
		}
