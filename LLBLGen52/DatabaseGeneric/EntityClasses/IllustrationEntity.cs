...
namespace AdventureWorks.Dal.Adapter.v52.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v52.EntityType.IllustrationEntity; }
		}
