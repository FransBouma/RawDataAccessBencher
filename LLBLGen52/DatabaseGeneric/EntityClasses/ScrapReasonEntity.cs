...
namespace AdventureWorks.Dal.Adapter.v52.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public ScrapReasonEntity(IEntityFields2 fields):base("ScrapReasonEntity")
		{
		...
		public ScrapReasonEntity(IValidator validator):base("ScrapReasonEntity")
		{
		...
		public virtual IRelationPredicateBucket GetRelationInfoWorkOrders()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(WorkOrderFields.ScrapReasonId, null, ComparisonOperator.Equal, this.ScrapReasonId));
			return bucket;
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(ScrapReasonEntityFactory));
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<WorkOrderEntity>(EntityFactoryCache2.GetEntityFactory(typeof(WorkOrderEntityFactory))), (IEntityRelation)GetRelationsForField("WorkOrders")[0], (int)AdventureWorks.Dal.Adapter.v52.EntityType.ScrapReasonEntity, (int)AdventureWorks.Dal.Adapter.v52.EntityType.WorkOrderEntity, 0, null, null, null, null, "WorkOrders", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get { return GetOrCreateEntityCollection<WorkOrderEntity, WorkOrderEntityFactory>("ScrapReason", true, false, ref _workOrders);	}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v52.EntityType.ScrapReasonEntity; }
		}
