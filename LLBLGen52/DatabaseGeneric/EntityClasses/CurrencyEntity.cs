...
namespace AdventureWorks.Dal.Adapter.v52.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<CurrencyRateEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CurrencyRateEntityFactory))), (IEntityRelation)GetRelationsForField("CurrencyRates")[0], (int)AdventureWorks.Dal.Adapter.v52.EntityType.CurrencyEntity, (int)AdventureWorks.Dal.Adapter.v52.EntityType.CurrencyRateEntity, 0, null, null, null, null, "CurrencyRates", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<CurrencyRateEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CurrencyRateEntityFactory))), (IEntityRelation)GetRelationsForField("CurrencyRates_")[0], (int)AdventureWorks.Dal.Adapter.v52.EntityType.CurrencyEntity, (int)AdventureWorks.Dal.Adapter.v52.EntityType.CurrencyRateEntity, 0, null, null, null, null, "CurrencyRates_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v52.EntityType.CurrencyEntity; }
		}
