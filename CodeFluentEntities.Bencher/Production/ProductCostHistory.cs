...
namespace CodeFluentEntities.Bencher.Production
{
    ...
    public partial class ProductCostHistory : System.ICloneable, System.IComparable, System.IComparable<CodeFluentEntities.Bencher.Production.ProductCostHistory>, CodeFluent.Runtime.ICodeFluentEntity, System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable<CodeFluentEntities.Bencher.Production.ProductCostHistory>
    {
        ...
        public virtual bool Equals(CodeFluentEntities.Bencher.Production.ProductCostHistory productCostHistory)
        {
            ...
            {
                return base.Equals(productCostHistory);
            }
            return (this.ProductID.Equals(productCostHistory.ProductID) == true);
        }
        ...
        public override bool Equals(object obj)
        {
			...
			productCostHistory = obj as CodeFluentEntities.Bencher.Production.ProductCostHistory;
            return this.Equals(productCostHistory);
        }
...
productCostHistory = value as CodeFluentEntities.Bencher.Production.ProductCostHistory;
            ...
            int localCompareTo = this.CompareTo(productCostHistory);
            return localCompareTo;
        }
        
        public virtual int CompareTo(CodeFluentEntities.Bencher.Production.ProductCostHistory productCostHistory)
        {
            if ((productCostHistory == null))
            {
                throw new System.ArgumentNullException("productCostHistory");
            }
            int localCompareTo = this.ProductID.CompareTo(productCostHistory.ProductID);
            return localCompareTo;
        }
        ...
        public virtual void Validate(System.Globalization.CultureInfo culture, System.Collections.Generic.IList<CodeFluent.Runtime.CodeFluentValidationException> results)
        {
            ...
            if ((evt.Cancel == true))
            {
                ...
                {
                    externalValidate = CodeFluentEntities.Bencher.Resources.Manager.GetStringWithDefault(culture, "CodeFluentEntities.Bencher.Production.ProductCostHistory.ExternalValidate", "Type \'CodeFluentEntities.Bencher.Production.ProductCostHistory\' cannot be validat" +
                            "ed.", null);
                }
        ...
        public virtual bool Delete()
        {
            ...
            persistence.CreateStoredProcedureCommand("Production", "ProductCostHistory", "Delete");
        ...
        public static CodeFluentEntities.Bencher.Production.ProductCostHistory Load(int productID)
        {
            ...
            CodeFluent.Runtime.CodeFluentPersistence persistence = CodeFluentContext.Get(CodeFluentEntities.Bencher.Constants.CodeFluentEntities_BencherStoreName).Persistence;
            persistence.CreateStoredProcedureCommand("Production", "ProductCostHistory", "Load");
            ...
            try
            {
                ...
                if ((reader.Read() == true))
                {
                    productCostHistory.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.Default);
        ...
        protected virtual bool BaseSave(bool force)
        {
            ...
            CodeFluent.Runtime.CodeFluentPersistence persistence = CodeFluentContext.Get(CodeFluentEntities.Bencher.Constants.CodeFluentEntities_BencherStoreName).Persistence;
            persistence.CreateStoredProcedureCommand("Production", "ProductCostHistory", "Save");
            persistence.AddRawParameter("@ProductID", this.ProductID);
        ...
        [System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, true)]
        public static CodeFluentEntities.Bencher.Production.ProductCostHistory LoadByEntityKey(string key)
        {
            if ((key == string.Empty))
            {
                return null;
            ...
            productCostHistory = CodeFluentEntities.Bencher.Production.ProductCostHistory.Load(var);
            return productCostHistory;
        }
        ...
        public CodeFluentEntities.Bencher.Production.ProductCostHistory Clone(bool deep)
        {
            CodeFluentEntities.Bencher.Production.ProductCostHistory productCostHistory = new CodeFluentEntities.Bencher.Production.ProductCostHistory();
            this.CopyTo(productCostHistory, deep);
            return productCostHistory;
        }
        
        public CodeFluentEntities.Bencher.Production.ProductCostHistory Clone()
        {
            CodeFluentEntities.Bencher.Production.ProductCostHistory localClone = this.Clone(true);
            return localClone;
        }
        ...
        public virtual void CopyTo(CodeFluentEntities.Bencher.Production.ProductCostHistory productCostHistory, bool deep)
        {
            if ((productCostHistory == null))
            {
                throw new System.ArgumentNullException("productCostHistory");
            }
            productCostHistory.ProductID = this.ProductID;
            productCostHistory.StandardCost = this.StandardCost;
            productCostHistory.ModifiedDate = this.ModifiedDate;
            productCostHistory.StartDate = this.StartDate;
            productCostHistory.EndDate = this.EndDate;
            this.OnEntityAction(new CodeFluent.Runtime.CodeFluentEntityActionEventArgs(this, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, productCostHistory));
        }
