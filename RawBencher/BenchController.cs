...
namespace RawBencher
{
   ...
   //         RegisteredBenchers.Add(new LLBLGenProResultsetCachingBencher(ConnectionString));
			...
			RegisteredBenchers.Add(new LLBLGenPro2003NoChangeTrackingBencher(ConnectionString));
            ...
            RegisteredBenchers.Add(new LLBLGenPro2003NormalBencher(ConnectionString));
#endif
