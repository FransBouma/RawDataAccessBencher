...
namespace RawBencher.Benchers
{
    ...
    public class ChainCompiledBencher : FetchOnlyBencherBase<SalesOrderHeader>
    {
        ...
        {
            return DataSource.From("[Sales].[SalesOrderHeader]", new { SalesOrderId = key }).Compile().ToObject<SalesOrderHeader>().Execute();
        }
        ...
        {
            return "Tortuga Chain, Compiled v" + BencherUtils.GetVersion(typeof(SqlServerDataSource));
        }
