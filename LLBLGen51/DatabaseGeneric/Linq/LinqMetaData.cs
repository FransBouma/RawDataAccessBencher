...
namespace AdventureWorks.Dal.Adapter.v51.Linq
{
	...
	public partial class LinqMetaData: ILinqMetaData
	{
		...
		public IDataSource GetQueryableForEntity(int typeOfEntity)
		{
			...
			switch((AdventureWorks.Dal.Adapter.v51.EntityType)typeOfEntity)
			{
		...
		public DataSource2<AdventureWorks.Dal.Adapter.v51.TypedViewClasses.SohLinqPocoRow> SohLinqPoco
		{
			get { return new DataSource2<AdventureWorks.Dal.Adapter.v51.TypedViewClasses.SohLinqPocoRow>(_adapterToUse, new ElementCreator(), _customFunctionMappings, _contextToUse) { TypedViewEnumTypeValue=(int)TypedViewType.SohLinqPocoTypedView }; }
		}
