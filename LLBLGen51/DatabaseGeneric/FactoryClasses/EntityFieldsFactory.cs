...
namespace AdventureWorks.Dal.Adapter.v51.FactoryClasses
{
	...
	{
		private static readonly Dictionary<AdventureWorks.Dal.Adapter.v51.EntityType, string> _entityTypeNamesCache = new Dictionary<AdventureWorks.Dal.Adapter.v51.EntityType, string>();

		/// <summary>static ctor which initializes the static entity type cache.</summary>
		static EntityFieldsFactory()
		{
			foreach(AdventureWorks.Dal.Adapter.v51.EntityType value in Enum.GetValues(typeof(AdventureWorks.Dal.Adapter.v51.EntityType)))
			{
				_entityTypeNamesCache.Add(value, Enum.GetName(typeof(AdventureWorks.Dal.Adapter.v51.EntityType), value));
			}
		}	
