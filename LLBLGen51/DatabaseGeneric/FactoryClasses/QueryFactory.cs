...
namespace AdventureWorks.Dal.Adapter.v51.FactoryClasses
{
	...
	public partial class QueryFactory
	{
		...
		public DynamicQuery<AdventureWorks.Dal.Adapter.v51.TypedViewClasses.SohQuerySpecPocoRow> SohQuerySpecPoco
		{
			get { return this.Create().Select<AdventureWorks.Dal.Adapter.v51.TypedViewClasses.SohQuerySpecPocoRow, AdventureWorks.Dal.Adapter.v51.HelperClasses.SohQuerySpecPocoFields>(); }
		}
