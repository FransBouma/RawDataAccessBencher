...
namespace AdventureWorks.Dal.Adapter.v51.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			this.PerformDesetupSyncRelatedEntity( _person, new PropertyChangedEventHandler( OnPersonPropertyChanged ), "Person", AdventureWorks.Dal.Adapter.v51.RelationClasses.StaticEmployeeRelations.PersonEntityUsingEmployeeIdStatic, true, signalRelatedEntity, "Employee", false, new int[] { (int)EmployeeFieldIndex.EmployeeId } );
			_person = null;
		}
		...
		private void SetupSyncPerson(IEntityCore relatedEntity)
		{
			if(_person!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _person, new PropertyChangedEventHandler( OnPersonPropertyChanged ), "Person", AdventureWorks.Dal.Adapter.v51.RelationClasses.StaticEmployeeRelations.PersonEntityUsingEmployeeIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncSalesPerson(IEntityCore relatedEntity)
		{
			if(_salesPerson!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _salesPerson, new PropertyChangedEventHandler( OnSalesPersonPropertyChanged ), "SalesPerson", AdventureWorks.Dal.Adapter.v51.RelationClasses.StaticEmployeeRelations.SalesPersonEntityUsingSalesPersonIdStatic, false, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<DocumentEntity>(EntityFactoryCache2.GetEntityFactory(typeof(DocumentEntityFactory))), (IEntityRelation)GetRelationsForField("Documents")[0], (int)AdventureWorks.Dal.Adapter.v51.EntityType.EmployeeEntity, (int)AdventureWorks.Dal.Adapter.v51.EntityType.DocumentEntity, 0, null, null, null, null, "Documents", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<JobCandidateEntity>(EntityFactoryCache2.GetEntityFactory(typeof(JobCandidateEntityFactory))), (IEntityRelation)GetRelationsForField("JobCandidates")[0], (int)AdventureWorks.Dal.Adapter.v51.EntityType.EmployeeEntity, (int)AdventureWorks.Dal.Adapter.v51.EntityType.JobCandidateEntity, 0, null, null, null, null, "JobCandidates", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v51.EntityType.EmployeeEntity; }
		}
