		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private void SetupSyncBusinessEntity(IEntityCore relatedEntity)
		{
			if(_businessEntity!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _businessEntity, new PropertyChangedEventHandler( OnBusinessEntityPropertyChanged ), "BusinessEntity", AdventureWorks.Dal.Adapter.v51.RelationClasses.StaticPersonRelations.BusinessEntityEntityUsingBusinessEntityIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", AdventureWorks.Dal.Adapter.v51.RelationClasses.StaticPersonRelations.EmployeeEntityUsingEmployeeIdStatic, false, signalRelatedEntity, "Person", false, new int[] { (int)PersonFieldIndex.BusinessEntityId } );
			_employee = null;
		}
		...
		private void SetupSyncEmployee(IEntityCore relatedEntity)
		{
			if(_employee!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", AdventureWorks.Dal.Adapter.v51.RelationClasses.StaticPersonRelations.EmployeeEntityUsingEmployeeIdStatic, false, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _password, new PropertyChangedEventHandler( OnPasswordPropertyChanged ), "Password", AdventureWorks.Dal.Adapter.v51.RelationClasses.StaticPersonRelations.PasswordEntityUsingBusinessEntityIdStatic, false, signalRelatedEntity, "Person", false, new int[] { (int)PersonFieldIndex.BusinessEntityId } );
			_password = null;
		}
		...
		private void SetupSyncPassword(IEntityCore relatedEntity)
		{
			if(_password!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _password, new PropertyChangedEventHandler( OnPasswordPropertyChanged ), "Password", AdventureWorks.Dal.Adapter.v51.RelationClasses.StaticPersonRelations.PasswordEntityUsingBusinessEntityIdStatic, false, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<EmailAddressEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmailAddressEntityFactory))), (IEntityRelation)GetRelationsForField("EmailAddresses")[0], (int)AdventureWorks.Dal.Adapter.v51.EntityType.PersonEntity, (int)AdventureWorks.Dal.Adapter.v51.EntityType.EmailAddressEntity, 0, null, null, null, null, "EmailAddresses", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<PersonPhoneEntity>(EntityFactoryCache2.GetEntityFactory(typeof(PersonPhoneEntityFactory))), (IEntityRelation)GetRelationsForField("PersonPhones")[0], (int)AdventureWorks.Dal.Adapter.v51.EntityType.PersonEntity, (int)AdventureWorks.Dal.Adapter.v51.EntityType.PersonPhoneEntity, 0, null, null, null, null, "PersonPhones", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get { return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeEntityFactory))), (IEntityRelation)GetRelationsForField("Employee")[0], (int)AdventureWorks.Dal.Adapter.v51.EntityType.PersonEntity, (int)AdventureWorks.Dal.Adapter.v51.EntityType.EmployeeEntity, 0, null, null, null, null, "Employee", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);	}
		}
		...
		{
			get { return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(PasswordEntityFactory))), (IEntityRelation)GetRelationsForField("Password")[0], (int)AdventureWorks.Dal.Adapter.v51.EntityType.PersonEntity, (int)AdventureWorks.Dal.Adapter.v51.EntityType.PasswordEntity, 0, null, null, null, null, "Password", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);	}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v51.EntityType.PersonEntity; }
		}
