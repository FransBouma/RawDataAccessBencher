		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private void SetupSyncProduct(IEntityCore relatedEntity)
		{
			if(_product!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", AdventureWorks.Dal.Adapter.v51.RelationClasses.StaticProductProductPhotoRelations.ProductEntityUsingProductIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductPhotoEntityFactory))),	(IEntityRelation)GetRelationsForField("ProductPhoto")[0], (int)AdventureWorks.Dal.Adapter.v51.EntityType.ProductProductPhotoEntity, (int)AdventureWorks.Dal.Adapter.v51.EntityType.ProductPhotoEntity, 0, null, null, null, null, "ProductPhoto", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v51.EntityType.ProductProductPhotoEntity; }
		}
