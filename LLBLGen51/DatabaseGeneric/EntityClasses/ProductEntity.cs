		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private void SetupSyncProductModel(IEntityCore relatedEntity)
		{
			if(_productModel!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _productModel, new PropertyChangedEventHandler( OnProductModelPropertyChanged ), "ProductModel", AdventureWorks.Dal.Adapter.v51.RelationClasses.StaticProductRelations.ProductModelEntityUsingProductModelIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncProductSubcategory(IEntityCore relatedEntity)
		{
			if(_productSubcategory!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _productSubcategory, new PropertyChangedEventHandler( OnProductSubcategoryPropertyChanged ), "ProductSubcategory", AdventureWorks.Dal.Adapter.v51.RelationClasses.StaticProductRelations.ProductSubcategoryEntityUsingProductSubcategoryIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncUnitMeasure(IEntityCore relatedEntity)
		{
			if(_unitMeasure!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _unitMeasure, new PropertyChangedEventHandler( OnUnitMeasurePropertyChanged ), "UnitMeasure", AdventureWorks.Dal.Adapter.v51.RelationClasses.StaticProductRelations.UnitMeasureEntityUsingSizeUnitMeasureCodeStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncUnitMeasure_(IEntityCore relatedEntity)
		{
			if(_unitMeasure_!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _unitMeasure_, new PropertyChangedEventHandler( OnUnitMeasure_PropertyChanged ), "UnitMeasure_", AdventureWorks.Dal.Adapter.v51.RelationClasses.StaticProductRelations.UnitMeasureEntityUsingWeightUnitMeasureCodeStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<BillOfMaterialEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BillOfMaterialEntityFactory))), (IEntityRelation)GetRelationsForField("BillOfMaterials")[0], (int)AdventureWorks.Dal.Adapter.v51.EntityType.ProductEntity, (int)AdventureWorks.Dal.Adapter.v51.EntityType.BillOfMaterialEntity, 0, null, null, null, null, "BillOfMaterials", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ProductCostHistoryEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductCostHistoryEntityFactory))), (IEntityRelation)GetRelationsForField("ProductCostHistories")[0], (int)AdventureWorks.Dal.Adapter.v51.EntityType.ProductEntity, (int)AdventureWorks.Dal.Adapter.v51.EntityType.ProductCostHistoryEntity, 0, null, null, null, null, "ProductCostHistories", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ProductDocumentEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductDocumentEntityFactory))), (IEntityRelation)GetRelationsForField("ProductDocuments")[0], (int)AdventureWorks.Dal.Adapter.v51.EntityType.ProductEntity, (int)AdventureWorks.Dal.Adapter.v51.EntityType.ProductDocumentEntity, 0, null, null, null, null, "ProductDocuments", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ProductInventoryEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductInventoryEntityFactory))), (IEntityRelation)GetRelationsForField("ProductInventories")[0], (int)AdventureWorks.Dal.Adapter.v51.EntityType.ProductEntity, (int)AdventureWorks.Dal.Adapter.v51.EntityType.ProductInventoryEntity, 0, null, null, null, null, "ProductInventories", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ProductProductPhotoEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductProductPhotoEntityFactory))), (IEntityRelation)GetRelationsForField("ProductProductPhotos")[0], (int)AdventureWorks.Dal.Adapter.v51.EntityType.ProductEntity, (int)AdventureWorks.Dal.Adapter.v51.EntityType.ProductProductPhotoEntity, 0, null, null, null, null, "ProductProductPhotos", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ProductReviewEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductReviewEntityFactory))), (IEntityRelation)GetRelationsForField("ProductReviews")[0], (int)AdventureWorks.Dal.Adapter.v51.EntityType.ProductEntity, (int)AdventureWorks.Dal.Adapter.v51.EntityType.ProductReviewEntity, 0, null, null, null, null, "ProductReviews", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ProductVendorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductVendorEntityFactory))), (IEntityRelation)GetRelationsForField("ProductVendors")[0], (int)AdventureWorks.Dal.Adapter.v51.EntityType.ProductEntity, (int)AdventureWorks.Dal.Adapter.v51.EntityType.ProductVendorEntity, 0, null, null, null, null, "ProductVendors", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<SpecialOfferProductEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SpecialOfferProductEntityFactory))), (IEntityRelation)GetRelationsForField("SpecialOfferProducts")[0], (int)AdventureWorks.Dal.Adapter.v51.EntityType.ProductEntity, (int)AdventureWorks.Dal.Adapter.v51.EntityType.SpecialOfferProductEntity, 0, null, null, null, null, "SpecialOfferProducts", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<TransactionHistoryEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TransactionHistoryEntityFactory))), (IEntityRelation)GetRelationsForField("TransactionHistories")[0], (int)AdventureWorks.Dal.Adapter.v51.EntityType.ProductEntity, (int)AdventureWorks.Dal.Adapter.v51.EntityType.TransactionHistoryEntity, 0, null, null, null, null, "TransactionHistories", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductModelEntityFactory))),	(IEntityRelation)GetRelationsForField("ProductModel")[0], (int)AdventureWorks.Dal.Adapter.v51.EntityType.ProductEntity, (int)AdventureWorks.Dal.Adapter.v51.EntityType.ProductModelEntity, 0, null, null, null, null, "ProductModel", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductSubcategoryEntityFactory))),	(IEntityRelation)GetRelationsForField("ProductSubcategory")[0], (int)AdventureWorks.Dal.Adapter.v51.EntityType.ProductEntity, (int)AdventureWorks.Dal.Adapter.v51.EntityType.ProductSubcategoryEntity, 0, null, null, null, null, "ProductSubcategory", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(UnitMeasureEntityFactory))),	(IEntityRelation)GetRelationsForField("UnitMeasure")[0], (int)AdventureWorks.Dal.Adapter.v51.EntityType.ProductEntity, (int)AdventureWorks.Dal.Adapter.v51.EntityType.UnitMeasureEntity, 0, null, null, null, null, "UnitMeasure", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(UnitMeasureEntityFactory))),	(IEntityRelation)GetRelationsForField("UnitMeasure_")[0], (int)AdventureWorks.Dal.Adapter.v51.EntityType.ProductEntity, (int)AdventureWorks.Dal.Adapter.v51.EntityType.UnitMeasureEntity, 0, null, null, null, null, "UnitMeasure_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v51.EntityType.ProductEntity; }
		}
