		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private void SetupSyncCountryRegion(IEntityCore relatedEntity)
		{
			if(_countryRegion!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _countryRegion, new PropertyChangedEventHandler( OnCountryRegionPropertyChanged ), "CountryRegion", AdventureWorks.Dal.Adapter.v51.RelationClasses.StaticStateProvinceRelations.CountryRegionEntityUsingCountryRegionCodeStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncSalesTerritory(IEntityCore relatedEntity)
		{
			if(_salesTerritory!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _salesTerritory, new PropertyChangedEventHandler( OnSalesTerritoryPropertyChanged ), "SalesTerritory", AdventureWorks.Dal.Adapter.v51.RelationClasses.StaticStateProvinceRelations.SalesTerritoryEntityUsingTerritoryIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<AddressEntity>(EntityFactoryCache2.GetEntityFactory(typeof(AddressEntityFactory))), (IEntityRelation)GetRelationsForField("Addresses")[0], (int)AdventureWorks.Dal.Adapter.v51.EntityType.StateProvinceEntity, (int)AdventureWorks.Dal.Adapter.v51.EntityType.AddressEntity, 0, null, null, null, null, "Addresses", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<SalesTaxRateEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SalesTaxRateEntityFactory))), (IEntityRelation)GetRelationsForField("SalesTaxRates")[0], (int)AdventureWorks.Dal.Adapter.v51.EntityType.StateProvinceEntity, (int)AdventureWorks.Dal.Adapter.v51.EntityType.SalesTaxRateEntity, 0, null, null, null, null, "SalesTaxRates", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CountryRegionEntityFactory))),	(IEntityRelation)GetRelationsForField("CountryRegion")[0], (int)AdventureWorks.Dal.Adapter.v51.EntityType.StateProvinceEntity, (int)AdventureWorks.Dal.Adapter.v51.EntityType.CountryRegionEntity, 0, null, null, null, null, "CountryRegion", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v51.EntityType.StateProvinceEntity; }
		}
