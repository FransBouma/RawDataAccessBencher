...
namespace AdventureWorks.Dal.Adapter.v51.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public IPredicateExpression ConstructFilterForUCRowguid()
		{
			...
			filter.Add(AdventureWorks.Dal.Adapter.v51.HelperClasses.DocumentFields.Rowguid == this.Fields.GetCurrentValue((int)DocumentFieldIndex.Rowguid));
 			return filter;
		}
		...
		private void SetupSyncEmployee(IEntityCore relatedEntity)
		{
			if(_employee!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", AdventureWorks.Dal.Adapter.v51.RelationClasses.StaticDocumentRelations.EmployeeEntityUsingOwnerStatic, true, new string[] {  } );
			}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v51.EntityType.DocumentEntity; }
		}
