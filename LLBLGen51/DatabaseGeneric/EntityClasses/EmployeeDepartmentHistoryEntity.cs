		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private void SetupSyncDepartment(IEntityCore relatedEntity)
		{
			if(_department!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _department, new PropertyChangedEventHandler( OnDepartmentPropertyChanged ), "Department", AdventureWorks.Dal.Adapter.v51.RelationClasses.StaticEmployeeDepartmentHistoryRelations.DepartmentEntityUsingDepartmentIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncEmployee(IEntityCore relatedEntity)
		{
			if(_employee!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", AdventureWorks.Dal.Adapter.v51.RelationClasses.StaticEmployeeDepartmentHistoryRelations.EmployeeEntityUsingEmployeeIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncShift(IEntityCore relatedEntity)
		{
			if(_shift!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _shift, new PropertyChangedEventHandler( OnShiftPropertyChanged ), "Shift", AdventureWorks.Dal.Adapter.v51.RelationClasses.StaticEmployeeDepartmentHistoryRelations.ShiftEntityUsingShiftIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(DepartmentEntityFactory))),	(IEntityRelation)GetRelationsForField("Department")[0], (int)AdventureWorks.Dal.Adapter.v51.EntityType.EmployeeDepartmentHistoryEntity, (int)AdventureWorks.Dal.Adapter.v51.EntityType.DepartmentEntity, 0, null, null, null, null, "Department", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ShiftEntityFactory))),	(IEntityRelation)GetRelationsForField("Shift")[0], (int)AdventureWorks.Dal.Adapter.v51.EntityType.EmployeeDepartmentHistoryEntity, (int)AdventureWorks.Dal.Adapter.v51.EntityType.ShiftEntity, 0, null, null, null, null, "Shift", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v51.EntityType.EmployeeDepartmentHistoryEntity; }
		}
