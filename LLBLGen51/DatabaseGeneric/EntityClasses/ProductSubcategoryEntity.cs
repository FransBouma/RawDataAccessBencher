...
namespace AdventureWorks.Dal.Adapter.v51.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductCategoryEntityFactory))),	(IEntityRelation)GetRelationsForField("ProductCategory")[0], (int)AdventureWorks.Dal.Adapter.v51.EntityType.ProductSubcategoryEntity, (int)AdventureWorks.Dal.Adapter.v51.EntityType.ProductCategoryEntity, 0, null, null, null, null, "ProductCategory", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v51.EntityType.ProductSubcategoryEntity; }
		}
