...
namespace AdventureWorks.Dal.Adapter.v51.TypedViewClasses
{
	/// <summary>Class which represents a row in the typed view 'SohLinqPoco'.</summary>
	/// <remarks>This class is a result class for a query, which is produced with the method <see cref="AdventureWorks.Dal.Adapter.v51.Linq.LinqMetaData.GetSohLinqPocoTypedView"/>.
