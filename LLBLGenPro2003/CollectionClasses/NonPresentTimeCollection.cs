...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of NonPresentTimeEntity objects. 
	/// </summary>
	[Serializable]
	public class NonPresentTimeCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public NonPresentTimeCollection():base(new PropertyDescriptorFactory(), typeof(NonPresentTimeCollection), new NonPresentTimeEntityFactory())
		{
		}
		...
		public NonPresentTimeCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(NonPresentTimeCollection), entityFactoryToUse)
		{
		}
		...
		public NonPresentTimeCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, NonPresentTimeValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(NonPresentTimeCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private NonPresentTimeCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("NonPresentTimeCollection");
		}

	
		/// <summary>
		/// Retrieves in this NonPresentTimeCollection object all NonPresentTimeEntity objects which have data in common
		...
		public bool GetMultiManyToOne(ReasonEntity reasonInstance, NonPresentTimeHeaderEntity nonPresentTimeHeaderInstance)
		{
			return GetMultiManyToOne(reasonInstance, nonPresentTimeHeaderInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, null);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(ReasonEntity reasonInstance, NonPresentTimeHeaderEntity nonPresentTimeHeaderInstance, IPredicateExpression filter)
		{
			return GetMultiManyToOne(reasonInstance, nonPresentTimeHeaderInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, filter);
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(ReasonEntity reasonInstance, NonPresentTimeHeaderEntity nonPresentTimeHeaderInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			...
			return dao.GetMulti(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, filter, reasonInstance, nonPresentTimeHeaderInstance);
		}
		...
		public int DeleteMultiManyToOne( ReasonEntity reasonInstance,  NonPresentTimeHeaderEntity nonPresentTimeHeaderInstance)
		{
			NonPresentTimeDAO dao = DAOFactory.CreateNonPresentTimeDAO();
			return dao.DeleteMulti(base.Transaction, reasonInstance, nonPresentTimeHeaderInstance);
		}


		/// <summary>
		/// Updates in the persistent storage all NonPresentTime entities which have data in common with the specified related Entities.
		/// If one is omitted, that entity is not used as a filter.
		...
		/// </summary>
		/// <param name="entityWithNewValues">NonPresentTimeEntity instance which holds the new values for the matching entities to update. Only
		/// changed fields are taken into account</param>
		/// <param name="reasonInstance">ReasonEntity instance to use as a filter for the NonPresentTimeEntity objects to return</param>
		/// <param name="nonPresentTimeHeaderInstance">NonPresentTimeHeaderEntity instance to use as a filter for the NonPresentTimeEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(NonPresentTimeEntity entityWithNewValues, ReasonEntity reasonInstance, NonPresentTimeHeaderEntity nonPresentTimeHeaderInstance)
		{
			NonPresentTimeDAO dao = DAOFactory.CreateNonPresentTimeDAO();
			return dao.UpdateMulti(entityWithNewValues.Fields, base.Transaction, reasonInstance, nonPresentTimeHeaderInstance);
		}
	
	

		/// <summary>
		/// Retrieves in this NonPresentTimeCollection object all NonPresentTimeEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves NonPresentTimeEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all NonPresentTime entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified NonPresentTimeEntity. 
		...
		/// will result in an update action which will affect all NonPresentTime entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(NonPresentTimeEntity entityWithNewValues, IPredicate updateFilter)
		{
			NonPresentTimeDAO dao = DAOFactory.CreateNonPresentTimeDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(NonPresentTimeEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			NonPresentTimeDAO dao = DAOFactory.CreateNonPresentTimeDAO();
		...
		{
			return "NonPresentTimeCollection";
		}
		...
		/// </summary>
		public NonPresentTimeEntity this [int index]
		{
			get { return (NonPresentTimeEntity)List[index]; }
		}
		#endregion
