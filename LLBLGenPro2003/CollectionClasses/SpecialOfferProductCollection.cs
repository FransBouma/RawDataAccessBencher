...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of SpecialOfferProductEntity objects. 
	/// </summary>
	[Serializable]
	public class SpecialOfferProductCollection : EntityCollectionBase
	{
		...
		/// CTor
		/// </summary>
		public SpecialOfferProductCollection():base(new PropertyDescriptorFactory(), typeof(SpecialOfferProductCollection), new SpecialOfferProductEntityFactory())
		{
		}
		...
		public SpecialOfferProductCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(SpecialOfferProductCollection), entityFactoryToUse)
		{
		}
		...
		public SpecialOfferProductCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, SpecialOfferProductValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(SpecialOfferProductCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private SpecialOfferProductCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("SpecialOfferProductCollection");
		}

	
		/// <summary>
		/// Retrieves in this SpecialOfferProductCollection object all SpecialOfferProductEntity objects which have data in common
		...
		public bool GetMultiManyToOne(ProductEntity productInstance, SpecialOfferEntity specialOfferInstance)
		{
			return GetMultiManyToOne(productInstance, specialOfferInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, null);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(ProductEntity productInstance, SpecialOfferEntity specialOfferInstance, IPredicateExpression filter)
		{
			return GetMultiManyToOne(productInstance, specialOfferInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, filter);
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(ProductEntity productInstance, SpecialOfferEntity specialOfferInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			...
			return dao.GetMulti(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, filter, productInstance, specialOfferInstance);
		}
		...
		public int DeleteMultiManyToOne( ProductEntity productInstance,  SpecialOfferEntity specialOfferInstance)
		{
			SpecialOfferProductDAO dao = DAOFactory.CreateSpecialOfferProductDAO();
		...
		/// <summary>
		/// Updates in the persistent storage all SpecialOfferProduct entities which have data in common with the specified related Entities.
		/// If one is omitted, that entity is not used as a filter.
		...
		/// </summary>
		/// <param name="entityWithNewValues">SpecialOfferProductEntity instance which holds the new values for the matching entities to update. Only
		/// changed fields are taken into account</param>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the SpecialOfferProductEntity objects to return</param>
		/// <param name="specialOfferInstance">SpecialOfferEntity instance to use as a filter for the SpecialOfferProductEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(SpecialOfferProductEntity entityWithNewValues, ProductEntity productInstance, SpecialOfferEntity specialOfferInstance)
		{
			SpecialOfferProductDAO dao = DAOFactory.CreateSpecialOfferProductDAO();
			return dao.UpdateMulti(entityWithNewValues.Fields, base.Transaction, productInstance, specialOfferInstance);
		}
	
	
		/// <summary>
		/// Retrieves in this SpecialOfferProductCollection object all SpecialOfferProductEntity objects which are related via a 
		/// Relation of type 'm:n' with the passed in SalesOrderHeaderEntity. 
		...
		public bool GetMultiManyToManyUsingSalesOrderHeader(SalesOrderHeaderEntity salesOrderHeaderInstance)
		{
			return GetMultiManyToManyUsingSalesOrderHeader(salesOrderHeaderInstance, base.MaxNumberOfItemsToReturn, base.SortClauses);
		}
		...
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingSalesOrderHeader(SalesOrderHeaderEntity salesOrderHeaderInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
			if(!base.SuppressClearInGetMulti)
			{
				this.Clear();
			...
			SpecialOfferProductDAO dao = DAOFactory.CreateSpecialOfferProductDAO();
			return dao.GetMultiUsingSalesOrderHeader(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, salesOrderHeaderInstance);
		}
	

		/// <summary>
		/// Retrieves in this SpecialOfferProductCollection object all SpecialOfferProductEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves SpecialOfferProductEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all SpecialOfferProduct entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified SpecialOfferProductEntity. 
