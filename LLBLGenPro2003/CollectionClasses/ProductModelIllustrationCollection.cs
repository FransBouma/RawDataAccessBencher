...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of ProductModelIllustrationEntity objects. 
	/// </summary>
	[Serializable]
	public class ProductModelIllustrationCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ProductModelIllustrationCollection():base(new PropertyDescriptorFactory(), typeof(ProductModelIllustrationCollection), new ProductModelIllustrationEntityFactory())
		{
		}
		...
		public ProductModelIllustrationCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ProductModelIllustrationCollection), entityFactoryToUse)
		{
		}
		...
		public ProductModelIllustrationCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, ProductModelIllustrationValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ProductModelIllustrationCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private ProductModelIllustrationCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("ProductModelIllustrationCollection");
		}

	
		/// <summary>
		/// Retrieves in this ProductModelIllustrationCollection object all ProductModelIllustrationEntity objects which have data in common
		...
		public bool GetMultiManyToOne(IllustrationEntity illustrationInstance, ProductModelEntity productModelInstance)
		{
			return GetMultiManyToOne(illustrationInstance, productModelInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, null);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(IllustrationEntity illustrationInstance, ProductModelEntity productModelInstance, IPredicateExpression filter)
		{
			return GetMultiManyToOne(illustrationInstance, productModelInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, filter);
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(IllustrationEntity illustrationInstance, ProductModelEntity productModelInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			...
			return dao.GetMulti(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, filter, illustrationInstance, productModelInstance);
		}
		...
		public int DeleteMultiManyToOne( IllustrationEntity illustrationInstance,  ProductModelEntity productModelInstance)
		{
			ProductModelIllustrationDAO dao = DAOFactory.CreateProductModelIllustrationDAO();
			return dao.DeleteMulti(base.Transaction, illustrationInstance, productModelInstance);
		}


		/// <summary>
		/// Updates in the persistent storage all ProductModelIllustration entities which have data in common with the specified related Entities.
		/// If one is omitted, that entity is not used as a filter.
		...
		/// </summary>
		/// <param name="entityWithNewValues">ProductModelIllustrationEntity instance which holds the new values for the matching entities to update. Only
		/// changed fields are taken into account</param>
		/// <param name="illustrationInstance">IllustrationEntity instance to use as a filter for the ProductModelIllustrationEntity objects to return</param>
		/// <param name="productModelInstance">ProductModelEntity instance to use as a filter for the ProductModelIllustrationEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(ProductModelIllustrationEntity entityWithNewValues, IllustrationEntity illustrationInstance, ProductModelEntity productModelInstance)
		{
			ProductModelIllustrationDAO dao = DAOFactory.CreateProductModelIllustrationDAO();
			return dao.UpdateMulti(entityWithNewValues.Fields, base.Transaction, illustrationInstance, productModelInstance);
		}
	
	

		/// <summary>
		/// Retrieves in this ProductModelIllustrationCollection object all ProductModelIllustrationEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves ProductModelIllustrationEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all ProductModelIllustration entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified ProductModelIllustrationEntity. 
		...
		/// will result in an update action which will affect all ProductModelIllustration entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(ProductModelIllustrationEntity entityWithNewValues, IPredicate updateFilter)
		{
			ProductModelIllustrationDAO dao = DAOFactory.CreateProductModelIllustrationDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(ProductModelIllustrationEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			ProductModelIllustrationDAO dao = DAOFactory.CreateProductModelIllustrationDAO();
		...
		/// </summary>
		public ProductModelIllustrationEntity this [int index]
		{
			get { return (ProductModelIllustrationEntity)List[index]; }
		}
		#endregion
