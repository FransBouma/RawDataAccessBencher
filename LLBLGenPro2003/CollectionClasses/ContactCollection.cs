...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of ContactEntity objects. 
	/// </summary>
	[Serializable]
	public class ContactCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ContactCollection():base(new PropertyDescriptorFactory(), typeof(ContactCollection), new ContactEntityFactory())
		{
		}
		...
		public ContactCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ContactCollection), entityFactoryToUse)
		{
		}
		...
		public ContactCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, ContactValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ContactCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private ContactCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("ContactCollection");
		}

	
	
		/// <summary>
		/// Retrieves in this ContactCollection object all ContactEntity objects which are related via a 
		...
		public bool GetMultiManyToManyUsingEmployee_(EmployeeEntity employeeInstance)
		{
			return GetMultiManyToManyUsingEmployee_(employeeInstance, base.MaxNumberOfItemsToReturn, base.SortClauses);
		}
		...
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingEmployee_(EmployeeEntity employeeInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
			...
			return dao.GetMultiUsingEmployee_(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, employeeInstance);
		}
		...
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingContactType_(ContactTypeEntity contactTypeInstance)
		{
			return GetMultiManyToManyUsingContactType_(contactTypeInstance, base.MaxNumberOfItemsToReturn, base.SortClauses);
		}
		...
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingContactType_(ContactTypeEntity contactTypeInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
			if(!base.SuppressClearInGetMulti)
			{
				this.Clear();
			...
			ContactDAO dao = DAOFactory.CreateContactDAO();
			return dao.GetMultiUsingContactType_(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, contactTypeInstance);
		}
		...
		/// <summary>
		/// Retrieves in this ContactCollection object all ContactEntity objects which are related via a 
		/// Relation of type 'm:n' with the passed in StoreEntity. 
		/// All current elements in the collection are removed from the collection.
		/// </summary>
		/// <param name="storeInstance">StoreEntity object to be used as a filter in the m:n relation</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingStore(StoreEntity storeInstance)
		{
			return GetMultiManyToManyUsingStore(storeInstance, base.MaxNumberOfItemsToReturn, base.SortClauses);
		}
		...
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingStore(StoreEntity storeInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
			if(!base.SuppressClearInGetMulti)
			{
				this.Clear();
			...
			ContactDAO dao = DAOFactory.CreateContactDAO();
			return dao.GetMultiUsingStore(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, storeInstance);
		}
	

		/// <summary>
		/// Retrieves in this ContactCollection object all ContactEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves ContactEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all Contact entities from the persistent storage</param>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified ContactEntity. 
		...
		/// </summary>
		/// <param name="entityWithNewValues">ContactEntity instance which holds the new values for the matching entities to update. Only
		...
		/// will result in an update action which will affect all Contact entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(ContactEntity entityWithNewValues, IPredicate updateFilter)
		{
			ContactDAO dao = DAOFactory.CreateContactDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(ContactEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			ContactDAO dao = DAOFactory.CreateContactDAO();
		...
		/// </summary>
		public ContactEntity this [int index]
		{
			get { return (ContactEntity)List[index]; }
		}
		#endregion
