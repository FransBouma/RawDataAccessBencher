...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of DepartmentEntity objects. 
	/// </summary>
	[Serializable]
	public class DepartmentCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public DepartmentCollection():base(new PropertyDescriptorFactory(), typeof(DepartmentCollection), new DepartmentEntityFactory())
		{
		}
		...
		public DepartmentCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(DepartmentCollection), entityFactoryToUse)
		{
		}
		...
		public DepartmentCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, DepartmentValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(DepartmentCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private DepartmentCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("DepartmentCollection");
		}

	
	
		/// <summary>
		/// Retrieves in this DepartmentCollection object all DepartmentEntity objects which are related via a 
		...
		/// <summary>
		/// Retrieves in this DepartmentCollection object all DepartmentEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves DepartmentEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all Department entities from the persistent storage</param>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified DepartmentEntity. 
		...
		/// </summary>
		/// <param name="entityWithNewValues">DepartmentEntity instance which holds the new values for the matching entities to update. Only
		...
		/// will result in an update action which will affect all Department entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(DepartmentEntity entityWithNewValues, IPredicate updateFilter)
		{
			DepartmentDAO dao = DAOFactory.CreateDepartmentDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(DepartmentEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			DepartmentDAO dao = DAOFactory.CreateDepartmentDAO();
		...
		/// </summary>
		public DepartmentEntity this [int index]
		{
			get { return (DepartmentEntity)List[index]; }
		}
		#endregion
