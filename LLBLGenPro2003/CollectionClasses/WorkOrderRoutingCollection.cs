...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of WorkOrderRoutingEntity objects. 
	/// </summary>
	[Serializable]
	public class WorkOrderRoutingCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public WorkOrderRoutingCollection():base(new PropertyDescriptorFactory(), typeof(WorkOrderRoutingCollection), new WorkOrderRoutingEntityFactory())
		{
		}
		...
		public WorkOrderRoutingCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(WorkOrderRoutingCollection), entityFactoryToUse)
		{
		}
		...
		public WorkOrderRoutingCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, WorkOrderRoutingValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(WorkOrderRoutingCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private WorkOrderRoutingCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("WorkOrderRoutingCollection");
		}

	
		/// <summary>
		/// Retrieves in this WorkOrderRoutingCollection object all WorkOrderRoutingEntity objects which have data in common
		...
		public bool GetMultiManyToOne(LocationEntity locationInstance, WorkOrderEntity workOrderInstance)
		{
			return GetMultiManyToOne(locationInstance, workOrderInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, null);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(LocationEntity locationInstance, WorkOrderEntity workOrderInstance, IPredicateExpression filter)
		{
			return GetMultiManyToOne(locationInstance, workOrderInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, filter);
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(LocationEntity locationInstance, WorkOrderEntity workOrderInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			...
			return dao.GetMulti(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, filter, locationInstance, workOrderInstance);
		}
		...
		public int DeleteMultiManyToOne( LocationEntity locationInstance,  WorkOrderEntity workOrderInstance)
		{
			WorkOrderRoutingDAO dao = DAOFactory.CreateWorkOrderRoutingDAO();
			return dao.DeleteMulti(base.Transaction, locationInstance, workOrderInstance);
		}


		/// <summary>
		/// Updates in the persistent storage all WorkOrderRouting entities which have data in common with the specified related Entities.
		/// If one is omitted, that entity is not used as a filter.
		...
		/// </summary>
		/// <param name="entityWithNewValues">WorkOrderRoutingEntity instance which holds the new values for the matching entities to update. Only
		/// changed fields are taken into account</param>
		/// <param name="locationInstance">LocationEntity instance to use as a filter for the WorkOrderRoutingEntity objects to return</param>
		/// <param name="workOrderInstance">WorkOrderEntity instance to use as a filter for the WorkOrderRoutingEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(WorkOrderRoutingEntity entityWithNewValues, LocationEntity locationInstance, WorkOrderEntity workOrderInstance)
		{
			WorkOrderRoutingDAO dao = DAOFactory.CreateWorkOrderRoutingDAO();
			return dao.UpdateMulti(entityWithNewValues.Fields, base.Transaction, locationInstance, workOrderInstance);
		}
	
	

		/// <summary>
		/// Retrieves in this WorkOrderRoutingCollection object all WorkOrderRoutingEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves WorkOrderRoutingEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all WorkOrderRouting entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified WorkOrderRoutingEntity. 
		...
		/// will result in an update action which will affect all WorkOrderRouting entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(WorkOrderRoutingEntity entityWithNewValues, IPredicate updateFilter)
		{
			WorkOrderRoutingDAO dao = DAOFactory.CreateWorkOrderRoutingDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(WorkOrderRoutingEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			WorkOrderRoutingDAO dao = DAOFactory.CreateWorkOrderRoutingDAO();
		...
		/// </summary>
		public WorkOrderRoutingEntity this [int index]
		{
			get { return (WorkOrderRoutingEntity)List[index]; }
		}
		#endregion
