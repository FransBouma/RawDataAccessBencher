...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of ProductCostHistoryEntity objects. 
	/// </summary>
	[Serializable]
	public class ProductCostHistoryCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ProductCostHistoryCollection():base(new PropertyDescriptorFactory(), typeof(ProductCostHistoryCollection), new ProductCostHistoryEntityFactory())
		{
		}
		...
		public ProductCostHistoryCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ProductCostHistoryCollection), entityFactoryToUse)
		{
		}
		...
		public ProductCostHistoryCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, ProductCostHistoryValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ProductCostHistoryCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private ProductCostHistoryCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("ProductCostHistoryCollection");
		}

	
		/// <summary>
		/// Retrieves in this ProductCostHistoryCollection object all ProductCostHistoryEntity objects which have data in common
		...
		/// <summary>
		/// Updates in the persistent storage all ProductCostHistory entities which have data in common with the specified related Entities.
		/// If one is omitted, that entity is not used as a filter.
		...
		/// </summary>
		/// <param name="entityWithNewValues">ProductCostHistoryEntity instance which holds the new values for the matching entities to update. Only
		/// changed fields are taken into account</param>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the ProductCostHistoryEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(ProductCostHistoryEntity entityWithNewValues, ProductEntity productInstance)
		{
			ProductCostHistoryDAO dao = DAOFactory.CreateProductCostHistoryDAO();
		...
		/// <summary>
		/// Retrieves in this ProductCostHistoryCollection object all ProductCostHistoryEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves ProductCostHistoryEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all ProductCostHistory entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified ProductCostHistoryEntity. 
		...
		/// will result in an update action which will affect all ProductCostHistory entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(ProductCostHistoryEntity entityWithNewValues, IPredicate updateFilter)
		{
			ProductCostHistoryDAO dao = DAOFactory.CreateProductCostHistoryDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(ProductCostHistoryEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			ProductCostHistoryDAO dao = DAOFactory.CreateProductCostHistoryDAO();
		...
		/// </summary>
		public ProductCostHistoryEntity this [int index]
		{
			get { return (ProductCostHistoryEntity)List[index]; }
		}
		#endregion
