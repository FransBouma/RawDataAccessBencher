...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of ShoppingCartItemEntity objects. 
	/// </summary>
	[Serializable]
	public class ShoppingCartItemCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ShoppingCartItemCollection():base(new PropertyDescriptorFactory(), typeof(ShoppingCartItemCollection), new ShoppingCartItemEntityFactory())
		{
		}
		...
		public ShoppingCartItemCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ShoppingCartItemCollection), entityFactoryToUse)
		{
		}
		...
		public ShoppingCartItemCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, ShoppingCartItemValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ShoppingCartItemCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private ShoppingCartItemCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("ShoppingCartItemCollection");
		}

	
		/// <summary>
		/// Retrieves in this ShoppingCartItemCollection object all ShoppingCartItemEntity objects which have data in common
		...
		/// <summary>
		/// Updates in the persistent storage all ShoppingCartItem entities which have data in common with the specified related Entities.
		/// If one is omitted, that entity is not used as a filter.
		...
		/// </summary>
		/// <param name="entityWithNewValues">ShoppingCartItemEntity instance which holds the new values for the matching entities to update. Only
		/// changed fields are taken into account</param>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the ShoppingCartItemEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(ShoppingCartItemEntity entityWithNewValues, ProductEntity productInstance)
		{
			ShoppingCartItemDAO dao = DAOFactory.CreateShoppingCartItemDAO();
		...
		/// <summary>
		/// Retrieves in this ShoppingCartItemCollection object all ShoppingCartItemEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves ShoppingCartItemEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all ShoppingCartItem entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified ShoppingCartItemEntity. 
		...
		/// will result in an update action which will affect all ShoppingCartItem entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(ShoppingCartItemEntity entityWithNewValues, IPredicate updateFilter)
		{
			ShoppingCartItemDAO dao = DAOFactory.CreateShoppingCartItemDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(ShoppingCartItemEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			ShoppingCartItemDAO dao = DAOFactory.CreateShoppingCartItemDAO();
		...
		/// </summary>
		public ShoppingCartItemEntity this [int index]
		{
			get { return (ShoppingCartItemEntity)List[index]; }
		}
		#endregion
