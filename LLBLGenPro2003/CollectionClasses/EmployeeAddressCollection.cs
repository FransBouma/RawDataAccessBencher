...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of EmployeeAddressEntity objects. 
	/// </summary>
	[Serializable]
	public class EmployeeAddressCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public EmployeeAddressCollection():base(new PropertyDescriptorFactory(), typeof(EmployeeAddressCollection), new EmployeeAddressEntityFactory())
		{
		}
		...
		public EmployeeAddressCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(EmployeeAddressCollection), entityFactoryToUse)
		{
		}
		...
		public EmployeeAddressCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, EmployeeAddressValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(EmployeeAddressCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private EmployeeAddressCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("EmployeeAddressCollection");
		}

	
		/// <summary>
		/// Retrieves in this EmployeeAddressCollection object all EmployeeAddressEntity objects which have data in common
		...
		public bool GetMultiManyToOne(AddressEntity addressInstance, EmployeeEntity employeeInstance)
		{
			return GetMultiManyToOne(addressInstance, employeeInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, null);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(AddressEntity addressInstance, EmployeeEntity employeeInstance, IPredicateExpression filter)
		{
			return GetMultiManyToOne(addressInstance, employeeInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, filter);
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(AddressEntity addressInstance, EmployeeEntity employeeInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			...
			EmployeeAddressDAO dao = DAOFactory.CreateEmployeeAddressDAO();
			return dao.GetMulti(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, filter, addressInstance, employeeInstance);
		}
		...
		public int DeleteMultiManyToOne( AddressEntity addressInstance,  EmployeeEntity employeeInstance)
		{
			EmployeeAddressDAO dao = DAOFactory.CreateEmployeeAddressDAO();
			return dao.DeleteMulti(base.Transaction, addressInstance, employeeInstance);
		}


		/// <summary>
		/// Updates in the persistent storage all EmployeeAddress entities which have data in common with the specified related Entities.
		/// If one is omitted, that entity is not used as a filter.
		...
		/// </summary>
		/// <param name="entityWithNewValues">EmployeeAddressEntity instance which holds the new values for the matching entities to update. Only
		/// changed fields are taken into account</param>
		/// <param name="addressInstance">AddressEntity instance to use as a filter for the EmployeeAddressEntity objects to return</param>
		/// <param name="employeeInstance">EmployeeEntity instance to use as a filter for the EmployeeAddressEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(EmployeeAddressEntity entityWithNewValues, AddressEntity addressInstance, EmployeeEntity employeeInstance)
		{
			EmployeeAddressDAO dao = DAOFactory.CreateEmployeeAddressDAO();
			return dao.UpdateMulti(entityWithNewValues.Fields, base.Transaction, addressInstance, employeeInstance);
		}
	
	

		/// <summary>
		/// Retrieves in this EmployeeAddressCollection object all EmployeeAddressEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves EmployeeAddressEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all EmployeeAddress entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified EmployeeAddressEntity. 
		...
		/// will result in an update action which will affect all EmployeeAddress entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(EmployeeAddressEntity entityWithNewValues, IPredicate updateFilter)
		{
			EmployeeAddressDAO dao = DAOFactory.CreateEmployeeAddressDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(EmployeeAddressEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			EmployeeAddressDAO dao = DAOFactory.CreateEmployeeAddressDAO();
		...
		/// </summary>
		public EmployeeAddressEntity this [int index]
		{
			get { return (EmployeeAddressEntity)List[index]; }
		}
		#endregion
