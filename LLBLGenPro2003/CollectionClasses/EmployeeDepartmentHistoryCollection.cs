...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of EmployeeDepartmentHistoryEntity objects. 
	/// </summary>
	[Serializable]
	public class EmployeeDepartmentHistoryCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public EmployeeDepartmentHistoryCollection():base(new PropertyDescriptorFactory(), typeof(EmployeeDepartmentHistoryCollection), new EmployeeDepartmentHistoryEntityFactory())
		{
		}
		...
		public EmployeeDepartmentHistoryCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(EmployeeDepartmentHistoryCollection), entityFactoryToUse)
		{
		}
		...
		public EmployeeDepartmentHistoryCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, EmployeeDepartmentHistoryValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(EmployeeDepartmentHistoryCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private EmployeeDepartmentHistoryCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("EmployeeDepartmentHistoryCollection");
		}

	
		/// <summary>
		/// Retrieves in this EmployeeDepartmentHistoryCollection object all EmployeeDepartmentHistoryEntity objects which have data in common
		...
		public bool GetMultiManyToOne(DepartmentEntity departmentInstance, EmployeeEntity employeeInstance, ShiftEntity shiftInstance)
		{
			return GetMultiManyToOne(departmentInstance, employeeInstance, shiftInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, null);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(DepartmentEntity departmentInstance, EmployeeEntity employeeInstance, ShiftEntity shiftInstance, IPredicateExpression filter)
		{
			return GetMultiManyToOne(departmentInstance, employeeInstance, shiftInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, filter);
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(DepartmentEntity departmentInstance, EmployeeEntity employeeInstance, ShiftEntity shiftInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			...
			return dao.GetMulti(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, filter, departmentInstance, employeeInstance, shiftInstance);
		}
		...
		public int DeleteMultiManyToOne( DepartmentEntity departmentInstance,  EmployeeEntity employeeInstance,  ShiftEntity shiftInstance)
		{
			EmployeeDepartmentHistoryDAO dao = DAOFactory.CreateEmployeeDepartmentHistoryDAO();
		...
		/// <summary>
		/// Updates in the persistent storage all EmployeeDepartmentHistory entities which have data in common with the specified related Entities.
		/// If one is omitted, that entity is not used as a filter.
		...
		/// </summary>
		/// <param name="entityWithNewValues">EmployeeDepartmentHistoryEntity instance which holds the new values for the matching entities to update. Only
		/// changed fields are taken into account</param>
		/// <param name="departmentInstance">DepartmentEntity instance to use as a filter for the EmployeeDepartmentHistoryEntity objects to return</param>
		/// <param name="employeeInstance">EmployeeEntity instance to use as a filter for the EmployeeDepartmentHistoryEntity objects to return</param>
		/// <param name="shiftInstance">ShiftEntity instance to use as a filter for the EmployeeDepartmentHistoryEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(EmployeeDepartmentHistoryEntity entityWithNewValues, DepartmentEntity departmentInstance, EmployeeEntity employeeInstance, ShiftEntity shiftInstance)
		{
			EmployeeDepartmentHistoryDAO dao = DAOFactory.CreateEmployeeDepartmentHistoryDAO();
			return dao.UpdateMulti(entityWithNewValues.Fields, base.Transaction, departmentInstance, employeeInstance, shiftInstance);
		}
	
	

		/// <summary>
		/// Retrieves in this EmployeeDepartmentHistoryCollection object all EmployeeDepartmentHistoryEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves EmployeeDepartmentHistoryEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all EmployeeDepartmentHistory entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified EmployeeDepartmentHistoryEntity. 
		...
		/// will result in an update action which will affect all EmployeeDepartmentHistory entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(EmployeeDepartmentHistoryEntity entityWithNewValues, IPredicate updateFilter)
		{
			EmployeeDepartmentHistoryDAO dao = DAOFactory.CreateEmployeeDepartmentHistoryDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(EmployeeDepartmentHistoryEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			EmployeeDepartmentHistoryDAO dao = DAOFactory.CreateEmployeeDepartmentHistoryDAO();
		...
		/// </summary>
		public EmployeeDepartmentHistoryEntity this [int index]
		{
			get { return (EmployeeDepartmentHistoryEntity)List[index]; }
		}
		#endregion
