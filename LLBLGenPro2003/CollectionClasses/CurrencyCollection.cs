...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of CurrencyEntity objects. 
	/// </summary>
	[Serializable]
	public class CurrencyCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public CurrencyCollection():base(new PropertyDescriptorFactory(), typeof(CurrencyCollection), new CurrencyEntityFactory())
		{
		}
		...
		public CurrencyCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(CurrencyCollection), entityFactoryToUse)
		{
		}
		...
		public CurrencyCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, CurrencyValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(CurrencyCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private CurrencyCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("CurrencyCollection");
		}

	
	
		/// <summary>
		/// Retrieves in this CurrencyCollection object all CurrencyEntity objects which are related via a 
		...
		/// <summary>
		/// Retrieves in this CurrencyCollection object all CurrencyEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves CurrencyEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all Currency entities from the persistent storage</param>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified CurrencyEntity. 
		...
		/// </summary>
		/// <param name="entityWithNewValues">CurrencyEntity instance which holds the new values for the matching entities to update. Only
		...
		/// will result in an update action which will affect all Currency entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(CurrencyEntity entityWithNewValues, IPredicate updateFilter)
		{
			CurrencyDAO dao = DAOFactory.CreateCurrencyDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(CurrencyEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			CurrencyDAO dao = DAOFactory.CreateCurrencyDAO();
		...
		/// </summary>
		public CurrencyEntity this [int index]
		{
			get { return (CurrencyEntity)List[index]; }
		}
		#endregion
