...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of ProductReviewEntity objects. 
	/// </summary>
	[Serializable]
	public class ProductReviewCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ProductReviewCollection():base(new PropertyDescriptorFactory(), typeof(ProductReviewCollection), new ProductReviewEntityFactory())
		{
		}
		...
		public ProductReviewCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ProductReviewCollection), entityFactoryToUse)
		{
		}
		...
		public ProductReviewCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, ProductReviewValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ProductReviewCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private ProductReviewCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("ProductReviewCollection");
		}

	
		/// <summary>
		/// Retrieves in this ProductReviewCollection object all ProductReviewEntity objects which have data in common
		...
		/// <summary>
		/// Updates in the persistent storage all ProductReview entities which have data in common with the specified related Entities.
		/// If one is omitted, that entity is not used as a filter.
		...
		/// </summary>
		/// <param name="entityWithNewValues">ProductReviewEntity instance which holds the new values for the matching entities to update. Only
		/// changed fields are taken into account</param>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the ProductReviewEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(ProductReviewEntity entityWithNewValues, ProductEntity productInstance)
		{
			ProductReviewDAO dao = DAOFactory.CreateProductReviewDAO();
		...
		/// <summary>
		/// Retrieves in this ProductReviewCollection object all ProductReviewEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves ProductReviewEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all ProductReview entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified ProductReviewEntity. 
		...
		/// will result in an update action which will affect all ProductReview entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(ProductReviewEntity entityWithNewValues, IPredicate updateFilter)
		{
			ProductReviewDAO dao = DAOFactory.CreateProductReviewDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(ProductReviewEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			ProductReviewDAO dao = DAOFactory.CreateProductReviewDAO();
		...
		/// </summary>
		public ProductReviewEntity this [int index]
		{
			get { return (ProductReviewEntity)List[index]; }
		}
		#endregion
