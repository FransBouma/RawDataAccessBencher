...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of SalesTaxRateEntity objects. 
	/// </summary>
	[Serializable]
	public class SalesTaxRateCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public SalesTaxRateCollection():base(new PropertyDescriptorFactory(), typeof(SalesTaxRateCollection), new SalesTaxRateEntityFactory())
		{
		}
		...
		public SalesTaxRateCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(SalesTaxRateCollection), entityFactoryToUse)
		{
		}
		...
		public SalesTaxRateCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, SalesTaxRateValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(SalesTaxRateCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private SalesTaxRateCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("SalesTaxRateCollection");
		}

	
		/// <summary>
		/// Retrieves in this SalesTaxRateCollection object all SalesTaxRateEntity objects which have data in common
		...
		/// <summary>
		/// Updates in the persistent storage all SalesTaxRate entities which have data in common with the specified related Entities.
		/// If one is omitted, that entity is not used as a filter.
		...
		/// </summary>
		/// <param name="entityWithNewValues">SalesTaxRateEntity instance which holds the new values for the matching entities to update. Only
		/// changed fields are taken into account</param>
		/// <param name="stateProvinceInstance">StateProvinceEntity instance to use as a filter for the SalesTaxRateEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(SalesTaxRateEntity entityWithNewValues, StateProvinceEntity stateProvinceInstance)
		{
			SalesTaxRateDAO dao = DAOFactory.CreateSalesTaxRateDAO();
		...
		/// <summary>
		/// Retrieves in this SalesTaxRateCollection object all SalesTaxRateEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves SalesTaxRateEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all SalesTaxRate entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified SalesTaxRateEntity. 
		...
		/// will result in an update action which will affect all SalesTaxRate entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(SalesTaxRateEntity entityWithNewValues, IPredicate updateFilter)
		{
			SalesTaxRateDAO dao = DAOFactory.CreateSalesTaxRateDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(SalesTaxRateEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			SalesTaxRateDAO dao = DAOFactory.CreateSalesTaxRateDAO();
		...
		/// </summary>
		public SalesTaxRateEntity this [int index]
		{
			get { return (SalesTaxRateEntity)List[index]; }
		}
		#endregion
