...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of DocumentEntity objects. 
	/// </summary>
	[Serializable]
	public class DocumentCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public DocumentCollection():base(new PropertyDescriptorFactory(), typeof(DocumentCollection), new DocumentEntityFactory())
		{
		}
		...
		public DocumentCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(DocumentCollection), entityFactoryToUse)
		{
		}
		...
		public DocumentCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, DocumentValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(DocumentCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private DocumentCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("DocumentCollection");
		}

	
	
		/// <summary>
		/// Retrieves in this DocumentCollection object all DocumentEntity objects which are related via a 
		...
		/// <summary>
		/// Retrieves in this DocumentCollection object all DocumentEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves DocumentEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all Document entities from the persistent storage</param>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified DocumentEntity. 
		...
		/// </summary>
		/// <param name="entityWithNewValues">DocumentEntity instance which holds the new values for the matching entities to update. Only
		...
		/// will result in an update action which will affect all Document entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(DocumentEntity entityWithNewValues, IPredicate updateFilter)
		{
			DocumentDAO dao = DAOFactory.CreateDocumentDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(DocumentEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			DocumentDAO dao = DAOFactory.CreateDocumentDAO();
		...
		/// </summary>
		public DocumentEntity this [int index]
		{
			get { return (DocumentEntity)List[index]; }
		}
		#endregion
