...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of CustomerEntity objects. 
	/// </summary>
	[Serializable]
	public class CustomerCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public CustomerCollection():base(new PropertyDescriptorFactory(), typeof(CustomerCollection), new CustomerEntityFactory())
		{
		}
		...
		public CustomerCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(CustomerCollection), entityFactoryToUse)
		{
		}
		...
		public CustomerCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, CustomerValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(CustomerCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private CustomerCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("CustomerCollection");
		}

	
		/// <summary>
		/// Retrieves in this CustomerCollection object all CustomerEntity objects which have data in common
		...
		/// <summary>
		/// Updates in the persistent storage all Customer entities which have data in common with the specified related Entities.
		/// If one is omitted, that entity is not used as a filter.
		...
		/// </summary>
		/// <param name="entityWithNewValues">CustomerEntity instance which holds the new values for the matching entities to update. Only
		/// changed fields are taken into account</param>
		/// <param name="salesTerritoryInstance">SalesTerritoryEntity instance to use as a filter for the CustomerEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(CustomerEntity entityWithNewValues, SalesTerritoryEntity salesTerritoryInstance)
		{
			CustomerDAO dao = DAOFactory.CreateCustomerDAO();
		...
		/// <summary>
		/// Retrieves in this CustomerCollection object all CustomerEntity objects which are related via a 
		...
		/// <param name="addressInstance">AddressEntity object to be used as a filter in the m:n relation</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingAddress__(AddressEntity addressInstance)
		{
			return GetMultiManyToManyUsingAddress__(addressInstance, base.MaxNumberOfItemsToReturn, base.SortClauses);
		}
		...
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingAddress__(AddressEntity addressInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
			if(!base.SuppressClearInGetMulti)
			{
				this.Clear();
			...
			CustomerDAO dao = DAOFactory.CreateCustomerDAO();
			return dao.GetMultiUsingAddress__(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, addressInstance);
		}
		...
		/// <summary>
		/// Retrieves in this CustomerCollection object all CustomerEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves CustomerEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all Customer entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified CustomerEntity. 
		...
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(CustomerEntity entityWithNewValues, IPredicate updateFilter)
		{
			CustomerDAO dao = DAOFactory.CreateCustomerDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(CustomerEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			CustomerDAO dao = DAOFactory.CreateCustomerDAO();
		...
		{
			get { return (CustomerEntity)List[index]; }
		}
		#endregion
