...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of AWBuildVersionEntity objects. 
	/// </summary>
	[Serializable]
	public class AWBuildVersionCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public AWBuildVersionCollection():base(new PropertyDescriptorFactory(), typeof(AWBuildVersionCollection), new AWBuildVersionEntityFactory())
		{
		}
		...
		public AWBuildVersionCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(AWBuildVersionCollection), entityFactoryToUse)
		{
		}
		...
		public AWBuildVersionCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, AWBuildVersionValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(AWBuildVersionCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private AWBuildVersionCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("AWBuildVersionCollection");
		}
		...
		/// <summary>
		/// Retrieves in this AWBuildVersionCollection object all AWBuildVersionEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves AWBuildVersionEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all AWBuildVersion entities from the persistent storage</param>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified AWBuildVersionEntity. 
		...
		/// </summary>
		/// <param name="entityWithNewValues">AWBuildVersionEntity instance which holds the new values for the matching entities to update. Only
		...
		/// will result in an update action which will affect all AWBuildVersion entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(AWBuildVersionEntity entityWithNewValues, IPredicate updateFilter)
		{
			AWBuildVersionDAO dao = DAOFactory.CreateAWBuildVersionDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(AWBuildVersionEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			AWBuildVersionDAO dao = DAOFactory.CreateAWBuildVersionDAO();
		...
		{
			return "AWBuildVersionCollection";
		}
		...
		/// </summary>
		public AWBuildVersionEntity this [int index]
		{
			get { return (AWBuildVersionEntity)List[index]; }
		}
		#endregion
