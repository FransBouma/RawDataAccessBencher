...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of ProductModelEntity objects. 
	/// </summary>
	[Serializable]
	public class ProductModelCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ProductModelCollection():base(new PropertyDescriptorFactory(), typeof(ProductModelCollection), new ProductModelEntityFactory())
		{
		}
		...
		public ProductModelCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ProductModelCollection), entityFactoryToUse)
		{
		}
		...
		public ProductModelCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, ProductModelValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ProductModelCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private ProductModelCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("ProductModelCollection");
		}

	
	
		/// <summary>
		/// Retrieves in this ProductModelCollection object all ProductModelEntity objects which are related via a 
		...
		/// <param name="unitMeasureInstance">UnitMeasureEntity object to be used as a filter in the m:n relation</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingUnitMeasure_(UnitMeasureEntity unitMeasureInstance)
		{
			return GetMultiManyToManyUsingUnitMeasure_(unitMeasureInstance, base.MaxNumberOfItemsToReturn, base.SortClauses);
		}
		...
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingUnitMeasure_(UnitMeasureEntity unitMeasureInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
			if(!base.SuppressClearInGetMulti)
			{
				this.Clear();
			...
			ProductModelDAO dao = DAOFactory.CreateProductModelDAO();
			return dao.GetMultiUsingUnitMeasure_(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, unitMeasureInstance);
		}
	
		/// <summary>
		/// Retrieves in this ProductModelCollection object all ProductModelEntity objects which are related via a 
		/// Relation of type 'm:n' with the passed in IllustrationEntity. 
		/// All current elements in the collection are removed from the collection.
		/// </summary>
		/// <param name="illustrationInstance">IllustrationEntity object to be used as a filter in the m:n relation</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingIllustration(IllustrationEntity illustrationInstance)
		{
			return GetMultiManyToManyUsingIllustration(illustrationInstance, base.MaxNumberOfItemsToReturn, base.SortClauses);
		}
		...
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingIllustration(IllustrationEntity illustrationInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
			if(!base.SuppressClearInGetMulti)
			{
				this.Clear();
			...
			ProductModelDAO dao = DAOFactory.CreateProductModelDAO();
			return dao.GetMultiUsingIllustration(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, illustrationInstance);
		}
	
		/// <summary>
		/// Retrieves in this ProductModelCollection object all ProductModelEntity objects which are related via a 
		/// Relation of type 'm:n' with the passed in CultureEntity. 
		/// All current elements in the collection are removed from the collection.
		/// </summary>
		/// <param name="cultureInstance">CultureEntity object to be used as a filter in the m:n relation</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingCulture(CultureEntity cultureInstance)
		{
			return GetMultiManyToManyUsingCulture(cultureInstance, base.MaxNumberOfItemsToReturn, base.SortClauses);
		}
		...
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingCulture(CultureEntity cultureInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
			if(!base.SuppressClearInGetMulti)
			{
				this.Clear();
			...
			ProductModelDAO dao = DAOFactory.CreateProductModelDAO();
			return dao.GetMultiUsingCulture(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, cultureInstance);
		}
	
		/// <summary>
		/// Retrieves in this ProductModelCollection object all ProductModelEntity objects which are related via a 
		/// Relation of type 'm:n' with the passed in ProductDescriptionEntity. 
		/// All current elements in the collection are removed from the collection.
		/// </summary>
		/// <param name="productDescriptionInstance">ProductDescriptionEntity object to be used as a filter in the m:n relation</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingProductDescription(ProductDescriptionEntity productDescriptionInstance)
		{
			return GetMultiManyToManyUsingProductDescription(productDescriptionInstance, base.MaxNumberOfItemsToReturn, base.SortClauses);
		}
		...
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingProductDescription(ProductDescriptionEntity productDescriptionInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
			if(!base.SuppressClearInGetMulti)
			{
				this.Clear();
			...
			ProductModelDAO dao = DAOFactory.CreateProductModelDAO();
			return dao.GetMultiUsingProductDescription(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, productDescriptionInstance);
		}
	

		/// <summary>
		/// Retrieves in this ProductModelCollection object all ProductModelEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves ProductModelEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all ProductModel entities from the persistent storage</param>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified ProductModelEntity. 
		...
		/// </summary>
		/// <param name="entityWithNewValues">ProductModelEntity instance which holds the new values for the matching entities to update. Only
		...
		/// will result in an update action which will affect all ProductModel entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(ProductModelEntity entityWithNewValues, IPredicate updateFilter)
		{
			ProductModelDAO dao = DAOFactory.CreateProductModelDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(ProductModelEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			ProductModelDAO dao = DAOFactory.CreateProductModelDAO();
		...
		/// </summary>
		public ProductModelEntity this [int index]
		{
			get { return (ProductModelEntity)List[index]; }
		}
		#endregion
