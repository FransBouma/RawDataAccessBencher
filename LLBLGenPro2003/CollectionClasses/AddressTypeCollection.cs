...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of AddressTypeEntity objects. 
	/// </summary>
	[Serializable]
	public class AddressTypeCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public AddressTypeCollection():base(new PropertyDescriptorFactory(), typeof(AddressTypeCollection), new AddressTypeEntityFactory())
		{
		}
		...
		public AddressTypeCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(AddressTypeCollection), entityFactoryToUse)
		{
		}
		...
		public AddressTypeCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, AddressTypeValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(AddressTypeCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private AddressTypeCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("AddressTypeCollection");
		}

	
	
		/// <summary>
		/// Retrieves in this AddressTypeCollection object all AddressTypeEntity objects which are related via a 
		...
		/// <summary>
		/// Retrieves in this AddressTypeCollection object all AddressTypeEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves AddressTypeEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all AddressType entities from the persistent storage</param>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified AddressTypeEntity. 
		...
		/// </summary>
		/// <param name="entityWithNewValues">AddressTypeEntity instance which holds the new values for the matching entities to update. Only
		...
		/// will result in an update action which will affect all AddressType entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(AddressTypeEntity entityWithNewValues, IPredicate updateFilter)
		{
			AddressTypeDAO dao = DAOFactory.CreateAddressTypeDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(AddressTypeEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			AddressTypeDAO dao = DAOFactory.CreateAddressTypeDAO();
		...
		/// </summary>
		public AddressTypeEntity this [int index]
		{
			get { return (AddressTypeEntity)List[index]; }
		}
		#endregion
