...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of SalesPersonQuotaHistoryEntity objects. 
	/// </summary>
	[Serializable]
	public class SalesPersonQuotaHistoryCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public SalesPersonQuotaHistoryCollection():base(new PropertyDescriptorFactory(), typeof(SalesPersonQuotaHistoryCollection), new SalesPersonQuotaHistoryEntityFactory())
		{
		}
		...
		public SalesPersonQuotaHistoryCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(SalesPersonQuotaHistoryCollection), entityFactoryToUse)
		{
		}
		...
		public SalesPersonQuotaHistoryCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, SalesPersonQuotaHistoryValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(SalesPersonQuotaHistoryCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private SalesPersonQuotaHistoryCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("SalesPersonQuotaHistoryCollection");
		}

	
		/// <summary>
		/// Retrieves in this SalesPersonQuotaHistoryCollection object all SalesPersonQuotaHistoryEntity objects which have data in common
		...
		/// <summary>
		/// Updates in the persistent storage all SalesPersonQuotaHistory entities which have data in common with the specified related Entities.
		/// If one is omitted, that entity is not used as a filter.
		...
		/// </summary>
		/// <param name="entityWithNewValues">SalesPersonQuotaHistoryEntity instance which holds the new values for the matching entities to update. Only
		/// changed fields are taken into account</param>
		/// <param name="salesPersonInstance">SalesPersonEntity instance to use as a filter for the SalesPersonQuotaHistoryEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(SalesPersonQuotaHistoryEntity entityWithNewValues, SalesPersonEntity salesPersonInstance)
		{
			SalesPersonQuotaHistoryDAO dao = DAOFactory.CreateSalesPersonQuotaHistoryDAO();
		...
		/// <summary>
		/// Retrieves in this SalesPersonQuotaHistoryCollection object all SalesPersonQuotaHistoryEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves SalesPersonQuotaHistoryEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all SalesPersonQuotaHistory entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified SalesPersonQuotaHistoryEntity. 
		...
		/// will result in an update action which will affect all SalesPersonQuotaHistory entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(SalesPersonQuotaHistoryEntity entityWithNewValues, IPredicate updateFilter)
		{
			SalesPersonQuotaHistoryDAO dao = DAOFactory.CreateSalesPersonQuotaHistoryDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(SalesPersonQuotaHistoryEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			SalesPersonQuotaHistoryDAO dao = DAOFactory.CreateSalesPersonQuotaHistoryDAO();
		...
		/// </summary>
		public SalesPersonQuotaHistoryEntity this [int index]
		{
			get { return (SalesPersonQuotaHistoryEntity)List[index]; }
		}
		#endregion
