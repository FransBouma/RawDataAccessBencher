...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of PurchaseOrderDetailEntity objects. 
	/// </summary>
	[Serializable]
	public class PurchaseOrderDetailCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public PurchaseOrderDetailCollection():base(new PropertyDescriptorFactory(), typeof(PurchaseOrderDetailCollection), new PurchaseOrderDetailEntityFactory())
		{
		}
		...
		public PurchaseOrderDetailCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(PurchaseOrderDetailCollection), entityFactoryToUse)
		{
		}
		...
		public PurchaseOrderDetailCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, PurchaseOrderDetailValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(PurchaseOrderDetailCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private PurchaseOrderDetailCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("PurchaseOrderDetailCollection");
		}

	
		/// <summary>
		/// Retrieves in this PurchaseOrderDetailCollection object all PurchaseOrderDetailEntity objects which have data in common
		...
		public bool GetMultiManyToOne(ProductEntity productInstance, PurchaseOrderHeaderEntity purchaseOrderHeaderInstance)
		{
			return GetMultiManyToOne(productInstance, purchaseOrderHeaderInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, null);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(ProductEntity productInstance, PurchaseOrderHeaderEntity purchaseOrderHeaderInstance, IPredicateExpression filter)
		{
			return GetMultiManyToOne(productInstance, purchaseOrderHeaderInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, filter);
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(ProductEntity productInstance, PurchaseOrderHeaderEntity purchaseOrderHeaderInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			...
			return dao.GetMulti(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, filter, productInstance, purchaseOrderHeaderInstance);
		}
		...
		public int DeleteMultiManyToOne( ProductEntity productInstance,  PurchaseOrderHeaderEntity purchaseOrderHeaderInstance)
		{
			PurchaseOrderDetailDAO dao = DAOFactory.CreatePurchaseOrderDetailDAO();
			return dao.DeleteMulti(base.Transaction, productInstance, purchaseOrderHeaderInstance);
		}


		/// <summary>
		/// Updates in the persistent storage all PurchaseOrderDetail entities which have data in common with the specified related Entities.
		/// If one is omitted, that entity is not used as a filter.
		...
		/// </summary>
		/// <param name="entityWithNewValues">PurchaseOrderDetailEntity instance which holds the new values for the matching entities to update. Only
		/// changed fields are taken into account</param>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the PurchaseOrderDetailEntity objects to return</param>
		/// <param name="purchaseOrderHeaderInstance">PurchaseOrderHeaderEntity instance to use as a filter for the PurchaseOrderDetailEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(PurchaseOrderDetailEntity entityWithNewValues, ProductEntity productInstance, PurchaseOrderHeaderEntity purchaseOrderHeaderInstance)
		{
			PurchaseOrderDetailDAO dao = DAOFactory.CreatePurchaseOrderDetailDAO();
			return dao.UpdateMulti(entityWithNewValues.Fields, base.Transaction, productInstance, purchaseOrderHeaderInstance);
		}
	
	

		/// <summary>
		/// Retrieves in this PurchaseOrderDetailCollection object all PurchaseOrderDetailEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves PurchaseOrderDetailEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all PurchaseOrderDetail entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified PurchaseOrderDetailEntity. 
		...
		/// will result in an update action which will affect all PurchaseOrderDetail entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(PurchaseOrderDetailEntity entityWithNewValues, IPredicate updateFilter)
		{
			PurchaseOrderDetailDAO dao = DAOFactory.CreatePurchaseOrderDetailDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(PurchaseOrderDetailEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			PurchaseOrderDetailDAO dao = DAOFactory.CreatePurchaseOrderDetailDAO();
		...
		/// </summary>
		public PurchaseOrderDetailEntity this [int index]
		{
			get { return (PurchaseOrderDetailEntity)List[index]; }
		}
		#endregion
