...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of VendorContactEntity objects. 
	/// </summary>
	[Serializable]
	public class VendorContactCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public VendorContactCollection():base(new PropertyDescriptorFactory(), typeof(VendorContactCollection), new VendorContactEntityFactory())
		{
		}
		...
		public VendorContactCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(VendorContactCollection), entityFactoryToUse)
		{
		}
		...
		public VendorContactCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, VendorContactValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(VendorContactCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private VendorContactCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("VendorContactCollection");
		}

	
		/// <summary>
		/// Retrieves in this VendorContactCollection object all VendorContactEntity objects which have data in common
		...
		public bool GetMultiManyToOne(ContactEntity contactInstance, ContactTypeEntity contactTypeInstance, VendorEntity vendorInstance)
		{
			return GetMultiManyToOne(contactInstance, contactTypeInstance, vendorInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, null);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(ContactEntity contactInstance, ContactTypeEntity contactTypeInstance, VendorEntity vendorInstance, IPredicateExpression filter)
		{
			return GetMultiManyToOne(contactInstance, contactTypeInstance, vendorInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, filter);
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(ContactEntity contactInstance, ContactTypeEntity contactTypeInstance, VendorEntity vendorInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			...
			return dao.GetMulti(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, filter, contactInstance, contactTypeInstance, vendorInstance);
		}
		...
		public int DeleteMultiManyToOne( ContactEntity contactInstance,  ContactTypeEntity contactTypeInstance,  VendorEntity vendorInstance)
		{
			VendorContactDAO dao = DAOFactory.CreateVendorContactDAO();
		...
		/// <summary>
		/// Updates in the persistent storage all VendorContact entities which have data in common with the specified related Entities.
		/// If one is omitted, that entity is not used as a filter.
		...
		/// </summary>
		/// <param name="entityWithNewValues">VendorContactEntity instance which holds the new values for the matching entities to update. Only
		/// changed fields are taken into account</param>
		/// <param name="contactInstance">ContactEntity instance to use as a filter for the VendorContactEntity objects to return</param>
		/// <param name="contactTypeInstance">ContactTypeEntity instance to use as a filter for the VendorContactEntity objects to return</param>
		/// <param name="vendorInstance">VendorEntity instance to use as a filter for the VendorContactEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(VendorContactEntity entityWithNewValues, ContactEntity contactInstance, ContactTypeEntity contactTypeInstance, VendorEntity vendorInstance)
		{
			VendorContactDAO dao = DAOFactory.CreateVendorContactDAO();
			return dao.UpdateMulti(entityWithNewValues.Fields, base.Transaction, contactInstance, contactTypeInstance, vendorInstance);
		}
	
	

		/// <summary>
		/// Retrieves in this VendorContactCollection object all VendorContactEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves VendorContactEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all VendorContact entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified VendorContactEntity. 
		...
		/// will result in an update action which will affect all VendorContact entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(VendorContactEntity entityWithNewValues, IPredicate updateFilter)
		{
			VendorContactDAO dao = DAOFactory.CreateVendorContactDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(VendorContactEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			VendorContactDAO dao = DAOFactory.CreateVendorContactDAO();
		...
		{
			return "VendorContactCollection";
		}
		...
		/// </summary>
		public VendorContactEntity this [int index]
		{
			get { return (VendorContactEntity)List[index]; }
		}
		#endregion
