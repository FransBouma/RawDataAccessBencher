...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of ScrapReasonEntity objects. 
	/// </summary>
	[Serializable]
	public class ScrapReasonCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ScrapReasonCollection():base(new PropertyDescriptorFactory(), typeof(ScrapReasonCollection), new ScrapReasonEntityFactory())
		{
		}
		...
		public ScrapReasonCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ScrapReasonCollection), entityFactoryToUse)
		{
		}
		...
		public ScrapReasonCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, ScrapReasonValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ScrapReasonCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private ScrapReasonCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("ScrapReasonCollection");
		}

	
	
		/// <summary>
		/// Retrieves in this ScrapReasonCollection object all ScrapReasonEntity objects which are related via a 
		...
		/// <summary>
		/// Retrieves in this ScrapReasonCollection object all ScrapReasonEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves ScrapReasonEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all ScrapReason entities from the persistent storage</param>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified ScrapReasonEntity. 
		...
		/// </summary>
		/// <param name="entityWithNewValues">ScrapReasonEntity instance which holds the new values for the matching entities to update. Only
		...
		/// will result in an update action which will affect all ScrapReason entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(ScrapReasonEntity entityWithNewValues, IPredicate updateFilter)
		{
			ScrapReasonDAO dao = DAOFactory.CreateScrapReasonDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(ScrapReasonEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			ScrapReasonDAO dao = DAOFactory.CreateScrapReasonDAO();
		...
		/// </summary>
		public ScrapReasonEntity this [int index]
		{
			get { return (ScrapReasonEntity)List[index]; }
		}
		#endregion
