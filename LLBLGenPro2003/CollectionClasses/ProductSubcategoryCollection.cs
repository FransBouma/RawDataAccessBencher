...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of ProductSubcategoryEntity objects. 
	/// </summary>
	[Serializable]
	public class ProductSubcategoryCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ProductSubcategoryCollection():base(new PropertyDescriptorFactory(), typeof(ProductSubcategoryCollection), new ProductSubcategoryEntityFactory())
		{
		}
		...
		public ProductSubcategoryCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ProductSubcategoryCollection), entityFactoryToUse)
		{
		}
		...
		public ProductSubcategoryCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, ProductSubcategoryValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ProductSubcategoryCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private ProductSubcategoryCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("ProductSubcategoryCollection");
		}

	
		/// <summary>
		/// Retrieves in this ProductSubcategoryCollection object all ProductSubcategoryEntity objects which have data in common
		...
		public bool GetMultiManyToOne(ProductCategoryEntity productCategoryInstance)
		{
			return GetMultiManyToOne(productCategoryInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, null);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(ProductCategoryEntity productCategoryInstance, IPredicateExpression filter)
		{
			return GetMultiManyToOne(productCategoryInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, filter);
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(ProductCategoryEntity productCategoryInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			...
			return dao.GetMulti(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, filter, productCategoryInstance);
		}
		...
		public int DeleteMultiManyToOne( ProductCategoryEntity productCategoryInstance)
		{
			ProductSubcategoryDAO dao = DAOFactory.CreateProductSubcategoryDAO();
		...
		/// <summary>
		/// Updates in the persistent storage all ProductSubcategory entities which have data in common with the specified related Entities.
		/// If one is omitted, that entity is not used as a filter.
		...
		/// </summary>
		/// <param name="entityWithNewValues">ProductSubcategoryEntity instance which holds the new values for the matching entities to update. Only
		/// changed fields are taken into account</param>
		/// <param name="productCategoryInstance">ProductCategoryEntity instance to use as a filter for the ProductSubcategoryEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(ProductSubcategoryEntity entityWithNewValues, ProductCategoryEntity productCategoryInstance)
		{
			ProductSubcategoryDAO dao = DAOFactory.CreateProductSubcategoryDAO();
			return dao.UpdateMulti(entityWithNewValues.Fields, base.Transaction, productCategoryInstance);
		}
	
	
		/// <summary>
		/// Retrieves in this ProductSubcategoryCollection object all ProductSubcategoryEntity objects which are related via a 
		...
		/// <summary>
		/// Retrieves in this ProductSubcategoryCollection object all ProductSubcategoryEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves ProductSubcategoryEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// <summary>
		/// Deletes from the persistent storage all ProductSubcategory entities which match with the specified filter, formulated in
		/// the predicate or predicate expression definition.
		/// </summary>
		...
		/// will result in a query removing all ProductSubcategory entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified ProductSubcategoryEntity. 
		...
		/// will result in an update action which will affect all ProductSubcategory entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(ProductSubcategoryEntity entityWithNewValues, IPredicate updateFilter)
		{
			ProductSubcategoryDAO dao = DAOFactory.CreateProductSubcategoryDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(ProductSubcategoryEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			ProductSubcategoryDAO dao = DAOFactory.CreateProductSubcategoryDAO();
		...
		/// </summary>
		public ProductSubcategoryEntity this [int index]
		{
			get { return (ProductSubcategoryEntity)List[index]; }
		}
		#endregion
