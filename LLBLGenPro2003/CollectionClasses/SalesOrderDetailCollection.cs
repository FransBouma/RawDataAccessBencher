...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of SalesOrderDetailEntity objects. 
	/// </summary>
	[Serializable]
	public class SalesOrderDetailCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public SalesOrderDetailCollection():base(new PropertyDescriptorFactory(), typeof(SalesOrderDetailCollection), new SalesOrderDetailEntityFactory())
		{
		}
		...
		public SalesOrderDetailCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(SalesOrderDetailCollection), entityFactoryToUse)
		{
		}
		...
		public SalesOrderDetailCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, SalesOrderDetailValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(SalesOrderDetailCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private SalesOrderDetailCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("SalesOrderDetailCollection");
		}

	
		/// <summary>
		/// Retrieves in this SalesOrderDetailCollection object all SalesOrderDetailEntity objects which have data in common
		...
		public bool GetMultiManyToOne(SalesOrderHeaderEntity salesOrderHeaderInstance, SpecialOfferProductEntity specialOfferProductInstance)
		{
			return GetMultiManyToOne(salesOrderHeaderInstance, specialOfferProductInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, null);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(SalesOrderHeaderEntity salesOrderHeaderInstance, SpecialOfferProductEntity specialOfferProductInstance, IPredicateExpression filter)
		{
			return GetMultiManyToOne(salesOrderHeaderInstance, specialOfferProductInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, filter);
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(SalesOrderHeaderEntity salesOrderHeaderInstance, SpecialOfferProductEntity specialOfferProductInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			...
			return dao.GetMulti(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, filter, salesOrderHeaderInstance, specialOfferProductInstance);
		}


		/// <summary>
		/// Deletes from the persistent storage all SalesOrderDetail entities which have data in common
		/// with the specified related Entities.
		...
		public int DeleteMultiManyToOne( SalesOrderHeaderEntity salesOrderHeaderInstance,  SpecialOfferProductEntity specialOfferProductInstance)
		{
			SalesOrderDetailDAO dao = DAOFactory.CreateSalesOrderDetailDAO();
			return dao.DeleteMulti(base.Transaction, salesOrderHeaderInstance, specialOfferProductInstance);
		}


		/// <summary>
		/// Updates in the persistent storage all SalesOrderDetail entities which have data in common with the specified related Entities.
		/// If one is omitted, that entity is not used as a filter.
		...
		/// </summary>
		/// <param name="entityWithNewValues">SalesOrderDetailEntity instance which holds the new values for the matching entities to update. Only
		/// changed fields are taken into account</param>
		/// <param name="salesOrderHeaderInstance">SalesOrderHeaderEntity instance to use as a filter for the SalesOrderDetailEntity objects to return</param>
		/// <param name="specialOfferProductInstance">SpecialOfferProductEntity instance to use as a filter for the SalesOrderDetailEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(SalesOrderDetailEntity entityWithNewValues, SalesOrderHeaderEntity salesOrderHeaderInstance, SpecialOfferProductEntity specialOfferProductInstance)
		{
			SalesOrderDetailDAO dao = DAOFactory.CreateSalesOrderDetailDAO();
			return dao.UpdateMulti(entityWithNewValues.Fields, base.Transaction, salesOrderHeaderInstance, specialOfferProductInstance);
		}
	
	

		/// <summary>
		/// Retrieves in this SalesOrderDetailCollection object all SalesOrderDetailEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves SalesOrderDetailEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// <summary>
		/// Deletes from the persistent storage all SalesOrderDetail entities which match with the specified filter, formulated in
		/// the predicate or predicate expression definition.
		/// </summary>
		...
		/// will result in a query removing all SalesOrderDetail entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified SalesOrderDetailEntity. 
		...
		/// will result in an update action which will affect all SalesOrderDetail entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(SalesOrderDetailEntity entityWithNewValues, IPredicate updateFilter)
		{
			SalesOrderDetailDAO dao = DAOFactory.CreateSalesOrderDetailDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(SalesOrderDetailEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			SalesOrderDetailDAO dao = DAOFactory.CreateSalesOrderDetailDAO();
		...
		/// </summary>
		public SalesOrderDetailEntity this [int index]
		{
			get { return (SalesOrderDetailEntity)List[index]; }
		}
		#endregion
