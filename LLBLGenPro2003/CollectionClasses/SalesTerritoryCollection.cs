...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of SalesTerritoryEntity objects. 
	/// </summary>
	[Serializable]
	public class SalesTerritoryCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public SalesTerritoryCollection():base(new PropertyDescriptorFactory(), typeof(SalesTerritoryCollection), new SalesTerritoryEntityFactory())
		{
		}
		...
		public SalesTerritoryCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(SalesTerritoryCollection), entityFactoryToUse)
		{
		}
		...
		public SalesTerritoryCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, SalesTerritoryValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(SalesTerritoryCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private SalesTerritoryCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("SalesTerritoryCollection");
		}

	
	
		/// <summary>
		/// Retrieves in this SalesTerritoryCollection object all SalesTerritoryEntity objects which are related via a 
		/// Relation of type 'm:n' with the passed in CountryRegionEntity. 
		...
		public bool GetMultiManyToManyUsingCountryRegion(CountryRegionEntity countryRegionInstance)
		{
			return GetMultiManyToManyUsingCountryRegion(countryRegionInstance, base.MaxNumberOfItemsToReturn, base.SortClauses);
		}
		...
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingCountryRegion(CountryRegionEntity countryRegionInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
			...
			return dao.GetMultiUsingCountryRegion(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, countryRegionInstance);
		}
		...
		/// <param name="salesPersonInstance">SalesPersonEntity object to be used as a filter in the m:n relation</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingSalesPerson__(SalesPersonEntity salesPersonInstance)
		{
			return GetMultiManyToManyUsingSalesPerson__(salesPersonInstance, base.MaxNumberOfItemsToReturn, base.SortClauses);
		}
		...
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingSalesPerson__(SalesPersonEntity salesPersonInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
			if(!base.SuppressClearInGetMulti)
			{
				this.Clear();
			...
			SalesTerritoryDAO dao = DAOFactory.CreateSalesTerritoryDAO();
			return dao.GetMultiUsingSalesPerson__(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, salesPersonInstance);
		}
	

		/// <summary>
		/// Retrieves in this SalesTerritoryCollection object all SalesTerritoryEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves SalesTerritoryEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all SalesTerritory entities from the persistent storage</param>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified SalesTerritoryEntity. 
		...
		/// </summary>
		/// <param name="entityWithNewValues">SalesTerritoryEntity instance which holds the new values for the matching entities to update. Only
		...
		/// will result in an update action which will affect all SalesTerritory entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(SalesTerritoryEntity entityWithNewValues, IPredicate updateFilter)
		{
			SalesTerritoryDAO dao = DAOFactory.CreateSalesTerritoryDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(SalesTerritoryEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			SalesTerritoryDAO dao = DAOFactory.CreateSalesTerritoryDAO();
		...
		{
			return "SalesTerritoryCollection";
		}
		...
		/// </summary>
		public SalesTerritoryEntity this [int index]
		{
			get { return (SalesTerritoryEntity)List[index]; }
		}
		#endregion
