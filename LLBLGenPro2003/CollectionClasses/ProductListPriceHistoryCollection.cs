...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of ProductListPriceHistoryEntity objects. 
	/// </summary>
	[Serializable]
	public class ProductListPriceHistoryCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ProductListPriceHistoryCollection():base(new PropertyDescriptorFactory(), typeof(ProductListPriceHistoryCollection), new ProductListPriceHistoryEntityFactory())
		{
		}
		...
		public ProductListPriceHistoryCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ProductListPriceHistoryCollection), entityFactoryToUse)
		{
		}
		...
		public ProductListPriceHistoryCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, ProductListPriceHistoryValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ProductListPriceHistoryCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private ProductListPriceHistoryCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("ProductListPriceHistoryCollection");
		}

	
		/// <summary>
		/// Retrieves in this ProductListPriceHistoryCollection object all ProductListPriceHistoryEntity objects which have data in common
		...
		/// <summary>
		/// Updates in the persistent storage all ProductListPriceHistory entities which have data in common with the specified related Entities.
		/// If one is omitted, that entity is not used as a filter.
		...
		/// </summary>
		/// <param name="entityWithNewValues">ProductListPriceHistoryEntity instance which holds the new values for the matching entities to update. Only
		/// changed fields are taken into account</param>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the ProductListPriceHistoryEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(ProductListPriceHistoryEntity entityWithNewValues, ProductEntity productInstance)
		{
			ProductListPriceHistoryDAO dao = DAOFactory.CreateProductListPriceHistoryDAO();
		...
		/// <summary>
		/// Retrieves in this ProductListPriceHistoryCollection object all ProductListPriceHistoryEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves ProductListPriceHistoryEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all ProductListPriceHistory entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified ProductListPriceHistoryEntity. 
		...
		/// will result in an update action which will affect all ProductListPriceHistory entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(ProductListPriceHistoryEntity entityWithNewValues, IPredicate updateFilter)
		{
			ProductListPriceHistoryDAO dao = DAOFactory.CreateProductListPriceHistoryDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(ProductListPriceHistoryEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			ProductListPriceHistoryDAO dao = DAOFactory.CreateProductListPriceHistoryDAO();
		...
		/// </summary>
		public ProductListPriceHistoryEntity this [int index]
		{
			get { return (ProductListPriceHistoryEntity)List[index]; }
		}
		#endregion
