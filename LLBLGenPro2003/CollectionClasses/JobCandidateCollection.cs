...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of JobCandidateEntity objects. 
	/// </summary>
	[Serializable]
	public class JobCandidateCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public JobCandidateCollection():base(new PropertyDescriptorFactory(), typeof(JobCandidateCollection), new JobCandidateEntityFactory())
		{
		}
		...
		public JobCandidateCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(JobCandidateCollection), entityFactoryToUse)
		{
		}
		...
		public JobCandidateCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, JobCandidateValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(JobCandidateCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private JobCandidateCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("JobCandidateCollection");
		}

	
		/// <summary>
		/// Retrieves in this JobCandidateCollection object all JobCandidateEntity objects which have data in common
		...
		/// <summary>
		/// Deletes from the persistent storage all JobCandidate entities which have data in common
		/// with the specified related Entities.
		...
		/// <summary>
		/// Updates in the persistent storage all JobCandidate entities which have data in common with the specified related Entities.
		/// If one is omitted, that entity is not used as a filter.
		...
		/// </summary>
		/// <param name="entityWithNewValues">JobCandidateEntity instance which holds the new values for the matching entities to update. Only
		/// changed fields are taken into account</param>
		/// <param name="employeeInstance">EmployeeEntity instance to use as a filter for the JobCandidateEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(JobCandidateEntity entityWithNewValues, EmployeeEntity employeeInstance)
		{
			JobCandidateDAO dao = DAOFactory.CreateJobCandidateDAO();
		...
		/// <summary>
		/// Retrieves in this JobCandidateCollection object all JobCandidateEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves JobCandidateEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// <summary>
		/// Deletes from the persistent storage all JobCandidate entities which match with the specified filter, formulated in
		/// the predicate or predicate expression definition.
		/// </summary>
		...
		/// will result in a query removing all JobCandidate entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified JobCandidateEntity. 
		...
		/// will result in an update action which will affect all JobCandidate entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(JobCandidateEntity entityWithNewValues, IPredicate updateFilter)
		{
			JobCandidateDAO dao = DAOFactory.CreateJobCandidateDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(JobCandidateEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			JobCandidateDAO dao = DAOFactory.CreateJobCandidateDAO();
		...
		/// </summary>
		public JobCandidateEntity this [int index]
		{
			get { return (JobCandidateEntity)List[index]; }
		}
		#endregion
