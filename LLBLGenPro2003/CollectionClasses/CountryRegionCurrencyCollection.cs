...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of CountryRegionCurrencyEntity objects. 
	/// </summary>
	[Serializable]
	public class CountryRegionCurrencyCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public CountryRegionCurrencyCollection():base(new PropertyDescriptorFactory(), typeof(CountryRegionCurrencyCollection), new CountryRegionCurrencyEntityFactory())
		{
		}
		...
		public CountryRegionCurrencyCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(CountryRegionCurrencyCollection), entityFactoryToUse)
		{
		}
		...
		public CountryRegionCurrencyCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, CountryRegionCurrencyValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(CountryRegionCurrencyCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private CountryRegionCurrencyCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("CountryRegionCurrencyCollection");
		}

	
		/// <summary>
		/// Retrieves in this CountryRegionCurrencyCollection object all CountryRegionCurrencyEntity objects which have data in common
		...
		public bool GetMultiManyToOne(CountryRegionEntity countryRegionInstance, CurrencyEntity currencyInstance)
		{
			return GetMultiManyToOne(countryRegionInstance, currencyInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, null);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(CountryRegionEntity countryRegionInstance, CurrencyEntity currencyInstance, IPredicateExpression filter)
		{
			return GetMultiManyToOne(countryRegionInstance, currencyInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, filter);
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(CountryRegionEntity countryRegionInstance, CurrencyEntity currencyInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			...
			return dao.GetMulti(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, filter, countryRegionInstance, currencyInstance);
		}
		...
		public int DeleteMultiManyToOne( CountryRegionEntity countryRegionInstance,  CurrencyEntity currencyInstance)
		{
			CountryRegionCurrencyDAO dao = DAOFactory.CreateCountryRegionCurrencyDAO();
			return dao.DeleteMulti(base.Transaction, countryRegionInstance, currencyInstance);
		}


		/// <summary>
		/// Updates in the persistent storage all CountryRegionCurrency entities which have data in common with the specified related Entities.
		/// If one is omitted, that entity is not used as a filter.
		...
		/// </summary>
		/// <param name="entityWithNewValues">CountryRegionCurrencyEntity instance which holds the new values for the matching entities to update. Only
		/// changed fields are taken into account</param>
		/// <param name="countryRegionInstance">CountryRegionEntity instance to use as a filter for the CountryRegionCurrencyEntity objects to return</param>
		/// <param name="currencyInstance">CurrencyEntity instance to use as a filter for the CountryRegionCurrencyEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(CountryRegionCurrencyEntity entityWithNewValues, CountryRegionEntity countryRegionInstance, CurrencyEntity currencyInstance)
		{
			CountryRegionCurrencyDAO dao = DAOFactory.CreateCountryRegionCurrencyDAO();
			return dao.UpdateMulti(entityWithNewValues.Fields, base.Transaction, countryRegionInstance, currencyInstance);
		}
	
	

		/// <summary>
		/// Retrieves in this CountryRegionCurrencyCollection object all CountryRegionCurrencyEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves CountryRegionCurrencyEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all CountryRegionCurrency entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified CountryRegionCurrencyEntity. 
		...
		/// will result in an update action which will affect all CountryRegionCurrency entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(CountryRegionCurrencyEntity entityWithNewValues, IPredicate updateFilter)
		{
			CountryRegionCurrencyDAO dao = DAOFactory.CreateCountryRegionCurrencyDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(CountryRegionCurrencyEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			CountryRegionCurrencyDAO dao = DAOFactory.CreateCountryRegionCurrencyDAO();
		...
		/// </summary>
		public CountryRegionCurrencyEntity this [int index]
		{
			get { return (CountryRegionCurrencyEntity)List[index]; }
		}
		#endregion
