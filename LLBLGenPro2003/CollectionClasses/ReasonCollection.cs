...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of ReasonEntity objects. 
	/// </summary>
	[Serializable]
	public class ReasonCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ReasonCollection():base(new PropertyDescriptorFactory(), typeof(ReasonCollection), new ReasonEntityFactory())
		{
		}
		...
		public ReasonCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ReasonCollection), entityFactoryToUse)
		{
		}
		...
		public ReasonCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, ReasonValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ReasonCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private ReasonCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("ReasonCollection");
		}

	
	
		/// <summary>
		/// Retrieves in this ReasonCollection object all ReasonEntity objects which are related via a 
		/// Relation of type 'm:n' with the passed in NonPresentTimeHeaderEntity. 
		...
		public bool GetMultiManyToManyUsingNonPresentTimeHeader(NonPresentTimeHeaderEntity nonPresentTimeHeaderInstance)
		{
			return GetMultiManyToManyUsingNonPresentTimeHeader(nonPresentTimeHeaderInstance, base.MaxNumberOfItemsToReturn, base.SortClauses);
		}
		...
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingNonPresentTimeHeader(NonPresentTimeHeaderEntity nonPresentTimeHeaderInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
			...
			return dao.GetMultiUsingNonPresentTimeHeader(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, nonPresentTimeHeaderInstance);
		}
	

		/// <summary>
		/// Retrieves in this ReasonCollection object all ReasonEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves ReasonEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all Reason entities from the persistent storage</param>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified ReasonEntity. 
		...
		/// </summary>
		/// <param name="entityWithNewValues">ReasonEntity instance which holds the new values for the matching entities to update. Only
		...
		/// will result in an update action which will affect all Reason entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(ReasonEntity entityWithNewValues, IPredicate updateFilter)
		{
			ReasonDAO dao = DAOFactory.CreateReasonDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(ReasonEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			ReasonDAO dao = DAOFactory.CreateReasonDAO();
		...
		/// </summary>
		public ReasonEntity this [int index]
		{
			get { return (ReasonEntity)List[index]; }
		}
		#endregion
