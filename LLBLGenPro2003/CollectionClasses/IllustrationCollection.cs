...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of IllustrationEntity objects. 
	/// </summary>
	[Serializable]
	public class IllustrationCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public IllustrationCollection():base(new PropertyDescriptorFactory(), typeof(IllustrationCollection), new IllustrationEntityFactory())
		{
		}
		...
		public IllustrationCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(IllustrationCollection), entityFactoryToUse)
		{
		}
		...
		public IllustrationCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, IllustrationValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(IllustrationCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private IllustrationCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("IllustrationCollection");
		}

	
	
		/// <summary>
		/// Retrieves in this IllustrationCollection object all IllustrationEntity objects which are related via a 
		...
		/// <summary>
		/// Retrieves in this IllustrationCollection object all IllustrationEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves IllustrationEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all Illustration entities from the persistent storage</param>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified IllustrationEntity. 
		...
		/// </summary>
		/// <param name="entityWithNewValues">IllustrationEntity instance which holds the new values for the matching entities to update. Only
		...
		/// will result in an update action which will affect all Illustration entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IllustrationEntity entityWithNewValues, IPredicate updateFilter)
		{
			IllustrationDAO dao = DAOFactory.CreateIllustrationDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IllustrationEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			IllustrationDAO dao = DAOFactory.CreateIllustrationDAO();
		...
		/// </summary>
		public IllustrationEntity this [int index]
		{
			get { return (IllustrationEntity)List[index]; }
		}
		#endregion
