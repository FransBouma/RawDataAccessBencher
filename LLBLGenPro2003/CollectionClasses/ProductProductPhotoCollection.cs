...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of ProductProductPhotoEntity objects. 
	/// </summary>
	[Serializable]
	public class ProductProductPhotoCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ProductProductPhotoCollection():base(new PropertyDescriptorFactory(), typeof(ProductProductPhotoCollection), new ProductProductPhotoEntityFactory())
		{
		}
		...
		public ProductProductPhotoCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ProductProductPhotoCollection), entityFactoryToUse)
		{
		}
		...
		public ProductProductPhotoCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, ProductProductPhotoValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ProductProductPhotoCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private ProductProductPhotoCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("ProductProductPhotoCollection");
		}

	
		/// <summary>
		/// Retrieves in this ProductProductPhotoCollection object all ProductProductPhotoEntity objects which have data in common
		...
		public bool GetMultiManyToOne(ProductEntity productInstance, ProductPhotoEntity productPhotoInstance)
		{
			return GetMultiManyToOne(productInstance, productPhotoInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, null);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(ProductEntity productInstance, ProductPhotoEntity productPhotoInstance, IPredicateExpression filter)
		{
			return GetMultiManyToOne(productInstance, productPhotoInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, filter);
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(ProductEntity productInstance, ProductPhotoEntity productPhotoInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			...
			return dao.GetMulti(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, filter, productInstance, productPhotoInstance);
		}
		...
		public int DeleteMultiManyToOne( ProductEntity productInstance,  ProductPhotoEntity productPhotoInstance)
		{
			ProductProductPhotoDAO dao = DAOFactory.CreateProductProductPhotoDAO();
			return dao.DeleteMulti(base.Transaction, productInstance, productPhotoInstance);
		}


		/// <summary>
		/// Updates in the persistent storage all ProductProductPhoto entities which have data in common with the specified related Entities.
		/// If one is omitted, that entity is not used as a filter.
		...
		/// </summary>
		/// <param name="entityWithNewValues">ProductProductPhotoEntity instance which holds the new values for the matching entities to update. Only
		/// changed fields are taken into account</param>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the ProductProductPhotoEntity objects to return</param>
		/// <param name="productPhotoInstance">ProductPhotoEntity instance to use as a filter for the ProductProductPhotoEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(ProductProductPhotoEntity entityWithNewValues, ProductEntity productInstance, ProductPhotoEntity productPhotoInstance)
		{
			ProductProductPhotoDAO dao = DAOFactory.CreateProductProductPhotoDAO();
			return dao.UpdateMulti(entityWithNewValues.Fields, base.Transaction, productInstance, productPhotoInstance);
		}
	
	

		/// <summary>
		/// Retrieves in this ProductProductPhotoCollection object all ProductProductPhotoEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves ProductProductPhotoEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all ProductProductPhoto entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified ProductProductPhotoEntity. 
		...
		/// will result in an update action which will affect all ProductProductPhoto entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(ProductProductPhotoEntity entityWithNewValues, IPredicate updateFilter)
		{
			ProductProductPhotoDAO dao = DAOFactory.CreateProductProductPhotoDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(ProductProductPhotoEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			ProductProductPhotoDAO dao = DAOFactory.CreateProductProductPhotoDAO();
		...
		/// </summary>
		public ProductProductPhotoEntity this [int index]
		{
			get { return (ProductProductPhotoEntity)List[index]; }
		}
		#endregion
