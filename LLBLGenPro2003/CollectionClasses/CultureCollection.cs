...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of CultureEntity objects. 
	/// </summary>
	[Serializable]
	public class CultureCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public CultureCollection():base(new PropertyDescriptorFactory(), typeof(CultureCollection), new CultureEntityFactory())
		{
		}
		...
		public CultureCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(CultureCollection), entityFactoryToUse)
		{
		}
		...
		public CultureCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, CultureValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(CultureCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		{
			return base.ToXml("CultureCollection");
		}

	
	
		/// <summary>
		/// Retrieves in this CultureCollection object all CultureEntity objects which are related via a 
		...
		/// <summary>
		/// Retrieves in this CultureCollection object all CultureEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves CultureEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all Culture entities from the persistent storage</param>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified CultureEntity. 
		...
		/// </summary>
		/// <param name="entityWithNewValues">CultureEntity instance which holds the new values for the matching entities to update. Only
		...
		/// will result in an update action which will affect all Culture entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(CultureEntity entityWithNewValues, IPredicate updateFilter)
		{
			CultureDAO dao = DAOFactory.CreateCultureDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(CultureEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			CultureDAO dao = DAOFactory.CreateCultureDAO();
		...
		/// </summary>
		public CultureEntity this [int index]
		{
			get { return (CultureEntity)List[index]; }
		}
		#endregion
