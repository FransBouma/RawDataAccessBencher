...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of SpecialOfferEntity objects. 
	/// </summary>
	[Serializable]
	public class SpecialOfferCollection : EntityCollectionBase
	{
		...
		/// CTor
		/// </summary>
		public SpecialOfferCollection():base(new PropertyDescriptorFactory(), typeof(SpecialOfferCollection), new SpecialOfferEntityFactory())
		{
		}
		...
		public SpecialOfferCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(SpecialOfferCollection), entityFactoryToUse)
		{
		}
		...
		public SpecialOfferCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, SpecialOfferValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(SpecialOfferCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private SpecialOfferCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("SpecialOfferCollection");
		}

	
	
		/// <summary>
		/// Retrieves in this SpecialOfferCollection object all SpecialOfferEntity objects which are related via a 
		...
		/// <summary>
		/// Retrieves in this SpecialOfferCollection object all SpecialOfferEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves SpecialOfferEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all SpecialOffer entities from the persistent storage</param>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified SpecialOfferEntity. 
		...
		/// </summary>
		/// <param name="entityWithNewValues">SpecialOfferEntity instance which holds the new values for the matching entities to update. Only
