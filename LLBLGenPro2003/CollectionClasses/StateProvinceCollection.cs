...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of StateProvinceEntity objects. 
	/// </summary>
	[Serializable]
	public class StateProvinceCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public StateProvinceCollection():base(new PropertyDescriptorFactory(), typeof(StateProvinceCollection), new StateProvinceEntityFactory())
		{
		}
		...
		public StateProvinceCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(StateProvinceCollection), entityFactoryToUse)
		{
		}
		...
		public StateProvinceCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, StateProvinceValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(StateProvinceCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private StateProvinceCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("StateProvinceCollection");
		}

	
		/// <summary>
		/// Retrieves in this StateProvinceCollection object all StateProvinceEntity objects which have data in common
		...
		public bool GetMultiManyToOne(CountryRegionEntity countryRegionInstance, SalesTerritoryEntity salesTerritoryInstance)
		{
			return GetMultiManyToOne(countryRegionInstance, salesTerritoryInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, null);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(CountryRegionEntity countryRegionInstance, SalesTerritoryEntity salesTerritoryInstance, IPredicateExpression filter)
		{
			return GetMultiManyToOne(countryRegionInstance, salesTerritoryInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, filter);
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(CountryRegionEntity countryRegionInstance, SalesTerritoryEntity salesTerritoryInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			...
			return dao.GetMulti(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, filter, countryRegionInstance, salesTerritoryInstance);
		}


		/// <summary>
		/// Deletes from the persistent storage all StateProvince entities which have data in common
		/// with the specified related Entities.
		...
		public int DeleteMultiManyToOne( CountryRegionEntity countryRegionInstance,  SalesTerritoryEntity salesTerritoryInstance)
		{
			StateProvinceDAO dao = DAOFactory.CreateStateProvinceDAO();
		...
		/// <summary>
		/// Updates in the persistent storage all StateProvince entities which have data in common with the specified related Entities.
		/// If one is omitted, that entity is not used as a filter.
		...
		/// </summary>
		/// <param name="entityWithNewValues">StateProvinceEntity instance which holds the new values for the matching entities to update. Only
		/// changed fields are taken into account</param>
		/// <param name="countryRegionInstance">CountryRegionEntity instance to use as a filter for the StateProvinceEntity objects to return</param>
		/// <param name="salesTerritoryInstance">SalesTerritoryEntity instance to use as a filter for the StateProvinceEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(StateProvinceEntity entityWithNewValues, CountryRegionEntity countryRegionInstance, SalesTerritoryEntity salesTerritoryInstance)
		{
			StateProvinceDAO dao = DAOFactory.CreateStateProvinceDAO();
			return dao.UpdateMulti(entityWithNewValues.Fields, base.Transaction, countryRegionInstance, salesTerritoryInstance);
		}
	
	

		/// <summary>
		/// Retrieves in this StateProvinceCollection object all StateProvinceEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves StateProvinceEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// <summary>
		/// Deletes from the persistent storage all StateProvince entities which match with the specified filter, formulated in
		/// the predicate or predicate expression definition.
		/// </summary>
		...
		/// will result in a query removing all StateProvince entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified StateProvinceEntity. 
		...
		/// will result in an update action which will affect all StateProvince entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(StateProvinceEntity entityWithNewValues, IPredicate updateFilter)
		{
			StateProvinceDAO dao = DAOFactory.CreateStateProvinceDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(StateProvinceEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			StateProvinceDAO dao = DAOFactory.CreateStateProvinceDAO();
		...
		/// </summary>
		public StateProvinceEntity this [int index]
		{
			get { return (StateProvinceEntity)List[index]; }
		}
		#endregion
