...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of ProductModelProductDescriptionCultureEntity objects. 
	/// </summary>
	[Serializable]
	public class ProductModelProductDescriptionCultureCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ProductModelProductDescriptionCultureCollection():base(new PropertyDescriptorFactory(), typeof(ProductModelProductDescriptionCultureCollection), new ProductModelProductDescriptionCultureEntityFactory())
		{
		}
		...
		public ProductModelProductDescriptionCultureCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ProductModelProductDescriptionCultureCollection), entityFactoryToUse)
		{
		}
		...
		public ProductModelProductDescriptionCultureCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, ProductModelProductDescriptionCultureValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ProductModelProductDescriptionCultureCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private ProductModelProductDescriptionCultureCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("ProductModelProductDescriptionCultureCollection");
		}

	
		/// <summary>
		/// Retrieves in this ProductModelProductDescriptionCultureCollection object all ProductModelProductDescriptionCultureEntity objects which have data in common
		...
		public bool GetMultiManyToOne(CultureEntity cultureInstance, ProductDescriptionEntity productDescriptionInstance, ProductModelEntity productModelInstance)
		{
			return GetMultiManyToOne(cultureInstance, productDescriptionInstance, productModelInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, null);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(CultureEntity cultureInstance, ProductDescriptionEntity productDescriptionInstance, ProductModelEntity productModelInstance, IPredicateExpression filter)
		{
			return GetMultiManyToOne(cultureInstance, productDescriptionInstance, productModelInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, filter);
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(CultureEntity cultureInstance, ProductDescriptionEntity productDescriptionInstance, ProductModelEntity productModelInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			...
			return dao.GetMulti(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, filter, cultureInstance, productDescriptionInstance, productModelInstance);
		}
		...
		public int DeleteMultiManyToOne( CultureEntity cultureInstance,  ProductDescriptionEntity productDescriptionInstance,  ProductModelEntity productModelInstance)
		{
			ProductModelProductDescriptionCultureDAO dao = DAOFactory.CreateProductModelProductDescriptionCultureDAO();
		...
		/// <summary>
		/// Updates in the persistent storage all ProductModelProductDescriptionCulture entities which have data in common with the specified related Entities.
		/// If one is omitted, that entity is not used as a filter.
		...
		/// </summary>
		/// <param name="entityWithNewValues">ProductModelProductDescriptionCultureEntity instance which holds the new values for the matching entities to update. Only
		/// changed fields are taken into account</param>
		/// <param name="cultureInstance">CultureEntity instance to use as a filter for the ProductModelProductDescriptionCultureEntity objects to return</param>
		/// <param name="productDescriptionInstance">ProductDescriptionEntity instance to use as a filter for the ProductModelProductDescriptionCultureEntity objects to return</param>
		/// <param name="productModelInstance">ProductModelEntity instance to use as a filter for the ProductModelProductDescriptionCultureEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(ProductModelProductDescriptionCultureEntity entityWithNewValues, CultureEntity cultureInstance, ProductDescriptionEntity productDescriptionInstance, ProductModelEntity productModelInstance)
		{
			ProductModelProductDescriptionCultureDAO dao = DAOFactory.CreateProductModelProductDescriptionCultureDAO();
			return dao.UpdateMulti(entityWithNewValues.Fields, base.Transaction, cultureInstance, productDescriptionInstance, productModelInstance);
		}
	
	

		/// <summary>
		/// Retrieves in this ProductModelProductDescriptionCultureCollection object all ProductModelProductDescriptionCultureEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves ProductModelProductDescriptionCultureEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all ProductModelProductDescriptionCulture entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified ProductModelProductDescriptionCultureEntity. 
		...
		/// will result in an update action which will affect all ProductModelProductDescriptionCulture entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(ProductModelProductDescriptionCultureEntity entityWithNewValues, IPredicate updateFilter)
		{
			ProductModelProductDescriptionCultureDAO dao = DAOFactory.CreateProductModelProductDescriptionCultureDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(ProductModelProductDescriptionCultureEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			ProductModelProductDescriptionCultureDAO dao = DAOFactory.CreateProductModelProductDescriptionCultureDAO();
		...
		/// </summary>
		public ProductModelProductDescriptionCultureEntity this [int index]
		{
			get { return (ProductModelProductDescriptionCultureEntity)List[index]; }
		}
		#endregion
