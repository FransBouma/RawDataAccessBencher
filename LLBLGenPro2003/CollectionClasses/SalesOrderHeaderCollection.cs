...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of SalesOrderHeaderEntity objects. 
	/// </summary>
	[Serializable]
	public partial class SalesOrderHeaderCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public SalesOrderHeaderCollection():base(new PropertyDescriptorFactory(), typeof(SalesOrderHeaderCollection), new SalesOrderHeaderEntityFactory())
		{
		}
		...
		public SalesOrderHeaderCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(SalesOrderHeaderCollection), entityFactoryToUse)
		{
		}
		...
		public SalesOrderHeaderCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, SalesOrderHeaderValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(SalesOrderHeaderCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private SalesOrderHeaderCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("SalesOrderHeaderCollection");
		}

	
		/// <summary>
		/// Retrieves in this SalesOrderHeaderCollection object all SalesOrderHeaderEntity objects which have data in common
		...
		public bool GetMultiManyToOne(AddressEntity addressInstance, AddressEntity address_Instance, CreditCardEntity creditCardInstance, CurrencyRateEntity currencyRateInstance, CustomerEntity customerInstance, SalesPersonEntity salesPersonInstance, SalesTerritoryEntity salesTerritoryInstance, ShipMethodEntity shipMethodInstance)
		{
			return GetMultiManyToOne(addressInstance, address_Instance, creditCardInstance, currencyRateInstance, customerInstance, salesPersonInstance, salesTerritoryInstance, shipMethodInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, null);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(AddressEntity addressInstance, AddressEntity address_Instance, CreditCardEntity creditCardInstance, CurrencyRateEntity currencyRateInstance, CustomerEntity customerInstance, SalesPersonEntity salesPersonInstance, SalesTerritoryEntity salesTerritoryInstance, ShipMethodEntity shipMethodInstance, IPredicateExpression filter)
		{
			return GetMultiManyToOne(addressInstance, address_Instance, creditCardInstance, currencyRateInstance, customerInstance, salesPersonInstance, salesTerritoryInstance, shipMethodInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, filter);
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(AddressEntity addressInstance, AddressEntity address_Instance, CreditCardEntity creditCardInstance, CurrencyRateEntity currencyRateInstance, CustomerEntity customerInstance, SalesPersonEntity salesPersonInstance, SalesTerritoryEntity salesTerritoryInstance, ShipMethodEntity shipMethodInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			...
			return dao.GetMulti(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, filter, addressInstance, address_Instance, creditCardInstance, currencyRateInstance, customerInstance, salesPersonInstance, salesTerritoryInstance, shipMethodInstance);
		}
		...
		public int DeleteMultiManyToOne( AddressEntity addressInstance,  AddressEntity address_Instance,  CreditCardEntity creditCardInstance,  CurrencyRateEntity currencyRateInstance,  CustomerEntity customerInstance,  SalesPersonEntity salesPersonInstance,  SalesTerritoryEntity salesTerritoryInstance,  ShipMethodEntity shipMethodInstance)
		{
			SalesOrderHeaderDAO dao = DAOFactory.CreateSalesOrderHeaderDAO();
			return dao.DeleteMulti(base.Transaction, addressInstance, address_Instance, creditCardInstance, currencyRateInstance, customerInstance, salesPersonInstance, salesTerritoryInstance, shipMethodInstance);
		}


		/// <summary>
		/// Updates in the persistent storage all SalesOrderHeader entities which have data in common with the specified related Entities.
		/// If one is omitted, that entity is not used as a filter.
		...
		/// </summary>
		/// <param name="entityWithNewValues">SalesOrderHeaderEntity instance which holds the new values for the matching entities to update. Only
		...
		/// <param name="shipMethodInstance">ShipMethodEntity instance to use as a filter for the SalesOrderHeaderEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(SalesOrderHeaderEntity entityWithNewValues, AddressEntity addressInstance, AddressEntity address_Instance, CreditCardEntity creditCardInstance, CurrencyRateEntity currencyRateInstance, CustomerEntity customerInstance, SalesPersonEntity salesPersonInstance, SalesTerritoryEntity salesTerritoryInstance, ShipMethodEntity shipMethodInstance)
		{
			SalesOrderHeaderDAO dao = DAOFactory.CreateSalesOrderHeaderDAO();
			return dao.UpdateMulti(entityWithNewValues.Fields, base.Transaction, addressInstance, address_Instance, creditCardInstance, currencyRateInstance, customerInstance, salesPersonInstance, salesTerritoryInstance, shipMethodInstance);
		}
	
	
		/// <summary>
		/// Retrieves in this SalesOrderHeaderCollection object all SalesOrderHeaderEntity objects which are related via a 
		/// Relation of type 'm:n' with the passed in SpecialOfferProductEntity. 
		...
		public bool GetMultiManyToManyUsingSpecialOfferProduct(SpecialOfferProductEntity specialOfferProductInstance)
		{
			return GetMultiManyToManyUsingSpecialOfferProduct(specialOfferProductInstance, base.MaxNumberOfItemsToReturn, base.SortClauses);
		}
		...
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingSpecialOfferProduct(SpecialOfferProductEntity specialOfferProductInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
			if(!base.SuppressClearInGetMulti)
			{
				this.Clear();
			...
			SalesOrderHeaderDAO dao = DAOFactory.CreateSalesOrderHeaderDAO();
			return dao.GetMultiUsingSpecialOfferProduct(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, specialOfferProductInstance);
		}
	
		/// <summary>
		/// Retrieves in this SalesOrderHeaderCollection object all SalesOrderHeaderEntity objects which are related via a 
		/// Relation of type 'm:n' with the passed in SalesReasonEntity. 
		/// All current elements in the collection are removed from the collection.
		/// </summary>
		/// <param name="salesReasonInstance">SalesReasonEntity object to be used as a filter in the m:n relation</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingSalesReason(SalesReasonEntity salesReasonInstance)
		{
			return GetMultiManyToManyUsingSalesReason(salesReasonInstance, base.MaxNumberOfItemsToReturn, base.SortClauses);
		}
		...
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingSalesReason(SalesReasonEntity salesReasonInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
			if(!base.SuppressClearInGetMulti)
			{
				this.Clear();
			...
			SalesOrderHeaderDAO dao = DAOFactory.CreateSalesOrderHeaderDAO();
			return dao.GetMultiUsingSalesReason(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, salesReasonInstance);
		}
	

		/// <summary>
		/// Retrieves in this SalesOrderHeaderCollection object all SalesOrderHeaderEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves SalesOrderHeaderEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all SalesOrderHeader entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified SalesOrderHeaderEntity. 
		...
		/// will result in an update action which will affect all SalesOrderHeader entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(SalesOrderHeaderEntity entityWithNewValues, IPredicate updateFilter)
		{
			SalesOrderHeaderDAO dao = DAOFactory.CreateSalesOrderHeaderDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(SalesOrderHeaderEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			SalesOrderHeaderDAO dao = DAOFactory.CreateSalesOrderHeaderDAO();
		...
		/// </summary>
		public SalesOrderHeaderEntity this [int index]
		{
			get { return (SalesOrderHeaderEntity)List[index]; }
		}
		#endregion
