...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of IndividualEntity objects. 
	/// </summary>
	[Serializable]
	public class IndividualCollection : EntityCollectionBase
	{
		...
		/// CTor
		/// </summary>
		public IndividualCollection():base(new PropertyDescriptorFactory(), typeof(IndividualCollection), new IndividualEntityFactory())
		{
		}
		...
		public IndividualCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(IndividualCollection), entityFactoryToUse)
		{
		}
		...
		public IndividualCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, IndividualValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(IndividualCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private IndividualCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("IndividualCollection");
		}

	
		/// <summary>
		/// Retrieves in this IndividualCollection object all IndividualEntity objects which have data in common
		...
		public bool GetMultiManyToOne(ContactEntity contactInstance)
		{
			return GetMultiManyToOne(contactInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, null);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(ContactEntity contactInstance, IPredicateExpression filter)
		{
			return GetMultiManyToOne(contactInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, filter);
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(ContactEntity contactInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			...
			return dao.GetMulti(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, filter, contactInstance);
		}
		...
		public int DeleteMultiManyToOne( ContactEntity contactInstance)
		{
			IndividualDAO dao = DAOFactory.CreateIndividualDAO();
		...
		/// <summary>
		/// Updates in the persistent storage all Individual entities which have data in common with the specified related Entities.
		/// If one is omitted, that entity is not used as a filter.
		...
		/// </summary>
		/// <param name="entityWithNewValues">IndividualEntity instance which holds the new values for the matching entities to update. Only
		/// changed fields are taken into account</param>
		/// <param name="contactInstance">ContactEntity instance to use as a filter for the IndividualEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(IndividualEntity entityWithNewValues, ContactEntity contactInstance)
		{
			IndividualDAO dao = DAOFactory.CreateIndividualDAO();
			return dao.UpdateMulti(entityWithNewValues.Fields, base.Transaction, contactInstance);
		}
	
	

		/// <summary>
		/// Retrieves in this IndividualCollection object all IndividualEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves IndividualEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all Individual entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified IndividualEntity. 
