...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of DatabaseLogEntity objects. 
	/// </summary>
	[Serializable]
	public class DatabaseLogCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public DatabaseLogCollection():base(new PropertyDescriptorFactory(), typeof(DatabaseLogCollection), new DatabaseLogEntityFactory())
		{
		}
		...
		public DatabaseLogCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(DatabaseLogCollection), entityFactoryToUse)
		{
		}
		...
		public DatabaseLogCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, DatabaseLogValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(DatabaseLogCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private DatabaseLogCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("DatabaseLogCollection");
		}
		...
		/// <summary>
		/// Retrieves in this DatabaseLogCollection object all DatabaseLogEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves DatabaseLogEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all DatabaseLog entities from the persistent storage</param>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified DatabaseLogEntity. 
		...
		/// </summary>
		/// <param name="entityWithNewValues">DatabaseLogEntity instance which holds the new values for the matching entities to update. Only
		...
		/// will result in an update action which will affect all DatabaseLog entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(DatabaseLogEntity entityWithNewValues, IPredicate updateFilter)
		{
			DatabaseLogDAO dao = DAOFactory.CreateDatabaseLogDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(DatabaseLogEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			DatabaseLogDAO dao = DAOFactory.CreateDatabaseLogDAO();
		...
		/// </summary>
		public DatabaseLogEntity this [int index]
		{
			get { return (DatabaseLogEntity)List[index]; }
		}
		#endregion
