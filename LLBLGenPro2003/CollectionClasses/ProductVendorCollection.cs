...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of ProductVendorEntity objects. 
	/// </summary>
	[Serializable]
	public class ProductVendorCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ProductVendorCollection():base(new PropertyDescriptorFactory(), typeof(ProductVendorCollection), new ProductVendorEntityFactory())
		{
		}
		...
		public ProductVendorCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ProductVendorCollection), entityFactoryToUse)
		{
		}
		...
		public ProductVendorCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, ProductVendorValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ProductVendorCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private ProductVendorCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("ProductVendorCollection");
		}

	
		/// <summary>
		/// Retrieves in this ProductVendorCollection object all ProductVendorEntity objects which have data in common
		...
		public bool GetMultiManyToOne(ProductEntity productInstance, UnitMeasureEntity unitMeasureInstance, VendorEntity vendorInstance)
		{
			return GetMultiManyToOne(productInstance, unitMeasureInstance, vendorInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, null);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(ProductEntity productInstance, UnitMeasureEntity unitMeasureInstance, VendorEntity vendorInstance, IPredicateExpression filter)
		{
			return GetMultiManyToOne(productInstance, unitMeasureInstance, vendorInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, filter);
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(ProductEntity productInstance, UnitMeasureEntity unitMeasureInstance, VendorEntity vendorInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			...
			return dao.GetMulti(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, filter, productInstance, unitMeasureInstance, vendorInstance);
		}
		...
		public int DeleteMultiManyToOne( ProductEntity productInstance,  UnitMeasureEntity unitMeasureInstance,  VendorEntity vendorInstance)
		{
			ProductVendorDAO dao = DAOFactory.CreateProductVendorDAO();
			return dao.DeleteMulti(base.Transaction, productInstance, unitMeasureInstance, vendorInstance);
		}


		/// <summary>
		/// Updates in the persistent storage all ProductVendor entities which have data in common with the specified related Entities.
		/// If one is omitted, that entity is not used as a filter.
		...
		/// </summary>
		/// <param name="entityWithNewValues">ProductVendorEntity instance which holds the new values for the matching entities to update. Only
		/// changed fields are taken into account</param>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the ProductVendorEntity objects to return</param>
		/// <param name="unitMeasureInstance">UnitMeasureEntity instance to use as a filter for the ProductVendorEntity objects to return</param>
		/// <param name="vendorInstance">VendorEntity instance to use as a filter for the ProductVendorEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(ProductVendorEntity entityWithNewValues, ProductEntity productInstance, UnitMeasureEntity unitMeasureInstance, VendorEntity vendorInstance)
		{
			ProductVendorDAO dao = DAOFactory.CreateProductVendorDAO();
			return dao.UpdateMulti(entityWithNewValues.Fields, base.Transaction, productInstance, unitMeasureInstance, vendorInstance);
		}
	
	

		/// <summary>
		/// Retrieves in this ProductVendorCollection object all ProductVendorEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves ProductVendorEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all ProductVendor entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified ProductVendorEntity. 
		...
		/// will result in an update action which will affect all ProductVendor entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(ProductVendorEntity entityWithNewValues, IPredicate updateFilter)
		{
			ProductVendorDAO dao = DAOFactory.CreateProductVendorDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(ProductVendorEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			ProductVendorDAO dao = DAOFactory.CreateProductVendorDAO();
		...
		/// </summary>
		public ProductVendorEntity this [int index]
		{
			get { return (ProductVendorEntity)List[index]; }
		}
		#endregion
