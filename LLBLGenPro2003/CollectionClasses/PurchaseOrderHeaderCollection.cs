...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of PurchaseOrderHeaderEntity objects. 
	/// </summary>
	[Serializable]
	public class PurchaseOrderHeaderCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public PurchaseOrderHeaderCollection():base(new PropertyDescriptorFactory(), typeof(PurchaseOrderHeaderCollection), new PurchaseOrderHeaderEntityFactory())
		{
		}
		...
		public PurchaseOrderHeaderCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(PurchaseOrderHeaderCollection), entityFactoryToUse)
		{
		}
		...
		public PurchaseOrderHeaderCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, PurchaseOrderHeaderValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(PurchaseOrderHeaderCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private PurchaseOrderHeaderCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("PurchaseOrderHeaderCollection");
		}

	
		/// <summary>
		/// Retrieves in this PurchaseOrderHeaderCollection object all PurchaseOrderHeaderEntity objects which have data in common
		...
		public bool GetMultiManyToOne(EmployeeEntity employeeInstance, ShipMethodEntity shipMethodInstance, VendorEntity vendorInstance)
		{
			return GetMultiManyToOne(employeeInstance, shipMethodInstance, vendorInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, null);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(EmployeeEntity employeeInstance, ShipMethodEntity shipMethodInstance, VendorEntity vendorInstance, IPredicateExpression filter)
		{
			return GetMultiManyToOne(employeeInstance, shipMethodInstance, vendorInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, filter);
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(EmployeeEntity employeeInstance, ShipMethodEntity shipMethodInstance, VendorEntity vendorInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			...
			return dao.GetMulti(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, filter, employeeInstance, shipMethodInstance, vendorInstance);
		}
		...
		public int DeleteMultiManyToOne( EmployeeEntity employeeInstance,  ShipMethodEntity shipMethodInstance,  VendorEntity vendorInstance)
		{
			PurchaseOrderHeaderDAO dao = DAOFactory.CreatePurchaseOrderHeaderDAO();
		...
		/// <summary>
		/// Updates in the persistent storage all PurchaseOrderHeader entities which have data in common with the specified related Entities.
		/// If one is omitted, that entity is not used as a filter.
		...
		/// </summary>
		/// <param name="entityWithNewValues">PurchaseOrderHeaderEntity instance which holds the new values for the matching entities to update. Only
		/// changed fields are taken into account</param>
		/// <param name="employeeInstance">EmployeeEntity instance to use as a filter for the PurchaseOrderHeaderEntity objects to return</param>
		/// <param name="shipMethodInstance">ShipMethodEntity instance to use as a filter for the PurchaseOrderHeaderEntity objects to return</param>
		/// <param name="vendorInstance">VendorEntity instance to use as a filter for the PurchaseOrderHeaderEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(PurchaseOrderHeaderEntity entityWithNewValues, EmployeeEntity employeeInstance, ShipMethodEntity shipMethodInstance, VendorEntity vendorInstance)
		{
			PurchaseOrderHeaderDAO dao = DAOFactory.CreatePurchaseOrderHeaderDAO();
			return dao.UpdateMulti(entityWithNewValues.Fields, base.Transaction, employeeInstance, shipMethodInstance, vendorInstance);
		}
	
	
		/// <summary>
		/// Retrieves in this PurchaseOrderHeaderCollection object all PurchaseOrderHeaderEntity objects which are related via a 
		...
		/// <summary>
		/// Retrieves in this PurchaseOrderHeaderCollection object all PurchaseOrderHeaderEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves PurchaseOrderHeaderEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all PurchaseOrderHeader entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified PurchaseOrderHeaderEntity. 
		...
		/// will result in an update action which will affect all PurchaseOrderHeader entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(PurchaseOrderHeaderEntity entityWithNewValues, IPredicate updateFilter)
		{
			PurchaseOrderHeaderDAO dao = DAOFactory.CreatePurchaseOrderHeaderDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(PurchaseOrderHeaderEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			PurchaseOrderHeaderDAO dao = DAOFactory.CreatePurchaseOrderHeaderDAO();
		...
		/// </summary>
		public PurchaseOrderHeaderEntity this [int index]
		{
			get { return (PurchaseOrderHeaderEntity)List[index]; }
		}
		#endregion
