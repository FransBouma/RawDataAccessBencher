...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of TransactionHistoryArchiveEntity objects. 
	/// </summary>
	[Serializable]
	public class TransactionHistoryArchiveCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public TransactionHistoryArchiveCollection():base(new PropertyDescriptorFactory(), typeof(TransactionHistoryArchiveCollection), new TransactionHistoryArchiveEntityFactory())
		{
		}
		...
		public TransactionHistoryArchiveCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(TransactionHistoryArchiveCollection), entityFactoryToUse)
		{
		}
		...
		public TransactionHistoryArchiveCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, TransactionHistoryArchiveValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(TransactionHistoryArchiveCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private TransactionHistoryArchiveCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("TransactionHistoryArchiveCollection");
		}
		...
		/// <summary>
		/// Retrieves in this TransactionHistoryArchiveCollection object all TransactionHistoryArchiveEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves TransactionHistoryArchiveEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all TransactionHistoryArchive entities from the persistent storage</param>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified TransactionHistoryArchiveEntity. 
		...
		/// </summary>
		/// <param name="entityWithNewValues">TransactionHistoryArchiveEntity instance which holds the new values for the matching entities to update. Only
		...
		/// will result in an update action which will affect all TransactionHistoryArchive entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(TransactionHistoryArchiveEntity entityWithNewValues, IPredicate updateFilter)
		{
			TransactionHistoryArchiveDAO dao = DAOFactory.CreateTransactionHistoryArchiveDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(TransactionHistoryArchiveEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			TransactionHistoryArchiveDAO dao = DAOFactory.CreateTransactionHistoryArchiveDAO();
		...
		{
			return "TransactionHistoryArchiveCollection";
		}
		...
		/// </summary>
		public TransactionHistoryArchiveEntity this [int index]
		{
			get { return (TransactionHistoryArchiveEntity)List[index]; }
		}
		#endregion
