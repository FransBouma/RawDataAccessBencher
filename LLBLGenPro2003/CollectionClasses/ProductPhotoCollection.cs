...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of ProductPhotoEntity objects. 
	/// </summary>
	[Serializable]
	public class ProductPhotoCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ProductPhotoCollection():base(new PropertyDescriptorFactory(), typeof(ProductPhotoCollection), new ProductPhotoEntityFactory())
		{
		}
		...
		public ProductPhotoCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ProductPhotoCollection), entityFactoryToUse)
		{
		}
		...
		public ProductPhotoCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, ProductPhotoValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ProductPhotoCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private ProductPhotoCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("ProductPhotoCollection");
		}

	
	
		/// <summary>
		/// Retrieves in this ProductPhotoCollection object all ProductPhotoEntity objects which are related via a 
		...
		/// <summary>
		/// Retrieves in this ProductPhotoCollection object all ProductPhotoEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves ProductPhotoEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all ProductPhoto entities from the persistent storage</param>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified ProductPhotoEntity. 
		...
		/// </summary>
		/// <param name="entityWithNewValues">ProductPhotoEntity instance which holds the new values for the matching entities to update. Only
		...
		/// will result in an update action which will affect all ProductPhoto entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(ProductPhotoEntity entityWithNewValues, IPredicate updateFilter)
		{
			ProductPhotoDAO dao = DAOFactory.CreateProductPhotoDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(ProductPhotoEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			ProductPhotoDAO dao = DAOFactory.CreateProductPhotoDAO();
		...
		/// </summary>
		public ProductPhotoEntity this [int index]
		{
			get { return (ProductPhotoEntity)List[index]; }
		}
		#endregion
