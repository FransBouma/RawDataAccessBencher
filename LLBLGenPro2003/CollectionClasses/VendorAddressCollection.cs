...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of VendorAddressEntity objects. 
	/// </summary>
	[Serializable]
	public class VendorAddressCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public VendorAddressCollection():base(new PropertyDescriptorFactory(), typeof(VendorAddressCollection), new VendorAddressEntityFactory())
		{
		}
		...
		public VendorAddressCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(VendorAddressCollection), entityFactoryToUse)
		{
		}
		...
		public VendorAddressCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, VendorAddressValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(VendorAddressCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private VendorAddressCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("VendorAddressCollection");
		}

	
		/// <summary>
		/// Retrieves in this VendorAddressCollection object all VendorAddressEntity objects which have data in common
		...
		public bool GetMultiManyToOne(AddressEntity addressInstance, AddressTypeEntity addressTypeInstance, VendorEntity vendorInstance)
		{
			return GetMultiManyToOne(addressInstance, addressTypeInstance, vendorInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, null);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(AddressEntity addressInstance, AddressTypeEntity addressTypeInstance, VendorEntity vendorInstance, IPredicateExpression filter)
		{
			return GetMultiManyToOne(addressInstance, addressTypeInstance, vendorInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, filter);
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(AddressEntity addressInstance, AddressTypeEntity addressTypeInstance, VendorEntity vendorInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			...
			return dao.GetMulti(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, filter, addressInstance, addressTypeInstance, vendorInstance);
		}
		...
		public int DeleteMultiManyToOne( AddressEntity addressInstance,  AddressTypeEntity addressTypeInstance,  VendorEntity vendorInstance)
		{
			VendorAddressDAO dao = DAOFactory.CreateVendorAddressDAO();
		...
		/// <summary>
		/// Updates in the persistent storage all VendorAddress entities which have data in common with the specified related Entities.
		/// If one is omitted, that entity is not used as a filter.
		...
		/// </summary>
		/// <param name="entityWithNewValues">VendorAddressEntity instance which holds the new values for the matching entities to update. Only
		/// changed fields are taken into account</param>
		/// <param name="addressInstance">AddressEntity instance to use as a filter for the VendorAddressEntity objects to return</param>
		/// <param name="addressTypeInstance">AddressTypeEntity instance to use as a filter for the VendorAddressEntity objects to return</param>
		/// <param name="vendorInstance">VendorEntity instance to use as a filter for the VendorAddressEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(VendorAddressEntity entityWithNewValues, AddressEntity addressInstance, AddressTypeEntity addressTypeInstance, VendorEntity vendorInstance)
		{
			VendorAddressDAO dao = DAOFactory.CreateVendorAddressDAO();
			return dao.UpdateMulti(entityWithNewValues.Fields, base.Transaction, addressInstance, addressTypeInstance, vendorInstance);
		}
	
	

		/// <summary>
		/// Retrieves in this VendorAddressCollection object all VendorAddressEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves VendorAddressEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all VendorAddress entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified VendorAddressEntity. 
		...
		/// will result in an update action which will affect all VendorAddress entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(VendorAddressEntity entityWithNewValues, IPredicate updateFilter)
		{
			VendorAddressDAO dao = DAOFactory.CreateVendorAddressDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(VendorAddressEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			VendorAddressDAO dao = DAOFactory.CreateVendorAddressDAO();
		...
		{
			return "VendorAddressCollection";
		}
		...
		/// </summary>
		public VendorAddressEntity this [int index]
		{
			get { return (VendorAddressEntity)List[index]; }
		}
		#endregion
