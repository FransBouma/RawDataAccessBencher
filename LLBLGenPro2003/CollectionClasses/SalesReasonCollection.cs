...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of SalesReasonEntity objects. 
	/// </summary>
	[Serializable]
	public class SalesReasonCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public SalesReasonCollection():base(new PropertyDescriptorFactory(), typeof(SalesReasonCollection), new SalesReasonEntityFactory())
		{
		}
		...
		public SalesReasonCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(SalesReasonCollection), entityFactoryToUse)
		{
		}
		...
		public SalesReasonCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, SalesReasonValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(SalesReasonCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private SalesReasonCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("SalesReasonCollection");
		}

	
	
		/// <summary>
		/// Retrieves in this SalesReasonCollection object all SalesReasonEntity objects which are related via a 
		...
		/// <summary>
		/// Retrieves in this SalesReasonCollection object all SalesReasonEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves SalesReasonEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// <summary>
		/// Deletes from the persistent storage all SalesReason entities which match with the specified filter, formulated in
		/// the predicate or predicate expression definition.
		/// </summary>
		...
		/// will result in a query removing all SalesReason entities from the persistent storage</param>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified SalesReasonEntity. 
		...
		/// </summary>
		/// <param name="entityWithNewValues">SalesReasonEntity instance which holds the new values for the matching entities to update. Only
		...
		/// will result in an update action which will affect all SalesReason entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(SalesReasonEntity entityWithNewValues, IPredicate updateFilter)
		{
			SalesReasonDAO dao = DAOFactory.CreateSalesReasonDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(SalesReasonEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			SalesReasonDAO dao = DAOFactory.CreateSalesReasonDAO();
		...
		/// </summary>
		public SalesReasonEntity this [int index]
		{
			get { return (SalesReasonEntity)List[index]; }
		}
		#endregion
