...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of SalesOrderHeaderSalesReasonEntity objects. 
	/// </summary>
	[Serializable]
	public class SalesOrderHeaderSalesReasonCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public SalesOrderHeaderSalesReasonCollection():base(new PropertyDescriptorFactory(), typeof(SalesOrderHeaderSalesReasonCollection), new SalesOrderHeaderSalesReasonEntityFactory())
		{
		}
		...
		public SalesOrderHeaderSalesReasonCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(SalesOrderHeaderSalesReasonCollection), entityFactoryToUse)
		{
		}
		...
		public SalesOrderHeaderSalesReasonCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, SalesOrderHeaderSalesReasonValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(SalesOrderHeaderSalesReasonCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private SalesOrderHeaderSalesReasonCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("SalesOrderHeaderSalesReasonCollection");
		}

	
		/// <summary>
		/// Retrieves in this SalesOrderHeaderSalesReasonCollection object all SalesOrderHeaderSalesReasonEntity objects which have data in common
		...
		public bool GetMultiManyToOne(SalesOrderHeaderEntity salesOrderHeaderInstance, SalesReasonEntity salesReasonInstance)
		{
			return GetMultiManyToOne(salesOrderHeaderInstance, salesReasonInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, null);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(SalesOrderHeaderEntity salesOrderHeaderInstance, SalesReasonEntity salesReasonInstance, IPredicateExpression filter)
		{
			return GetMultiManyToOne(salesOrderHeaderInstance, salesReasonInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, filter);
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(SalesOrderHeaderEntity salesOrderHeaderInstance, SalesReasonEntity salesReasonInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			...
			return dao.GetMulti(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, filter, salesOrderHeaderInstance, salesReasonInstance);
		}
		...
		public int DeleteMultiManyToOne( SalesOrderHeaderEntity salesOrderHeaderInstance,  SalesReasonEntity salesReasonInstance)
		{
			SalesOrderHeaderSalesReasonDAO dao = DAOFactory.CreateSalesOrderHeaderSalesReasonDAO();
			return dao.DeleteMulti(base.Transaction, salesOrderHeaderInstance, salesReasonInstance);
		}


		/// <summary>
		/// Updates in the persistent storage all SalesOrderHeaderSalesReason entities which have data in common with the specified related Entities.
		/// If one is omitted, that entity is not used as a filter.
		...
		/// </summary>
		/// <param name="entityWithNewValues">SalesOrderHeaderSalesReasonEntity instance which holds the new values for the matching entities to update. Only
		/// changed fields are taken into account</param>
		/// <param name="salesOrderHeaderInstance">SalesOrderHeaderEntity instance to use as a filter for the SalesOrderHeaderSalesReasonEntity objects to return</param>
		/// <param name="salesReasonInstance">SalesReasonEntity instance to use as a filter for the SalesOrderHeaderSalesReasonEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(SalesOrderHeaderSalesReasonEntity entityWithNewValues, SalesOrderHeaderEntity salesOrderHeaderInstance, SalesReasonEntity salesReasonInstance)
		{
			SalesOrderHeaderSalesReasonDAO dao = DAOFactory.CreateSalesOrderHeaderSalesReasonDAO();
			return dao.UpdateMulti(entityWithNewValues.Fields, base.Transaction, salesOrderHeaderInstance, salesReasonInstance);
		}
	
	

		/// <summary>
		/// Retrieves in this SalesOrderHeaderSalesReasonCollection object all SalesOrderHeaderSalesReasonEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves SalesOrderHeaderSalesReasonEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all SalesOrderHeaderSalesReason entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified SalesOrderHeaderSalesReasonEntity. 
		...
		/// will result in an update action which will affect all SalesOrderHeaderSalesReason entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(SalesOrderHeaderSalesReasonEntity entityWithNewValues, IPredicate updateFilter)
		{
			SalesOrderHeaderSalesReasonDAO dao = DAOFactory.CreateSalesOrderHeaderSalesReasonDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(SalesOrderHeaderSalesReasonEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			SalesOrderHeaderSalesReasonDAO dao = DAOFactory.CreateSalesOrderHeaderSalesReasonDAO();
		...
		/// </summary>
		public SalesOrderHeaderSalesReasonEntity this [int index]
		{
			get { return (SalesOrderHeaderSalesReasonEntity)List[index]; }
		}
		#endregion
