...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of CreativeAddressesEntity objects. 
	/// </summary>
	[Serializable]
	public class CreativeAddressesCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public CreativeAddressesCollection():base(new PropertyDescriptorFactory(), typeof(CreativeAddressesCollection), new CreativeAddressesEntityFactory())
		{
		}
		...
		public CreativeAddressesCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(CreativeAddressesCollection), entityFactoryToUse)
		{
		}
		...
		public CreativeAddressesCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, CreativeAddressesValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(CreativeAddressesCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private CreativeAddressesCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("CreativeAddressesCollection");
		}
		...
		/// <summary>
		/// Retrieves in this CreativeAddressesCollection object all CreativeAddressesEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves CreativeAddressesEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all CreativeAddresses entities from the persistent storage</param>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified CreativeAddressesEntity. 
		...
		/// </summary>
		/// <param name="entityWithNewValues">CreativeAddressesEntity instance which holds the new values for the matching entities to update. Only
		...
		/// will result in an update action which will affect all CreativeAddresses entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(CreativeAddressesEntity entityWithNewValues, IPredicate updateFilter)
		{
			CreativeAddressesDAO dao = DAOFactory.CreateCreativeAddressesDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(CreativeAddressesEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			CreativeAddressesDAO dao = DAOFactory.CreateCreativeAddressesDAO();
		...
		{
			return "CreativeAddressesCollection";
		}
		...
		/// </summary>
		public CreativeAddressesEntity this [int index]
		{
			get { return (CreativeAddressesEntity)List[index]; }
		}
		#endregion
