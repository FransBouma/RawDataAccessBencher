...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of ContactCreditCardEntity objects. 
	/// </summary>
	[Serializable]
	public class ContactCreditCardCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ContactCreditCardCollection():base(new PropertyDescriptorFactory(), typeof(ContactCreditCardCollection), new ContactCreditCardEntityFactory())
		{
		}
		...
		public ContactCreditCardCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ContactCreditCardCollection), entityFactoryToUse)
		{
		}
		...
		public ContactCreditCardCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, ContactCreditCardValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ContactCreditCardCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private ContactCreditCardCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("ContactCreditCardCollection");
		}

	
		/// <summary>
		/// Retrieves in this ContactCreditCardCollection object all ContactCreditCardEntity objects which have data in common
		...
		public bool GetMultiManyToOne(ContactEntity contactInstance, CreditCardEntity creditCardInstance)
		{
			return GetMultiManyToOne(contactInstance, creditCardInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, null);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(ContactEntity contactInstance, CreditCardEntity creditCardInstance, IPredicateExpression filter)
		{
			return GetMultiManyToOne(contactInstance, creditCardInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, filter);
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(ContactEntity contactInstance, CreditCardEntity creditCardInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			...
			return dao.GetMulti(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, filter, contactInstance, creditCardInstance);
		}
		...
		public int DeleteMultiManyToOne( ContactEntity contactInstance,  CreditCardEntity creditCardInstance)
		{
			ContactCreditCardDAO dao = DAOFactory.CreateContactCreditCardDAO();
			return dao.DeleteMulti(base.Transaction, contactInstance, creditCardInstance);
		}


		/// <summary>
		/// Updates in the persistent storage all ContactCreditCard entities which have data in common with the specified related Entities.
		/// If one is omitted, that entity is not used as a filter.
		...
		/// </summary>
		/// <param name="entityWithNewValues">ContactCreditCardEntity instance which holds the new values for the matching entities to update. Only
		/// changed fields are taken into account</param>
		/// <param name="contactInstance">ContactEntity instance to use as a filter for the ContactCreditCardEntity objects to return</param>
		/// <param name="creditCardInstance">CreditCardEntity instance to use as a filter for the ContactCreditCardEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(ContactCreditCardEntity entityWithNewValues, ContactEntity contactInstance, CreditCardEntity creditCardInstance)
		{
			ContactCreditCardDAO dao = DAOFactory.CreateContactCreditCardDAO();
			return dao.UpdateMulti(entityWithNewValues.Fields, base.Transaction, contactInstance, creditCardInstance);
		}
	
	

		/// <summary>
		/// Retrieves in this ContactCreditCardCollection object all ContactCreditCardEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves ContactCreditCardEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all ContactCreditCard entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified ContactCreditCardEntity. 
		...
		/// will result in an update action which will affect all ContactCreditCard entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(ContactCreditCardEntity entityWithNewValues, IPredicate updateFilter)
		{
			ContactCreditCardDAO dao = DAOFactory.CreateContactCreditCardDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(ContactCreditCardEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			ContactCreditCardDAO dao = DAOFactory.CreateContactCreditCardDAO();
		...
		{
			return "ContactCreditCardCollection";
		}
		...
		/// </summary>
		public ContactCreditCardEntity this [int index]
		{
			get { return (ContactCreditCardEntity)List[index]; }
		}
		#endregion
