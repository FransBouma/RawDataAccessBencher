...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of ProductDescriptionEntity objects. 
	/// </summary>
	[Serializable]
	public class ProductDescriptionCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ProductDescriptionCollection():base(new PropertyDescriptorFactory(), typeof(ProductDescriptionCollection), new ProductDescriptionEntityFactory())
		{
		}
		...
		public ProductDescriptionCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ProductDescriptionCollection), entityFactoryToUse)
		{
		}
		...
		public ProductDescriptionCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, ProductDescriptionValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ProductDescriptionCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private ProductDescriptionCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("ProductDescriptionCollection");
		}

	
	
		/// <summary>
		/// Retrieves in this ProductDescriptionCollection object all ProductDescriptionEntity objects which are related via a 
		...
		/// <summary>
		/// Retrieves in this ProductDescriptionCollection object all ProductDescriptionEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves ProductDescriptionEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all ProductDescription entities from the persistent storage</param>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified ProductDescriptionEntity. 
		...
		/// </summary>
		/// <param name="entityWithNewValues">ProductDescriptionEntity instance which holds the new values for the matching entities to update. Only
		...
		/// will result in an update action which will affect all ProductDescription entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(ProductDescriptionEntity entityWithNewValues, IPredicate updateFilter)
		{
			ProductDescriptionDAO dao = DAOFactory.CreateProductDescriptionDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(ProductDescriptionEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			ProductDescriptionDAO dao = DAOFactory.CreateProductDescriptionDAO();
		...
		/// </summary>
		public ProductDescriptionEntity this [int index]
		{
			get { return (ProductDescriptionEntity)List[index]; }
		}
		#endregion
