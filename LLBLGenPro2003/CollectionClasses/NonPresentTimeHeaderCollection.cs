...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of NonPresentTimeHeaderEntity objects. 
	/// </summary>
	[Serializable]
	public class NonPresentTimeHeaderCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public NonPresentTimeHeaderCollection():base(new PropertyDescriptorFactory(), typeof(NonPresentTimeHeaderCollection), new NonPresentTimeHeaderEntityFactory())
		{
		}
		...
		public NonPresentTimeHeaderCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(NonPresentTimeHeaderCollection), entityFactoryToUse)
		{
		}
		...
		public NonPresentTimeHeaderCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, NonPresentTimeHeaderValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(NonPresentTimeHeaderCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private NonPresentTimeHeaderCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("NonPresentTimeHeaderCollection");
		}

	
		/// <summary>
		/// Retrieves in this NonPresentTimeHeaderCollection object all NonPresentTimeHeaderEntity objects which have data in common
		...
		public bool GetMultiManyToOne(UserDetailEntity userDetailInstance, UserDetailEntity userDetail_Instance)
		{
			return GetMultiManyToOne(userDetailInstance, userDetail_Instance, base.MaxNumberOfItemsToReturn, base.SortClauses, null);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(UserDetailEntity userDetailInstance, UserDetailEntity userDetail_Instance, IPredicateExpression filter)
		{
			return GetMultiManyToOne(userDetailInstance, userDetail_Instance, base.MaxNumberOfItemsToReturn, base.SortClauses, filter);
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(UserDetailEntity userDetailInstance, UserDetailEntity userDetail_Instance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			...
			return dao.GetMulti(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, filter, userDetailInstance, userDetail_Instance);
		}
		...
		public int DeleteMultiManyToOne( UserDetailEntity userDetailInstance,  UserDetailEntity userDetail_Instance)
		{
			NonPresentTimeHeaderDAO dao = DAOFactory.CreateNonPresentTimeHeaderDAO();
			return dao.DeleteMulti(base.Transaction, userDetailInstance, userDetail_Instance);
		}


		/// <summary>
		/// Updates in the persistent storage all NonPresentTimeHeader entities which have data in common with the specified related Entities.
		/// If one is omitted, that entity is not used as a filter.
		...
		/// </summary>
		/// <param name="entityWithNewValues">NonPresentTimeHeaderEntity instance which holds the new values for the matching entities to update. Only
		/// changed fields are taken into account</param>
		/// <param name="userDetailInstance">UserDetailEntity instance to use as a filter for the NonPresentTimeHeaderEntity objects to return</param>
		/// <param name="userDetail_Instance">UserDetailEntity instance to use as a filter for the NonPresentTimeHeaderEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(NonPresentTimeHeaderEntity entityWithNewValues, UserDetailEntity userDetailInstance, UserDetailEntity userDetail_Instance)
		{
			NonPresentTimeHeaderDAO dao = DAOFactory.CreateNonPresentTimeHeaderDAO();
			return dao.UpdateMulti(entityWithNewValues.Fields, base.Transaction, userDetailInstance, userDetail_Instance);
		}
	
	
		/// <summary>
		/// Retrieves in this NonPresentTimeHeaderCollection object all NonPresentTimeHeaderEntity objects which are related via a 
		/// Relation of type 'm:n' with the passed in ReasonEntity. 
		...
		public bool GetMultiManyToManyUsingReason(ReasonEntity reasonInstance)
		{
			return GetMultiManyToManyUsingReason(reasonInstance, base.MaxNumberOfItemsToReturn, base.SortClauses);
		}
		...
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingReason(ReasonEntity reasonInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
			if(!base.SuppressClearInGetMulti)
			{
				this.Clear();
			...
			NonPresentTimeHeaderDAO dao = DAOFactory.CreateNonPresentTimeHeaderDAO();
			return dao.GetMultiUsingReason(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, reasonInstance);
		}
	

		/// <summary>
		/// Retrieves in this NonPresentTimeHeaderCollection object all NonPresentTimeHeaderEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves NonPresentTimeHeaderEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all NonPresentTimeHeader entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified NonPresentTimeHeaderEntity. 
		...
		/// will result in an update action which will affect all NonPresentTimeHeader entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(NonPresentTimeHeaderEntity entityWithNewValues, IPredicate updateFilter)
		{
			NonPresentTimeHeaderDAO dao = DAOFactory.CreateNonPresentTimeHeaderDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(NonPresentTimeHeaderEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			NonPresentTimeHeaderDAO dao = DAOFactory.CreateNonPresentTimeHeaderDAO();
		...
		{
			return "NonPresentTimeHeaderCollection";
		}
		...
		/// </summary>
		public NonPresentTimeHeaderEntity this [int index]
		{
			get { return (NonPresentTimeHeaderEntity)List[index]; }
		}
		#endregion
