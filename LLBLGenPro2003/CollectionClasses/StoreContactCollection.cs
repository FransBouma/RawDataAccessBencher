...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of StoreContactEntity objects. 
	/// </summary>
	[Serializable]
	public class StoreContactCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public StoreContactCollection():base(new PropertyDescriptorFactory(), typeof(StoreContactCollection), new StoreContactEntityFactory())
		{
		}
		...
		public StoreContactCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(StoreContactCollection), entityFactoryToUse)
		{
		}
		...
		public StoreContactCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, StoreContactValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(StoreContactCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private StoreContactCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("StoreContactCollection");
		}

	
		/// <summary>
		/// Retrieves in this StoreContactCollection object all StoreContactEntity objects which have data in common
		...
		public bool GetMultiManyToOne(ContactEntity contactInstance, ContactTypeEntity contactTypeInstance, StoreEntity storeInstance)
		{
			return GetMultiManyToOne(contactInstance, contactTypeInstance, storeInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, null);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(ContactEntity contactInstance, ContactTypeEntity contactTypeInstance, StoreEntity storeInstance, IPredicateExpression filter)
		{
			return GetMultiManyToOne(contactInstance, contactTypeInstance, storeInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, filter);
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(ContactEntity contactInstance, ContactTypeEntity contactTypeInstance, StoreEntity storeInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			...
			return dao.GetMulti(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, filter, contactInstance, contactTypeInstance, storeInstance);
		}
		...
		public int DeleteMultiManyToOne( ContactEntity contactInstance,  ContactTypeEntity contactTypeInstance,  StoreEntity storeInstance)
		{
			StoreContactDAO dao = DAOFactory.CreateStoreContactDAO();
			return dao.DeleteMulti(base.Transaction, contactInstance, contactTypeInstance, storeInstance);
		}


		/// <summary>
		/// Updates in the persistent storage all StoreContact entities which have data in common with the specified related Entities.
		/// If one is omitted, that entity is not used as a filter.
		...
		/// </summary>
		/// <param name="entityWithNewValues">StoreContactEntity instance which holds the new values for the matching entities to update. Only
		/// changed fields are taken into account</param>
		/// <param name="contactInstance">ContactEntity instance to use as a filter for the StoreContactEntity objects to return</param>
		/// <param name="contactTypeInstance">ContactTypeEntity instance to use as a filter for the StoreContactEntity objects to return</param>
		/// <param name="storeInstance">StoreEntity instance to use as a filter for the StoreContactEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(StoreContactEntity entityWithNewValues, ContactEntity contactInstance, ContactTypeEntity contactTypeInstance, StoreEntity storeInstance)
		{
			StoreContactDAO dao = DAOFactory.CreateStoreContactDAO();
			return dao.UpdateMulti(entityWithNewValues.Fields, base.Transaction, contactInstance, contactTypeInstance, storeInstance);
		}
	
	

		/// <summary>
		/// Retrieves in this StoreContactCollection object all StoreContactEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves StoreContactEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all StoreContact entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified StoreContactEntity. 
		...
		/// will result in an update action which will affect all StoreContact entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(StoreContactEntity entityWithNewValues, IPredicate updateFilter)
		{
			StoreContactDAO dao = DAOFactory.CreateStoreContactDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(StoreContactEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			StoreContactDAO dao = DAOFactory.CreateStoreContactDAO();
		...
		/// </summary>
		public StoreContactEntity this [int index]
		{
			get { return (StoreContactEntity)List[index]; }
		}
		#endregion
