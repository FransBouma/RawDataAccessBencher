...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of ContactTypeEntity objects. 
	/// </summary>
	[Serializable]
	public class ContactTypeCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ContactTypeCollection():base(new PropertyDescriptorFactory(), typeof(ContactTypeCollection), new ContactTypeEntityFactory())
		{
		}
		...
		public ContactTypeCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ContactTypeCollection), entityFactoryToUse)
		{
		}
		...
		public ContactTypeCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, ContactTypeValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ContactTypeCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private ContactTypeCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("ContactTypeCollection");
		}

	
	
		/// <summary>
		/// Retrieves in this ContactTypeCollection object all ContactTypeEntity objects which are related via a 
		...
		/// <summary>
		/// Retrieves in this ContactTypeCollection object all ContactTypeEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves ContactTypeEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all ContactType entities from the persistent storage</param>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified ContactTypeEntity. 
		...
		/// </summary>
		/// <param name="entityWithNewValues">ContactTypeEntity instance which holds the new values for the matching entities to update. Only
		...
		/// will result in an update action which will affect all ContactType entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(ContactTypeEntity entityWithNewValues, IPredicate updateFilter)
		{
			ContactTypeDAO dao = DAOFactory.CreateContactTypeDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(ContactTypeEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			ContactTypeDAO dao = DAOFactory.CreateContactTypeDAO();
		...
		/// </summary>
		public ContactTypeEntity this [int index]
		{
			get { return (ContactTypeEntity)List[index]; }
		}
		#endregion
