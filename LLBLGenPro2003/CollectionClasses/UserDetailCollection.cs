...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of UserDetailEntity objects. 
using SD.LLBLGen.Pro.ORMSupportClasses2003;	[Serializable]
	public class UserDetailCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public UserDetailCollection():base(new PropertyDescriptorFactory(), typeof(UserDetailCollection), new UserDetailEntityFactory())
		{
		}
		...
		public UserDetailCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(UserDetailCollection), entityFactoryToUse)
		{
		}
		...
		public UserDetailCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, UserDetailValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(UserDetailCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private UserDetailCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("UserDetailCollection");
		}
		...
		/// <summary>
		/// Retrieves in this UserDetailCollection object all UserDetailEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves UserDetailEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all UserDetail entities from the persistent storage</param>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified UserDetailEntity. 
		...
		/// </summary>
		/// <param name="entityWithNewValues">UserDetailEntity instance which holds the new values for the matching entities to update. Only
		...
		/// will result in an update action which will affect all UserDetail entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(UserDetailEntity entityWithNewValues, IPredicate updateFilter)
		{
			UserDetailDAO dao = DAOFactory.CreateUserDetailDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(UserDetailEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			UserDetailDAO dao = DAOFactory.CreateUserDetailDAO();
		...
		/// </summary>
		public UserDetailEntity this [int index]
		{
			get { return (UserDetailEntity)List[index]; }
		}
		#endregion
