...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of ShipMethodEntity objects. 
	/// </summary>
	[Serializable]
	public class ShipMethodCollection : EntityCollectionBase
	{
		...
		/// CTor
		/// </summary>
		public ShipMethodCollection():base(new PropertyDescriptorFactory(), typeof(ShipMethodCollection), new ShipMethodEntityFactory())
		{
		}
		...
		public ShipMethodCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ShipMethodCollection), entityFactoryToUse)
		{
		}
		...
		public ShipMethodCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, ShipMethodValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ShipMethodCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private ShipMethodCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("ShipMethodCollection");
		}

	
	
		/// <summary>
		/// Retrieves in this ShipMethodCollection object all ShipMethodEntity objects which are related via a 
		...
		/// <summary>
		/// Retrieves in this ShipMethodCollection object all ShipMethodEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves ShipMethodEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all ShipMethod entities from the persistent storage</param>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified ShipMethodEntity. 
		...
		/// </summary>
		/// <param name="entityWithNewValues">ShipMethodEntity instance which holds the new values for the matching entities to update. Only
