...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of ProductCategoryEntity objects. 
	/// </summary>
	[Serializable]
	public class ProductCategoryCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ProductCategoryCollection():base(new PropertyDescriptorFactory(), typeof(ProductCategoryCollection), new ProductCategoryEntityFactory())
		{
		}
		...
		public ProductCategoryCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ProductCategoryCollection), entityFactoryToUse)
		{
		}
		...
		public ProductCategoryCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, ProductCategoryValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(ProductCategoryCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private ProductCategoryCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("ProductCategoryCollection");
		}
		...
		/// <summary>
		/// Retrieves in this ProductCategoryCollection object all ProductCategoryEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves ProductCategoryEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all ProductCategory entities from the persistent storage</param>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified ProductCategoryEntity. 
		...
		/// </summary>
		/// <param name="entityWithNewValues">ProductCategoryEntity instance which holds the new values for the matching entities to update. Only
		...
		/// will result in an update action which will affect all ProductCategory entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(ProductCategoryEntity entityWithNewValues, IPredicate updateFilter)
		{
			ProductCategoryDAO dao = DAOFactory.CreateProductCategoryDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(ProductCategoryEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			ProductCategoryDAO dao = DAOFactory.CreateProductCategoryDAO();
		...
		/// </summary>
		public ProductCategoryEntity this [int index]
		{
			get { return (ProductCategoryEntity)List[index]; }
		}
		#endregion
