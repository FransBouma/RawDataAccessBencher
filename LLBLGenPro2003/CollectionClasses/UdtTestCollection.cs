...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of UdtTestEntity objects. 
	/// </summary>
	[Serializable]
	public class UdtTestCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public UdtTestCollection():base(new PropertyDescriptorFactory(), typeof(UdtTestCollection), new UdtTestEntityFactory())
		{
		}
		...
		public UdtTestCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(UdtTestCollection), entityFactoryToUse)
		{
		}
		...
		public UdtTestCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, UdtTestValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(UdtTestCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private UdtTestCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("UdtTestCollection");
		}
		...
		/// <summary>
		/// Retrieves in this UdtTestCollection object all UdtTestEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves UdtTestEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all UdtTest entities from the persistent storage</param>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified UdtTestEntity. 
		...
		/// </summary>
		/// <param name="entityWithNewValues">UdtTestEntity instance which holds the new values for the matching entities to update. Only
		...
		/// will result in an update action which will affect all UdtTest entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(UdtTestEntity entityWithNewValues, IPredicate updateFilter)
		{
			UdtTestDAO dao = DAOFactory.CreateUdtTestDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(UdtTestEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			UdtTestDAO dao = DAOFactory.CreateUdtTestDAO();
		...
		/// </summary>
		public UdtTestEntity this [int index]
		{
			get { return (UdtTestEntity)List[index]; }
		}
		#endregion
