...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of CustomerAddressEntity objects. 
	/// </summary>
	[Serializable]
	public class CustomerAddressCollection : EntityCollectionBase
	{
		...
		/// CTor
		/// </summary>
		public CustomerAddressCollection():base(new PropertyDescriptorFactory(), typeof(CustomerAddressCollection), new CustomerAddressEntityFactory())
		{
		}
		...
		public CustomerAddressCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(CustomerAddressCollection), entityFactoryToUse)
		{
		}
		...
		public CustomerAddressCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, CustomerAddressValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(CustomerAddressCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private CustomerAddressCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("CustomerAddressCollection");
		}

	
		/// <summary>
		/// Retrieves in this CustomerAddressCollection object all CustomerAddressEntity objects which have data in common
		...
		public bool GetMultiManyToOne(AddressEntity addressInstance, AddressTypeEntity addressTypeInstance, CustomerEntity customerInstance)
		{
			return GetMultiManyToOne(addressInstance, addressTypeInstance, customerInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, null);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(AddressEntity addressInstance, AddressTypeEntity addressTypeInstance, CustomerEntity customerInstance, IPredicateExpression filter)
		{
			return GetMultiManyToOne(addressInstance, addressTypeInstance, customerInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, filter);
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(AddressEntity addressInstance, AddressTypeEntity addressTypeInstance, CustomerEntity customerInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			...
			return dao.GetMulti(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, filter, addressInstance, addressTypeInstance, customerInstance);
		}
		...
		public int DeleteMultiManyToOne( AddressEntity addressInstance,  AddressTypeEntity addressTypeInstance,  CustomerEntity customerInstance)
		{
			CustomerAddressDAO dao = DAOFactory.CreateCustomerAddressDAO();
		...
		/// <summary>
		/// Updates in the persistent storage all CustomerAddress entities which have data in common with the specified related Entities.
		/// If one is omitted, that entity is not used as a filter.
		...
		/// </summary>
		/// <param name="entityWithNewValues">CustomerAddressEntity instance which holds the new values for the matching entities to update. Only
		/// changed fields are taken into account</param>
		/// <param name="addressInstance">AddressEntity instance to use as a filter for the CustomerAddressEntity objects to return</param>
		/// <param name="addressTypeInstance">AddressTypeEntity instance to use as a filter for the CustomerAddressEntity objects to return</param>
		/// <param name="customerInstance">CustomerEntity instance to use as a filter for the CustomerAddressEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(CustomerAddressEntity entityWithNewValues, AddressEntity addressInstance, AddressTypeEntity addressTypeInstance, CustomerEntity customerInstance)
		{
			CustomerAddressDAO dao = DAOFactory.CreateCustomerAddressDAO();
			return dao.UpdateMulti(entityWithNewValues.Fields, base.Transaction, addressInstance, addressTypeInstance, customerInstance);
		}
	
	

		/// <summary>
		/// Retrieves in this CustomerAddressCollection object all CustomerAddressEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves CustomerAddressEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all CustomerAddress entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified CustomerAddressEntity. 
