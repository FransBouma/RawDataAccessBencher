...
{
	/// <summary>
	/// Collection class for storing and retrieving collections of SalesPersonEntity objects. 
	/// </summary>
	[Serializable]
	public class SalesPersonCollection : EntityCollectionBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public SalesPersonCollection():base(new PropertyDescriptorFactory(), typeof(SalesPersonCollection), new SalesPersonEntityFactory())
		{
		}
		...
		public SalesPersonCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
			:base(propertyDescriptorFactoryToUse, typeof(SalesPersonCollection), entityFactoryToUse)
		{
		}
		...
		public SalesPersonCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, SalesPersonValidator validatorToUse)
			:base(propertyDescriptorFactoryToUse, typeof(SalesPersonCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		private SalesPersonCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		{
			return base.ToXml("SalesPersonCollection");
		}

	
		/// <summary>
		/// Retrieves in this SalesPersonCollection object all SalesPersonEntity objects which have data in common
		...
		public bool GetMultiManyToOne(SalesTerritoryEntity salesTerritoryInstance)
		{
			return GetMultiManyToOne(salesTerritoryInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, null);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(SalesTerritoryEntity salesTerritoryInstance, IPredicateExpression filter)
		{
			return GetMultiManyToOne(salesTerritoryInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, filter);
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(SalesTerritoryEntity salesTerritoryInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			...
			return dao.GetMulti(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, filter, salesTerritoryInstance);
		}
		...
		public int DeleteMultiManyToOne( SalesTerritoryEntity salesTerritoryInstance)
		{
			SalesPersonDAO dao = DAOFactory.CreateSalesPersonDAO();
		...
		/// <summary>
		/// Updates in the persistent storage all SalesPerson entities which have data in common with the specified related Entities.
		/// If one is omitted, that entity is not used as a filter.
		...
		/// </summary>
		/// <param name="entityWithNewValues">SalesPersonEntity instance which holds the new values for the matching entities to update. Only
		/// changed fields are taken into account</param>
		/// <param name="salesTerritoryInstance">SalesTerritoryEntity instance to use as a filter for the SalesPersonEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(SalesPersonEntity entityWithNewValues, SalesTerritoryEntity salesTerritoryInstance)
		{
			SalesPersonDAO dao = DAOFactory.CreateSalesPersonDAO();
			return dao.UpdateMulti(entityWithNewValues.Fields, base.Transaction, salesTerritoryInstance);
		}
	
	
		/// <summary>
		/// Retrieves in this SalesPersonCollection object all SalesPersonEntity objects which are related via a 
		...
		/// <param name="salesTerritoryInstance">SalesTerritoryEntity object to be used as a filter in the m:n relation</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingSalesTerritory__(SalesTerritoryEntity salesTerritoryInstance)
		{
			return GetMultiManyToManyUsingSalesTerritory__(salesTerritoryInstance, base.MaxNumberOfItemsToReturn, base.SortClauses);
		}
		...
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingSalesTerritory__(SalesTerritoryEntity salesTerritoryInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
			if(!base.SuppressClearInGetMulti)
			{
				this.Clear();
			...
			SalesPersonDAO dao = DAOFactory.CreateSalesPersonDAO();
			return dao.GetMultiUsingSalesTerritory__(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, salesTerritoryInstance);
		}
	

		/// <summary>
		/// Retrieves in this SalesPersonCollection object all SalesPersonEntity objects which match with the specified filter, formulated in
		...
		/// <summary>
		/// Retrieves SalesPersonEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.
		/// </summary>
		/// <param name="selectFilter">A predicate or predicate expression which should be used as filter for the entities to retrieve.</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		/// will result in a query removing all SalesPerson entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary>
		/// Updates in the persistent storage all entities which have data in common with the specified SalesPersonEntity. 
		...
		/// will result in an update action which will affect all SalesPerson entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(SalesPersonEntity entityWithNewValues, IPredicate updateFilter)
		{
			SalesPersonDAO dao = DAOFactory.CreateSalesPersonDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(SalesPersonEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			SalesPersonDAO dao = DAOFactory.CreateSalesPersonDAO();
		...
		/// </summary>
		public SalesPersonEntity this [int index]
		{
			get { return (SalesPersonEntity)List[index]; }
		}
		#endregion
