...
namespace LLBL2003.AdventureWorks2008.DaoClasses
{
	...
	/// </summary>
	public class SalesOrderHeaderDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Adds the given fields to the database as a new 'SalesOrderHeader' entity.
		/// </summary>
		...
		public bool AddSalesOrderHeader(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'SalesOrderHeaderEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateSalesOrderHeader(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)SalesOrderHeaderFieldIndex.SalesOrderID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateSalesOrderHeader(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'SalesOrderHeaderEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchSalesOrderHeader(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 salesOrderID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)SalesOrderHeaderFieldIndex.SalesOrderID], ComparisonOperator.Equal, salesOrderID));
		...
		/// <summary>
		/// Deletes an entity of type 'SalesOrderHeaderEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteSalesOrderHeader(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)SalesOrderHeaderFieldIndex.SalesOrderID], ComparisonOperator.Equal));
		...
		public bool GetMulti(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, 
				IEntityFactory entityFactoryToUse, IValidator validatorToUse, IPredicateExpression filter, AddressEntity addressInstance, AddressEntity address_Instance, CreditCardEntity creditCardInstance, CurrencyRateEntity currencyRateInstance, CustomerEntity customerInstance, SalesPersonEntity salesPersonInstance, SalesTerritoryEntity salesTerritoryInstance, ShipMethodEntity shipMethodInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.SalesOrderHeaderEntity);
			IPredicateExpression selectFilter = CreateFilterUsingForeignKeys(addressInstance, address_Instance, creditCardInstance, currencyRateInstance, customerInstance, salesPersonInstance, salesTerritoryInstance, shipMethodInstance, fieldsToReturn);
			if(filter!=null)
			{
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingSpecialOfferProduct(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, 
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, SpecialOfferProductEntity specialOfferProductInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.SalesOrderHeaderEntity);
			...
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(specialOfferProductInstance.Fields[(int)SpecialOfferProductFieldIndex.SpecialOfferID], ComparisonOperator.Equal, specialOfferProductInstance.SpecialOfferID));
selectFilter.Add(new FieldCompareValuePredicate(specialOfferProductInstance.Fields[(int)SpecialOfferProductFieldIndex.ProductID], ComparisonOperator.Equal, specialOfferProductInstance.ProductID));
			CreateAndRunMultiInstanceRetrievalQuery(fieldsToReturn, containingTransaction, collectionToFill, maxNumberOfItemsToReturn, sortClauses, 
				entityFactoryToUse, selectFilter, validatorToUse, relations);
			return true;
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingSalesReason(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, 
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, SalesReasonEntity salesReasonInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.SalesOrderHeaderEntity);

			RelationCollection relations = new RelationCollection();
			// add the relations to walk.
			relations.Add(SalesOrderHeaderEntity.Relations.SalesOrderHeaderSalesReasonEntityUsingSalesOrderID);
			relations.Add(SalesOrderHeaderSalesReasonEntity.Relations.SalesReasonEntityUsingSalesReasonID);
			
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(salesReasonInstance.Fields[(int)SalesReasonFieldIndex.SalesReasonID], ComparisonOperator.Equal, salesReasonInstance.SalesReasonID));
			CreateAndRunMultiInstanceRetrievalQuery(fieldsToReturn, containingTransaction, collectionToFill, maxNumberOfItemsToReturn, sortClauses, 
				entityFactoryToUse, selectFilter, validatorToUse, relations);
			return true;
		}
		...
		public int DeleteMulti(ITransaction containingTransaction, AddressEntity addressInstance, AddressEntity address_Instance, CreditCardEntity creditCardInstance, CurrencyRateEntity currencyRateInstance, CustomerEntity customerInstance, SalesPersonEntity salesPersonInstance, SalesTerritoryEntity salesTerritoryInstance, ShipMethodEntity shipMethodInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.SalesOrderHeaderEntity);
			IPredicateExpression deleteFilter = CreateFilterUsingForeignKeys(addressInstance, address_Instance, creditCardInstance, currencyRateInstance, customerInstance, salesPersonInstance, salesTerritoryInstance, shipMethodInstance, fields);
			return CreateAndRunDeleteQuery(fields[0], containingTransaction, deleteFilter);
		}
	

		/// <summary>
		/// Deletes from the persistent storage all 'SalesOrderHeader' entities which match with the specified filter, formulated in
		...
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IEntityFields fieldsWithNewValues, ITransaction containingTransaction, AddressEntity addressInstance, AddressEntity address_Instance, CreditCardEntity creditCardInstance, CurrencyRateEntity currencyRateInstance, CustomerEntity customerInstance, SalesPersonEntity salesPersonInstance, SalesTerritoryEntity salesTerritoryInstance, ShipMethodEntity shipMethodInstance)
		{
			...
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.SalesOrderHeaderEntity);
			IPredicateExpression updateFilter = CreateFilterUsingForeignKeys(addressInstance, address_Instance, creditCardInstance, currencyRateInstance, customerInstance, salesPersonInstance, salesTerritoryInstance, shipMethodInstance, fields);
		...
		private IPredicateExpression CreateFilterUsingForeignKeys(AddressEntity addressInstance, AddressEntity address_Instance, CreditCardEntity creditCardInstance, CurrencyRateEntity currencyRateInstance, CustomerEntity customerInstance, SalesPersonEntity salesPersonInstance, SalesTerritoryEntity salesTerritoryInstance, ShipMethodEntity shipMethodInstance, IEntityFields fieldsToReturn)
		{
			IPredicateExpression selectFilter = new PredicateExpression();
			
			if(addressInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)SalesOrderHeaderFieldIndex.BillToAddressID], ComparisonOperator.Equal, addressInstance.AddressID));
			}
			
			if(address_Instance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)SalesOrderHeaderFieldIndex.ShipToAddressID], ComparisonOperator.Equal, address_Instance.AddressID));
			}
			
			if(creditCardInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)SalesOrderHeaderFieldIndex.CreditCardID], ComparisonOperator.Equal, creditCardInstance.CreditCardID));
			}
			
			if(currencyRateInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)SalesOrderHeaderFieldIndex.CurrencyRateID], ComparisonOperator.Equal, currencyRateInstance.CurrencyRateID));
			}
			
			if(customerInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)SalesOrderHeaderFieldIndex.CustomerID], ComparisonOperator.Equal, customerInstance.CustomerID));
			}
			
			if(salesPersonInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)SalesOrderHeaderFieldIndex.SalesPersonID], ComparisonOperator.Equal, salesPersonInstance.SalesPersonID));
			}
			
			if(salesTerritoryInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)SalesOrderHeaderFieldIndex.TerritoryID], ComparisonOperator.Equal, salesTerritoryInstance.TerritoryID));
			}
			
			if(shipMethodInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)SalesOrderHeaderFieldIndex.ShipMethodID], ComparisonOperator.Equal, shipMethodInstance.ShipMethodID));
			}
