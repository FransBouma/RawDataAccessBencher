...
{
	/// <summary>
	/// General DAO class for the ProductPhoto Entity. It will perform database oriented actions for
	/// a entity of type 'ProductPhotoEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class ProductPhotoDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Adds the given fields to the database as a new 'ProductPhoto' entity.
		/// </summary>
		...
		public bool AddProductPhoto(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'ProductPhotoEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateProductPhoto(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductPhotoFieldIndex.ProductPhotoID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateProductPhoto(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'ProductPhotoEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchProductPhoto(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 productPhotoID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)ProductPhotoFieldIndex.ProductPhotoID], ComparisonOperator.Equal, productPhotoID));
		...
		/// <summary>
		/// Deletes an entity of type 'ProductPhotoEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteProductPhoto(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductPhotoFieldIndex.ProductPhotoID], ComparisonOperator.Equal));
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductPhotoEntity);
		...
		/// <summary>
		/// Retrieves entities of the type 'ProductPhotoEntity' in a datatable which match the specified filter. 
			...
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, ProductEntity productInstance)
		{
			...
			relations.Add(ProductPhotoEntity.Relations.ProductProductPhotoEntityUsingProductPhotoID);
			relations.Add(ProductProductPhotoEntity.Relations.ProductEntityUsingProductID);
		...
		/// <summary>
		/// Deletes from the persistent storage all 'ProductPhoto' entities which match with the specified filter, formulated in
		...
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductPhotoEntity);
