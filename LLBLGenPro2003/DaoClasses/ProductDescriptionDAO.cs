...
{
	/// <summary>
	/// General DAO class for the ProductDescription Entity. It will perform database oriented actions for
	/// a entity of type 'ProductDescriptionEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class ProductDescriptionDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Adds the given fields to the database as a new 'ProductDescription' entity.
		/// </summary>
		...
		public bool AddProductDescription(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'ProductDescriptionEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateProductDescription(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductDescriptionFieldIndex.ProductDescriptionID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateProductDescription(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'ProductDescriptionEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchProductDescription(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 productDescriptionID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)ProductDescriptionFieldIndex.ProductDescriptionID], ComparisonOperator.Equal, productDescriptionID));
		...
		/// <summary>
		/// Deletes an entity of type 'ProductDescriptionEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteProductDescription(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductDescriptionFieldIndex.ProductDescriptionID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling ProductDescriptionCollection object all ProductDescriptionEntity objects
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductDescriptionEntity);
		...
		/// <summary>
		/// Retrieves entities of the type 'ProductDescriptionEntity' in a datatable which match the specified filter. 
			...
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, CultureEntity cultureInstance)
		{
			...
			relations.Add(ProductDescriptionEntity.Relations.ProductModelProductDescriptionCultureEntityUsingProductDescriptionID);
			...
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, ProductModelEntity productModelInstance)
		{
			...
			// add the relations to walk.
			relations.Add(ProductDescriptionEntity.Relations.ProductModelProductDescriptionCultureEntityUsingProductDescriptionID);
			relations.Add(ProductModelProductDescriptionCultureEntity.Relations.ProductModelEntityUsingProductModelID);
		...
		/// <summary>
		/// Deletes from the persistent storage all 'ProductDescription' entities which match with the specified filter, formulated in
		...
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductDescriptionEntity);
