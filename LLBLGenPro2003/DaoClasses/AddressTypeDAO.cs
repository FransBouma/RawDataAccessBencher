...
{
	/// <summary>
	/// General DAO class for the AddressType Entity. It will perform database oriented actions for
	/// a entity of type 'AddressTypeEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class AddressTypeDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Adds the given fields to the database as a new 'AddressType' entity.
		/// </summary>
		...
		public bool AddAddressType(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'AddressTypeEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateAddressType(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)AddressTypeFieldIndex.AddressTypeID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateAddressType(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'AddressTypeEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		/// <summary>
		/// Deletes an entity of type 'AddressTypeEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteAddressType(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)AddressTypeFieldIndex.AddressTypeID], ComparisonOperator.Equal));
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.AddressTypeEntity);
		...
		/// <summary>
		/// Retrieves entities of the type 'AddressTypeEntity' in a datatable which match the specified filter. 
			...
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, AddressEntity addressInstance)
		{
			...
			relations.Add(AddressTypeEntity.Relations.VendorAddressEntityUsingAddressTypeID);
			...
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, AddressEntity addressInstance)
		{
			...
			RelationCollection relations = new RelationCollection();
			// add the relations to walk.
			relations.Add(AddressTypeEntity.Relations.CustomerAddressEntityUsingAddressTypeID);
		...
		/// <summary>
		/// Deletes from the persistent storage all 'AddressType' entities which match with the specified filter, formulated in
		...
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.AddressTypeEntity);
