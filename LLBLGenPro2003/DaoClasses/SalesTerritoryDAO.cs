...
namespace LLBL2003.AdventureWorks2008.DaoClasses
{
	...
	/// </summary>
	public class SalesTerritoryDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public SalesTerritoryDAO()
		{
		}

		/// <summary>
		/// Adds the given fields to the database as a new 'SalesTerritory' entity.
		/// </summary>
		...
		public bool AddSalesTerritory(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'SalesTerritoryEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateSalesTerritory(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)SalesTerritoryFieldIndex.TerritoryID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateSalesTerritory(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'SalesTerritoryEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchSalesTerritory(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 territoryID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)SalesTerritoryFieldIndex.TerritoryID], ComparisonOperator.Equal, territoryID));
		...
		/// <summary>
		/// Deletes an entity of type 'SalesTerritoryEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteSalesTerritory(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)SalesTerritoryFieldIndex.TerritoryID], ComparisonOperator.Equal));
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.SalesTerritoryEntity);
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingCountryRegion(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, 
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, CountryRegionEntity countryRegionInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.SalesTerritoryEntity);

			RelationCollection relations = new RelationCollection();
			// add the relations to walk.
			relations.Add(SalesTerritoryEntity.Relations.StateProvinceEntityUsingTerritoryID);
			relations.Add(StateProvinceEntity.Relations.CountryRegionEntityUsingCountryRegionCode);
			
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(countryRegionInstance.Fields[(int)CountryRegionFieldIndex.CountryRegionCode], ComparisonOperator.Equal, countryRegionInstance.CountryRegionCode));
			CreateAndRunMultiInstanceRetrievalQuery(fieldsToReturn, containingTransaction, collectionToFill, maxNumberOfItemsToReturn, sortClauses, 
				entityFactoryToUse, selectFilter, validatorToUse, relations);
			return true;
		}
			...
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, AddressEntity addressInstance)
		{
			...
			RelationCollection relations = new RelationCollection();
			// add the relations to walk.
			relations.Add(SalesTerritoryEntity.Relations.SalesOrderHeaderEntityUsingTerritoryID);
		...
		/// <param name="salesPersonInstance">SalesPersonEntity object to be used as a filter in the m:n relation</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingSalesPerson__(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, 
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, SalesPersonEntity salesPersonInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.SalesTerritoryEntity);
			...
			RelationCollection relations = new RelationCollection();
			// add the relations to walk.
			relations.Add(SalesTerritoryEntity.Relations.SalesTerritoryHistoryEntityUsingTerritoryID);
			relations.Add(SalesTerritoryHistoryEntity.Relations.SalesPersonEntityUsingSalesPersonID);
		...
		/// <summary>
		/// Deletes from the persistent storage all 'SalesTerritory' entities which match with the specified filter, formulated in
		...
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.SalesTerritoryEntity);
