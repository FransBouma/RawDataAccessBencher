...
{
	/// <summary>
	/// General DAO class for the VendorAddress Entity. It will perform database oriented actions for
	/// a entity of type 'VendorAddressEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class VendorAddressDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public VendorAddressDAO()
		{
		}

		/// <summary>
		/// Adds the given fields to the database as a new 'VendorAddress' entity.
		/// </summary>
		...
		public bool AddVendorAddress(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'VendorAddressEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateVendorAddress(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)VendorAddressFieldIndex.VendorID], ComparisonOperator.Equal));
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)VendorAddressFieldIndex.AddressID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateVendorAddress(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'VendorAddressEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchVendorAddress(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 vendorID, System.Int32 addressID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)VendorAddressFieldIndex.VendorID], ComparisonOperator.Equal, vendorID));
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)VendorAddressFieldIndex.AddressID], ComparisonOperator.Equal, addressID));
		...
		/// <summary>
		/// Deletes an entity of type 'VendorAddressEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteVendorAddress(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)VendorAddressFieldIndex.VendorID], ComparisonOperator.Equal));
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)VendorAddressFieldIndex.AddressID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling VendorAddressCollection object all VendorAddressEntity objects which have data in common
		...
		public bool GetMulti(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, 
				IEntityFactory entityFactoryToUse, IValidator validatorToUse, IPredicateExpression filter, AddressEntity addressInstance, AddressTypeEntity addressTypeInstance, VendorEntity vendorInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.VendorAddressEntity);
		...
		/// <summary>
		/// Retrieves in the calling VendorAddressCollection object all VendorAddressEntity objects
		...
		/// <summary>
		/// Retrieves entities of the type 'VendorAddressEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'VendorAddress' entities which have data in common
		/// with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		...
		public int DeleteMulti(ITransaction containingTransaction, AddressEntity addressInstance, AddressTypeEntity addressTypeInstance, VendorEntity vendorInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.VendorAddressEntity);
		...
		/// <summary>
		/// Deletes from the persistent storage all 'VendorAddress' entities which match with the specified filter, formulated in
		...
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IEntityFields fieldsWithNewValues, ITransaction containingTransaction, AddressEntity addressInstance, AddressTypeEntity addressTypeInstance, VendorEntity vendorInstance)
		{
		...
		private IPredicateExpression CreateFilterUsingForeignKeys(AddressEntity addressInstance, AddressTypeEntity addressTypeInstance, VendorEntity vendorInstance, IEntityFields fieldsToReturn)
		{
			IPredicateExpression selectFilter = new PredicateExpression();
			
			if(addressInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)VendorAddressFieldIndex.AddressID], ComparisonOperator.Equal, addressInstance.AddressID));
			}
			
			if(addressTypeInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)VendorAddressFieldIndex.AddressTypeID], ComparisonOperator.Equal, addressTypeInstance.AddressTypeID));
			}
			
			if(vendorInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)VendorAddressFieldIndex.VendorID], ComparisonOperator.Equal, vendorInstance.VendorID));
			}
