...
{
	/// <summary>
	/// General DAO class for the ProductDocument Entity. It will perform database oriented actions for
	/// a entity of type 'ProductDocumentEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class ProductDocumentDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ProductDocumentDAO()
		{
		}

		/// <summary>
		/// Adds the given fields to the database as a new 'ProductDocument' entity.
		/// </summary>
		...
		public bool AddProductDocument(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'ProductDocumentEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateProductDocument(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductDocumentFieldIndex.ProductID], ComparisonOperator.Equal));
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductDocumentFieldIndex.DocumentID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateProductDocument(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'ProductDocumentEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchProductDocument(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 productID, System.Int32 documentID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)ProductDocumentFieldIndex.ProductID], ComparisonOperator.Equal, productID));
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)ProductDocumentFieldIndex.DocumentID], ComparisonOperator.Equal, documentID));
		...
		/// <summary>
		/// Deletes an entity of type 'ProductDocumentEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteProductDocument(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductDocumentFieldIndex.ProductID], ComparisonOperator.Equal));
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductDocumentFieldIndex.DocumentID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling ProductDocumentCollection object all ProductDocumentEntity objects which have data in common
		...
		/// <param name="documentInstance">DocumentEntity instance to use as a filter for the ProductDocumentEntity objects to return</param>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the ProductDocumentEntity objects to return</param>
		...
		public bool GetMulti(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, 
				IEntityFactory entityFactoryToUse, IValidator validatorToUse, IPredicateExpression filter, DocumentEntity documentInstance, ProductEntity productInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductDocumentEntity);
			IPredicateExpression selectFilter = CreateFilterUsingForeignKeys(documentInstance, productInstance, fieldsToReturn);
			if(filter!=null)
			{
		...
		/// <summary>
		/// Retrieves in the calling ProductDocumentCollection object all ProductDocumentEntity objects
		...
		/// <summary>
		/// Retrieves entities of the type 'ProductDocumentEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'ProductDocument' entities which have data in common
		/// with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="documentInstance">DocumentEntity instance to use as a filter for the ProductDocumentEntity objects to delete</param>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the ProductDocumentEntity objects to delete</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int DeleteMulti(ITransaction containingTransaction, DocumentEntity documentInstance, ProductEntity productInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductDocumentEntity);
			IPredicateExpression deleteFilter = CreateFilterUsingForeignKeys(documentInstance, productInstance, fields);
			return CreateAndRunDeleteQuery(fields[0], containingTransaction, deleteFilter);
		}
	

		/// <summary>
		/// Deletes from the persistent storage all 'ProductDocument' entities which match with the specified filter, formulated in
		...
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="documentInstance">DocumentEntity instance to use as a filter for the ProductDocumentEntity objects to update</param>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the ProductDocumentEntity objects to update</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IEntityFields fieldsWithNewValues, ITransaction containingTransaction, DocumentEntity documentInstance, ProductEntity productInstance)
		{
			...
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductDocumentEntity);
			IPredicateExpression updateFilter = CreateFilterUsingForeignKeys(documentInstance, productInstance, fields);
		...
		/// </summary>
		/// <param name="documentInstance">DocumentEntity instance to use as a filter for the ProductDocumentEntity objects</param>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the ProductDocumentEntity objects</param>
		/// <param name="fieldsToReturn">IEntityFields implementation which forms the definition of the fieldset of the target entity.</param>
		/// <returns>A ready to use PredicateExpression based on the passed in foreign key value holders.</returns>
		private IPredicateExpression CreateFilterUsingForeignKeys(DocumentEntity documentInstance, ProductEntity productInstance, IEntityFields fieldsToReturn)
		{
			IPredicateExpression selectFilter = new PredicateExpression();
			
			if(documentInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)ProductDocumentFieldIndex.DocumentID], ComparisonOperator.Equal, documentInstance.DocumentID));
			}
			
			if(productInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)ProductDocumentFieldIndex.ProductID], ComparisonOperator.Equal, productInstance.ProductID));
			}
