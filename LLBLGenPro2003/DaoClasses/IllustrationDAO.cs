...
{
	/// <summary>
	/// General DAO class for the Illustration Entity. It will perform database oriented actions for
	/// a entity of type 'IllustrationEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class IllustrationDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public IllustrationDAO()
		{
		}

		/// <summary>
		/// Adds the given fields to the database as a new 'Illustration' entity.
		/// </summary>
		...
		public bool AddIllustration(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'IllustrationEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateIllustration(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)IllustrationFieldIndex.IllustrationID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateIllustration(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'IllustrationEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchIllustration(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 illustrationID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)IllustrationFieldIndex.IllustrationID], ComparisonOperator.Equal, illustrationID));
		...
		/// <summary>
		/// Deletes an entity of type 'IllustrationEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteIllustration(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)IllustrationFieldIndex.IllustrationID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling IllustrationCollection object all IllustrationEntity objects
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.IllustrationEntity);
		...
		/// <summary>
		/// Retrieves entities of the type 'IllustrationEntity' in a datatable which match the specified filter. 
			...
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, ProductModelEntity productModelInstance)
		{
			...
			relations.Add(IllustrationEntity.Relations.ProductModelIllustrationEntityUsingIllustrationID);
			relations.Add(ProductModelIllustrationEntity.Relations.ProductModelEntityUsingProductModelID);
		...
		/// <summary>
		/// Deletes from the persistent storage all 'Illustration' entities which match with the specified filter, formulated in
		...
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.IllustrationEntity);
