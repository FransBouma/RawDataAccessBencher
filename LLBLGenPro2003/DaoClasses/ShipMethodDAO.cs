...
namespace LLBL2003.AdventureWorks2008.DaoClasses
{
	...
	/// </summary>
	public class ShipMethodDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Adds the given fields to the database as a new 'ShipMethod' entity.
		/// </summary>
		...
		public bool AddShipMethod(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'ShipMethodEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateShipMethod(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)ShipMethodFieldIndex.ShipMethodID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateShipMethod(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'ShipMethodEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchShipMethod(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 shipMethodID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)ShipMethodFieldIndex.ShipMethodID], ComparisonOperator.Equal, shipMethodID));
		...
		/// <summary>
		/// Deletes an entity of type 'ShipMethodEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteShipMethod(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)ShipMethodFieldIndex.ShipMethodID], ComparisonOperator.Equal));
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ShipMethodEntity);
			...
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, EmployeeEntity employeeInstance)
		{
			...
			relations.Add(ShipMethodEntity.Relations.PurchaseOrderHeaderEntityUsingShipMethodID);
			relations.Add(PurchaseOrderHeaderEntity.Relations.EmployeeEntityUsingEmployeeID);
		...
		/// <summary>
		/// Deletes from the persistent storage all 'ShipMethod' entities which match with the specified filter, formulated in
		...
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ShipMethodEntity);
