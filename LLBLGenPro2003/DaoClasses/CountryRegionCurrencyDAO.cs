...
{
	/// <summary>
	/// General DAO class for the CountryRegionCurrency Entity. It will perform database oriented actions for
	/// a entity of type 'CountryRegionCurrencyEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class CountryRegionCurrencyDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public CountryRegionCurrencyDAO()
		{
		}

		/// <summary>
		/// Adds the given fields to the database as a new 'CountryRegionCurrency' entity.
		/// </summary>
		...
		public bool AddCountryRegionCurrency(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'CountryRegionCurrencyEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateCountryRegionCurrency(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)CountryRegionCurrencyFieldIndex.CountryRegionCode], ComparisonOperator.Equal));
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)CountryRegionCurrencyFieldIndex.CurrencyCode], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateCountryRegionCurrency(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'CountryRegionCurrencyEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchCountryRegionCurrency(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.String countryRegionCode, System.String currencyCode)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)CountryRegionCurrencyFieldIndex.CountryRegionCode], ComparisonOperator.Equal, countryRegionCode));
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)CountryRegionCurrencyFieldIndex.CurrencyCode], ComparisonOperator.Equal, currencyCode));
		...
		/// <summary>
		/// Deletes an entity of type 'CountryRegionCurrencyEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteCountryRegionCurrency(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)CountryRegionCurrencyFieldIndex.CountryRegionCode], ComparisonOperator.Equal));
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)CountryRegionCurrencyFieldIndex.CurrencyCode], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling CountryRegionCurrencyCollection object all CountryRegionCurrencyEntity objects which have data in common
		...
		public bool GetMulti(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, 
				IEntityFactory entityFactoryToUse, IValidator validatorToUse, IPredicateExpression filter, CountryRegionEntity countryRegionInstance, CurrencyEntity currencyInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.CountryRegionCurrencyEntity);
			IPredicateExpression selectFilter = CreateFilterUsingForeignKeys(countryRegionInstance, currencyInstance, fieldsToReturn);
			if(filter!=null)
			{
		...
		/// <summary>
		/// Retrieves in the calling CountryRegionCurrencyCollection object all CountryRegionCurrencyEntity objects
		...
		/// <summary>
		/// Retrieves entities of the type 'CountryRegionCurrencyEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'CountryRegionCurrency' entities which have data in common
		/// with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="countryRegionInstance">CountryRegionEntity instance to use as a filter for the CountryRegionCurrencyEntity objects to delete</param>
		/// <param name="currencyInstance">CurrencyEntity instance to use as a filter for the CountryRegionCurrencyEntity objects to delete</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int DeleteMulti(ITransaction containingTransaction, CountryRegionEntity countryRegionInstance, CurrencyEntity currencyInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.CountryRegionCurrencyEntity);
			IPredicateExpression deleteFilter = CreateFilterUsingForeignKeys(countryRegionInstance, currencyInstance, fields);
			return CreateAndRunDeleteQuery(fields[0], containingTransaction, deleteFilter);
		}
	

		/// <summary>
		/// Deletes from the persistent storage all 'CountryRegionCurrency' entities which match with the specified filter, formulated in
		...
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="countryRegionInstance">CountryRegionEntity instance to use as a filter for the CountryRegionCurrencyEntity objects to update</param>
		/// <param name="currencyInstance">CurrencyEntity instance to use as a filter for the CountryRegionCurrencyEntity objects to update</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IEntityFields fieldsWithNewValues, ITransaction containingTransaction, CountryRegionEntity countryRegionInstance, CurrencyEntity currencyInstance)
		{
			...
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.CountryRegionCurrencyEntity);
			IPredicateExpression updateFilter = CreateFilterUsingForeignKeys(countryRegionInstance, currencyInstance, fields);
		...
		/// </summary>
		/// <param name="countryRegionInstance">CountryRegionEntity instance to use as a filter for the CountryRegionCurrencyEntity objects</param>
		/// <param name="currencyInstance">CurrencyEntity instance to use as a filter for the CountryRegionCurrencyEntity objects</param>
		/// <param name="fieldsToReturn">IEntityFields implementation which forms the definition of the fieldset of the target entity.</param>
		/// <returns>A ready to use PredicateExpression based on the passed in foreign key value holders.</returns>
		private IPredicateExpression CreateFilterUsingForeignKeys(CountryRegionEntity countryRegionInstance, CurrencyEntity currencyInstance, IEntityFields fieldsToReturn)
		{
			IPredicateExpression selectFilter = new PredicateExpression();
			
			if(countryRegionInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)CountryRegionCurrencyFieldIndex.CountryRegionCode], ComparisonOperator.Equal, countryRegionInstance.CountryRegionCode));
			}
			
			if(currencyInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)CountryRegionCurrencyFieldIndex.CurrencyCode], ComparisonOperator.Equal, currencyInstance.CurrencyCode));
			}
