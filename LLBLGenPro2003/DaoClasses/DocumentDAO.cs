...
{
	/// <summary>
	/// General DAO class for the Document Entity. It will perform database oriented actions for
	/// a entity of type 'DocumentEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class DocumentDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Adds the given fields to the database as a new 'Document' entity.
		/// </summary>
		...
		public bool AddDocument(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'DocumentEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateDocument(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)DocumentFieldIndex.DocumentID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateDocument(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'DocumentEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchDocument(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 documentID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)DocumentFieldIndex.DocumentID], ComparisonOperator.Equal, documentID));
		...
		/// <summary>
		/// Deletes an entity of type 'DocumentEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteDocument(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)DocumentFieldIndex.DocumentID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling DocumentCollection object all DocumentEntity objects
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.DocumentEntity);
		...
		/// <summary>
		/// Retrieves entities of the type 'DocumentEntity' in a datatable which match the specified filter. 
			...
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, ProductEntity productInstance)
		{
			...
			relations.Add(DocumentEntity.Relations.ProductDocumentEntityUsingDocumentID);
			relations.Add(ProductDocumentEntity.Relations.ProductEntityUsingProductID);
		...
		/// <summary>
		/// Deletes from the persistent storage all 'Document' entities which match with the specified filter, formulated in
		...
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.DocumentEntity);
