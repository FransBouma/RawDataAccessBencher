...
{
	/// <summary>
	/// General DAO class for the DatabaseLog Entity. It will perform database oriented actions for
	/// a entity of type 'DatabaseLogEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class DatabaseLogDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Adds the given fields to the database as a new 'DatabaseLog' entity.
		/// </summary>
		...
		public bool AddDatabaseLog(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'DatabaseLogEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateDatabaseLog(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)DatabaseLogFieldIndex.DatabaseLogID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateDatabaseLog(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'DatabaseLogEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchDatabaseLog(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 databaseLogID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)DatabaseLogFieldIndex.DatabaseLogID], ComparisonOperator.Equal, databaseLogID));
		...
		/// <summary>
		/// Deletes an entity of type 'DatabaseLogEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteDatabaseLog(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)DatabaseLogFieldIndex.DatabaseLogID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling DatabaseLogCollection object all DatabaseLogEntity objects
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.DatabaseLogEntity);
		...
		/// <summary>
		/// Retrieves entities of the type 'DatabaseLogEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'DatabaseLog' entities which match with the specified filter, formulated in
		...
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.DatabaseLogEntity);
