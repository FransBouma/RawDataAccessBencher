...
namespace LLBL2003.AdventureWorks2008.DaoClasses
{
	...
	public class SpecialOfferDAO : DaoBase
	{
		...
		/// CTor
		/// </summary>
		public SpecialOfferDAO()
		{
		}

		/// <summary>
		/// Adds the given fields to the database as a new 'SpecialOffer' entity.
		/// </summary>
		...
		public bool AddSpecialOffer(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'SpecialOfferEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateSpecialOffer(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)SpecialOfferFieldIndex.SpecialOfferID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateSpecialOffer(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'SpecialOfferEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchSpecialOffer(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 specialOfferID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)SpecialOfferFieldIndex.SpecialOfferID], ComparisonOperator.Equal, specialOfferID));
		...
		/// <summary>
		/// Deletes an entity of type 'SpecialOfferEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteSpecialOffer(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)SpecialOfferFieldIndex.SpecialOfferID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling SpecialOfferCollection object all SpecialOfferEntity objects
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.SpecialOfferEntity);
		...
		/// <summary>
		/// Retrieves entities of the type 'SpecialOfferEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'SpecialOffer' entities which match with the specified filter, formulated in
		...
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.SpecialOfferEntity);
