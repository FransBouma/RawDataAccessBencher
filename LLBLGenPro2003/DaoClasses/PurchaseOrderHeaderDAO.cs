...
{
	/// <summary>
	/// General DAO class for the PurchaseOrderHeader Entity. It will perform database oriented actions for
	/// a entity of type 'PurchaseOrderHeaderEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class PurchaseOrderHeaderDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Adds the given fields to the database as a new 'PurchaseOrderHeader' entity.
		/// </summary>
		...
		public bool AddPurchaseOrderHeader(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'PurchaseOrderHeaderEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdatePurchaseOrderHeader(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)PurchaseOrderHeaderFieldIndex.PurchaseOrderID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdatePurchaseOrderHeader(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'PurchaseOrderHeaderEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchPurchaseOrderHeader(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 purchaseOrderID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)PurchaseOrderHeaderFieldIndex.PurchaseOrderID], ComparisonOperator.Equal, purchaseOrderID));
		...
		/// <summary>
		/// Deletes an entity of type 'PurchaseOrderHeaderEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeletePurchaseOrderHeader(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)PurchaseOrderHeaderFieldIndex.PurchaseOrderID], ComparisonOperator.Equal));
		...
		public bool GetMulti(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, 
				IEntityFactory entityFactoryToUse, IValidator validatorToUse, IPredicateExpression filter, EmployeeEntity employeeInstance, ShipMethodEntity shipMethodInstance, VendorEntity vendorInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.PurchaseOrderHeaderEntity);
		...
		/// <summary>
		/// Retrieves in the calling PurchaseOrderHeaderCollection object all PurchaseOrderHeaderEntity objects
		...
		/// <summary>
		/// Retrieves entities of the type 'PurchaseOrderHeaderEntity' in a datatable which match the specified filter. 
			...
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, ProductEntity productInstance)
		{
			...
			relations.Add(PurchaseOrderHeaderEntity.Relations.PurchaseOrderDetailEntityUsingPurchaseOrderID);
			relations.Add(PurchaseOrderDetailEntity.Relations.ProductEntityUsingProductID);
		...
		/// <summary>
		/// Deletes from the persistent storage all 'PurchaseOrderHeader' entities which have data in common
		/// with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		...
		public int DeleteMulti(ITransaction containingTransaction, EmployeeEntity employeeInstance, ShipMethodEntity shipMethodInstance, VendorEntity vendorInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.PurchaseOrderHeaderEntity);
		...
		/// <summary>
		/// Deletes from the persistent storage all 'PurchaseOrderHeader' entities which match with the specified filter, formulated in
		...
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IEntityFields fieldsWithNewValues, ITransaction containingTransaction, EmployeeEntity employeeInstance, ShipMethodEntity shipMethodInstance, VendorEntity vendorInstance)
		{
		...
		private IPredicateExpression CreateFilterUsingForeignKeys(EmployeeEntity employeeInstance, ShipMethodEntity shipMethodInstance, VendorEntity vendorInstance, IEntityFields fieldsToReturn)
		{
			IPredicateExpression selectFilter = new PredicateExpression();
			
			if(employeeInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)PurchaseOrderHeaderFieldIndex.EmployeeID], ComparisonOperator.Equal, employeeInstance.EmployeeID));
			}
			
			if(shipMethodInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)PurchaseOrderHeaderFieldIndex.ShipMethodID], ComparisonOperator.Equal, shipMethodInstance.ShipMethodID));
			}
			
			if(vendorInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)PurchaseOrderHeaderFieldIndex.VendorID], ComparisonOperator.Equal, vendorInstance.VendorID));
			}
