...
{
	/// <summary>
	/// General DAO class for the VendorContact Entity. It will perform database oriented actions for
	/// a entity of type 'VendorContactEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class VendorContactDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public VendorContactDAO()
		{
		}

		/// <summary>
		/// Adds the given fields to the database as a new 'VendorContact' entity.
		/// </summary>
		...
		public bool AddVendorContact(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'VendorContactEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateVendorContact(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)VendorContactFieldIndex.VendorID], ComparisonOperator.Equal));
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)VendorContactFieldIndex.ContactID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateVendorContact(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'VendorContactEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchVendorContact(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 vendorID, System.Int32 contactID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)VendorContactFieldIndex.VendorID], ComparisonOperator.Equal, vendorID));
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)VendorContactFieldIndex.ContactID], ComparisonOperator.Equal, contactID));
		...
		/// <summary>
		/// Deletes an entity of type 'VendorContactEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteVendorContact(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)VendorContactFieldIndex.VendorID], ComparisonOperator.Equal));
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)VendorContactFieldIndex.ContactID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling VendorContactCollection object all VendorContactEntity objects which have data in common
		...
		public bool GetMulti(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, 
				IEntityFactory entityFactoryToUse, IValidator validatorToUse, IPredicateExpression filter, ContactEntity contactInstance, ContactTypeEntity contactTypeInstance, VendorEntity vendorInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.VendorContactEntity);
			IPredicateExpression selectFilter = CreateFilterUsingForeignKeys(contactInstance, contactTypeInstance, vendorInstance, fieldsToReturn);
			if(filter!=null)
			{
		...
		/// <summary>
		/// Retrieves in the calling VendorContactCollection object all VendorContactEntity objects
		...
		/// <summary>
		/// Retrieves entities of the type 'VendorContactEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'VendorContact' entities which have data in common
		/// with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="contactInstance">ContactEntity instance to use as a filter for the VendorContactEntity objects to delete</param>
		/// <param name="contactTypeInstance">ContactTypeEntity instance to use as a filter for the VendorContactEntity objects to delete</param>
		/// <param name="vendorInstance">VendorEntity instance to use as a filter for the VendorContactEntity objects to delete</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int DeleteMulti(ITransaction containingTransaction, ContactEntity contactInstance, ContactTypeEntity contactTypeInstance, VendorEntity vendorInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.VendorContactEntity);
			IPredicateExpression deleteFilter = CreateFilterUsingForeignKeys(contactInstance, contactTypeInstance, vendorInstance, fields);
			return CreateAndRunDeleteQuery(fields[0], containingTransaction, deleteFilter);
		}
	

		/// <summary>
		/// Deletes from the persistent storage all 'VendorContact' entities which match with the specified filter, formulated in
		...
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="contactInstance">ContactEntity instance to use as a filter for the VendorContactEntity objects to update</param>
		/// <param name="contactTypeInstance">ContactTypeEntity instance to use as a filter for the VendorContactEntity objects to update</param>
		/// <param name="vendorInstance">VendorEntity instance to use as a filter for the VendorContactEntity objects to update</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IEntityFields fieldsWithNewValues, ITransaction containingTransaction, ContactEntity contactInstance, ContactTypeEntity contactTypeInstance, VendorEntity vendorInstance)
		{
			...
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.VendorContactEntity);
			IPredicateExpression updateFilter = CreateFilterUsingForeignKeys(contactInstance, contactTypeInstance, vendorInstance, fields);
		...
		/// </summary>
		/// <param name="contactInstance">ContactEntity instance to use as a filter for the VendorContactEntity objects</param>
		/// <param name="contactTypeInstance">ContactTypeEntity instance to use as a filter for the VendorContactEntity objects</param>
		/// <param name="vendorInstance">VendorEntity instance to use as a filter for the VendorContactEntity objects</param>
		/// <param name="fieldsToReturn">IEntityFields implementation which forms the definition of the fieldset of the target entity.</param>
		/// <returns>A ready to use PredicateExpression based on the passed in foreign key value holders.</returns>
		private IPredicateExpression CreateFilterUsingForeignKeys(ContactEntity contactInstance, ContactTypeEntity contactTypeInstance, VendorEntity vendorInstance, IEntityFields fieldsToReturn)
		{
			IPredicateExpression selectFilter = new PredicateExpression();
			
			if(contactInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)VendorContactFieldIndex.ContactID], ComparisonOperator.Equal, contactInstance.ContactID));
			}
			
			if(contactTypeInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)VendorContactFieldIndex.ContactTypeID], ComparisonOperator.Equal, contactTypeInstance.ContactTypeID));
			}
			
			if(vendorInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)VendorContactFieldIndex.VendorID], ComparisonOperator.Equal, vendorInstance.VendorID));
			}
