...
{
	/// <summary>
	/// General DAO class for the SalesOrderHeaderSalesReason Entity. It will perform database oriented actions for
	/// a entity of type 'SalesOrderHeaderSalesReasonEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class SalesOrderHeaderSalesReasonDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public SalesOrderHeaderSalesReasonDAO()
		{
		}

		/// <summary>
		/// Adds the given fields to the database as a new 'SalesOrderHeaderSalesReason' entity.
		/// </summary>
		...
		public bool AddSalesOrderHeaderSalesReason(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'SalesOrderHeaderSalesReasonEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateSalesOrderHeaderSalesReason(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)SalesOrderHeaderSalesReasonFieldIndex.SalesOrderID], ComparisonOperator.Equal));
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)SalesOrderHeaderSalesReasonFieldIndex.SalesReasonID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateSalesOrderHeaderSalesReason(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'SalesOrderHeaderSalesReasonEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchSalesOrderHeaderSalesReason(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 salesOrderID, System.Int32 salesReasonID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)SalesOrderHeaderSalesReasonFieldIndex.SalesOrderID], ComparisonOperator.Equal, salesOrderID));
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)SalesOrderHeaderSalesReasonFieldIndex.SalesReasonID], ComparisonOperator.Equal, salesReasonID));
		...
		/// <summary>
		/// Deletes an entity of type 'SalesOrderHeaderSalesReasonEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteSalesOrderHeaderSalesReason(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)SalesOrderHeaderSalesReasonFieldIndex.SalesOrderID], ComparisonOperator.Equal));
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)SalesOrderHeaderSalesReasonFieldIndex.SalesReasonID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling SalesOrderHeaderSalesReasonCollection object all SalesOrderHeaderSalesReasonEntity objects which have data in common
		...
		public bool GetMulti(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, 
				IEntityFactory entityFactoryToUse, IValidator validatorToUse, IPredicateExpression filter, SalesOrderHeaderEntity salesOrderHeaderInstance, SalesReasonEntity salesReasonInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.SalesOrderHeaderSalesReasonEntity);
		...
		/// <summary>
		/// Retrieves in the calling SalesOrderHeaderSalesReasonCollection object all SalesOrderHeaderSalesReasonEntity objects
		...
		/// <summary>
		/// Retrieves entities of the type 'SalesOrderHeaderSalesReasonEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'SalesOrderHeaderSalesReason' entities which have data in common
		/// with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		...
		public int DeleteMulti(ITransaction containingTransaction, SalesOrderHeaderEntity salesOrderHeaderInstance, SalesReasonEntity salesReasonInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.SalesOrderHeaderSalesReasonEntity);
		...
		/// <summary>
		/// Deletes from the persistent storage all 'SalesOrderHeaderSalesReason' entities which match with the specified filter, formulated in
		...
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IEntityFields fieldsWithNewValues, ITransaction containingTransaction, SalesOrderHeaderEntity salesOrderHeaderInstance, SalesReasonEntity salesReasonInstance)
		{
		...
		private IPredicateExpression CreateFilterUsingForeignKeys(SalesOrderHeaderEntity salesOrderHeaderInstance, SalesReasonEntity salesReasonInstance, IEntityFields fieldsToReturn)
		{
			IPredicateExpression selectFilter = new PredicateExpression();
			
			if(salesOrderHeaderInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)SalesOrderHeaderSalesReasonFieldIndex.SalesOrderID], ComparisonOperator.Equal, salesOrderHeaderInstance.SalesOrderID));
			}
			
			if(salesReasonInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)SalesOrderHeaderSalesReasonFieldIndex.SalesReasonID], ComparisonOperator.Equal, salesReasonInstance.SalesReasonID));
			}
