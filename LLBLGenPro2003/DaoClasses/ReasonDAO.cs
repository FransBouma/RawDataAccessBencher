...
{
	/// <summary>
	/// General DAO class for the Reason Entity. It will perform database oriented actions for
	/// a entity of type 'ReasonEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class ReasonDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Adds the given fields to the database as a new 'Reason' entity.
		/// </summary>
		...
		public bool AddReason(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'ReasonEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateReason(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)ReasonFieldIndex.ID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateReason(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'ReasonEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchReason(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 iD)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)ReasonFieldIndex.ID], ComparisonOperator.Equal, iD));
		...
		/// <summary>
		/// Deletes an entity of type 'ReasonEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteReason(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)ReasonFieldIndex.ID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling ReasonCollection object all ReasonEntity objects
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ReasonEntity);
		...
		/// <summary>
		/// Retrieves entities of the type 'ReasonEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Retrieves in the calling ReasonCollection object all ReasonEntity objects
		/// which are related via a relation of type 'm:n' with the passed in NonPresentTimeHeaderEntity. 
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="collectionToFill">Collection to fill with the entity objects retrieved</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query. 
		...
		/// <param name="entityFactoryToUse">The EntityFactory to use when creating entity objects during a GetMulti() call.</param>
		/// <param name="validatorToUse">The Validator object to use when creating entity objects during a GetMulti() call.</param>
		/// <param name="nonPresentTimeHeaderInstance">NonPresentTimeHeaderEntity object to be used as a filter in the m:n relation</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingNonPresentTimeHeader(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, 
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, NonPresentTimeHeaderEntity nonPresentTimeHeaderInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ReasonEntity);

			RelationCollection relations = new RelationCollection();
			// add the relations to walk.
			relations.Add(ReasonEntity.Relations.NonPresentTimeEntityUsingReasonID);
			relations.Add(NonPresentTimeEntity.Relations.NonPresentTimeHeaderEntityUsingHeaderID);
			
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(nonPresentTimeHeaderInstance.Fields[(int)NonPresentTimeHeaderFieldIndex.ID], ComparisonOperator.Equal, nonPresentTimeHeaderInstance.ID));
			CreateAndRunMultiInstanceRetrievalQuery(fieldsToReturn, containingTransaction, collectionToFill, maxNumberOfItemsToReturn, sortClauses, 
				entityFactoryToUse, selectFilter, validatorToUse, relations);
			return true;
		}
		...
		/// <summary>
		/// Deletes from the persistent storage all 'Reason' entities which match with the specified filter, formulated in
		...
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ReasonEntity);
