...
{
	/// <summary>
	/// General DAO class for the CreativeAddresses Entity. It will perform database oriented actions for
	/// a entity of type 'CreativeAddressesEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class CreativeAddressesDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public CreativeAddressesDAO()
		{
		}

		/// <summary>
		/// Adds the given fields to the database as a new 'CreativeAddresses' entity.
		/// </summary>
		...
		public bool AddCreativeAddresses(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'CreativeAddressesEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateCreativeAddresses(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)CreativeAddressesFieldIndex.ID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateCreativeAddresses(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'CreativeAddressesEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchCreativeAddresses(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 iD)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)CreativeAddressesFieldIndex.ID], ComparisonOperator.Equal, iD));
		...
		/// <summary>
		/// Deletes an entity of type 'CreativeAddressesEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteCreativeAddresses(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)CreativeAddressesFieldIndex.ID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling CreativeAddressesCollection object all CreativeAddressesEntity objects
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.CreativeAddressesEntity);
		...
		/// <summary>
		/// Retrieves entities of the type 'CreativeAddressesEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'CreativeAddresses' entities which match with the specified filter, formulated in
		...
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.CreativeAddressesEntity);
