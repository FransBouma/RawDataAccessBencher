...
{
	/// <summary>
	/// General DAO class for the ProductVendor Entity. It will perform database oriented actions for
	/// a entity of type 'ProductVendorEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class ProductVendorDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ProductVendorDAO()
		{
		}

		/// <summary>
		/// Adds the given fields to the database as a new 'ProductVendor' entity.
		/// </summary>
		...
		public bool AddProductVendor(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'ProductVendorEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateProductVendor(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductVendorFieldIndex.ProductID], ComparisonOperator.Equal));
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductVendorFieldIndex.VendorID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateProductVendor(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'ProductVendorEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchProductVendor(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 productID, System.Int32 vendorID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)ProductVendorFieldIndex.ProductID], ComparisonOperator.Equal, productID));
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)ProductVendorFieldIndex.VendorID], ComparisonOperator.Equal, vendorID));
		...
		/// <summary>
		/// Deletes an entity of type 'ProductVendorEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteProductVendor(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductVendorFieldIndex.ProductID], ComparisonOperator.Equal));
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductVendorFieldIndex.VendorID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling ProductVendorCollection object all ProductVendorEntity objects which have data in common
		...
		/// <param name="productInstance">ProductEntity instance to use as a filter for the ProductVendorEntity objects to return</param>
		/// <param name="unitMeasureInstance">UnitMeasureEntity instance to use as a filter for the ProductVendorEntity objects to return</param>
		/// <param name="vendorInstance">VendorEntity instance to use as a filter for the ProductVendorEntity objects to return</param>
		...
		public bool GetMulti(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, 
				IEntityFactory entityFactoryToUse, IValidator validatorToUse, IPredicateExpression filter, ProductEntity productInstance, UnitMeasureEntity unitMeasureInstance, VendorEntity vendorInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductVendorEntity);
			IPredicateExpression selectFilter = CreateFilterUsingForeignKeys(productInstance, unitMeasureInstance, vendorInstance, fieldsToReturn);
			if(filter!=null)
			{
		...
		/// <summary>
		/// Retrieves in the calling ProductVendorCollection object all ProductVendorEntity objects
		...
		/// <summary>
		/// Retrieves entities of the type 'ProductVendorEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'ProductVendor' entities which have data in common
		/// with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the ProductVendorEntity objects to delete</param>
		/// <param name="unitMeasureInstance">UnitMeasureEntity instance to use as a filter for the ProductVendorEntity objects to delete</param>
		/// <param name="vendorInstance">VendorEntity instance to use as a filter for the ProductVendorEntity objects to delete</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int DeleteMulti(ITransaction containingTransaction, ProductEntity productInstance, UnitMeasureEntity unitMeasureInstance, VendorEntity vendorInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductVendorEntity);
			IPredicateExpression deleteFilter = CreateFilterUsingForeignKeys(productInstance, unitMeasureInstance, vendorInstance, fields);
			return CreateAndRunDeleteQuery(fields[0], containingTransaction, deleteFilter);
		}
	

		/// <summary>
		/// Deletes from the persistent storage all 'ProductVendor' entities which match with the specified filter, formulated in
		...
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the ProductVendorEntity objects to update</param>
		/// <param name="unitMeasureInstance">UnitMeasureEntity instance to use as a filter for the ProductVendorEntity objects to update</param>
		/// <param name="vendorInstance">VendorEntity instance to use as a filter for the ProductVendorEntity objects to update</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IEntityFields fieldsWithNewValues, ITransaction containingTransaction, ProductEntity productInstance, UnitMeasureEntity unitMeasureInstance, VendorEntity vendorInstance)
		{
			...
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductVendorEntity);
			IPredicateExpression updateFilter = CreateFilterUsingForeignKeys(productInstance, unitMeasureInstance, vendorInstance, fields);
		...
		/// </summary>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the ProductVendorEntity objects</param>
		/// <param name="unitMeasureInstance">UnitMeasureEntity instance to use as a filter for the ProductVendorEntity objects</param>
		/// <param name="vendorInstance">VendorEntity instance to use as a filter for the ProductVendorEntity objects</param>
		/// <param name="fieldsToReturn">IEntityFields implementation which forms the definition of the fieldset of the target entity.</param>
		/// <returns>A ready to use PredicateExpression based on the passed in foreign key value holders.</returns>
		private IPredicateExpression CreateFilterUsingForeignKeys(ProductEntity productInstance, UnitMeasureEntity unitMeasureInstance, VendorEntity vendorInstance, IEntityFields fieldsToReturn)
		{
			IPredicateExpression selectFilter = new PredicateExpression();
			
			if(productInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)ProductVendorFieldIndex.ProductID], ComparisonOperator.Equal, productInstance.ProductID));
			}
			
			if(unitMeasureInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)ProductVendorFieldIndex.UnitMeasureCode], ComparisonOperator.Equal, unitMeasureInstance.UnitMeasureCode));
			}
			
			if(vendorInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)ProductVendorFieldIndex.VendorID], ComparisonOperator.Equal, vendorInstance.VendorID));
			}
