...
namespace LLBL2003.AdventureWorks2008.DaoClasses
{
	...
	/// </summary>
	public class ProductModelDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Adds the given fields to the database as a new 'ProductModel' entity.
		/// </summary>
		...
		public bool AddProductModel(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'ProductModelEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateProductModel(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductModelFieldIndex.ProductModelID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateProductModel(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'ProductModelEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchProductModel(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 productModelID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)ProductModelFieldIndex.ProductModelID], ComparisonOperator.Equal, productModelID));
		...
		/// <summary>
		/// Deletes an entity of type 'ProductModelEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteProductModel(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductModelFieldIndex.ProductModelID], ComparisonOperator.Equal));
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductModelEntity);
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingProductSubcategory(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, 
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, ProductSubcategoryEntity productSubcategoryInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductModelEntity);

			RelationCollection relations = new RelationCollection();
			// add the relations to walk.
			relations.Add(ProductModelEntity.Relations.ProductEntityUsingProductModelID);
			relations.Add(ProductEntity.Relations.ProductSubcategoryEntityUsingProductSubcategoryID);
			
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(productSubcategoryInstance.Fields[(int)ProductSubcategoryFieldIndex.ProductSubcategoryID], ComparisonOperator.Equal, productSubcategoryInstance.ProductSubcategoryID));
			CreateAndRunMultiInstanceRetrievalQuery(fieldsToReturn, containingTransaction, collectionToFill, maxNumberOfItemsToReturn, sortClauses, 
				entityFactoryToUse, selectFilter, validatorToUse, relations);
			return true;
		}
			...
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, UnitMeasureEntity unitMeasureInstance)
		{
			...
			// add the relations to walk.
			relations.Add(ProductModelEntity.Relations.ProductEntityUsingProductModelID);
			relations.Add(ProductEntity.Relations.UnitMeasureEntityUsingSizeUnitMeasureCode);
		...
		/// <param name="unitMeasureInstance">UnitMeasureEntity object to be used as a filter in the m:n relation</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingUnitMeasure_(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, 
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, UnitMeasureEntity unitMeasureInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductModelEntity);
			...
			// add the relations to walk.
			relations.Add(ProductModelEntity.Relations.ProductEntityUsingProductModelID);
			relations.Add(ProductEntity.Relations.UnitMeasureEntityUsingWeightUnitMeasureCode);
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingIllustration(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, 
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, IllustrationEntity illustrationInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductModelEntity);

			RelationCollection relations = new RelationCollection();
			// add the relations to walk.
			relations.Add(ProductModelEntity.Relations.ProductModelIllustrationEntityUsingProductModelID);
			relations.Add(ProductModelIllustrationEntity.Relations.IllustrationEntityUsingIllustrationID);
			
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(illustrationInstance.Fields[(int)IllustrationFieldIndex.IllustrationID], ComparisonOperator.Equal, illustrationInstance.IllustrationID));
			CreateAndRunMultiInstanceRetrievalQuery(fieldsToReturn, containingTransaction, collectionToFill, maxNumberOfItemsToReturn, sortClauses, 
				entityFactoryToUse, selectFilter, validatorToUse, relations);
			return true;
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingCulture(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, 
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, CultureEntity cultureInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductModelEntity);

			RelationCollection relations = new RelationCollection();
			// add the relations to walk.
			relations.Add(ProductModelEntity.Relations.ProductModelProductDescriptionCultureEntityUsingProductModelID);
			relations.Add(ProductModelProductDescriptionCultureEntity.Relations.CultureEntityUsingCultureID);
			
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(cultureInstance.Fields[(int)CultureFieldIndex.CultureID], ComparisonOperator.Equal, cultureInstance.CultureID));
			CreateAndRunMultiInstanceRetrievalQuery(fieldsToReturn, containingTransaction, collectionToFill, maxNumberOfItemsToReturn, sortClauses, 
				entityFactoryToUse, selectFilter, validatorToUse, relations);
			return true;
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingProductDescription(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, 
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, ProductDescriptionEntity productDescriptionInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductModelEntity);
			...
			// add the relations to walk.
			relations.Add(ProductModelEntity.Relations.ProductModelProductDescriptionCultureEntityUsingProductModelID);
			relations.Add(ProductModelProductDescriptionCultureEntity.Relations.ProductDescriptionEntityUsingProductDescriptionID);
			
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(productDescriptionInstance.Fields[(int)ProductDescriptionFieldIndex.ProductDescriptionID], ComparisonOperator.Equal, productDescriptionInstance.ProductDescriptionID));
			CreateAndRunMultiInstanceRetrievalQuery(fieldsToReturn, containingTransaction, collectionToFill, maxNumberOfItemsToReturn, sortClauses, 
				entityFactoryToUse, selectFilter, validatorToUse, relations);
			return true;
		}
		...
		/// <summary>
		/// Deletes from the persistent storage all 'ProductModel' entities which match with the specified filter, formulated in
		...
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductModelEntity);
