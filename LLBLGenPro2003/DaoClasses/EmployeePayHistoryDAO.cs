...
{
	/// <summary>
	/// General DAO class for the EmployeePayHistory Entity. It will perform database oriented actions for
	/// a entity of type 'EmployeePayHistoryEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class EmployeePayHistoryDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public EmployeePayHistoryDAO()
		{
		}

		/// <summary>
		/// Adds the given fields to the database as a new 'EmployeePayHistory' entity.
		/// </summary>
		...
		public bool AddEmployeePayHistory(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'EmployeePayHistoryEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateEmployeePayHistory(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)EmployeePayHistoryFieldIndex.EmployeeID], ComparisonOperator.Equal));
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)EmployeePayHistoryFieldIndex.RateChangeDate], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateEmployeePayHistory(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'EmployeePayHistoryEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchEmployeePayHistory(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 employeeID, System.DateTime rateChangeDate)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)EmployeePayHistoryFieldIndex.EmployeeID], ComparisonOperator.Equal, employeeID));
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)EmployeePayHistoryFieldIndex.RateChangeDate], ComparisonOperator.Equal, rateChangeDate));
		...
		/// <summary>
		/// Deletes an entity of type 'EmployeePayHistoryEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteEmployeePayHistory(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)EmployeePayHistoryFieldIndex.EmployeeID], ComparisonOperator.Equal));
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)EmployeePayHistoryFieldIndex.RateChangeDate], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling EmployeePayHistoryCollection object all EmployeePayHistoryEntity objects which have data in common
		...
		/// <param name="employeeInstance">EmployeeEntity instance to use as a filter for the EmployeePayHistoryEntity objects to return</param>
		...
		public bool GetMulti(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, 
				IEntityFactory entityFactoryToUse, IValidator validatorToUse, IPredicateExpression filter, EmployeeEntity employeeInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.EmployeePayHistoryEntity);
		...
		/// <summary>
		/// Retrieves in the calling EmployeePayHistoryCollection object all EmployeePayHistoryEntity objects
		...
		/// <summary>
		/// Retrieves entities of the type 'EmployeePayHistoryEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'EmployeePayHistory' entities which have data in common
		/// with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="employeeInstance">EmployeeEntity instance to use as a filter for the EmployeePayHistoryEntity objects to delete</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int DeleteMulti(ITransaction containingTransaction, EmployeeEntity employeeInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.EmployeePayHistoryEntity);
		...
		/// <summary>
		/// Deletes from the persistent storage all 'EmployeePayHistory' entities which match with the specified filter, formulated in
		...
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="employeeInstance">EmployeeEntity instance to use as a filter for the EmployeePayHistoryEntity objects to update</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IEntityFields fieldsWithNewValues, ITransaction containingTransaction, EmployeeEntity employeeInstance)
		{
		...
		/// </summary>
		/// <param name="employeeInstance">EmployeeEntity instance to use as a filter for the EmployeePayHistoryEntity objects</param>
		/// <param name="fieldsToReturn">IEntityFields implementation which forms the definition of the fieldset of the target entity.</param>
		/// <returns>A ready to use PredicateExpression based on the passed in foreign key value holders.</returns>
		private IPredicateExpression CreateFilterUsingForeignKeys(EmployeeEntity employeeInstance, IEntityFields fieldsToReturn)
		{
			IPredicateExpression selectFilter = new PredicateExpression();
			
			if(employeeInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)EmployeePayHistoryFieldIndex.EmployeeID], ComparisonOperator.Equal, employeeInstance.EmployeeID));
			}
