...
{
	/// <summary>
	/// General DAO class for the WorkOrderRouting Entity. It will perform database oriented actions for
	/// a entity of type 'WorkOrderRoutingEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class WorkOrderRoutingDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public WorkOrderRoutingDAO()
		{
		}

		/// <summary>
		/// Adds the given fields to the database as a new 'WorkOrderRouting' entity.
		/// </summary>
		...
		public bool AddWorkOrderRouting(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'WorkOrderRoutingEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateWorkOrderRouting(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)WorkOrderRoutingFieldIndex.WorkOrderID], ComparisonOperator.Equal));
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)WorkOrderRoutingFieldIndex.ProductID], ComparisonOperator.Equal));
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)WorkOrderRoutingFieldIndex.OperationSequence], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateWorkOrderRouting(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'WorkOrderRoutingEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchWorkOrderRouting(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 workOrderID, System.Int32 productID, System.Int16 operationSequence)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)WorkOrderRoutingFieldIndex.WorkOrderID], ComparisonOperator.Equal, workOrderID));
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)WorkOrderRoutingFieldIndex.ProductID], ComparisonOperator.Equal, productID));
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)WorkOrderRoutingFieldIndex.OperationSequence], ComparisonOperator.Equal, operationSequence));
		...
		/// <summary>
		/// Deletes an entity of type 'WorkOrderRoutingEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteWorkOrderRouting(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)WorkOrderRoutingFieldIndex.WorkOrderID], ComparisonOperator.Equal));
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)WorkOrderRoutingFieldIndex.ProductID], ComparisonOperator.Equal));
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)WorkOrderRoutingFieldIndex.OperationSequence], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling WorkOrderRoutingCollection object all WorkOrderRoutingEntity objects which have data in common
		...
		public bool GetMulti(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, 
				IEntityFactory entityFactoryToUse, IValidator validatorToUse, IPredicateExpression filter, LocationEntity locationInstance, WorkOrderEntity workOrderInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.WorkOrderRoutingEntity);
			IPredicateExpression selectFilter = CreateFilterUsingForeignKeys(locationInstance, workOrderInstance, fieldsToReturn);
			if(filter!=null)
			{
		...
		/// <summary>
		/// Retrieves in the calling WorkOrderRoutingCollection object all WorkOrderRoutingEntity objects
		...
		/// <summary>
		/// Retrieves entities of the type 'WorkOrderRoutingEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'WorkOrderRouting' entities which have data in common
		/// with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="locationInstance">LocationEntity instance to use as a filter for the WorkOrderRoutingEntity objects to delete</param>
		/// <param name="workOrderInstance">WorkOrderEntity instance to use as a filter for the WorkOrderRoutingEntity objects to delete</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int DeleteMulti(ITransaction containingTransaction, LocationEntity locationInstance, WorkOrderEntity workOrderInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.WorkOrderRoutingEntity);
			IPredicateExpression deleteFilter = CreateFilterUsingForeignKeys(locationInstance, workOrderInstance, fields);
			return CreateAndRunDeleteQuery(fields[0], containingTransaction, deleteFilter);
		}
	

		/// <summary>
		/// Deletes from the persistent storage all 'WorkOrderRouting' entities which match with the specified filter, formulated in
		...
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="locationInstance">LocationEntity instance to use as a filter for the WorkOrderRoutingEntity objects to update</param>
		/// <param name="workOrderInstance">WorkOrderEntity instance to use as a filter for the WorkOrderRoutingEntity objects to update</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IEntityFields fieldsWithNewValues, ITransaction containingTransaction, LocationEntity locationInstance, WorkOrderEntity workOrderInstance)
		{
			...
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.WorkOrderRoutingEntity);
			IPredicateExpression updateFilter = CreateFilterUsingForeignKeys(locationInstance, workOrderInstance, fields);
		...
		/// </summary>
		/// <param name="locationInstance">LocationEntity instance to use as a filter for the WorkOrderRoutingEntity objects</param>
		/// <param name="workOrderInstance">WorkOrderEntity instance to use as a filter for the WorkOrderRoutingEntity objects</param>
		/// <param name="fieldsToReturn">IEntityFields implementation which forms the definition of the fieldset of the target entity.</param>
		/// <returns>A ready to use PredicateExpression based on the passed in foreign key value holders.</returns>
		private IPredicateExpression CreateFilterUsingForeignKeys(LocationEntity locationInstance, WorkOrderEntity workOrderInstance, IEntityFields fieldsToReturn)
		{
			IPredicateExpression selectFilter = new PredicateExpression();
			
			if(locationInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)WorkOrderRoutingFieldIndex.LocationID], ComparisonOperator.Equal, locationInstance.LocationID));
			}
			
			if(workOrderInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)WorkOrderRoutingFieldIndex.WorkOrderID], ComparisonOperator.Equal, workOrderInstance.WorkOrderID));
			}
