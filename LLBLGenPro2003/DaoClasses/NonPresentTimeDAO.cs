...
{
	/// <summary>
	/// General DAO class for the NonPresentTime Entity. It will perform database oriented actions for
	/// a entity of type 'NonPresentTimeEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class NonPresentTimeDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public NonPresentTimeDAO()
		{
		}

		/// <summary>
		/// Adds the given fields to the database as a new 'NonPresentTime' entity.
		/// </summary>
		...
		public bool AddNonPresentTime(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'NonPresentTimeEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateNonPresentTime(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)NonPresentTimeFieldIndex.ID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateNonPresentTime(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'NonPresentTimeEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchNonPresentTime(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 iD)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)NonPresentTimeFieldIndex.ID], ComparisonOperator.Equal, iD));
		...
		/// <summary>
		/// Deletes an entity of type 'NonPresentTimeEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteNonPresentTime(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)NonPresentTimeFieldIndex.ID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling NonPresentTimeCollection object all NonPresentTimeEntity objects which have data in common
		...
		/// <param name="reasonInstance">ReasonEntity instance to use as a filter for the NonPresentTimeEntity objects to return</param>
		/// <param name="nonPresentTimeHeaderInstance">NonPresentTimeHeaderEntity instance to use as a filter for the NonPresentTimeEntity objects to return</param>
		...
		public bool GetMulti(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, 
				IEntityFactory entityFactoryToUse, IValidator validatorToUse, IPredicateExpression filter, ReasonEntity reasonInstance, NonPresentTimeHeaderEntity nonPresentTimeHeaderInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.NonPresentTimeEntity);
			IPredicateExpression selectFilter = CreateFilterUsingForeignKeys(reasonInstance, nonPresentTimeHeaderInstance, fieldsToReturn);
			if(filter!=null)
			{
		...
		/// <summary>
		/// Retrieves in the calling NonPresentTimeCollection object all NonPresentTimeEntity objects
		...
		/// <summary>
		/// Retrieves entities of the type 'NonPresentTimeEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'NonPresentTime' entities which have data in common
		/// with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="reasonInstance">ReasonEntity instance to use as a filter for the NonPresentTimeEntity objects to delete</param>
		/// <param name="nonPresentTimeHeaderInstance">NonPresentTimeHeaderEntity instance to use as a filter for the NonPresentTimeEntity objects to delete</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int DeleteMulti(ITransaction containingTransaction, ReasonEntity reasonInstance, NonPresentTimeHeaderEntity nonPresentTimeHeaderInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.NonPresentTimeEntity);
			IPredicateExpression deleteFilter = CreateFilterUsingForeignKeys(reasonInstance, nonPresentTimeHeaderInstance, fields);
			return CreateAndRunDeleteQuery(fields[0], containingTransaction, deleteFilter);
		}
	

		/// <summary>
		/// Deletes from the persistent storage all 'NonPresentTime' entities which match with the specified filter, formulated in
		...
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="reasonInstance">ReasonEntity instance to use as a filter for the NonPresentTimeEntity objects to update</param>
		/// <param name="nonPresentTimeHeaderInstance">NonPresentTimeHeaderEntity instance to use as a filter for the NonPresentTimeEntity objects to update</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IEntityFields fieldsWithNewValues, ITransaction containingTransaction, ReasonEntity reasonInstance, NonPresentTimeHeaderEntity nonPresentTimeHeaderInstance)
		{
			...
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.NonPresentTimeEntity);
			IPredicateExpression updateFilter = CreateFilterUsingForeignKeys(reasonInstance, nonPresentTimeHeaderInstance, fields);
		...
		/// </summary>
		/// <param name="reasonInstance">ReasonEntity instance to use as a filter for the NonPresentTimeEntity objects</param>
		/// <param name="nonPresentTimeHeaderInstance">NonPresentTimeHeaderEntity instance to use as a filter for the NonPresentTimeEntity objects</param>
		/// <param name="fieldsToReturn">IEntityFields implementation which forms the definition of the fieldset of the target entity.</param>
		/// <returns>A ready to use PredicateExpression based on the passed in foreign key value holders.</returns>
		private IPredicateExpression CreateFilterUsingForeignKeys(ReasonEntity reasonInstance, NonPresentTimeHeaderEntity nonPresentTimeHeaderInstance, IEntityFields fieldsToReturn)
		{
			IPredicateExpression selectFilter = new PredicateExpression();
			
			if(reasonInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)NonPresentTimeFieldIndex.ReasonID], ComparisonOperator.Equal, reasonInstance.ID));
			}
			
			if(nonPresentTimeHeaderInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)NonPresentTimeFieldIndex.HeaderID], ComparisonOperator.Equal, nonPresentTimeHeaderInstance.ID));
			}
