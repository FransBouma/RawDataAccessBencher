...
{
	/// <summary>
	/// General DAO class for the AWBuildVersion Entity. It will perform database oriented actions for
	/// a entity of type 'AWBuildVersionEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class AWBuildVersionDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public AWBuildVersionDAO()
		{
		}

		/// <summary>
		/// Adds the given fields to the database as a new 'AWBuildVersion' entity.
		/// </summary>
		...
		public bool AddAWBuildVersion(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'AWBuildVersionEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateAWBuildVersion(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)AWBuildVersionFieldIndex.SystemInformationID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateAWBuildVersion(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'AWBuildVersionEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchAWBuildVersion(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Byte systemInformationID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)AWBuildVersionFieldIndex.SystemInformationID], ComparisonOperator.Equal, systemInformationID));
		...
		/// <summary>
		/// Deletes an entity of type 'AWBuildVersionEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteAWBuildVersion(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)AWBuildVersionFieldIndex.SystemInformationID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling AWBuildVersionCollection object all AWBuildVersionEntity objects
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.AWBuildVersionEntity);
		...
		/// <summary>
		/// Retrieves entities of the type 'AWBuildVersionEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'AWBuildVersion' entities which match with the specified filter, formulated in
		...
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.AWBuildVersionEntity);
