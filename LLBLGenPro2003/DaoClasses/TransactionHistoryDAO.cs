...
{
	/// <summary>
	/// General DAO class for the TransactionHistory Entity. It will perform database oriented actions for
	/// a entity of type 'TransactionHistoryEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class TransactionHistoryDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Adds the given fields to the database as a new 'TransactionHistory' entity.
		/// </summary>
		...
		public bool AddTransactionHistory(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'TransactionHistoryEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateTransactionHistory(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)TransactionHistoryFieldIndex.TransactionID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateTransactionHistory(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'TransactionHistoryEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchTransactionHistory(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 transactionID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)TransactionHistoryFieldIndex.TransactionID], ComparisonOperator.Equal, transactionID));
		...
		/// <summary>
		/// Deletes an entity of type 'TransactionHistoryEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteTransactionHistory(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)TransactionHistoryFieldIndex.TransactionID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling TransactionHistoryCollection object all TransactionHistoryEntity objects which have data in common
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.TransactionHistoryEntity);
		...
		/// <summary>
		/// Retrieves in the calling TransactionHistoryCollection object all TransactionHistoryEntity objects
		...
		/// <summary>
		/// Retrieves entities of the type 'TransactionHistoryEntity' in a datatable which match the specified filter. 
		...
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the TransactionHistoryEntity objects to delete</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int DeleteMulti(ITransaction containingTransaction, ProductEntity productInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.TransactionHistoryEntity);
		...
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the TransactionHistoryEntity objects to update</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// </summary>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the TransactionHistoryEntity objects</param>
		...
		private IPredicateExpression CreateFilterUsingForeignKeys(ProductEntity productInstance, IEntityFields fieldsToReturn)
		{
			...
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)TransactionHistoryFieldIndex.ProductID], ComparisonOperator.Equal, productInstance.ProductID));
			}
