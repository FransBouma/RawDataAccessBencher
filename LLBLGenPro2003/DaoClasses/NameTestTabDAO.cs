...
{
	/// <summary>
	/// General DAO class for the NameTestTab Entity. It will perform database oriented actions for
	/// a entity of type 'NameTestTabEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class NameTestTabDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public NameTestTabDAO()
		{
		}

		/// <summary>
		/// Adds the given fields to the database as a new 'NameTestTab' entity.
		/// </summary>
		...
		public bool AddNameTestTab(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'NameTestTabEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateNameTestTab(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)NameTestTabFieldIndex.ID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateNameTestTab(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'NameTestTabEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchNameTestTab(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 iD)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)NameTestTabFieldIndex.ID], ComparisonOperator.Equal, iD));
		...
		/// <summary>
		/// Deletes an entity of type 'NameTestTabEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteNameTestTab(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)NameTestTabFieldIndex.ID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling NameTestTabCollection object all NameTestTabEntity objects
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.NameTestTabEntity);
		...
		/// <summary>
		/// Retrieves entities of the type 'NameTestTabEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'NameTestTab' entities which match with the specified filter, formulated in
		...
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.NameTestTabEntity);
