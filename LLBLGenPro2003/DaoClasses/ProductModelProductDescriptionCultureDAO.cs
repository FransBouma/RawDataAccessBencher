...
{
	/// <summary>
	/// General DAO class for the ProductModelProductDescriptionCulture Entity. It will perform database oriented actions for
	/// a entity of type 'ProductModelProductDescriptionCultureEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class ProductModelProductDescriptionCultureDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ProductModelProductDescriptionCultureDAO()
		{
		}

		/// <summary>
		/// Adds the given fields to the database as a new 'ProductModelProductDescriptionCulture' entity.
		/// </summary>
		...
		public bool AddProductModelProductDescriptionCulture(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'ProductModelProductDescriptionCultureEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateProductModelProductDescriptionCulture(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductModelProductDescriptionCultureFieldIndex.ProductModelID], ComparisonOperator.Equal));
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductModelProductDescriptionCultureFieldIndex.ProductDescriptionID], ComparisonOperator.Equal));
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductModelProductDescriptionCultureFieldIndex.CultureID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateProductModelProductDescriptionCulture(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'ProductModelProductDescriptionCultureEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchProductModelProductDescriptionCulture(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 productModelID, System.Int32 productDescriptionID, System.String cultureID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)ProductModelProductDescriptionCultureFieldIndex.ProductModelID], ComparisonOperator.Equal, productModelID));
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)ProductModelProductDescriptionCultureFieldIndex.ProductDescriptionID], ComparisonOperator.Equal, productDescriptionID));
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)ProductModelProductDescriptionCultureFieldIndex.CultureID], ComparisonOperator.Equal, cultureID));
		...
		/// <summary>
		/// Deletes an entity of type 'ProductModelProductDescriptionCultureEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteProductModelProductDescriptionCulture(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductModelProductDescriptionCultureFieldIndex.ProductModelID], ComparisonOperator.Equal));
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductModelProductDescriptionCultureFieldIndex.ProductDescriptionID], ComparisonOperator.Equal));
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductModelProductDescriptionCultureFieldIndex.CultureID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling ProductModelProductDescriptionCultureCollection object all ProductModelProductDescriptionCultureEntity objects which have data in common
		...
		public bool GetMulti(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, 
				IEntityFactory entityFactoryToUse, IValidator validatorToUse, IPredicateExpression filter, CultureEntity cultureInstance, ProductDescriptionEntity productDescriptionInstance, ProductModelEntity productModelInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductModelProductDescriptionCultureEntity);
		...
		/// <summary>
		/// Retrieves in the calling ProductModelProductDescriptionCultureCollection object all ProductModelProductDescriptionCultureEntity objects
		...
		/// <summary>
		/// Retrieves entities of the type 'ProductModelProductDescriptionCultureEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'ProductModelProductDescriptionCulture' entities which have data in common
		/// with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		...
		public int DeleteMulti(ITransaction containingTransaction, CultureEntity cultureInstance, ProductDescriptionEntity productDescriptionInstance, ProductModelEntity productModelInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductModelProductDescriptionCultureEntity);
		...
		/// <summary>
		/// Deletes from the persistent storage all 'ProductModelProductDescriptionCulture' entities which match with the specified filter, formulated in
		...
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IEntityFields fieldsWithNewValues, ITransaction containingTransaction, CultureEntity cultureInstance, ProductDescriptionEntity productDescriptionInstance, ProductModelEntity productModelInstance)
		{
		...
		private IPredicateExpression CreateFilterUsingForeignKeys(CultureEntity cultureInstance, ProductDescriptionEntity productDescriptionInstance, ProductModelEntity productModelInstance, IEntityFields fieldsToReturn)
		{
			IPredicateExpression selectFilter = new PredicateExpression();
			
			if(cultureInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)ProductModelProductDescriptionCultureFieldIndex.CultureID], ComparisonOperator.Equal, cultureInstance.CultureID));
			}
			
			if(productDescriptionInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)ProductModelProductDescriptionCultureFieldIndex.ProductDescriptionID], ComparisonOperator.Equal, productDescriptionInstance.ProductDescriptionID));
			}
			
			if(productModelInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)ProductModelProductDescriptionCultureFieldIndex.ProductModelID], ComparisonOperator.Equal, productModelInstance.ProductModelID));
			}
