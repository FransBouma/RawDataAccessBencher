...
{
	/// <summary>
	/// General DAO class for the ProductModelIllustration Entity. It will perform database oriented actions for
	/// a entity of type 'ProductModelIllustrationEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class ProductModelIllustrationDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ProductModelIllustrationDAO()
		{
		}

		/// <summary>
		/// Adds the given fields to the database as a new 'ProductModelIllustration' entity.
		/// </summary>
		...
		public bool AddProductModelIllustration(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'ProductModelIllustrationEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateProductModelIllustration(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductModelIllustrationFieldIndex.ProductModelID], ComparisonOperator.Equal));
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductModelIllustrationFieldIndex.IllustrationID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateProductModelIllustration(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'ProductModelIllustrationEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchProductModelIllustration(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 productModelID, System.Int32 illustrationID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)ProductModelIllustrationFieldIndex.ProductModelID], ComparisonOperator.Equal, productModelID));
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)ProductModelIllustrationFieldIndex.IllustrationID], ComparisonOperator.Equal, illustrationID));
		...
		/// <summary>
		/// Deletes an entity of type 'ProductModelIllustrationEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteProductModelIllustration(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductModelIllustrationFieldIndex.ProductModelID], ComparisonOperator.Equal));
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductModelIllustrationFieldIndex.IllustrationID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling ProductModelIllustrationCollection object all ProductModelIllustrationEntity objects which have data in common
		...
		public bool GetMulti(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, 
				IEntityFactory entityFactoryToUse, IValidator validatorToUse, IPredicateExpression filter, IllustrationEntity illustrationInstance, ProductModelEntity productModelInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductModelIllustrationEntity);
			IPredicateExpression selectFilter = CreateFilterUsingForeignKeys(illustrationInstance, productModelInstance, fieldsToReturn);
			if(filter!=null)
			{
		...
		/// <summary>
		/// Retrieves in the calling ProductModelIllustrationCollection object all ProductModelIllustrationEntity objects
		...
		/// <summary>
		/// Retrieves entities of the type 'ProductModelIllustrationEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'ProductModelIllustration' entities which have data in common
		/// with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="illustrationInstance">IllustrationEntity instance to use as a filter for the ProductModelIllustrationEntity objects to delete</param>
		/// <param name="productModelInstance">ProductModelEntity instance to use as a filter for the ProductModelIllustrationEntity objects to delete</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int DeleteMulti(ITransaction containingTransaction, IllustrationEntity illustrationInstance, ProductModelEntity productModelInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductModelIllustrationEntity);
			IPredicateExpression deleteFilter = CreateFilterUsingForeignKeys(illustrationInstance, productModelInstance, fields);
			return CreateAndRunDeleteQuery(fields[0], containingTransaction, deleteFilter);
		}
	

		/// <summary>
		/// Deletes from the persistent storage all 'ProductModelIllustration' entities which match with the specified filter, formulated in
		...
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="illustrationInstance">IllustrationEntity instance to use as a filter for the ProductModelIllustrationEntity objects to update</param>
		/// <param name="productModelInstance">ProductModelEntity instance to use as a filter for the ProductModelIllustrationEntity objects to update</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IEntityFields fieldsWithNewValues, ITransaction containingTransaction, IllustrationEntity illustrationInstance, ProductModelEntity productModelInstance)
		{
			...
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductModelIllustrationEntity);
			IPredicateExpression updateFilter = CreateFilterUsingForeignKeys(illustrationInstance, productModelInstance, fields);
		...
		/// </summary>
		/// <param name="illustrationInstance">IllustrationEntity instance to use as a filter for the ProductModelIllustrationEntity objects</param>
		/// <param name="productModelInstance">ProductModelEntity instance to use as a filter for the ProductModelIllustrationEntity objects</param>
		/// <param name="fieldsToReturn">IEntityFields implementation which forms the definition of the fieldset of the target entity.</param>
		/// <returns>A ready to use PredicateExpression based on the passed in foreign key value holders.</returns>
		private IPredicateExpression CreateFilterUsingForeignKeys(IllustrationEntity illustrationInstance, ProductModelEntity productModelInstance, IEntityFields fieldsToReturn)
		{
			IPredicateExpression selectFilter = new PredicateExpression();
			
			if(illustrationInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)ProductModelIllustrationFieldIndex.IllustrationID], ComparisonOperator.Equal, illustrationInstance.IllustrationID));
			}
			
			if(productModelInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)ProductModelIllustrationFieldIndex.ProductModelID], ComparisonOperator.Equal, productModelInstance.ProductModelID));
			}
