...
{
	/// <summary>
	/// General DAO class for the Currency Entity. It will perform database oriented actions for
	/// a entity of type 'CurrencyEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class CurrencyDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Adds the given fields to the database as a new 'Currency' entity.
		/// </summary>
		...
		public bool AddCurrency(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'CurrencyEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateCurrency(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)CurrencyFieldIndex.CurrencyCode], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateCurrency(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'CurrencyEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchCurrency(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.String currencyCode)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)CurrencyFieldIndex.CurrencyCode], ComparisonOperator.Equal, currencyCode));
		...
		/// <summary>
		/// Deletes an entity of type 'CurrencyEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteCurrency(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)CurrencyFieldIndex.CurrencyCode], ComparisonOperator.Equal));
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.CurrencyEntity);
		...
		/// <summary>
		/// Retrieves entities of the type 'CurrencyEntity' in a datatable which match the specified filter. 
			...
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, CountryRegionEntity countryRegionInstance)
		{
			...
			relations.Add(CurrencyEntity.Relations.CountryRegionCurrencyEntityUsingCurrencyCode);
			relations.Add(CountryRegionCurrencyEntity.Relations.CountryRegionEntityUsingCountryRegionCode);
		...
		/// <summary>
		/// Deletes from the persistent storage all 'Currency' entities which match with the specified filter, formulated in
		...
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.CurrencyEntity);
