...
namespace LLBL2003.AdventureWorks2008.DaoClasses
{
	...
	/// </summary>
	public class WorkOrderDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Adds the given fields to the database as a new 'WorkOrder' entity.
		/// </summary>
		...
		public bool AddWorkOrder(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'WorkOrderEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateWorkOrder(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)WorkOrderFieldIndex.WorkOrderID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateWorkOrder(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'WorkOrderEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchWorkOrder(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 workOrderID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)WorkOrderFieldIndex.WorkOrderID], ComparisonOperator.Equal, workOrderID));
		...
		/// <summary>
		/// Deletes an entity of type 'WorkOrderEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteWorkOrder(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)WorkOrderFieldIndex.WorkOrderID], ComparisonOperator.Equal));
		...
		public bool GetMulti(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, 
				IEntityFactory entityFactoryToUse, IValidator validatorToUse, IPredicateExpression filter, ProductEntity productInstance, ScrapReasonEntity scrapReasonInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.WorkOrderEntity);
			...
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, LocationEntity locationInstance)
		{
			...
			relations.Add(WorkOrderEntity.Relations.WorkOrderRoutingEntityUsingWorkOrderID);
			relations.Add(WorkOrderRoutingEntity.Relations.LocationEntityUsingLocationID);
		...
		public int DeleteMulti(ITransaction containingTransaction, ProductEntity productInstance, ScrapReasonEntity scrapReasonInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.WorkOrderEntity);
		...
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IEntityFields fieldsWithNewValues, ITransaction containingTransaction, ProductEntity productInstance, ScrapReasonEntity scrapReasonInstance)
		{
		...
		private IPredicateExpression CreateFilterUsingForeignKeys(ProductEntity productInstance, ScrapReasonEntity scrapReasonInstance, IEntityFields fieldsToReturn)
		{
			IPredicateExpression selectFilter = new PredicateExpression();
			
			if(productInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)WorkOrderFieldIndex.ProductID], ComparisonOperator.Equal, productInstance.ProductID));
			}
			
			if(scrapReasonInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)WorkOrderFieldIndex.ScrapReasonID], ComparisonOperator.Equal, scrapReasonInstance.ScrapReasonID));
			}
