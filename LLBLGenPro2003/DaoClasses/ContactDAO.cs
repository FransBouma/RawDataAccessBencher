...
namespace LLBL2003.AdventureWorks2008.DaoClasses
{
	...
	/// </summary>
	public class ContactDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Adds the given fields to the database as a new 'Contact' entity.
		/// </summary>
		...
		public bool AddContact(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'ContactEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateContact(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)ContactFieldIndex.ContactID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateContact(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'ContactEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchContact(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 contactID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)ContactFieldIndex.ContactID], ComparisonOperator.Equal, contactID));
		...
		/// <summary>
		/// Deletes an entity of type 'ContactEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteContact(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)ContactFieldIndex.ContactID], ComparisonOperator.Equal));
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ContactEntity);
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingEmployee_(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, 
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingContactType_(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, 
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, ContactTypeEntity contactTypeInstance)
		{
			...
			RelationCollection relations = new RelationCollection();
			// add the relations to walk.
			relations.Add(ContactEntity.Relations.VendorContactEntityUsingContactID);
			...
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, VendorEntity vendorInstance)
		{
			...
			// add the relations to walk.
			relations.Add(ContactEntity.Relations.VendorContactEntityUsingContactID);
			relations.Add(VendorContactEntity.Relations.VendorEntityUsingVendorID);
			...
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, CreditCardEntity creditCardInstance)
		{
			...
			RelationCollection relations = new RelationCollection();
			// add the relations to walk.
			relations.Add(ContactEntity.Relations.ContactCreditCardEntityUsingContactID);
			relations.Add(ContactCreditCardEntity.Relations.CreditCardEntityUsingCreditCardID);
			...
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, ContactTypeEntity contactTypeInstance)
		{
			...
			RelationCollection relations = new RelationCollection();
			// add the relations to walk.
			relations.Add(ContactEntity.Relations.StoreContactEntityUsingContactID);
			relations.Add(StoreContactEntity.Relations.ContactTypeEntityUsingContactTypeID);
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingStore(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, 
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, StoreEntity storeInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ContactEntity);
			...
			// add the relations to walk.
			relations.Add(ContactEntity.Relations.StoreContactEntityUsingContactID);
			relations.Add(StoreContactEntity.Relations.StoreEntityUsingCustomerID);
			
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(storeInstance.Fields[(int)StoreFieldIndex.CustomerID], ComparisonOperator.Equal, storeInstance.CustomerID));
			CreateAndRunMultiInstanceRetrievalQuery(fieldsToReturn, containingTransaction, collectionToFill, maxNumberOfItemsToReturn, sortClauses, 
				entityFactoryToUse, selectFilter, validatorToUse, relations);
			return true;
		}
		...
		/// <summary>
		/// Deletes from the persistent storage all 'Contact' entities which match with the specified filter, formulated in
		...
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ContactEntity);
