...
{
	/// <summary>
	/// General DAO class for the Shift Entity. It will perform database oriented actions for
	/// a entity of type 'ShiftEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class ShiftDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Adds the given fields to the database as a new 'Shift' entity.
		/// </summary>
		...
		public bool AddShift(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'ShiftEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateShift(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)ShiftFieldIndex.ShiftID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateShift(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'ShiftEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchShift(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Byte shiftID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)ShiftFieldIndex.ShiftID], ComparisonOperator.Equal, shiftID));
		...
		/// <summary>
		/// Deletes an entity of type 'ShiftEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteShift(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)ShiftFieldIndex.ShiftID], ComparisonOperator.Equal));
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ShiftEntity);
		...
		/// <summary>
		/// Retrieves entities of the type 'ShiftEntity' in a datatable which match the specified filter. 
			...
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, DepartmentEntity departmentInstance)
		{
			...
			relations.Add(ShiftEntity.Relations.EmployeeDepartmentHistoryEntityUsingShiftID);
		...
		/// <summary>
		/// Deletes from the persistent storage all 'Shift' entities which match with the specified filter, formulated in
		...
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ShiftEntity);
