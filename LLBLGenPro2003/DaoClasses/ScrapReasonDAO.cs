...
{
	/// <summary>
	/// General DAO class for the ScrapReason Entity. It will perform database oriented actions for
	/// a entity of type 'ScrapReasonEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class ScrapReasonDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ScrapReasonDAO()
		{
		}

		/// <summary>
		/// Adds the given fields to the database as a new 'ScrapReason' entity.
		/// </summary>
		...
		public bool AddScrapReason(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'ScrapReasonEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateScrapReason(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)ScrapReasonFieldIndex.ScrapReasonID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateScrapReason(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'ScrapReasonEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchScrapReason(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int16 scrapReasonID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)ScrapReasonFieldIndex.ScrapReasonID], ComparisonOperator.Equal, scrapReasonID));
		...
		/// <summary>
		/// Deletes an entity of type 'ScrapReasonEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteScrapReason(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)ScrapReasonFieldIndex.ScrapReasonID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling ScrapReasonCollection object all ScrapReasonEntity objects
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ScrapReasonEntity);
		...
		/// <summary>
		/// Retrieves entities of the type 'ScrapReasonEntity' in a datatable which match the specified filter. 
			...
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, ProductEntity productInstance)
		{
			...
			relations.Add(ScrapReasonEntity.Relations.WorkOrderEntityUsingScrapReasonID);
			relations.Add(WorkOrderEntity.Relations.ProductEntityUsingProductID);
		...
		/// <summary>
		/// Deletes from the persistent storage all 'ScrapReason' entities which match with the specified filter, formulated in
		...
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ScrapReasonEntity);
