...
{
	/// <summary>
	/// General DAO class for the NewSequentialIDTest Entity. It will perform database oriented actions for
	/// a entity of type 'NewSequentialIDTestEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class NewSequentialIDTestDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public NewSequentialIDTestDAO()
		{
		}

		/// <summary>
		/// Adds the given fields to the database as a new 'NewSequentialIDTest' entity.
		/// </summary>
		...
		public bool AddNewSequentialIDTest(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'NewSequentialIDTestEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateNewSequentialIDTest(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)NewSequentialIDTestFieldIndex.ID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateNewSequentialIDTest(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'NewSequentialIDTestEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchNewSequentialIDTest(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Guid iD)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)NewSequentialIDTestFieldIndex.ID], ComparisonOperator.Equal, iD));
		...
		/// <summary>
		/// Deletes an entity of type 'NewSequentialIDTestEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteNewSequentialIDTest(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)NewSequentialIDTestFieldIndex.ID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling NewSequentialIDTestCollection object all NewSequentialIDTestEntity objects
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.NewSequentialIDTestEntity);
		...
		/// <summary>
		/// Retrieves entities of the type 'NewSequentialIDTestEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'NewSequentialIDTest' entities which match with the specified filter, formulated in
		...
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.NewSequentialIDTestEntity);
