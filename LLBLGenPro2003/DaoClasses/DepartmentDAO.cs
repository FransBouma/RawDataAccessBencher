...
{
	/// <summary>
	/// General DAO class for the Department Entity. It will perform database oriented actions for
	/// a entity of type 'DepartmentEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class DepartmentDAO : DaoBase
	{
		...
		/// <summary>
		/// Adds the given fields to the database as a new 'Department' entity.
		/// </summary>
		...
		public bool AddDepartment(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'DepartmentEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateDepartment(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)DepartmentFieldIndex.DepartmentID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateDepartment(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'DepartmentEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchDepartment(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int16 departmentID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)DepartmentFieldIndex.DepartmentID], ComparisonOperator.Equal, departmentID));
		...
		/// <summary>
		/// Deletes an entity of type 'DepartmentEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteDepartment(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)DepartmentFieldIndex.DepartmentID], ComparisonOperator.Equal));
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.DepartmentEntity);
		...
		/// <summary>
		/// Retrieves entities of the type 'DepartmentEntity' in a datatable which match the specified filter. 
			...
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, EmployeeEntity employeeInstance)
		{
			...
			relations.Add(DepartmentEntity.Relations.EmployeeDepartmentHistoryEntityUsingDepartmentID);
			relations.Add(EmployeeDepartmentHistoryEntity.Relations.EmployeeEntityUsingEmployeeID);
		...
		/// <summary>
		/// Deletes from the persistent storage all 'Department' entities which match with the specified filter, formulated in
		...
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.DepartmentEntity);
