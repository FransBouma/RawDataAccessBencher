...
{
	/// <summary>
	/// General DAO class for the SalesTaxRate Entity. It will perform database oriented actions for
	/// a entity of type 'SalesTaxRateEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class SalesTaxRateDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public SalesTaxRateDAO()
		{
		}

		/// <summary>
		/// Adds the given fields to the database as a new 'SalesTaxRate' entity.
		/// </summary>
		...
		public bool AddSalesTaxRate(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'SalesTaxRateEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateSalesTaxRate(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)SalesTaxRateFieldIndex.SalesTaxRateID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateSalesTaxRate(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'SalesTaxRateEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchSalesTaxRate(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 salesTaxRateID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)SalesTaxRateFieldIndex.SalesTaxRateID], ComparisonOperator.Equal, salesTaxRateID));
		...
		/// <summary>
		/// Deletes an entity of type 'SalesTaxRateEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteSalesTaxRate(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)SalesTaxRateFieldIndex.SalesTaxRateID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling SalesTaxRateCollection object all SalesTaxRateEntity objects which have data in common
		...
		/// <param name="stateProvinceInstance">StateProvinceEntity instance to use as a filter for the SalesTaxRateEntity objects to return</param>
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.SalesTaxRateEntity);
		...
		/// <summary>
		/// Retrieves in the calling SalesTaxRateCollection object all SalesTaxRateEntity objects
		...
		/// <summary>
		/// Retrieves entities of the type 'SalesTaxRateEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'SalesTaxRate' entities which have data in common
		/// with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="stateProvinceInstance">StateProvinceEntity instance to use as a filter for the SalesTaxRateEntity objects to delete</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int DeleteMulti(ITransaction containingTransaction, StateProvinceEntity stateProvinceInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.SalesTaxRateEntity);
		...
		/// <summary>
		/// Deletes from the persistent storage all 'SalesTaxRate' entities which match with the specified filter, formulated in
		...
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="stateProvinceInstance">StateProvinceEntity instance to use as a filter for the SalesTaxRateEntity objects to update</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// </summary>
		/// <param name="stateProvinceInstance">StateProvinceEntity instance to use as a filter for the SalesTaxRateEntity objects</param>
		...
		private IPredicateExpression CreateFilterUsingForeignKeys(StateProvinceEntity stateProvinceInstance, IEntityFields fieldsToReturn)
		{
			...
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)SalesTaxRateFieldIndex.StateProvinceID], ComparisonOperator.Equal, stateProvinceInstance.StateProvinceID));
			}
