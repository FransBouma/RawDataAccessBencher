...
{
	/// <summary>
	/// General DAO class for the ErrorLog Entity. It will perform database oriented actions for
	/// a entity of type 'ErrorLogEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class ErrorLogDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Adds the given fields to the database as a new 'ErrorLog' entity.
		/// </summary>
		...
		public bool AddErrorLog(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'ErrorLogEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateErrorLog(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)ErrorLogFieldIndex.ErrorLogID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateErrorLog(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'ErrorLogEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchErrorLog(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 errorLogID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)ErrorLogFieldIndex.ErrorLogID], ComparisonOperator.Equal, errorLogID));
		...
		/// <summary>
		/// Deletes an entity of type 'ErrorLogEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteErrorLog(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)ErrorLogFieldIndex.ErrorLogID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling ErrorLogCollection object all ErrorLogEntity objects
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ErrorLogEntity);
		...
		/// <summary>
		/// Retrieves entities of the type 'ErrorLogEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'ErrorLog' entities which match with the specified filter, formulated in
		...
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ErrorLogEntity);
