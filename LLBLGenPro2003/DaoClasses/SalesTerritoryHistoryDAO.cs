...
{
	/// <summary>
	/// General DAO class for the SalesTerritoryHistory Entity. It will perform database oriented actions for
	/// a entity of type 'SalesTerritoryHistoryEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class SalesTerritoryHistoryDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public SalesTerritoryHistoryDAO()
		{
		}

		/// <summary>
		/// Adds the given fields to the database as a new 'SalesTerritoryHistory' entity.
		/// </summary>
		...
		public bool AddSalesTerritoryHistory(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'SalesTerritoryHistoryEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateSalesTerritoryHistory(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)SalesTerritoryHistoryFieldIndex.SalesPersonID], ComparisonOperator.Equal));
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)SalesTerritoryHistoryFieldIndex.TerritoryID], ComparisonOperator.Equal));
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)SalesTerritoryHistoryFieldIndex.StartDate], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateSalesTerritoryHistory(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'SalesTerritoryHistoryEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchSalesTerritoryHistory(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 salesPersonID, System.Int32 territoryID, System.DateTime startDate)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)SalesTerritoryHistoryFieldIndex.SalesPersonID], ComparisonOperator.Equal, salesPersonID));
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)SalesTerritoryHistoryFieldIndex.TerritoryID], ComparisonOperator.Equal, territoryID));
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)SalesTerritoryHistoryFieldIndex.StartDate], ComparisonOperator.Equal, startDate));
		...
		/// <summary>
		/// Deletes an entity of type 'SalesTerritoryHistoryEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteSalesTerritoryHistory(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)SalesTerritoryHistoryFieldIndex.SalesPersonID], ComparisonOperator.Equal));
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)SalesTerritoryHistoryFieldIndex.TerritoryID], ComparisonOperator.Equal));
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)SalesTerritoryHistoryFieldIndex.StartDate], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling SalesTerritoryHistoryCollection object all SalesTerritoryHistoryEntity objects which have data in common
		...
		public bool GetMulti(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, 
				IEntityFactory entityFactoryToUse, IValidator validatorToUse, IPredicateExpression filter, SalesPersonEntity salesPersonInstance, SalesTerritoryEntity salesTerritoryInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.SalesTerritoryHistoryEntity);
			IPredicateExpression selectFilter = CreateFilterUsingForeignKeys(salesPersonInstance, salesTerritoryInstance, fieldsToReturn);
			if(filter!=null)
			{
		...
		/// <summary>
		/// Retrieves in the calling SalesTerritoryHistoryCollection object all SalesTerritoryHistoryEntity objects
		...
		/// <summary>
		/// Retrieves entities of the type 'SalesTerritoryHistoryEntity' in a datatable which match the specified filter. 
		...
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="salesPersonInstance">SalesPersonEntity instance to use as a filter for the SalesTerritoryHistoryEntity objects to delete</param>
		/// <param name="salesTerritoryInstance">SalesTerritoryEntity instance to use as a filter for the SalesTerritoryHistoryEntity objects to delete</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int DeleteMulti(ITransaction containingTransaction, SalesPersonEntity salesPersonInstance, SalesTerritoryEntity salesTerritoryInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.SalesTerritoryHistoryEntity);
			IPredicateExpression deleteFilter = CreateFilterUsingForeignKeys(salesPersonInstance, salesTerritoryInstance, fields);
		...
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="salesPersonInstance">SalesPersonEntity instance to use as a filter for the SalesTerritoryHistoryEntity objects to update</param>
		/// <param name="salesTerritoryInstance">SalesTerritoryEntity instance to use as a filter for the SalesTerritoryHistoryEntity objects to update</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IEntityFields fieldsWithNewValues, ITransaction containingTransaction, SalesPersonEntity salesPersonInstance, SalesTerritoryEntity salesTerritoryInstance)
		{
			...
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.SalesTerritoryHistoryEntity);
			IPredicateExpression updateFilter = CreateFilterUsingForeignKeys(salesPersonInstance, salesTerritoryInstance, fields);
		...
		/// </summary>
		/// <param name="salesPersonInstance">SalesPersonEntity instance to use as a filter for the SalesTerritoryHistoryEntity objects</param>
		/// <param name="salesTerritoryInstance">SalesTerritoryEntity instance to use as a filter for the SalesTerritoryHistoryEntity objects</param>
		/// <param name="fieldsToReturn">IEntityFields implementation which forms the definition of the fieldset of the target entity.</param>
		/// <returns>A ready to use PredicateExpression based on the passed in foreign key value holders.</returns>
		private IPredicateExpression CreateFilterUsingForeignKeys(SalesPersonEntity salesPersonInstance, SalesTerritoryEntity salesTerritoryInstance, IEntityFields fieldsToReturn)
		{
			IPredicateExpression selectFilter = new PredicateExpression();
			
			if(salesPersonInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)SalesTerritoryHistoryFieldIndex.SalesPersonID], ComparisonOperator.Equal, salesPersonInstance.SalesPersonID));
			}
			
			if(salesTerritoryInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)SalesTerritoryHistoryFieldIndex.TerritoryID], ComparisonOperator.Equal, salesTerritoryInstance.TerritoryID));
			}
