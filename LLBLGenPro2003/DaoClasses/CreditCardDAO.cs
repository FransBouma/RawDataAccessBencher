...
{
	/// <summary>
	/// General DAO class for the CreditCard Entity. It will perform database oriented actions for
	/// a entity of type 'CreditCardEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class CreditCardDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Adds the given fields to the database as a new 'CreditCard' entity.
		/// </summary>
		...
		public bool AddCreditCard(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'CreditCardEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateCreditCard(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)CreditCardFieldIndex.CreditCardID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateCreditCard(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'CreditCardEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchCreditCard(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 creditCardID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)CreditCardFieldIndex.CreditCardID], ComparisonOperator.Equal, creditCardID));
		...
		/// <summary>
		/// Deletes an entity of type 'CreditCardEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteCreditCard(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)CreditCardFieldIndex.CreditCardID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling CreditCardCollection object all CreditCardEntity objects
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.CreditCardEntity);
		...
		/// <summary>
		/// Retrieves entities of the type 'CreditCardEntity' in a datatable which match the specified filter. 
			...
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, ContactEntity contactInstance)
		{
			...
			relations.Add(CreditCardEntity.Relations.ContactCreditCardEntityUsingCreditCardID);
			relations.Add(ContactCreditCardEntity.Relations.ContactEntityUsingContactID);
			...
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, AddressEntity addressInstance)
		{
			...
			RelationCollection relations = new RelationCollection();
			// add the relations to walk.
			relations.Add(CreditCardEntity.Relations.SalesOrderHeaderEntityUsingCreditCardID);
		...
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.CreditCardEntity);
