...
namespace LLBL2003.AdventureWorks2008.DaoClasses
{
	...
	public class EmployeeAddressDAO : DaoBase
	{
		...
		/// <summary>
		/// Adds the given fields to the database as a new 'EmployeeAddress' entity.
		/// </summary>
		...
		public bool AddEmployeeAddress(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'EmployeeAddressEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateEmployeeAddress(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)EmployeeAddressFieldIndex.EmployeeID], ComparisonOperator.Equal));
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)EmployeeAddressFieldIndex.AddressID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateEmployeeAddress(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'EmployeeAddressEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchEmployeeAddress(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 employeeID, System.Int32 addressID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)EmployeeAddressFieldIndex.EmployeeID], ComparisonOperator.Equal, employeeID));
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)EmployeeAddressFieldIndex.AddressID], ComparisonOperator.Equal, addressID));
		...
		/// <summary>
		/// Deletes an entity of type 'EmployeeAddressEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteEmployeeAddress(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)EmployeeAddressFieldIndex.EmployeeID], ComparisonOperator.Equal));
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)EmployeeAddressFieldIndex.AddressID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling EmployeeAddressCollection object all EmployeeAddressEntity objects which have data in common
		...
		public bool GetMulti(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, 
				IEntityFactory entityFactoryToUse, IValidator validatorToUse, IPredicateExpression filter, AddressEntity addressInstance, EmployeeEntity employeeInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.EmployeeAddressEntity);
			IPredicateExpression selectFilter = CreateFilterUsingForeignKeys(addressInstance, employeeInstance, fieldsToReturn);
			if(filter!=null)
			{
		...
		/// <summary>
		/// Retrieves in the calling EmployeeAddressCollection object all EmployeeAddressEntity objects
		...
		/// <summary>
		/// Retrieves entities of the type 'EmployeeAddressEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'EmployeeAddress' entities which have data in common
		/// with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		...
		public int DeleteMulti(ITransaction containingTransaction, AddressEntity addressInstance, EmployeeEntity employeeInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.EmployeeAddressEntity);
			IPredicateExpression deleteFilter = CreateFilterUsingForeignKeys(addressInstance, employeeInstance, fields);
			return CreateAndRunDeleteQuery(fields[0], containingTransaction, deleteFilter);
		}
	

		/// <summary>
		/// Deletes from the persistent storage all 'EmployeeAddress' entities which match with the specified filter, formulated in
		...
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IEntityFields fieldsWithNewValues, ITransaction containingTransaction, AddressEntity addressInstance, EmployeeEntity employeeInstance)
		{
			...
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.EmployeeAddressEntity);
			IPredicateExpression updateFilter = CreateFilterUsingForeignKeys(addressInstance, employeeInstance, fields);
		...
		private IPredicateExpression CreateFilterUsingForeignKeys(AddressEntity addressInstance, EmployeeEntity employeeInstance, IEntityFields fieldsToReturn)
		{
			IPredicateExpression selectFilter = new PredicateExpression();
			
			if(addressInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)EmployeeAddressFieldIndex.AddressID], ComparisonOperator.Equal, addressInstance.AddressID));
			}
			
			if(employeeInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)EmployeeAddressFieldIndex.EmployeeID], ComparisonOperator.Equal, employeeInstance.EmployeeID));
			}
