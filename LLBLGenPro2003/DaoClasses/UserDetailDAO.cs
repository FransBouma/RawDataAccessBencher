...
{
	/// <summary>
	/// General DAO class for the UserDetail Entity. It will perform database oriented actions for
	/// a entity of type 'UserDetailEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class UserDetailDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Adds the given fields to the database as a new 'UserDetail' entity.
		/// </summary>
		...
		public bool AddUserDetail(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'UserDetailEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateUserDetail(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)UserDetailFieldIndex.ID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateUserDetail(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'UserDetailEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchUserDetail(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 iD)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)UserDetailFieldIndex.ID], ComparisonOperator.Equal, iD));
		...
		/// <summary>
		/// Deletes an entity of type 'UserDetailEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteUserDetail(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)UserDetailFieldIndex.ID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Reads the entity's data into EntityFields object and returns that object. Which entity is read is determined from
		/// the passed in fields for the UniqueConstraint.
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="userName">Value for a field in the UniqueConstraint, which is used to retrieve the contents.</param>
		/// <returns>fields read</returns>
		public IEntityFields FetchUserDetailUsingUCUserName(ITransaction containingTransaction, System.String userName)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.UserDetailEntity);
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)UserDetailFieldIndex.UserName], ComparisonOperator.Equal, userName)); 
			CreateAndRunSingleInstanceRetrievalQuery(fieldsToReturn, containingTransaction, selectFilter);
		...
		/// <returns>fields read</returns>
		public IEntityFields FetchUserDetailUsingUCEmployeeNr(ITransaction containingTransaction, System.String employeeNr)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.UserDetailEntity);
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)UserDetailFieldIndex.EmployeeNr], ComparisonOperator.Equal, employeeNr)); 
			CreateAndRunSingleInstanceRetrievalQuery(fieldsToReturn, containingTransaction, selectFilter);
			return fieldsToReturn;
		}
		...
		/// <summary>
		/// Retrieves in the calling UserDetailCollection object all UserDetailEntity objects
		...
		/// <summary>
		/// Retrieves entities of the type 'UserDetailEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'UserDetail' entities which match with the specified filter, formulated in
		...
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.UserDetailEntity);
