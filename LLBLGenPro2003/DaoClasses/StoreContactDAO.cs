...
{
	/// <summary>
	/// General DAO class for the StoreContact Entity. It will perform database oriented actions for
	/// a entity of type 'StoreContactEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class StoreContactDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public StoreContactDAO()
		{
		}

		/// <summary>
		/// Adds the given fields to the database as a new 'StoreContact' entity.
		/// </summary>
		...
		public bool AddStoreContact(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'StoreContactEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateStoreContact(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)StoreContactFieldIndex.CustomerID], ComparisonOperator.Equal));
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)StoreContactFieldIndex.ContactID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateStoreContact(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'StoreContactEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchStoreContact(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 customerID, System.Int32 contactID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)StoreContactFieldIndex.CustomerID], ComparisonOperator.Equal, customerID));
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)StoreContactFieldIndex.ContactID], ComparisonOperator.Equal, contactID));
		...
		/// <summary>
		/// Deletes an entity of type 'StoreContactEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteStoreContact(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)StoreContactFieldIndex.CustomerID], ComparisonOperator.Equal));
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)StoreContactFieldIndex.ContactID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling StoreContactCollection object all StoreContactEntity objects which have data in common
		...
		public bool GetMulti(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, 
				IEntityFactory entityFactoryToUse, IValidator validatorToUse, IPredicateExpression filter, ContactEntity contactInstance, ContactTypeEntity contactTypeInstance, StoreEntity storeInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.StoreContactEntity);
		...
		/// <summary>
		/// Retrieves in the calling StoreContactCollection object all StoreContactEntity objects
		...
		/// <summary>
		/// Retrieves entities of the type 'StoreContactEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'StoreContact' entities which have data in common
		/// with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		...
		public int DeleteMulti(ITransaction containingTransaction, ContactEntity contactInstance, ContactTypeEntity contactTypeInstance, StoreEntity storeInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.StoreContactEntity);
		...
		/// <summary>
		/// Deletes from the persistent storage all 'StoreContact' entities which match with the specified filter, formulated in
		...
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IEntityFields fieldsWithNewValues, ITransaction containingTransaction, ContactEntity contactInstance, ContactTypeEntity contactTypeInstance, StoreEntity storeInstance)
		{
		...
		private IPredicateExpression CreateFilterUsingForeignKeys(ContactEntity contactInstance, ContactTypeEntity contactTypeInstance, StoreEntity storeInstance, IEntityFields fieldsToReturn)
		{
			IPredicateExpression selectFilter = new PredicateExpression();
			
			if(contactInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)StoreContactFieldIndex.ContactID], ComparisonOperator.Equal, contactInstance.ContactID));
			}
			
			if(contactTypeInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)StoreContactFieldIndex.ContactTypeID], ComparisonOperator.Equal, contactTypeInstance.ContactTypeID));
			}
			
			if(storeInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)StoreContactFieldIndex.CustomerID], ComparisonOperator.Equal, storeInstance.CustomerID));
			}
