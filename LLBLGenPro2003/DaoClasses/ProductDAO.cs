...
namespace LLBL2003.AdventureWorks2008.DaoClasses
{
	...
	public class ProductDAO : DaoBase
	{
		...
		/// <summary>
		/// Adds the given fields to the database as a new 'Product' entity.
		/// </summary>
		...
		public bool AddProduct(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'ProductEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateProduct(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductFieldIndex.ProductID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateProduct(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'ProductEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchProduct(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 productID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)ProductFieldIndex.ProductID], ComparisonOperator.Equal, productID));
		...
		/// <summary>
		/// Deletes an entity of type 'ProductEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteProduct(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductFieldIndex.ProductID], ComparisonOperator.Equal));
		...
		public bool GetMulti(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, 
				IEntityFactory entityFactoryToUse, IValidator validatorToUse, IPredicateExpression filter, ProductModelEntity productModelInstance, ProductSubcategoryEntity productSubcategoryInstance, UnitMeasureEntity unitMeasureInstance, UnitMeasureEntity unitMeasure_Instance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductEntity);
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingUnitMeasure__(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, 
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, UnitMeasureEntity unitMeasureInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductEntity);

			RelationCollection relations = new RelationCollection();
			// add the relations to walk.
			relations.Add(ProductEntity.Relations.BillOfMaterialsEntityUsingComponentID);
			relations.Add(BillOfMaterialsEntity.Relations.UnitMeasureEntityUsingUnitMeasureCode);
			
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(unitMeasureInstance.Fields[(int)UnitMeasureFieldIndex.UnitMeasureCode], ComparisonOperator.Equal, unitMeasureInstance.UnitMeasureCode));
			CreateAndRunMultiInstanceRetrievalQuery(fieldsToReturn, containingTransaction, collectionToFill, maxNumberOfItemsToReturn, sortClauses, 
				entityFactoryToUse, selectFilter, validatorToUse, relations);
			return true;
		}
		...
		/// <param name="unitMeasureInstance">UnitMeasureEntity object to be used as a filter in the m:n relation</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingUnitMeasure___(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, 
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, UnitMeasureEntity unitMeasureInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductEntity);
			...
			RelationCollection relations = new RelationCollection();
			// add the relations to walk.
			relations.Add(ProductEntity.Relations.BillOfMaterialsEntityUsingProductAssemblyID);
			relations.Add(BillOfMaterialsEntity.Relations.UnitMeasureEntityUsingUnitMeasureCode);
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingDocument(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, 
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, DocumentEntity documentInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductEntity);

			RelationCollection relations = new RelationCollection();
			// add the relations to walk.
			relations.Add(ProductEntity.Relations.ProductDocumentEntityUsingProductID);
			relations.Add(ProductDocumentEntity.Relations.DocumentEntityUsingDocumentID);
			
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(documentInstance.Fields[(int)DocumentFieldIndex.DocumentID], ComparisonOperator.Equal, documentInstance.DocumentID));
			CreateAndRunMultiInstanceRetrievalQuery(fieldsToReturn, containingTransaction, collectionToFill, maxNumberOfItemsToReturn, sortClauses, 
				entityFactoryToUse, selectFilter, validatorToUse, relations);
			return true;
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingLocation(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, 
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, LocationEntity locationInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductEntity);

			RelationCollection relations = new RelationCollection();
			// add the relations to walk.
			relations.Add(ProductEntity.Relations.ProductInventoryEntityUsingProductID);
			relations.Add(ProductInventoryEntity.Relations.LocationEntityUsingLocationID);
			
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(locationInstance.Fields[(int)LocationFieldIndex.LocationID], ComparisonOperator.Equal, locationInstance.LocationID));
			CreateAndRunMultiInstanceRetrievalQuery(fieldsToReturn, containingTransaction, collectionToFill, maxNumberOfItemsToReturn, sortClauses, 
				entityFactoryToUse, selectFilter, validatorToUse, relations);
			return true;
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingProductPhoto(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, 
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, ProductPhotoEntity productPhotoInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductEntity);

			RelationCollection relations = new RelationCollection();
			// add the relations to walk.
			relations.Add(ProductEntity.Relations.ProductProductPhotoEntityUsingProductID);
			relations.Add(ProductProductPhotoEntity.Relations.ProductPhotoEntityUsingProductPhotoID);
			
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(productPhotoInstance.Fields[(int)ProductPhotoFieldIndex.ProductPhotoID], ComparisonOperator.Equal, productPhotoInstance.ProductPhotoID));
			CreateAndRunMultiInstanceRetrievalQuery(fieldsToReturn, containingTransaction, collectionToFill, maxNumberOfItemsToReturn, sortClauses, 
				entityFactoryToUse, selectFilter, validatorToUse, relations);
			return true;
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingScrapReason(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, 
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, ScrapReasonEntity scrapReasonInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductEntity);

			RelationCollection relations = new RelationCollection();
			// add the relations to walk.
			relations.Add(ProductEntity.Relations.WorkOrderEntityUsingProductID);
			relations.Add(WorkOrderEntity.Relations.ScrapReasonEntityUsingScrapReasonID);
			
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(scrapReasonInstance.Fields[(int)ScrapReasonFieldIndex.ScrapReasonID], ComparisonOperator.Equal, scrapReasonInstance.ScrapReasonID));
			CreateAndRunMultiInstanceRetrievalQuery(fieldsToReturn, containingTransaction, collectionToFill, maxNumberOfItemsToReturn, sortClauses, 
				entityFactoryToUse, selectFilter, validatorToUse, relations);
			return true;
		}
		...
		/// <param name="unitMeasureInstance">UnitMeasureEntity object to be used as a filter in the m:n relation</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingUnitMeasure____(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, 
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, UnitMeasureEntity unitMeasureInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductEntity);
			...
			RelationCollection relations = new RelationCollection();
			// add the relations to walk.
			relations.Add(ProductEntity.Relations.ProductVendorEntityUsingProductID);
			relations.Add(ProductVendorEntity.Relations.UnitMeasureEntityUsingUnitMeasureCode);
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingVendor(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, 
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, VendorEntity vendorInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductEntity);
			...
			// add the relations to walk.
			relations.Add(ProductEntity.Relations.ProductVendorEntityUsingProductID);
			relations.Add(ProductVendorEntity.Relations.VendorEntityUsingVendorID);
			
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(vendorInstance.Fields[(int)VendorFieldIndex.VendorID], ComparisonOperator.Equal, vendorInstance.VendorID));
			CreateAndRunMultiInstanceRetrievalQuery(fieldsToReturn, containingTransaction, collectionToFill, maxNumberOfItemsToReturn, sortClauses, 
				entityFactoryToUse, selectFilter, validatorToUse, relations);
			return true;
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingPurchaseOrderHeader(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, 
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, PurchaseOrderHeaderEntity purchaseOrderHeaderInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductEntity);

			RelationCollection relations = new RelationCollection();
			// add the relations to walk.
			relations.Add(ProductEntity.Relations.PurchaseOrderDetailEntityUsingProductID);
			relations.Add(PurchaseOrderDetailEntity.Relations.PurchaseOrderHeaderEntityUsingPurchaseOrderID);
			
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(purchaseOrderHeaderInstance.Fields[(int)PurchaseOrderHeaderFieldIndex.PurchaseOrderID], ComparisonOperator.Equal, purchaseOrderHeaderInstance.PurchaseOrderID));
			CreateAndRunMultiInstanceRetrievalQuery(fieldsToReturn, containingTransaction, collectionToFill, maxNumberOfItemsToReturn, sortClauses, 
				entityFactoryToUse, selectFilter, validatorToUse, relations);
			return true;
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingSpecialOffer(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, 
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, SpecialOfferEntity specialOfferInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductEntity);
			...
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(specialOfferInstance.Fields[(int)SpecialOfferFieldIndex.SpecialOfferID], ComparisonOperator.Equal, specialOfferInstance.SpecialOfferID));
			CreateAndRunMultiInstanceRetrievalQuery(fieldsToReturn, containingTransaction, collectionToFill, maxNumberOfItemsToReturn, sortClauses, 
				entityFactoryToUse, selectFilter, validatorToUse, relations);
			return true;
		}
		...
		public int DeleteMulti(ITransaction containingTransaction, ProductModelEntity productModelInstance, ProductSubcategoryEntity productSubcategoryInstance, UnitMeasureEntity unitMeasureInstance, UnitMeasureEntity unitMeasure_Instance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductEntity);
		...
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IEntityFields fieldsWithNewValues, ITransaction containingTransaction, ProductModelEntity productModelInstance, ProductSubcategoryEntity productSubcategoryInstance, UnitMeasureEntity unitMeasureInstance, UnitMeasureEntity unitMeasure_Instance)
		{
		...
		private IPredicateExpression CreateFilterUsingForeignKeys(ProductModelEntity productModelInstance, ProductSubcategoryEntity productSubcategoryInstance, UnitMeasureEntity unitMeasureInstance, UnitMeasureEntity unitMeasure_Instance, IEntityFields fieldsToReturn)
		{
			IPredicateExpression selectFilter = new PredicateExpression();
			
			if(productModelInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)ProductFieldIndex.ProductModelID], ComparisonOperator.Equal, productModelInstance.ProductModelID));
			}
			
			if(productSubcategoryInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)ProductFieldIndex.ProductSubcategoryID], ComparisonOperator.Equal, productSubcategoryInstance.ProductSubcategoryID));
			}
			
			if(unitMeasureInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)ProductFieldIndex.SizeUnitMeasureCode], ComparisonOperator.Equal, unitMeasureInstance.UnitMeasureCode));
			}
			
			if(unitMeasure_Instance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)ProductFieldIndex.WeightUnitMeasureCode], ComparisonOperator.Equal, unitMeasure_Instance.UnitMeasureCode));
			}
