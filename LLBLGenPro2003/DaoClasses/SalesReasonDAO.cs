...
{
	/// <summary>
	/// General DAO class for the SalesReason Entity. It will perform database oriented actions for
	/// a entity of type 'SalesReasonEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class SalesReasonDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public SalesReasonDAO()
		{
		}

		/// <summary>
		/// Adds the given fields to the database as a new 'SalesReason' entity.
		/// </summary>
		...
		public bool AddSalesReason(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'SalesReasonEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateSalesReason(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)SalesReasonFieldIndex.SalesReasonID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateSalesReason(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'SalesReasonEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchSalesReason(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 salesReasonID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)SalesReasonFieldIndex.SalesReasonID], ComparisonOperator.Equal, salesReasonID));
		...
		/// <summary>
		/// Deletes an entity of type 'SalesReasonEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteSalesReason(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)SalesReasonFieldIndex.SalesReasonID], ComparisonOperator.Equal));
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.SalesReasonEntity);
		...
		/// <summary>
		/// Retrieves entities of the type 'SalesReasonEntity' in a datatable which match the specified filter. 
			...
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, SalesOrderHeaderEntity salesOrderHeaderInstance)
		{
			...
			relations.Add(SalesReasonEntity.Relations.SalesOrderHeaderSalesReasonEntityUsingSalesReasonID);
			relations.Add(SalesOrderHeaderSalesReasonEntity.Relations.SalesOrderHeaderEntityUsingSalesOrderID);
		...
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.SalesReasonEntity);
