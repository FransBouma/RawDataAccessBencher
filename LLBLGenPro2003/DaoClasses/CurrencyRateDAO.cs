...
namespace LLBL2003.AdventureWorks2008.DaoClasses
{
	...
	/// </summary>
	public class CurrencyRateDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Adds the given fields to the database as a new 'CurrencyRate' entity.
		/// </summary>
		...
		public bool AddCurrencyRate(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'CurrencyRateEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateCurrencyRate(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)CurrencyRateFieldIndex.CurrencyRateID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateCurrencyRate(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'CurrencyRateEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchCurrencyRate(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 currencyRateID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)CurrencyRateFieldIndex.CurrencyRateID], ComparisonOperator.Equal, currencyRateID));
		...
		/// <summary>
		/// Deletes an entity of type 'CurrencyRateEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteCurrencyRate(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)CurrencyRateFieldIndex.CurrencyRateID], ComparisonOperator.Equal));
		...
		public bool GetMulti(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, 
				IEntityFactory entityFactoryToUse, IValidator validatorToUse, IPredicateExpression filter, CurrencyEntity currencyInstance, CurrencyEntity currency_Instance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.CurrencyRateEntity);
			IPredicateExpression selectFilter = CreateFilterUsingForeignKeys(currencyInstance, currency_Instance, fieldsToReturn);
			if(filter!=null)
			{
			...
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, AddressEntity addressInstance)
		{
			...
			relations.Add(CurrencyRateEntity.Relations.SalesOrderHeaderEntityUsingCurrencyRateID);
		...
		public int DeleteMulti(ITransaction containingTransaction, CurrencyEntity currencyInstance, CurrencyEntity currency_Instance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.CurrencyRateEntity);
			IPredicateExpression deleteFilter = CreateFilterUsingForeignKeys(currencyInstance, currency_Instance, fields);
		...
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IEntityFields fieldsWithNewValues, ITransaction containingTransaction, CurrencyEntity currencyInstance, CurrencyEntity currency_Instance)
		{
			...
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.CurrencyRateEntity);
			IPredicateExpression updateFilter = CreateFilterUsingForeignKeys(currencyInstance, currency_Instance, fields);
		...
		private IPredicateExpression CreateFilterUsingForeignKeys(CurrencyEntity currencyInstance, CurrencyEntity currency_Instance, IEntityFields fieldsToReturn)
		{
			IPredicateExpression selectFilter = new PredicateExpression();
			
			if(currencyInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)CurrencyRateFieldIndex.FromCurrencyCode], ComparisonOperator.Equal, currencyInstance.CurrencyCode));
			}
			
			if(currency_Instance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)CurrencyRateFieldIndex.ToCurrencyCode], ComparisonOperator.Equal, currency_Instance.CurrencyCode));
			}
