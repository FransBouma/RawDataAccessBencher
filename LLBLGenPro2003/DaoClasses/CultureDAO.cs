...
{
	/// <summary>
	/// General DAO class for the Culture Entity. It will perform database oriented actions for
	/// a entity of type 'CultureEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class CultureDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Adds the given fields to the database as a new 'Culture' entity.
		/// </summary>
		...
		public bool AddCulture(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'CultureEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateCulture(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)CultureFieldIndex.CultureID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateCulture(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'CultureEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchCulture(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.String cultureID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)CultureFieldIndex.CultureID], ComparisonOperator.Equal, cultureID));
		...
		/// <summary>
		/// Deletes an entity of type 'CultureEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteCulture(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)CultureFieldIndex.CultureID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling CultureCollection object all CultureEntity objects
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.CultureEntity);
		...
		/// <summary>
		/// Retrieves entities of the type 'CultureEntity' in a datatable which match the specified filter. 
			...
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, ProductDescriptionEntity productDescriptionInstance)
		{
			...
			relations.Add(CultureEntity.Relations.ProductModelProductDescriptionCultureEntityUsingCultureID);
		...
		/// <summary>
		/// Deletes from the persistent storage all 'Culture' entities which match with the specified filter, formulated in
		...
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.CultureEntity);
