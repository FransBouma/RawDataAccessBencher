...
{
	/// <summary>
	/// General DAO class for the PurchaseOrderDetail Entity. It will perform database oriented actions for
	/// a entity of type 'PurchaseOrderDetailEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class PurchaseOrderDetailDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Adds the given fields to the database as a new 'PurchaseOrderDetail' entity.
		/// </summary>
		...
		public bool AddPurchaseOrderDetail(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'PurchaseOrderDetailEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdatePurchaseOrderDetail(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)PurchaseOrderDetailFieldIndex.PurchaseOrderID], ComparisonOperator.Equal));
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)PurchaseOrderDetailFieldIndex.PurchaseOrderDetailID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdatePurchaseOrderDetail(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'PurchaseOrderDetailEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchPurchaseOrderDetail(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 purchaseOrderID, System.Int32 purchaseOrderDetailID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)PurchaseOrderDetailFieldIndex.PurchaseOrderID], ComparisonOperator.Equal, purchaseOrderID));
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)PurchaseOrderDetailFieldIndex.PurchaseOrderDetailID], ComparisonOperator.Equal, purchaseOrderDetailID));
		...
		/// <summary>
		/// Deletes an entity of type 'PurchaseOrderDetailEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeletePurchaseOrderDetail(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)PurchaseOrderDetailFieldIndex.PurchaseOrderID], ComparisonOperator.Equal));
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)PurchaseOrderDetailFieldIndex.PurchaseOrderDetailID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling PurchaseOrderDetailCollection object all PurchaseOrderDetailEntity objects which have data in common
		...
		/// <param name="productInstance">ProductEntity instance to use as a filter for the PurchaseOrderDetailEntity objects to return</param>
		/// <param name="purchaseOrderHeaderInstance">PurchaseOrderHeaderEntity instance to use as a filter for the PurchaseOrderDetailEntity objects to return</param>
		...
		public bool GetMulti(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, 
				IEntityFactory entityFactoryToUse, IValidator validatorToUse, IPredicateExpression filter, ProductEntity productInstance, PurchaseOrderHeaderEntity purchaseOrderHeaderInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.PurchaseOrderDetailEntity);
			IPredicateExpression selectFilter = CreateFilterUsingForeignKeys(productInstance, purchaseOrderHeaderInstance, fieldsToReturn);
			if(filter!=null)
			{
		...
		/// <summary>
		/// Retrieves in the calling PurchaseOrderDetailCollection object all PurchaseOrderDetailEntity objects
		...
		/// <summary>
		/// Retrieves entities of the type 'PurchaseOrderDetailEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'PurchaseOrderDetail' entities which have data in common
		/// with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the PurchaseOrderDetailEntity objects to delete</param>
		/// <param name="purchaseOrderHeaderInstance">PurchaseOrderHeaderEntity instance to use as a filter for the PurchaseOrderDetailEntity objects to delete</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int DeleteMulti(ITransaction containingTransaction, ProductEntity productInstance, PurchaseOrderHeaderEntity purchaseOrderHeaderInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.PurchaseOrderDetailEntity);
			IPredicateExpression deleteFilter = CreateFilterUsingForeignKeys(productInstance, purchaseOrderHeaderInstance, fields);
			return CreateAndRunDeleteQuery(fields[0], containingTransaction, deleteFilter);
		}
	

		/// <summary>
		/// Deletes from the persistent storage all 'PurchaseOrderDetail' entities which match with the specified filter, formulated in
		...
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the PurchaseOrderDetailEntity objects to update</param>
		/// <param name="purchaseOrderHeaderInstance">PurchaseOrderHeaderEntity instance to use as a filter for the PurchaseOrderDetailEntity objects to update</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IEntityFields fieldsWithNewValues, ITransaction containingTransaction, ProductEntity productInstance, PurchaseOrderHeaderEntity purchaseOrderHeaderInstance)
		{
			...
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.PurchaseOrderDetailEntity);
			IPredicateExpression updateFilter = CreateFilterUsingForeignKeys(productInstance, purchaseOrderHeaderInstance, fields);
		...
		/// </summary>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the PurchaseOrderDetailEntity objects</param>
		/// <param name="purchaseOrderHeaderInstance">PurchaseOrderHeaderEntity instance to use as a filter for the PurchaseOrderDetailEntity objects</param>
		/// <param name="fieldsToReturn">IEntityFields implementation which forms the definition of the fieldset of the target entity.</param>
		/// <returns>A ready to use PredicateExpression based on the passed in foreign key value holders.</returns>
		private IPredicateExpression CreateFilterUsingForeignKeys(ProductEntity productInstance, PurchaseOrderHeaderEntity purchaseOrderHeaderInstance, IEntityFields fieldsToReturn)
		{
			IPredicateExpression selectFilter = new PredicateExpression();
			
			if(productInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)PurchaseOrderDetailFieldIndex.ProductID], ComparisonOperator.Equal, productInstance.ProductID));
			}
			
			if(purchaseOrderHeaderInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)PurchaseOrderDetailFieldIndex.PurchaseOrderID], ComparisonOperator.Equal, purchaseOrderHeaderInstance.PurchaseOrderID));
			}
