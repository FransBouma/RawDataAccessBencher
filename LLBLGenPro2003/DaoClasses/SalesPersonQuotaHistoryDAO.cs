...
{
	/// <summary>
	/// General DAO class for the SalesPersonQuotaHistory Entity. It will perform database oriented actions for
	/// a entity of type 'SalesPersonQuotaHistoryEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class SalesPersonQuotaHistoryDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public SalesPersonQuotaHistoryDAO()
		{
		}

		/// <summary>
		/// Adds the given fields to the database as a new 'SalesPersonQuotaHistory' entity.
		/// </summary>
		...
		public bool AddSalesPersonQuotaHistory(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'SalesPersonQuotaHistoryEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateSalesPersonQuotaHistory(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)SalesPersonQuotaHistoryFieldIndex.SalesPersonID], ComparisonOperator.Equal));
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)SalesPersonQuotaHistoryFieldIndex.QuotaDate], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateSalesPersonQuotaHistory(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'SalesPersonQuotaHistoryEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchSalesPersonQuotaHistory(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 salesPersonID, System.DateTime quotaDate)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)SalesPersonQuotaHistoryFieldIndex.SalesPersonID], ComparisonOperator.Equal, salesPersonID));
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)SalesPersonQuotaHistoryFieldIndex.QuotaDate], ComparisonOperator.Equal, quotaDate));
		...
		/// <summary>
		/// Deletes an entity of type 'SalesPersonQuotaHistoryEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteSalesPersonQuotaHistory(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)SalesPersonQuotaHistoryFieldIndex.SalesPersonID], ComparisonOperator.Equal));
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)SalesPersonQuotaHistoryFieldIndex.QuotaDate], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling SalesPersonQuotaHistoryCollection object all SalesPersonQuotaHistoryEntity objects which have data in common
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.SalesPersonQuotaHistoryEntity);
		...
		/// <summary>
		/// Retrieves in the calling SalesPersonQuotaHistoryCollection object all SalesPersonQuotaHistoryEntity objects
		...
		/// <summary>
		/// Retrieves entities of the type 'SalesPersonQuotaHistoryEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'SalesPersonQuotaHistory' entities which have data in common
		/// with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		...
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.SalesPersonQuotaHistoryEntity);
		...
		/// <summary>
		/// Deletes from the persistent storage all 'SalesPersonQuotaHistory' entities which match with the specified filter, formulated in
		...
		private IPredicateExpression CreateFilterUsingForeignKeys(SalesPersonEntity salesPersonInstance, IEntityFields fieldsToReturn)
		{
			...
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)SalesPersonQuotaHistoryFieldIndex.SalesPersonID], ComparisonOperator.Equal, salesPersonInstance.SalesPersonID));
			}
