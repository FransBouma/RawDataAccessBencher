...
{
	/// <summary>
	/// General DAO class for the StateProvince Entity. It will perform database oriented actions for
	/// a entity of type 'StateProvinceEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class StateProvinceDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Adds the given fields to the database as a new 'StateProvince' entity.
		/// </summary>
		...
		public bool AddStateProvince(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'StateProvinceEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateStateProvince(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)StateProvinceFieldIndex.StateProvinceID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateStateProvince(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'StateProvinceEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchStateProvince(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 stateProvinceID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)StateProvinceFieldIndex.StateProvinceID], ComparisonOperator.Equal, stateProvinceID));
		...
		/// <summary>
		/// Deletes an entity of type 'StateProvinceEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteStateProvince(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)StateProvinceFieldIndex.StateProvinceID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling StateProvinceCollection object all StateProvinceEntity objects which have data in common
		...
		public bool GetMulti(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, 
				IEntityFactory entityFactoryToUse, IValidator validatorToUse, IPredicateExpression filter, CountryRegionEntity countryRegionInstance, SalesTerritoryEntity salesTerritoryInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.StateProvinceEntity);
		...
		/// <summary>
		/// Retrieves in the calling StateProvinceCollection object all StateProvinceEntity objects
		...
		/// <summary>
		/// Retrieves entities of the type 'StateProvinceEntity' in a datatable which match the specified filter. 
		...
		public int DeleteMulti(ITransaction containingTransaction, CountryRegionEntity countryRegionInstance, SalesTerritoryEntity salesTerritoryInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.StateProvinceEntity);
		...
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IEntityFields fieldsWithNewValues, ITransaction containingTransaction, CountryRegionEntity countryRegionInstance, SalesTerritoryEntity salesTerritoryInstance)
		{
		...
		private IPredicateExpression CreateFilterUsingForeignKeys(CountryRegionEntity countryRegionInstance, SalesTerritoryEntity salesTerritoryInstance, IEntityFields fieldsToReturn)
		{
			IPredicateExpression selectFilter = new PredicateExpression();
			
			if(countryRegionInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)StateProvinceFieldIndex.CountryRegionCode], ComparisonOperator.Equal, countryRegionInstance.CountryRegionCode));
			}
			
			if(salesTerritoryInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)StateProvinceFieldIndex.TerritoryID], ComparisonOperator.Equal, salesTerritoryInstance.TerritoryID));
			}
