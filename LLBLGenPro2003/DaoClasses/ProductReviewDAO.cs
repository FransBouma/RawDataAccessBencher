...
{
	/// <summary>
	/// General DAO class for the ProductReview Entity. It will perform database oriented actions for
	/// a entity of type 'ProductReviewEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class ProductReviewDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Adds the given fields to the database as a new 'ProductReview' entity.
		/// </summary>
		...
		public bool AddProductReview(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'ProductReviewEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateProductReview(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductReviewFieldIndex.ProductReviewID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateProductReview(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'ProductReviewEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchProductReview(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 productReviewID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)ProductReviewFieldIndex.ProductReviewID], ComparisonOperator.Equal, productReviewID));
		...
		/// <summary>
		/// Deletes an entity of type 'ProductReviewEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteProductReview(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductReviewFieldIndex.ProductReviewID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling ProductReviewCollection object all ProductReviewEntity objects which have data in common
		...
		/// <param name="productInstance">ProductEntity instance to use as a filter for the ProductReviewEntity objects to return</param>
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductReviewEntity);
		...
		/// <summary>
		/// Retrieves in the calling ProductReviewCollection object all ProductReviewEntity objects
		...
		/// <summary>
		/// Retrieves entities of the type 'ProductReviewEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'ProductReview' entities which have data in common
		/// with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the ProductReviewEntity objects to delete</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int DeleteMulti(ITransaction containingTransaction, ProductEntity productInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductReviewEntity);
		...
		/// <summary>
		/// Deletes from the persistent storage all 'ProductReview' entities which match with the specified filter, formulated in
		...
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the ProductReviewEntity objects to update</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// </summary>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the ProductReviewEntity objects</param>
		...
		private IPredicateExpression CreateFilterUsingForeignKeys(ProductEntity productInstance, IEntityFields fieldsToReturn)
		{
			...
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)ProductReviewFieldIndex.ProductID], ComparisonOperator.Equal, productInstance.ProductID));
			}
