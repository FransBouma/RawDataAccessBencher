...
{
	/// <summary>
	/// General DAO class for the ProductCategory Entity. It will perform database oriented actions for
	/// a entity of type 'ProductCategoryEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class ProductCategoryDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Adds the given fields to the database as a new 'ProductCategory' entity.
		/// </summary>
		...
		public bool AddProductCategory(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'ProductCategoryEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateProductCategory(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductCategoryFieldIndex.ProductCategoryID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateProductCategory(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'ProductCategoryEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchProductCategory(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 productCategoryID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)ProductCategoryFieldIndex.ProductCategoryID], ComparisonOperator.Equal, productCategoryID));
		...
		/// <summary>
		/// Deletes an entity of type 'ProductCategoryEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteProductCategory(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductCategoryFieldIndex.ProductCategoryID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling ProductCategoryCollection object all ProductCategoryEntity objects
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductCategoryEntity);
		...
		/// <summary>
		/// Retrieves entities of the type 'ProductCategoryEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'ProductCategory' entities which match with the specified filter, formulated in
		...
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductCategoryEntity);
