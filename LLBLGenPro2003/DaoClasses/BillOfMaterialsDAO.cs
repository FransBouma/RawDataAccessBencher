...
{
	/// <summary>
	/// General DAO class for the BillOfMaterials Entity. It will perform database oriented actions for
	/// a entity of type 'BillOfMaterialsEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class BillOfMaterialsDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Adds the given fields to the database as a new 'BillOfMaterials' entity.
		/// </summary>
		...
		public bool AddBillOfMaterials(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'BillOfMaterialsEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateBillOfMaterials(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)BillOfMaterialsFieldIndex.BillOfMaterialsID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateBillOfMaterials(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'BillOfMaterialsEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchBillOfMaterials(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 billOfMaterialsID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)BillOfMaterialsFieldIndex.BillOfMaterialsID], ComparisonOperator.Equal, billOfMaterialsID));
		...
		/// <summary>
		/// Deletes an entity of type 'BillOfMaterialsEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteBillOfMaterials(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)BillOfMaterialsFieldIndex.BillOfMaterialsID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling BillOfMaterialsCollection object all BillOfMaterialsEntity objects which have data in common
		...
		/// <param name="productInstance">ProductEntity instance to use as a filter for the BillOfMaterialsEntity objects to return</param>
		/// <param name="product_Instance">ProductEntity instance to use as a filter for the BillOfMaterialsEntity objects to return</param>
		/// <param name="unitMeasureInstance">UnitMeasureEntity instance to use as a filter for the BillOfMaterialsEntity objects to return</param>
		...
		public bool GetMulti(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, 
				IEntityFactory entityFactoryToUse, IValidator validatorToUse, IPredicateExpression filter, ProductEntity productInstance, ProductEntity product_Instance, UnitMeasureEntity unitMeasureInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.BillOfMaterialsEntity);
		...
		/// <summary>
		/// Retrieves in the calling BillOfMaterialsCollection object all BillOfMaterialsEntity objects
		...
		/// <summary>
		/// Retrieves entities of the type 'BillOfMaterialsEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'BillOfMaterials' entities which have data in common
		/// with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the BillOfMaterialsEntity objects to delete</param>
		/// <param name="product_Instance">ProductEntity instance to use as a filter for the BillOfMaterialsEntity objects to delete</param>
		/// <param name="unitMeasureInstance">UnitMeasureEntity instance to use as a filter for the BillOfMaterialsEntity objects to delete</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int DeleteMulti(ITransaction containingTransaction, ProductEntity productInstance, ProductEntity product_Instance, UnitMeasureEntity unitMeasureInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.BillOfMaterialsEntity);
		...
		/// <summary>
		/// Deletes from the persistent storage all 'BillOfMaterials' entities which match with the specified filter, formulated in
		...
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the BillOfMaterialsEntity objects to update</param>
		/// <param name="product_Instance">ProductEntity instance to use as a filter for the BillOfMaterialsEntity objects to update</param>
		/// <param name="unitMeasureInstance">UnitMeasureEntity instance to use as a filter for the BillOfMaterialsEntity objects to update</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IEntityFields fieldsWithNewValues, ITransaction containingTransaction, ProductEntity productInstance, ProductEntity product_Instance, UnitMeasureEntity unitMeasureInstance)
		{
		...
		/// </summary>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the BillOfMaterialsEntity objects</param>
		/// <param name="product_Instance">ProductEntity instance to use as a filter for the BillOfMaterialsEntity objects</param>
		/// <param name="unitMeasureInstance">UnitMeasureEntity instance to use as a filter for the BillOfMaterialsEntity objects</param>
		/// <param name="fieldsToReturn">IEntityFields implementation which forms the definition of the fieldset of the target entity.</param>
		/// <returns>A ready to use PredicateExpression based on the passed in foreign key value holders.</returns>
		private IPredicateExpression CreateFilterUsingForeignKeys(ProductEntity productInstance, ProductEntity product_Instance, UnitMeasureEntity unitMeasureInstance, IEntityFields fieldsToReturn)
		{
			IPredicateExpression selectFilter = new PredicateExpression();
			
			if(productInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)BillOfMaterialsFieldIndex.ComponentID], ComparisonOperator.Equal, productInstance.ProductID));
			}
			
			if(product_Instance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)BillOfMaterialsFieldIndex.ProductAssemblyID], ComparisonOperator.Equal, product_Instance.ProductID));
			}
			
			if(unitMeasureInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)BillOfMaterialsFieldIndex.UnitMeasureCode], ComparisonOperator.Equal, unitMeasureInstance.UnitMeasureCode));
			}
