...
{
	/// <summary>
	/// General DAO class for the JobCandidate Entity. It will perform database oriented actions for
	/// a entity of type 'JobCandidateEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class JobCandidateDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Adds the given fields to the database as a new 'JobCandidate' entity.
		/// </summary>
		...
		public bool AddJobCandidate(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'JobCandidateEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateJobCandidate(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)JobCandidateFieldIndex.JobCandidateID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateJobCandidate(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'JobCandidateEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchJobCandidate(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 jobCandidateID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)JobCandidateFieldIndex.JobCandidateID], ComparisonOperator.Equal, jobCandidateID));
		...
		/// <summary>
		/// Deletes an entity of type 'JobCandidateEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteJobCandidate(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)JobCandidateFieldIndex.JobCandidateID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling JobCandidateCollection object all JobCandidateEntity objects which have data in common
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.JobCandidateEntity);
		...
		/// <summary>
		/// Retrieves in the calling JobCandidateCollection object all JobCandidateEntity objects
		...
		/// <summary>
		/// Retrieves entities of the type 'JobCandidateEntity' in a datatable which match the specified filter. 
		...
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.JobCandidateEntity);
		...
		private IPredicateExpression CreateFilterUsingForeignKeys(EmployeeEntity employeeInstance, IEntityFields fieldsToReturn)
		{
			...
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)JobCandidateFieldIndex.EmployeeID], ComparisonOperator.Equal, employeeInstance.EmployeeID));
			}
