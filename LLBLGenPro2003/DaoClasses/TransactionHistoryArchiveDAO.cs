...
{
	/// <summary>
	/// General DAO class for the TransactionHistoryArchive Entity. It will perform database oriented actions for
	/// a entity of type 'TransactionHistoryArchiveEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class TransactionHistoryArchiveDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public TransactionHistoryArchiveDAO()
		{
		}

		/// <summary>
		/// Adds the given fields to the database as a new 'TransactionHistoryArchive' entity.
		/// </summary>
		...
		public bool AddTransactionHistoryArchive(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'TransactionHistoryArchiveEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateTransactionHistoryArchive(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)TransactionHistoryArchiveFieldIndex.TransactionID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateTransactionHistoryArchive(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'TransactionHistoryArchiveEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchTransactionHistoryArchive(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 transactionID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)TransactionHistoryArchiveFieldIndex.TransactionID], ComparisonOperator.Equal, transactionID));
		...
		/// <summary>
		/// Deletes an entity of type 'TransactionHistoryArchiveEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteTransactionHistoryArchive(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)TransactionHistoryArchiveFieldIndex.TransactionID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling TransactionHistoryArchiveCollection object all TransactionHistoryArchiveEntity objects
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.TransactionHistoryArchiveEntity);
		...
		/// <summary>
		/// Retrieves entities of the type 'TransactionHistoryArchiveEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'TransactionHistoryArchive' entities which match with the specified filter, formulated in
		...
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.TransactionHistoryArchiveEntity);
