...
{
	/// <summary>
	/// General DAO class for the NonPresentTimeHeader Entity. It will perform database oriented actions for
	/// a entity of type 'NonPresentTimeHeaderEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class NonPresentTimeHeaderDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public NonPresentTimeHeaderDAO()
		{
		}

		/// <summary>
		/// Adds the given fields to the database as a new 'NonPresentTimeHeader' entity.
		/// </summary>
		...
		public bool AddNonPresentTimeHeader(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'NonPresentTimeHeaderEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateNonPresentTimeHeader(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)NonPresentTimeHeaderFieldIndex.ID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateNonPresentTimeHeader(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'NonPresentTimeHeaderEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchNonPresentTimeHeader(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 iD)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)NonPresentTimeHeaderFieldIndex.ID], ComparisonOperator.Equal, iD));
		...
		/// <summary>
		/// Deletes an entity of type 'NonPresentTimeHeaderEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteNonPresentTimeHeader(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)NonPresentTimeHeaderFieldIndex.ID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling NonPresentTimeHeaderCollection object all NonPresentTimeHeaderEntity objects which have data in common
		...
		/// <param name="userDetailInstance">UserDetailEntity instance to use as a filter for the NonPresentTimeHeaderEntity objects to return</param>
		/// <param name="userDetail_Instance">UserDetailEntity instance to use as a filter for the NonPresentTimeHeaderEntity objects to return</param>
		...
		public bool GetMulti(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, 
				IEntityFactory entityFactoryToUse, IValidator validatorToUse, IPredicateExpression filter, UserDetailEntity userDetailInstance, UserDetailEntity userDetail_Instance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.NonPresentTimeHeaderEntity);
			IPredicateExpression selectFilter = CreateFilterUsingForeignKeys(userDetailInstance, userDetail_Instance, fieldsToReturn);
			if(filter!=null)
			{
		...
		/// <summary>
		/// Retrieves in the calling NonPresentTimeHeaderCollection object all NonPresentTimeHeaderEntity objects
		...
		/// <summary>
		/// Retrieves entities of the type 'NonPresentTimeHeaderEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Retrieves in the calling NonPresentTimeHeaderCollection object all NonPresentTimeHeaderEntity objects
		/// which are related via a relation of type 'm:n' with the passed in ReasonEntity. 
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="collectionToFill">Collection to fill with the entity objects retrieved</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query. 
		...
		/// <param name="entityFactoryToUse">The EntityFactory to use when creating entity objects during a GetMulti() call.</param>
		/// <param name="validatorToUse">The Validator object to use when creating entity objects during a GetMulti() call.</param>
		/// <param name="reasonInstance">ReasonEntity object to be used as a filter in the m:n relation</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingReason(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, 
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, ReasonEntity reasonInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.NonPresentTimeHeaderEntity);

			RelationCollection relations = new RelationCollection();
			// add the relations to walk.
			relations.Add(NonPresentTimeHeaderEntity.Relations.NonPresentTimeEntityUsingHeaderID);
			relations.Add(NonPresentTimeEntity.Relations.ReasonEntityUsingReasonID);
			
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(reasonInstance.Fields[(int)ReasonFieldIndex.ID], ComparisonOperator.Equal, reasonInstance.ID));
			CreateAndRunMultiInstanceRetrievalQuery(fieldsToReturn, containingTransaction, collectionToFill, maxNumberOfItemsToReturn, sortClauses, 
				entityFactoryToUse, selectFilter, validatorToUse, relations);
			return true;
		}
		...
		/// <summary>
		/// Deletes from the persistent storage all 'NonPresentTimeHeader' entities which have data in common
		/// with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="userDetailInstance">UserDetailEntity instance to use as a filter for the NonPresentTimeHeaderEntity objects to delete</param>
		/// <param name="userDetail_Instance">UserDetailEntity instance to use as a filter for the NonPresentTimeHeaderEntity objects to delete</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int DeleteMulti(ITransaction containingTransaction, UserDetailEntity userDetailInstance, UserDetailEntity userDetail_Instance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.NonPresentTimeHeaderEntity);
			IPredicateExpression deleteFilter = CreateFilterUsingForeignKeys(userDetailInstance, userDetail_Instance, fields);
			return CreateAndRunDeleteQuery(fields[0], containingTransaction, deleteFilter);
		}
	

		/// <summary>
		/// Deletes from the persistent storage all 'NonPresentTimeHeader' entities which match with the specified filter, formulated in
		...
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="userDetailInstance">UserDetailEntity instance to use as a filter for the NonPresentTimeHeaderEntity objects to update</param>
		/// <param name="userDetail_Instance">UserDetailEntity instance to use as a filter for the NonPresentTimeHeaderEntity objects to update</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IEntityFields fieldsWithNewValues, ITransaction containingTransaction, UserDetailEntity userDetailInstance, UserDetailEntity userDetail_Instance)
		{
			...
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.NonPresentTimeHeaderEntity);
			IPredicateExpression updateFilter = CreateFilterUsingForeignKeys(userDetailInstance, userDetail_Instance, fields);
		...
		/// </summary>
		/// <param name="userDetailInstance">UserDetailEntity instance to use as a filter for the NonPresentTimeHeaderEntity objects</param>
		/// <param name="userDetail_Instance">UserDetailEntity instance to use as a filter for the NonPresentTimeHeaderEntity objects</param>
		/// <param name="fieldsToReturn">IEntityFields implementation which forms the definition of the fieldset of the target entity.</param>
		/// <returns>A ready to use PredicateExpression based on the passed in foreign key value holders.</returns>
		private IPredicateExpression CreateFilterUsingForeignKeys(UserDetailEntity userDetailInstance, UserDetailEntity userDetail_Instance, IEntityFields fieldsToReturn)
		{
			IPredicateExpression selectFilter = new PredicateExpression();
			
			if(userDetailInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)NonPresentTimeHeaderFieldIndex.UserID], ComparisonOperator.Equal, userDetailInstance.ID));
			}
			
			if(userDetail_Instance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)NonPresentTimeHeaderFieldIndex.ApprovedFromID], ComparisonOperator.Equal, userDetail_Instance.ID));
			}
