...
{
	/// <summary>
	/// General DAO class for the ProductProductPhoto Entity. It will perform database oriented actions for
	/// a entity of type 'ProductProductPhotoEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class ProductProductPhotoDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ProductProductPhotoDAO()
		{
		}

		/// <summary>
		/// Adds the given fields to the database as a new 'ProductProductPhoto' entity.
		/// </summary>
		...
		public bool AddProductProductPhoto(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'ProductProductPhotoEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateProductProductPhoto(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductProductPhotoFieldIndex.ProductID], ComparisonOperator.Equal));
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductProductPhotoFieldIndex.ProductPhotoID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateProductProductPhoto(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'ProductProductPhotoEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchProductProductPhoto(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 productID, System.Int32 productPhotoID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)ProductProductPhotoFieldIndex.ProductID], ComparisonOperator.Equal, productID));
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)ProductProductPhotoFieldIndex.ProductPhotoID], ComparisonOperator.Equal, productPhotoID));
		...
		/// <summary>
		/// Deletes an entity of type 'ProductProductPhotoEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteProductProductPhoto(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductProductPhotoFieldIndex.ProductID], ComparisonOperator.Equal));
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductProductPhotoFieldIndex.ProductPhotoID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling ProductProductPhotoCollection object all ProductProductPhotoEntity objects which have data in common
		...
		/// <param name="productInstance">ProductEntity instance to use as a filter for the ProductProductPhotoEntity objects to return</param>
		/// <param name="productPhotoInstance">ProductPhotoEntity instance to use as a filter for the ProductProductPhotoEntity objects to return</param>
		...
		public bool GetMulti(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, 
				IEntityFactory entityFactoryToUse, IValidator validatorToUse, IPredicateExpression filter, ProductEntity productInstance, ProductPhotoEntity productPhotoInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductProductPhotoEntity);
			IPredicateExpression selectFilter = CreateFilterUsingForeignKeys(productInstance, productPhotoInstance, fieldsToReturn);
			if(filter!=null)
			{
		...
		/// <summary>
		/// Retrieves in the calling ProductProductPhotoCollection object all ProductProductPhotoEntity objects
		...
		/// <summary>
		/// Retrieves entities of the type 'ProductProductPhotoEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'ProductProductPhoto' entities which have data in common
		/// with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the ProductProductPhotoEntity objects to delete</param>
		/// <param name="productPhotoInstance">ProductPhotoEntity instance to use as a filter for the ProductProductPhotoEntity objects to delete</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int DeleteMulti(ITransaction containingTransaction, ProductEntity productInstance, ProductPhotoEntity productPhotoInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductProductPhotoEntity);
			IPredicateExpression deleteFilter = CreateFilterUsingForeignKeys(productInstance, productPhotoInstance, fields);
			return CreateAndRunDeleteQuery(fields[0], containingTransaction, deleteFilter);
		}
	

		/// <summary>
		/// Deletes from the persistent storage all 'ProductProductPhoto' entities which match with the specified filter, formulated in
		...
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the ProductProductPhotoEntity objects to update</param>
		/// <param name="productPhotoInstance">ProductPhotoEntity instance to use as a filter for the ProductProductPhotoEntity objects to update</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IEntityFields fieldsWithNewValues, ITransaction containingTransaction, ProductEntity productInstance, ProductPhotoEntity productPhotoInstance)
		{
			...
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductProductPhotoEntity);
			IPredicateExpression updateFilter = CreateFilterUsingForeignKeys(productInstance, productPhotoInstance, fields);
		...
		/// </summary>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the ProductProductPhotoEntity objects</param>
		/// <param name="productPhotoInstance">ProductPhotoEntity instance to use as a filter for the ProductProductPhotoEntity objects</param>
		/// <param name="fieldsToReturn">IEntityFields implementation which forms the definition of the fieldset of the target entity.</param>
		/// <returns>A ready to use PredicateExpression based on the passed in foreign key value holders.</returns>
		private IPredicateExpression CreateFilterUsingForeignKeys(ProductEntity productInstance, ProductPhotoEntity productPhotoInstance, IEntityFields fieldsToReturn)
		{
			IPredicateExpression selectFilter = new PredicateExpression();
			
			if(productInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)ProductProductPhotoFieldIndex.ProductID], ComparisonOperator.Equal, productInstance.ProductID));
			}
			
			if(productPhotoInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)ProductProductPhotoFieldIndex.ProductPhotoID], ComparisonOperator.Equal, productPhotoInstance.ProductPhotoID));
			}
