...
{
	/// <summary>
	/// General DAO class for the EmployeeDepartmentHistory Entity. It will perform database oriented actions for
	/// a entity of type 'EmployeeDepartmentHistoryEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class EmployeeDepartmentHistoryDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public EmployeeDepartmentHistoryDAO()
		{
		}

		/// <summary>
		/// Adds the given fields to the database as a new 'EmployeeDepartmentHistory' entity.
		/// </summary>
		...
		public bool AddEmployeeDepartmentHistory(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'EmployeeDepartmentHistoryEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateEmployeeDepartmentHistory(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)EmployeeDepartmentHistoryFieldIndex.EmployeeID], ComparisonOperator.Equal));
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)EmployeeDepartmentHistoryFieldIndex.DepartmentID], ComparisonOperator.Equal));
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)EmployeeDepartmentHistoryFieldIndex.ShiftID], ComparisonOperator.Equal));
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)EmployeeDepartmentHistoryFieldIndex.StartDate], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateEmployeeDepartmentHistory(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'EmployeeDepartmentHistoryEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchEmployeeDepartmentHistory(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 employeeID, System.Int16 departmentID, System.Byte shiftID, System.DateTime startDate)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)EmployeeDepartmentHistoryFieldIndex.EmployeeID], ComparisonOperator.Equal, employeeID));
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)EmployeeDepartmentHistoryFieldIndex.DepartmentID], ComparisonOperator.Equal, departmentID));
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)EmployeeDepartmentHistoryFieldIndex.ShiftID], ComparisonOperator.Equal, shiftID));
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)EmployeeDepartmentHistoryFieldIndex.StartDate], ComparisonOperator.Equal, startDate));
		...
		/// <summary>
		/// Deletes an entity of type 'EmployeeDepartmentHistoryEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteEmployeeDepartmentHistory(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)EmployeeDepartmentHistoryFieldIndex.EmployeeID], ComparisonOperator.Equal));
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)EmployeeDepartmentHistoryFieldIndex.DepartmentID], ComparisonOperator.Equal));
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)EmployeeDepartmentHistoryFieldIndex.ShiftID], ComparisonOperator.Equal));
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)EmployeeDepartmentHistoryFieldIndex.StartDate], ComparisonOperator.Equal));
		...
		public bool GetMulti(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, 
				IEntityFactory entityFactoryToUse, IValidator validatorToUse, IPredicateExpression filter, DepartmentEntity departmentInstance, EmployeeEntity employeeInstance, ShiftEntity shiftInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.EmployeeDepartmentHistoryEntity);
		...
		/// <summary>
		/// Retrieves in the calling EmployeeDepartmentHistoryCollection object all EmployeeDepartmentHistoryEntity objects
		...
		/// <summary>
		/// Retrieves entities of the type 'EmployeeDepartmentHistoryEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'EmployeeDepartmentHistory' entities which have data in common
		/// with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		...
		public int DeleteMulti(ITransaction containingTransaction, DepartmentEntity departmentInstance, EmployeeEntity employeeInstance, ShiftEntity shiftInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.EmployeeDepartmentHistoryEntity);
		...
		/// <summary>
		/// Deletes from the persistent storage all 'EmployeeDepartmentHistory' entities which match with the specified filter, formulated in
		...
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IEntityFields fieldsWithNewValues, ITransaction containingTransaction, DepartmentEntity departmentInstance, EmployeeEntity employeeInstance, ShiftEntity shiftInstance)
		{
		...
		private IPredicateExpression CreateFilterUsingForeignKeys(DepartmentEntity departmentInstance, EmployeeEntity employeeInstance, ShiftEntity shiftInstance, IEntityFields fieldsToReturn)
		{
			IPredicateExpression selectFilter = new PredicateExpression();
			
			if(departmentInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)EmployeeDepartmentHistoryFieldIndex.DepartmentID], ComparisonOperator.Equal, departmentInstance.DepartmentID));
			}
			
			if(employeeInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)EmployeeDepartmentHistoryFieldIndex.EmployeeID], ComparisonOperator.Equal, employeeInstance.EmployeeID));
			}
			
			if(shiftInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)EmployeeDepartmentHistoryFieldIndex.ShiftID], ComparisonOperator.Equal, shiftInstance.ShiftID));
			}
