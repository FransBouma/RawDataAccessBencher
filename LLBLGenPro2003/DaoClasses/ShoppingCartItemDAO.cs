...
{
	/// <summary>
	/// General DAO class for the ShoppingCartItem Entity. It will perform database oriented actions for
	/// a entity of type 'ShoppingCartItemEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class ShoppingCartItemDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Adds the given fields to the database as a new 'ShoppingCartItem' entity.
		/// </summary>
		...
		public bool AddShoppingCartItem(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'ShoppingCartItemEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateShoppingCartItem(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)ShoppingCartItemFieldIndex.ShoppingCartItemID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateShoppingCartItem(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'ShoppingCartItemEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchShoppingCartItem(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 shoppingCartItemID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)ShoppingCartItemFieldIndex.ShoppingCartItemID], ComparisonOperator.Equal, shoppingCartItemID));
		...
		/// <summary>
		/// Deletes an entity of type 'ShoppingCartItemEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteShoppingCartItem(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)ShoppingCartItemFieldIndex.ShoppingCartItemID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling ShoppingCartItemCollection object all ShoppingCartItemEntity objects which have data in common
		...
		/// <param name="productInstance">ProductEntity instance to use as a filter for the ShoppingCartItemEntity objects to return</param>
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ShoppingCartItemEntity);
		...
		/// <summary>
		/// Retrieves in the calling ShoppingCartItemCollection object all ShoppingCartItemEntity objects
		...
		/// <summary>
		/// Retrieves entities of the type 'ShoppingCartItemEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'ShoppingCartItem' entities which have data in common
		/// with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the ShoppingCartItemEntity objects to delete</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int DeleteMulti(ITransaction containingTransaction, ProductEntity productInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ShoppingCartItemEntity);
		...
		/// <summary>
		/// Deletes from the persistent storage all 'ShoppingCartItem' entities which match with the specified filter, formulated in
		...
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the ShoppingCartItemEntity objects to update</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// </summary>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the ShoppingCartItemEntity objects</param>
		...
		private IPredicateExpression CreateFilterUsingForeignKeys(ProductEntity productInstance, IEntityFields fieldsToReturn)
		{
			...
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)ShoppingCartItemFieldIndex.ProductID], ComparisonOperator.Equal, productInstance.ProductID));
			}
