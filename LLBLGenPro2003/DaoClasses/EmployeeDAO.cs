...
namespace LLBL2003.AdventureWorks2008.DaoClasses
{
	...
	public class EmployeeDAO : DaoBase
	{
		...
		/// <summary>
		/// Adds the given fields to the database as a new 'Employee' entity.
		/// </summary>
		...
		public bool AddEmployee(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'EmployeeEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateEmployee(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)EmployeeFieldIndex.EmployeeID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateEmployee(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'EmployeeEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchEmployee(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 employeeID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)EmployeeFieldIndex.EmployeeID], ComparisonOperator.Equal, employeeID));
		...
		/// <summary>
		/// Deletes an entity of type 'EmployeeEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteEmployee(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)EmployeeFieldIndex.EmployeeID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling EmployeeCollection object all EmployeeEntity objects which have data in common
		...
		public bool GetMulti(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, 
				IEntityFactory entityFactoryToUse, IValidator validatorToUse, IPredicateExpression filter, ContactEntity contactInstance, EmployeeEntity employeeEmployeeIDInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.EmployeeEntity);
			IPredicateExpression selectFilter = CreateFilterUsingForeignKeys(contactInstance, employeeEmployeeIDInstance, fieldsToReturn);
			if(filter!=null)
			{
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingContact_(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, 
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, ContactEntity contactInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.EmployeeEntity);
			...
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(contactInstance.Fields[(int)ContactFieldIndex.ContactID], ComparisonOperator.Equal, contactInstance.ContactID));
			CreateAndRunMultiInstanceRetrievalQuery(fieldsToReturn, containingTransaction, collectionToFill, maxNumberOfItemsToReturn, sortClauses, 
				entityFactoryToUse, selectFilter, validatorToUse, relations);
			return true;
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingDepartment(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, 
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, DepartmentEntity departmentInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.EmployeeEntity);

			RelationCollection relations = new RelationCollection();
			// add the relations to walk.
			relations.Add(EmployeeEntity.Relations.EmployeeDepartmentHistoryEntityUsingEmployeeID);
			relations.Add(EmployeeDepartmentHistoryEntity.Relations.DepartmentEntityUsingDepartmentID);
			
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(departmentInstance.Fields[(int)DepartmentFieldIndex.DepartmentID], ComparisonOperator.Equal, departmentInstance.DepartmentID));
			CreateAndRunMultiInstanceRetrievalQuery(fieldsToReturn, containingTransaction, collectionToFill, maxNumberOfItemsToReturn, sortClauses, 
				entityFactoryToUse, selectFilter, validatorToUse, relations);
			return true;
		}
		...
		/// <summary>
		/// Retrieves in the calling EmployeeCollection object all EmployeeEntity objects
		/// which are related via a relation of type 'm:n' with the passed in ShiftEntity. 
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="collectionToFill">Collection to fill with the entity objects retrieved</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query. 
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingShift(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, 
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, ShiftEntity shiftInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.EmployeeEntity);
			...
			// add the relations to walk.
			relations.Add(EmployeeEntity.Relations.EmployeeDepartmentHistoryEntityUsingEmployeeID);
			relations.Add(EmployeeDepartmentHistoryEntity.Relations.ShiftEntityUsingShiftID);
			
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(shiftInstance.Fields[(int)ShiftFieldIndex.ShiftID], ComparisonOperator.Equal, shiftInstance.ShiftID));
			CreateAndRunMultiInstanceRetrievalQuery(fieldsToReturn, containingTransaction, collectionToFill, maxNumberOfItemsToReturn, sortClauses, 
				entityFactoryToUse, selectFilter, validatorToUse, relations);
			return true;
		}
			...
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, ShipMethodEntity shipMethodInstance)
		{
			...
			RelationCollection relations = new RelationCollection();
			// add the relations to walk.
			relations.Add(EmployeeEntity.Relations.PurchaseOrderHeaderEntityUsingEmployeeID);
			relations.Add(PurchaseOrderHeaderEntity.Relations.ShipMethodEntityUsingShipMethodID);
			...
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, VendorEntity vendorInstance)
		{
			...
			// add the relations to walk.
			relations.Add(EmployeeEntity.Relations.PurchaseOrderHeaderEntityUsingEmployeeID);
			relations.Add(PurchaseOrderHeaderEntity.Relations.VendorEntityUsingVendorID);
		...
		/// <param name="employeeEmployeeIDInstance">EmployeeEntity instance to use as a filter for the EmployeeEntity objects to delete</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int DeleteMulti(ITransaction containingTransaction, ContactEntity contactInstance, EmployeeEntity employeeEmployeeIDInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.EmployeeEntity);
			IPredicateExpression deleteFilter = CreateFilterUsingForeignKeys(contactInstance, employeeEmployeeIDInstance, fields);
		...
		/// <param name="employeeEmployeeIDInstance">EmployeeEntity instance to use as a filter for the EmployeeEntity objects to update</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IEntityFields fieldsWithNewValues, ITransaction containingTransaction, ContactEntity contactInstance, EmployeeEntity employeeEmployeeIDInstance)
		{
			...
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.EmployeeEntity);
			IPredicateExpression updateFilter = CreateFilterUsingForeignKeys(contactInstance, employeeEmployeeIDInstance, fields);
		...
		/// <param name="employeeEmployeeIDInstance">EmployeeEntity instance to use as a filter for the EmployeeEntity objects</param>
		/// <param name="fieldsToReturn">IEntityFields implementation which forms the definition of the fieldset of the target entity.</param>
		/// <returns>A ready to use PredicateExpression based on the passed in foreign key value holders.</returns>
		private IPredicateExpression CreateFilterUsingForeignKeys(ContactEntity contactInstance, EmployeeEntity employeeEmployeeIDInstance, IEntityFields fieldsToReturn)
		{
			IPredicateExpression selectFilter = new PredicateExpression();
			
			if(contactInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)EmployeeFieldIndex.ContactID], ComparisonOperator.Equal, contactInstance.ContactID));
			}
			
			if(employeeEmployeeIDInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)EmployeeFieldIndex.ManagerID], ComparisonOperator.Equal, employeeEmployeeIDInstance.EmployeeID));
			}
