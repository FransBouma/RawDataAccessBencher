...
{
	/// <summary>
	/// General DAO class for the ProductInventory Entity. It will perform database oriented actions for
	/// a entity of type 'ProductInventoryEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class ProductInventoryDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Adds the given fields to the database as a new 'ProductInventory' entity.
		/// </summary>
		...
		public bool AddProductInventory(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'ProductInventoryEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateProductInventory(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductInventoryFieldIndex.ProductID], ComparisonOperator.Equal));
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductInventoryFieldIndex.LocationID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateProductInventory(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'ProductInventoryEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchProductInventory(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 productID, System.Int16 locationID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)ProductInventoryFieldIndex.ProductID], ComparisonOperator.Equal, productID));
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)ProductInventoryFieldIndex.LocationID], ComparisonOperator.Equal, locationID));
		...
		/// <summary>
		/// Deletes an entity of type 'ProductInventoryEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteProductInventory(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductInventoryFieldIndex.ProductID], ComparisonOperator.Equal));
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductInventoryFieldIndex.LocationID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling ProductInventoryCollection object all ProductInventoryEntity objects which have data in common
		...
		/// <param name="locationInstance">LocationEntity instance to use as a filter for the ProductInventoryEntity objects to return</param>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the ProductInventoryEntity objects to return</param>
		...
		public bool GetMulti(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, 
				IEntityFactory entityFactoryToUse, IValidator validatorToUse, IPredicateExpression filter, LocationEntity locationInstance, ProductEntity productInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductInventoryEntity);
			IPredicateExpression selectFilter = CreateFilterUsingForeignKeys(locationInstance, productInstance, fieldsToReturn);
			if(filter!=null)
			{
		...
		/// <summary>
		/// Retrieves in the calling ProductInventoryCollection object all ProductInventoryEntity objects
		...
		/// <summary>
		/// Retrieves entities of the type 'ProductInventoryEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'ProductInventory' entities which have data in common
		/// with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="locationInstance">LocationEntity instance to use as a filter for the ProductInventoryEntity objects to delete</param>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the ProductInventoryEntity objects to delete</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int DeleteMulti(ITransaction containingTransaction, LocationEntity locationInstance, ProductEntity productInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductInventoryEntity);
			IPredicateExpression deleteFilter = CreateFilterUsingForeignKeys(locationInstance, productInstance, fields);
			return CreateAndRunDeleteQuery(fields[0], containingTransaction, deleteFilter);
		}
	

		/// <summary>
		/// Deletes from the persistent storage all 'ProductInventory' entities which match with the specified filter, formulated in
		...
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="locationInstance">LocationEntity instance to use as a filter for the ProductInventoryEntity objects to update</param>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the ProductInventoryEntity objects to update</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IEntityFields fieldsWithNewValues, ITransaction containingTransaction, LocationEntity locationInstance, ProductEntity productInstance)
		{
			...
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductInventoryEntity);
			IPredicateExpression updateFilter = CreateFilterUsingForeignKeys(locationInstance, productInstance, fields);
		...
		/// </summary>
		/// <param name="locationInstance">LocationEntity instance to use as a filter for the ProductInventoryEntity objects</param>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the ProductInventoryEntity objects</param>
		/// <param name="fieldsToReturn">IEntityFields implementation which forms the definition of the fieldset of the target entity.</param>
		/// <returns>A ready to use PredicateExpression based on the passed in foreign key value holders.</returns>
		private IPredicateExpression CreateFilterUsingForeignKeys(LocationEntity locationInstance, ProductEntity productInstance, IEntityFields fieldsToReturn)
		{
			IPredicateExpression selectFilter = new PredicateExpression();
			
			if(locationInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)ProductInventoryFieldIndex.LocationID], ComparisonOperator.Equal, locationInstance.LocationID));
			}
			
			if(productInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)ProductInventoryFieldIndex.ProductID], ComparisonOperator.Equal, productInstance.ProductID));
			}
