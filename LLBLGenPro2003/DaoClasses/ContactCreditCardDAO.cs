...
{
	/// <summary>
	/// General DAO class for the ContactCreditCard Entity. It will perform database oriented actions for
	/// a entity of type 'ContactCreditCardEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class ContactCreditCardDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ContactCreditCardDAO()
		{
		}

		/// <summary>
		/// Adds the given fields to the database as a new 'ContactCreditCard' entity.
		/// </summary>
		...
		public bool AddContactCreditCard(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'ContactCreditCardEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateContactCreditCard(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)ContactCreditCardFieldIndex.ContactID], ComparisonOperator.Equal));
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)ContactCreditCardFieldIndex.CreditCardID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateContactCreditCard(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'ContactCreditCardEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchContactCreditCard(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 contactID, System.Int32 creditCardID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)ContactCreditCardFieldIndex.ContactID], ComparisonOperator.Equal, contactID));
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)ContactCreditCardFieldIndex.CreditCardID], ComparisonOperator.Equal, creditCardID));
		...
		/// <summary>
		/// Deletes an entity of type 'ContactCreditCardEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteContactCreditCard(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)ContactCreditCardFieldIndex.ContactID], ComparisonOperator.Equal));
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)ContactCreditCardFieldIndex.CreditCardID], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling ContactCreditCardCollection object all ContactCreditCardEntity objects which have data in common
		...
		/// <param name="contactInstance">ContactEntity instance to use as a filter for the ContactCreditCardEntity objects to return</param>
		/// <param name="creditCardInstance">CreditCardEntity instance to use as a filter for the ContactCreditCardEntity objects to return</param>
		...
		public bool GetMulti(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, 
				IEntityFactory entityFactoryToUse, IValidator validatorToUse, IPredicateExpression filter, ContactEntity contactInstance, CreditCardEntity creditCardInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ContactCreditCardEntity);
			IPredicateExpression selectFilter = CreateFilterUsingForeignKeys(contactInstance, creditCardInstance, fieldsToReturn);
			if(filter!=null)
			{
		...
		/// <summary>
		/// Retrieves in the calling ContactCreditCardCollection object all ContactCreditCardEntity objects
		...
		/// <summary>
		/// Retrieves entities of the type 'ContactCreditCardEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'ContactCreditCard' entities which have data in common
		/// with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="contactInstance">ContactEntity instance to use as a filter for the ContactCreditCardEntity objects to delete</param>
		/// <param name="creditCardInstance">CreditCardEntity instance to use as a filter for the ContactCreditCardEntity objects to delete</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int DeleteMulti(ITransaction containingTransaction, ContactEntity contactInstance, CreditCardEntity creditCardInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ContactCreditCardEntity);
			IPredicateExpression deleteFilter = CreateFilterUsingForeignKeys(contactInstance, creditCardInstance, fields);
			return CreateAndRunDeleteQuery(fields[0], containingTransaction, deleteFilter);
		}
	

		/// <summary>
		/// Deletes from the persistent storage all 'ContactCreditCard' entities which match with the specified filter, formulated in
		...
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="contactInstance">ContactEntity instance to use as a filter for the ContactCreditCardEntity objects to update</param>
		/// <param name="creditCardInstance">CreditCardEntity instance to use as a filter for the ContactCreditCardEntity objects to update</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IEntityFields fieldsWithNewValues, ITransaction containingTransaction, ContactEntity contactInstance, CreditCardEntity creditCardInstance)
		{
			...
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ContactCreditCardEntity);
			IPredicateExpression updateFilter = CreateFilterUsingForeignKeys(contactInstance, creditCardInstance, fields);
		...
		/// </summary>
		/// <param name="contactInstance">ContactEntity instance to use as a filter for the ContactCreditCardEntity objects</param>
		/// <param name="creditCardInstance">CreditCardEntity instance to use as a filter for the ContactCreditCardEntity objects</param>
		/// <param name="fieldsToReturn">IEntityFields implementation which forms the definition of the fieldset of the target entity.</param>
		/// <returns>A ready to use PredicateExpression based on the passed in foreign key value holders.</returns>
		private IPredicateExpression CreateFilterUsingForeignKeys(ContactEntity contactInstance, CreditCardEntity creditCardInstance, IEntityFields fieldsToReturn)
		{
			IPredicateExpression selectFilter = new PredicateExpression();
			
			if(contactInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)ContactCreditCardFieldIndex.ContactID], ComparisonOperator.Equal, contactInstance.ContactID));
			}
			
			if(creditCardInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)ContactCreditCardFieldIndex.CreditCardID], ComparisonOperator.Equal, creditCardInstance.CreditCardID));
			}
