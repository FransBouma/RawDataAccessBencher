...
namespace LLBL2003.AdventureWorks2008.DaoClasses
{
	...
	public class SalesOrderDetailDAO : DaoBase
	{
		...
		/// <summary>
		/// Adds the given fields to the database as a new 'SalesOrderDetail' entity.
		/// </summary>
		...
		public bool AddSalesOrderDetail(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'SalesOrderDetailEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateSalesOrderDetail(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)SalesOrderDetailFieldIndex.SalesOrderID], ComparisonOperator.Equal));
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)SalesOrderDetailFieldIndex.SalesOrderDetailID], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateSalesOrderDetail(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'SalesOrderDetailEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchSalesOrderDetail(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 salesOrderID, System.Int32 salesOrderDetailID)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)SalesOrderDetailFieldIndex.SalesOrderID], ComparisonOperator.Equal, salesOrderID));
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)SalesOrderDetailFieldIndex.SalesOrderDetailID], ComparisonOperator.Equal, salesOrderDetailID));
		...
		/// <summary>
		/// Deletes an entity of type 'SalesOrderDetailEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteSalesOrderDetail(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)SalesOrderDetailFieldIndex.SalesOrderID], ComparisonOperator.Equal));
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)SalesOrderDetailFieldIndex.SalesOrderDetailID], ComparisonOperator.Equal));
		...
		public bool GetMulti(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, 
				IEntityFactory entityFactoryToUse, IValidator validatorToUse, IPredicateExpression filter, SalesOrderHeaderEntity salesOrderHeaderInstance, SpecialOfferProductEntity specialOfferProductInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.SalesOrderDetailEntity);
		...
		/// <summary>
		/// Retrieves in the calling SalesOrderDetailCollection object all SalesOrderDetailEntity objects
		...
		/// <summary>
		/// Retrieves entities of the type 'SalesOrderDetailEntity' in a datatable which match the specified filter. 
		...
		public int DeleteMulti(ITransaction containingTransaction, SalesOrderHeaderEntity salesOrderHeaderInstance, SpecialOfferProductEntity specialOfferProductInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.SalesOrderDetailEntity);
		...
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IEntityFields fieldsWithNewValues, ITransaction containingTransaction, SalesOrderHeaderEntity salesOrderHeaderInstance, SpecialOfferProductEntity specialOfferProductInstance)
		{
		...
		private IPredicateExpression CreateFilterUsingForeignKeys(SalesOrderHeaderEntity salesOrderHeaderInstance, SpecialOfferProductEntity specialOfferProductInstance, IEntityFields fieldsToReturn)
		{
			IPredicateExpression selectFilter = new PredicateExpression();
			
			if(salesOrderHeaderInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)SalesOrderDetailFieldIndex.SalesOrderID], ComparisonOperator.Equal, salesOrderHeaderInstance.SalesOrderID));
			}
			
			if(specialOfferProductInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)SalesOrderDetailFieldIndex.SpecialOfferID], ComparisonOperator.Equal, specialOfferProductInstance.SpecialOfferID));
selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)SalesOrderDetailFieldIndex.ProductID], ComparisonOperator.Equal, specialOfferProductInstance.ProductID));
			}
