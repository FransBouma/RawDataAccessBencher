...
{
	/// <summary>
	/// General DAO class for the ProductCostHistory Entity. It will perform database oriented actions for
	/// a entity of type 'ProductCostHistoryEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class ProductCostHistoryDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ProductCostHistoryDAO()
		{
		}

		/// <summary>
		/// Adds the given fields to the database as a new 'ProductCostHistory' entity.
		/// </summary>
		...
		public bool AddProductCostHistory(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'ProductCostHistoryEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateProductCostHistory(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductCostHistoryFieldIndex.ProductID], ComparisonOperator.Equal));
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductCostHistoryFieldIndex.StartDate], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateProductCostHistory(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'ProductCostHistoryEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchProductCostHistory(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.Int32 productID, System.DateTime startDate)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)ProductCostHistoryFieldIndex.ProductID], ComparisonOperator.Equal, productID));
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)ProductCostHistoryFieldIndex.StartDate], ComparisonOperator.Equal, startDate));
		...
		/// <summary>
		/// Deletes an entity of type 'ProductCostHistoryEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteProductCostHistory(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductCostHistoryFieldIndex.ProductID], ComparisonOperator.Equal));
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)ProductCostHistoryFieldIndex.StartDate], ComparisonOperator.Equal));
		...
		/// <summary>
		/// Retrieves in the calling ProductCostHistoryCollection object all ProductCostHistoryEntity objects which have data in common
		...
		/// <param name="productInstance">ProductEntity instance to use as a filter for the ProductCostHistoryEntity objects to return</param>
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductCostHistoryEntity);
		...
		/// <summary>
		/// Retrieves in the calling ProductCostHistoryCollection object all ProductCostHistoryEntity objects
		...
		/// <summary>
		/// Retrieves entities of the type 'ProductCostHistoryEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'ProductCostHistory' entities which have data in common
		/// with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the ProductCostHistoryEntity objects to delete</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int DeleteMulti(ITransaction containingTransaction, ProductEntity productInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductCostHistoryEntity);
		...
		/// <summary>
		/// Deletes from the persistent storage all 'ProductCostHistory' entities which match with the specified filter, formulated in
		...
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the ProductCostHistoryEntity objects to update</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// </summary>
		/// <param name="productInstance">ProductEntity instance to use as a filter for the ProductCostHistoryEntity objects</param>
		...
		private IPredicateExpression CreateFilterUsingForeignKeys(ProductEntity productInstance, IEntityFields fieldsToReturn)
		{
			...
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)ProductCostHistoryFieldIndex.ProductID], ComparisonOperator.Equal, productInstance.ProductID));
			}
