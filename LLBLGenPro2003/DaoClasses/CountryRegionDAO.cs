...
{
	/// <summary>
	/// General DAO class for the CountryRegion Entity. It will perform database oriented actions for
	/// a entity of type 'CountryRegionEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public class CountryRegionDAO : DaoBase
	{
		/// <summary>
		/// CTor
		/// </summary>
		public CountryRegionDAO()
		{
		}

		/// <summary>
		/// Adds the given fields to the database as a new 'CountryRegion' entity.
		/// </summary>
		...
		public bool AddCountryRegion(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
		...
		/// <summary>
		/// Updates an entity of type 'CountryRegionEntity' using the given fields. 
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateCountryRegion(IEntityFields fields, ITransaction containingTransaction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			updateFilter.Add(new FieldCompareValuePredicate(fields[(int)CountryRegionFieldIndex.CountryRegionCode], ComparisonOperator.Equal));
		...
		/// <returns>true if the update was succesful, false otherwise</returns>
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool UpdateCountryRegion(IEntityFields fields, ITransaction containingTransaction, IPredicate updateRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
		...
		/// <summary>
		/// Reads the data of an entity of type 'CountryRegionEntity' data into EntityFields object and returns that object. Which data is read is determined using
		...
		public IEntityFields FetchCountryRegion(IEntityFields fieldsToFetch, ITransaction containingTransaction, System.String countryRegionCode)
		{
			fieldsToFetch.State = EntityState.New;
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(fieldsToFetch[(int)CountryRegionFieldIndex.CountryRegionCode], ComparisonOperator.Equal, countryRegionCode));
		...
		/// <summary>
		/// Deletes an entity of type 'CountryRegionEntity' from the persistent storage. Which entity is deleted is determined from the passed in EntityFields object.
		/// </summary>
		...
		/// <exception cref="ArgumentNullException">When fields is null</exception>
		public bool DeleteCountryRegion(IEntityFields fields, ITransaction containingTransaction, IPredicate deleteRestriction)
		{
			if(fields==null)
			{
				throw new ArgumentNullException("fields", "fields can't be null");
			...
			deleteFilter.Add(new FieldCompareValuePredicate(fields[(int)CountryRegionFieldIndex.CountryRegionCode], ComparisonOperator.Equal));
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.CountryRegionEntity);
		...
		/// <summary>
		/// Retrieves entities of the type 'CountryRegionEntity' in a datatable which match the specified filter. 
			...
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, SalesTerritoryEntity salesTerritoryInstance)
		{
			...
			relations.Add(CountryRegionEntity.Relations.StateProvinceEntityUsingCountryRegionCode);
			relations.Add(StateProvinceEntity.Relations.SalesTerritoryEntityUsingTerritoryID);
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingCurrency(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, 
			ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, CurrencyEntity currencyInstance)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.CountryRegionEntity);

			RelationCollection relations = new RelationCollection();
			// add the relations to walk.
			relations.Add(CountryRegionEntity.Relations.CountryRegionCurrencyEntityUsingCountryRegionCode);
			relations.Add(CountryRegionCurrencyEntity.Relations.CurrencyEntityUsingCurrencyCode);
			
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(currencyInstance.Fields[(int)CurrencyFieldIndex.CurrencyCode], ComparisonOperator.Equal, currencyInstance.CurrencyCode));
			CreateAndRunMultiInstanceRetrievalQuery(fieldsToReturn, containingTransaction, collectionToFill, maxNumberOfItemsToReturn, sortClauses, 
				entityFactoryToUse, selectFilter, validatorToUse, relations);
			return true;
		}
		...
		/// <summary>
		/// Deletes from the persistent storage all 'CountryRegion' entities which match with the specified filter, formulated in
		...
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.CountryRegionEntity);
