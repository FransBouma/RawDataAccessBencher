...
{
	/// <summary>
	/// Implementation of the Employee Validator class. This class formulates validation rules for the
	/// EmployeeEntity class. It is plugged into an instance of the EmployeeEntity class using the Strategy
	...
	/// EmployeeEntity class instead of an instance of this class. The EmployeeEntity code will then call your
	...
	public class EmployeeValidator : IValidator
	{
		...
		{
			// TODO:  Add EmployeeValidator.Validate implementation
			return true;
		}
	}
}
