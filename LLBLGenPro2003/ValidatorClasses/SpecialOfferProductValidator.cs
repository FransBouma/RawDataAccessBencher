...
{
	/// <summary>
	/// Implementation of the SpecialOfferProduct Validator class. This class formulates validation rules for the
	/// SpecialOfferProductEntity class. It is plugged into an instance of the SpecialOfferProductEntity class using the Strategy
	...
	/// SpecialOfferProductEntity class instead of an instance of this class. The SpecialOfferProductEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class SpecialOfferProductValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public SpecialOfferProductValidator()
		{
		}
		...
		{
			// TODO:  Add SpecialOfferProductValidator.Validate implementation
			return true;
		}
	}
}
