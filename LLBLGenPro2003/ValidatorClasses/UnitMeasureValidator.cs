...
{
	/// <summary>
	/// Implementation of the UnitMeasure Validator class. This class formulates validation rules for the
	/// UnitMeasureEntity class. It is plugged into an instance of the UnitMeasureEntity class using the Strategy
	...
	/// UnitMeasureEntity class instead of an instance of this class. The UnitMeasureEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class UnitMeasureValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		{
			// TODO:  Add UnitMeasureValidator.Validate implementation
			return true;
		}
	}
}
