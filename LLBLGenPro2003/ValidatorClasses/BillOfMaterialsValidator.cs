...
{
	/// <summary>
	/// Implementation of the BillOfMaterials Validator class. This class formulates validation rules for the
	/// BillOfMaterialsEntity class. It is plugged into an instance of the BillOfMaterialsEntity class using the Strategy
	...
	/// BillOfMaterialsEntity class instead of an instance of this class. The BillOfMaterialsEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class BillOfMaterialsValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		{
			// TODO:  Add BillOfMaterialsValidator.Validate implementation
			return true;
		}
	}
}
