...
{
	/// <summary>
	/// Implementation of the SalesReason Validator class. This class formulates validation rules for the
	/// SalesReasonEntity class. It is plugged into an instance of the SalesReasonEntity class using the Strategy
	...
	/// SalesReasonEntity class instead of an instance of this class. The SalesReasonEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class SalesReasonValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public SalesReasonValidator()
		{
		}
		...
		{
			// TODO:  Add SalesReasonValidator.Validate implementation
			return true;
		}
	}
}
