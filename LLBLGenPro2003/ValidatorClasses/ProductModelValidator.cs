...
{
	/// <summary>
	/// Implementation of the ProductModel Validator class. This class formulates validation rules for the
	/// ProductModelEntity class. It is plugged into an instance of the ProductModelEntity class using the Strategy
	...
	/// ProductModelEntity class instead of an instance of this class. The ProductModelEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class ProductModelValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		{
			// TODO:  Add ProductModelValidator.Validate implementation
			return true;
		}
	}
}
