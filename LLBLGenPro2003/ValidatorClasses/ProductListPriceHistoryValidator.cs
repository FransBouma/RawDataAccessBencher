...
{
	/// <summary>
	/// Implementation of the ProductListPriceHistory Validator class. This class formulates validation rules for the
	/// ProductListPriceHistoryEntity class. It is plugged into an instance of the ProductListPriceHistoryEntity class using the Strategy
	...
	/// ProductListPriceHistoryEntity class instead of an instance of this class. The ProductListPriceHistoryEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class ProductListPriceHistoryValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ProductListPriceHistoryValidator()
		{
		}
		...
		{
			// TODO:  Add ProductListPriceHistoryValidator.Validate implementation
			return true;
		}
	}
}
