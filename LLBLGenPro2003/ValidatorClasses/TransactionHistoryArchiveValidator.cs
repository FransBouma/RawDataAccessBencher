...
{
	/// <summary>
	/// Implementation of the TransactionHistoryArchive Validator class. This class formulates validation rules for the
	/// TransactionHistoryArchiveEntity class. It is plugged into an instance of the TransactionHistoryArchiveEntity class using the Strategy
	...
	/// TransactionHistoryArchiveEntity class instead of an instance of this class. The TransactionHistoryArchiveEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class TransactionHistoryArchiveValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public TransactionHistoryArchiveValidator()
		{
		}
		...
		{
			// TODO:  Add TransactionHistoryArchiveValidator.Validate implementation
			return true;
		}
	}
}
