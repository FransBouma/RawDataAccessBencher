...
{
	/// <summary>
	/// Implementation of the DatabaseLog Validator class. This class formulates validation rules for the
	/// DatabaseLogEntity class. It is plugged into an instance of the DatabaseLogEntity class using the Strategy
	...
	/// DatabaseLogEntity class instead of an instance of this class. The DatabaseLogEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class DatabaseLogValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public DatabaseLogValidator()
		{
		}
		...
		{
			// TODO:  Add DatabaseLogValidator.Validate implementation
			return true;
		}
	}
}
