...
{
	/// <summary>
	/// Implementation of the Contact Validator class. This class formulates validation rules for the
	/// ContactEntity class. It is plugged into an instance of the ContactEntity class using the Strategy
	...
	/// ContactEntity class instead of an instance of this class. The ContactEntity code will then call your
	...
	public class ContactValidator : IValidator
	{
		...
		{
			// TODO:  Add ContactValidator.Validate implementation
			return true;
		}
	}
}
