...
{
	/// <summary>
	/// Implementation of the VendorAddress Validator class. This class formulates validation rules for the
	/// VendorAddressEntity class. It is plugged into an instance of the VendorAddressEntity class using the Strategy
	...
	/// VendorAddressEntity class instead of an instance of this class. The VendorAddressEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class VendorAddressValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		{
			// TODO:  Add VendorAddressValidator.Validate implementation
			return true;
		}
	}
}
