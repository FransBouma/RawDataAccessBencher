...
{
	/// <summary>
	/// Implementation of the NewSequentialIDTest Validator class. This class formulates validation rules for the
	/// NewSequentialIDTestEntity class. It is plugged into an instance of the NewSequentialIDTestEntity class using the Strategy
	...
	/// NewSequentialIDTestEntity class instead of an instance of this class. The NewSequentialIDTestEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class NewSequentialIDTestValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public NewSequentialIDTestValidator()
		{
		}
		...
		{
			// TODO:  Add NewSequentialIDTestValidator.Validate implementation
			return true;
		}
	}
}
