...
{
	/// <summary>
	/// Implementation of the EmployeeAddress Validator class. This class formulates validation rules for the
	/// EmployeeAddressEntity class. It is plugged into an instance of the EmployeeAddressEntity class using the Strategy
	...
	/// EmployeeAddressEntity class instead of an instance of this class. The EmployeeAddressEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class EmployeeAddressValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		{
			// TODO:  Add EmployeeAddressValidator.Validate implementation
			return true;
		}
	}
}
