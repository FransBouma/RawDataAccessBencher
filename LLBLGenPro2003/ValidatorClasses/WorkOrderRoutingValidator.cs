...
{
	/// <summary>
	/// Implementation of the WorkOrderRouting Validator class. This class formulates validation rules for the
	/// WorkOrderRoutingEntity class. It is plugged into an instance of the WorkOrderRoutingEntity class using the Strategy
	...
	/// WorkOrderRoutingEntity class instead of an instance of this class. The WorkOrderRoutingEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class WorkOrderRoutingValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public WorkOrderRoutingValidator()
		{
		}
		...
		{
			// TODO:  Add WorkOrderRoutingValidator.Validate implementation
			return true;
		}
	}
}
