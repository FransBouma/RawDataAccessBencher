...
{
	/// <summary>
	/// Implementation of the JobCandidate Validator class. This class formulates validation rules for the
	/// JobCandidateEntity class. It is plugged into an instance of the JobCandidateEntity class using the Strategy
	...
	/// JobCandidateEntity class instead of an instance of this class. The JobCandidateEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class JobCandidateValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		{
			// TODO:  Add JobCandidateValidator.Validate implementation
			return true;
		}
	}
}
