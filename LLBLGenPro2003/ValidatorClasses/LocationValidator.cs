...
{
	/// <summary>
	/// Implementation of the Location Validator class. This class formulates validation rules for the
	/// LocationEntity class. It is plugged into an instance of the LocationEntity class using the Strategy
	...
	/// LocationEntity class instead of an instance of this class. The LocationEntity code will then call your
	...
	public class LocationValidator : IValidator
	{
		...
		{
			// TODO:  Add LocationValidator.Validate implementation
			return true;
		}
	}
}
