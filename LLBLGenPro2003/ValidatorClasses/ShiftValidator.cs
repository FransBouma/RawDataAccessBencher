...
{
	/// <summary>
	/// Implementation of the Shift Validator class. This class formulates validation rules for the
	/// ShiftEntity class. It is plugged into an instance of the ShiftEntity class using the Strategy
	...
	/// ShiftEntity class instead of an instance of this class. The ShiftEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class ShiftValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		{
			// TODO:  Add ShiftValidator.Validate implementation
			return true;
		}
	}
}
