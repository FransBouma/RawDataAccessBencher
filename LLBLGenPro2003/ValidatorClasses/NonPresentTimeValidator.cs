...
{
	/// <summary>
	/// Implementation of the NonPresentTime Validator class. This class formulates validation rules for the
	/// NonPresentTimeEntity class. It is plugged into an instance of the NonPresentTimeEntity class using the Strategy
	...
	/// NonPresentTimeEntity class instead of an instance of this class. The NonPresentTimeEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class NonPresentTimeValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public NonPresentTimeValidator()
		{
		}
		...
		{
			// TODO:  Add NonPresentTimeValidator.Validate implementation
			return true;
		}
	}
}
