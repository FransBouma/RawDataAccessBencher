...
{
	/// <summary>
	/// Implementation of the SpecialOffer Validator class. This class formulates validation rules for the
	/// SpecialOfferEntity class. It is plugged into an instance of the SpecialOfferEntity class using the Strategy
	...
	/// SpecialOfferEntity class instead of an instance of this class. The SpecialOfferEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class SpecialOfferValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public SpecialOfferValidator()
		{
		}
		...
		{
			// TODO:  Add SpecialOfferValidator.Validate implementation
			return true;
		}
	}
}
