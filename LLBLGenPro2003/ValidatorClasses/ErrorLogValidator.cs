...
{
	/// <summary>
	/// Implementation of the ErrorLog Validator class. This class formulates validation rules for the
	/// ErrorLogEntity class. It is plugged into an instance of the ErrorLogEntity class using the Strategy
	...
	/// ErrorLogEntity class instead of an instance of this class. The ErrorLogEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class ErrorLogValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		{
			// TODO:  Add ErrorLogValidator.Validate implementation
			return true;
		}
	}
}
