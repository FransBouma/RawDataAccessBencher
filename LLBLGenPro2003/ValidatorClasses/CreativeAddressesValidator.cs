...
{
	/// <summary>
	/// Implementation of the CreativeAddresses Validator class. This class formulates validation rules for the
	/// CreativeAddressesEntity class. It is plugged into an instance of the CreativeAddressesEntity class using the Strategy
	...
	/// CreativeAddressesEntity class instead of an instance of this class. The CreativeAddressesEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class CreativeAddressesValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public CreativeAddressesValidator()
		{
		}
		...
		{
			// TODO:  Add CreativeAddressesValidator.Validate implementation
			return true;
		}
	}
}
