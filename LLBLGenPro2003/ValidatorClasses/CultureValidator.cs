...
{
	/// <summary>
	/// Implementation of the Culture Validator class. This class formulates validation rules for the
	/// CultureEntity class. It is plugged into an instance of the CultureEntity class using the Strategy
	...
	/// CultureEntity class instead of an instance of this class. The CultureEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class CultureValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		{
			// TODO:  Add CultureValidator.Validate implementation
			return true;
		}
	}
}
