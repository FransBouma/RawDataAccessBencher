...
{
	/// <summary>
	/// Implementation of the SalesTaxRate Validator class. This class formulates validation rules for the
	/// SalesTaxRateEntity class. It is plugged into an instance of the SalesTaxRateEntity class using the Strategy
	...
	/// SalesTaxRateEntity class instead of an instance of this class. The SalesTaxRateEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class SalesTaxRateValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public SalesTaxRateValidator()
		{
		}
		...
		{
			// TODO:  Add SalesTaxRateValidator.Validate implementation
			return true;
		}
	}
}
