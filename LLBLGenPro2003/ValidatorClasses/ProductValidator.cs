...
{
	/// <summary>
	/// Implementation of the Product Validator class. This class formulates validation rules for the
	/// ProductEntity class. It is plugged into an instance of the ProductEntity class using the Strategy
	...
	/// ProductEntity class instead of an instance of this class. The ProductEntity code will then call your
	...
	public class ProductValidator : IValidator
	{
		...
		{
			// TODO:  Add ProductValidator.Validate implementation
			return true;
		}
	}
}
