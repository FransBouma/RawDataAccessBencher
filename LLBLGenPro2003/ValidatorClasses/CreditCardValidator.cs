...
{
	/// <summary>
	/// Implementation of the CreditCard Validator class. This class formulates validation rules for the
	/// CreditCardEntity class. It is plugged into an instance of the CreditCardEntity class using the Strategy
	...
	/// CreditCardEntity class instead of an instance of this class. The CreditCardEntity code will then call your
	...
	public class CreditCardValidator : IValidator
	{
		...
		{
			// TODO:  Add CreditCardValidator.Validate implementation
			return true;
		}
	}
}
