...
{
	/// <summary>
	/// Implementation of the PurchaseOrderHeader Validator class. This class formulates validation rules for the
	/// PurchaseOrderHeaderEntity class. It is plugged into an instance of the PurchaseOrderHeaderEntity class using the Strategy
	...
	/// PurchaseOrderHeaderEntity class instead of an instance of this class. The PurchaseOrderHeaderEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class PurchaseOrderHeaderValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		{
			// TODO:  Add PurchaseOrderHeaderValidator.Validate implementation
			return true;
		}
	}
}
