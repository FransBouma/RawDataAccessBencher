...
{
	/// <summary>
	/// Implementation of the StateProvince Validator class. This class formulates validation rules for the
	/// StateProvinceEntity class. It is plugged into an instance of the StateProvinceEntity class using the Strategy
	...
	/// StateProvinceEntity class instead of an instance of this class. The StateProvinceEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class StateProvinceValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		{
			// TODO:  Add StateProvinceValidator.Validate implementation
			return true;
		}
	}
}
