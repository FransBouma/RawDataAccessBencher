...
{
	/// <summary>
	/// Implementation of the CurrencyRate Validator class. This class formulates validation rules for the
	/// CurrencyRateEntity class. It is plugged into an instance of the CurrencyRateEntity class using the Strategy
	...
	/// CurrencyRateEntity class instead of an instance of this class. The CurrencyRateEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class CurrencyRateValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		{
			// TODO:  Add CurrencyRateValidator.Validate implementation
			return true;
		}
	}
}
