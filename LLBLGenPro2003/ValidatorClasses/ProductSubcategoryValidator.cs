...
{
	/// <summary>
	/// Implementation of the ProductSubcategory Validator class. This class formulates validation rules for the
	/// ProductSubcategoryEntity class. It is plugged into an instance of the ProductSubcategoryEntity class using the Strategy
	...
	/// ProductSubcategoryEntity class instead of an instance of this class. The ProductSubcategoryEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class ProductSubcategoryValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		{
			// TODO:  Add ProductSubcategoryValidator.Validate implementation
			return true;
		}
	}
}
