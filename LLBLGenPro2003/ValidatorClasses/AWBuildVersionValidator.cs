...
{
	/// <summary>
	/// Implementation of the AWBuildVersion Validator class. This class formulates validation rules for the
	/// AWBuildVersionEntity class. It is plugged into an instance of the AWBuildVersionEntity class using the Strategy
	...
	/// AWBuildVersionEntity class instead of an instance of this class. The AWBuildVersionEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class AWBuildVersionValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public AWBuildVersionValidator()
		{
		}
		...
		{
			// TODO:  Add AWBuildVersionValidator.Validate implementation
			return true;
		}
	}
}
