...
{
	/// <summary>
	/// Implementation of the ProductInventory Validator class. This class formulates validation rules for the
	/// ProductInventoryEntity class. It is plugged into an instance of the ProductInventoryEntity class using the Strategy
	...
	/// ProductInventoryEntity class instead of an instance of this class. The ProductInventoryEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class ProductInventoryValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		{
			// TODO:  Add ProductInventoryValidator.Validate implementation
			return true;
		}
	}
}
