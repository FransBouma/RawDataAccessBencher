...
{
	/// <summary>
	/// Implementation of the WorkOrder Validator class. This class formulates validation rules for the
	/// WorkOrderEntity class. It is plugged into an instance of the WorkOrderEntity class using the Strategy
	...
	/// WorkOrderEntity class instead of an instance of this class. The WorkOrderEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class WorkOrderValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		{
			// TODO:  Add WorkOrderValidator.Validate implementation
			return true;
		}
	}
}
