...
{
	/// <summary>
	/// Implementation of the ProductReview Validator class. This class formulates validation rules for the
	/// ProductReviewEntity class. It is plugged into an instance of the ProductReviewEntity class using the Strategy
	...
	/// ProductReviewEntity class instead of an instance of this class. The ProductReviewEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class ProductReviewValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		{
			// TODO:  Add ProductReviewValidator.Validate implementation
			return true;
		}
	}
}
