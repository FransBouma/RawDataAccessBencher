...
{
	/// <summary>
	/// Implementation of the SalesPerson Validator class. This class formulates validation rules for the
	/// SalesPersonEntity class. It is plugged into an instance of the SalesPersonEntity class using the Strategy
	...
	/// SalesPersonEntity class instead of an instance of this class. The SalesPersonEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class SalesPersonValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		{
			// TODO:  Add SalesPersonValidator.Validate implementation
			return true;
		}
	}
}
