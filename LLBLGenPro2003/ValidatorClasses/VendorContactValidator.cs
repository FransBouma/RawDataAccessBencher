...
{
	/// <summary>
	/// Implementation of the VendorContact Validator class. This class formulates validation rules for the
	/// VendorContactEntity class. It is plugged into an instance of the VendorContactEntity class using the Strategy
	...
	/// VendorContactEntity class instead of an instance of this class. The VendorContactEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class VendorContactValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		{
			// TODO:  Add VendorContactValidator.Validate implementation
			return true;
		}
	}
}
