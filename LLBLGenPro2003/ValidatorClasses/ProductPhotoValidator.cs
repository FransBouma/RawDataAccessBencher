...
{
	/// <summary>
	/// Implementation of the ProductPhoto Validator class. This class formulates validation rules for the
	/// ProductPhotoEntity class. It is plugged into an instance of the ProductPhotoEntity class using the Strategy
	...
	/// ProductPhotoEntity class instead of an instance of this class. The ProductPhotoEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class ProductPhotoValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		{
			// TODO:  Add ProductPhotoValidator.Validate implementation
			return true;
		}
	}
}
