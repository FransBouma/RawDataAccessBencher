...
{
	/// <summary>
	/// Implementation of the Store Validator class. This class formulates validation rules for the
	/// StoreEntity class. It is plugged into an instance of the StoreEntity class using the Strategy
	...
	/// StoreEntity class instead of an instance of this class. The StoreEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class StoreValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		{
			// TODO:  Add StoreValidator.Validate implementation
			return true;
		}
	}
}
