...
{
	/// <summary>
	/// Implementation of the Customer Validator class. This class formulates validation rules for the
	/// CustomerEntity class. It is plugged into an instance of the CustomerEntity class using the Strategy
	...
	/// CustomerEntity class instead of an instance of this class. The CustomerEntity code will then call your
	...
	public class CustomerValidator : IValidator
	{
		...
		{
			// TODO:  Add CustomerValidator.Validate implementation
			return true;
		}
	}
}
