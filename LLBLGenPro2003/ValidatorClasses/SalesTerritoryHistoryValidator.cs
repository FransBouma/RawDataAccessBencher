...
{
	/// <summary>
	/// Implementation of the SalesTerritoryHistory Validator class. This class formulates validation rules for the
	/// SalesTerritoryHistoryEntity class. It is plugged into an instance of the SalesTerritoryHistoryEntity class using the Strategy
	...
	/// SalesTerritoryHistoryEntity class instead of an instance of this class. The SalesTerritoryHistoryEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class SalesTerritoryHistoryValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public SalesTerritoryHistoryValidator()
		{
		}
		...
		{
			// TODO:  Add SalesTerritoryHistoryValidator.Validate implementation
			return true;
		}
	}
}
