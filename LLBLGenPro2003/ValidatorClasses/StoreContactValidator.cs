...
{
	/// <summary>
	/// Implementation of the StoreContact Validator class. This class formulates validation rules for the
	/// StoreContactEntity class. It is plugged into an instance of the StoreContactEntity class using the Strategy
	...
	/// StoreContactEntity class instead of an instance of this class. The StoreContactEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class StoreContactValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		{
			// TODO:  Add StoreContactValidator.Validate implementation
			return true;
		}
	}
}
