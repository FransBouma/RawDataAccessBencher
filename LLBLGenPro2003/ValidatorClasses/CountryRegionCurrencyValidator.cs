...
{
	/// <summary>
	/// Implementation of the CountryRegionCurrency Validator class. This class formulates validation rules for the
	/// CountryRegionCurrencyEntity class. It is plugged into an instance of the CountryRegionCurrencyEntity class using the Strategy
	...
	/// CountryRegionCurrencyEntity class instead of an instance of this class. The CountryRegionCurrencyEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class CountryRegionCurrencyValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public CountryRegionCurrencyValidator()
		{
		}
		...
		{
			// TODO:  Add CountryRegionCurrencyValidator.Validate implementation
			return true;
		}
	}
}
