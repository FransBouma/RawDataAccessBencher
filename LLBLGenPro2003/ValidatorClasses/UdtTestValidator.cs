...
{
	/// <summary>
	/// Implementation of the UdtTest Validator class. This class formulates validation rules for the
	/// UdtTestEntity class. It is plugged into an instance of the UdtTestEntity class using the Strategy
	...
	/// UdtTestEntity class instead of an instance of this class. The UdtTestEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class UdtTestValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public UdtTestValidator()
		{
		}
		...
		{
			// TODO:  Add UdtTestValidator.Validate implementation
			return true;
		}
	}
}
