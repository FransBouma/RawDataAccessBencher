...
{
	/// <summary>
	/// Implementation of the Reason Validator class. This class formulates validation rules for the
	/// ReasonEntity class. It is plugged into an instance of the ReasonEntity class using the Strategy
	...
	/// ReasonEntity class instead of an instance of this class. The ReasonEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class ReasonValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		{
			// TODO:  Add ReasonValidator.Validate implementation
			return true;
		}
	}
}
