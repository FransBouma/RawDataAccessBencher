...
{
	/// <summary>
	/// Implementation of the ProductCostHistory Validator class. This class formulates validation rules for the
	/// ProductCostHistoryEntity class. It is plugged into an instance of the ProductCostHistoryEntity class using the Strategy
	...
	/// ProductCostHistoryEntity class instead of an instance of this class. The ProductCostHistoryEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class ProductCostHistoryValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ProductCostHistoryValidator()
		{
		}
		...
		{
			// TODO:  Add ProductCostHistoryValidator.Validate implementation
			return true;
		}
	}
}
