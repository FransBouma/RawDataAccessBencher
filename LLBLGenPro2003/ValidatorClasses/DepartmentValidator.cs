...
{
	/// <summary>
	/// Implementation of the Department Validator class. This class formulates validation rules for the
	/// DepartmentEntity class. It is plugged into an instance of the DepartmentEntity class using the Strategy
	...
	/// DepartmentEntity class instead of an instance of this class. The DepartmentEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class DepartmentValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		{
			// TODO:  Add DepartmentValidator.Validate implementation
			return true;
		}
	}
}
