...
{
	/// <summary>
	/// Implementation of the Illustration Validator class. This class formulates validation rules for the
	/// IllustrationEntity class. It is plugged into an instance of the IllustrationEntity class using the Strategy
	...
	/// IllustrationEntity class instead of an instance of this class. The IllustrationEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class IllustrationValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public IllustrationValidator()
		{
		}
		...
		{
			// TODO:  Add IllustrationValidator.Validate implementation
			return true;
		}
	}
}
