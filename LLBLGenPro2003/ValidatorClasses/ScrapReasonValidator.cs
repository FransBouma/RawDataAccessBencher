...
{
	/// <summary>
	/// Implementation of the ScrapReason Validator class. This class formulates validation rules for the
	/// ScrapReasonEntity class. It is plugged into an instance of the ScrapReasonEntity class using the Strategy
	...
	/// ScrapReasonEntity class instead of an instance of this class. The ScrapReasonEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class ScrapReasonValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ScrapReasonValidator()
		{
		}
		...
		{
			// TODO:  Add ScrapReasonValidator.Validate implementation
			return true;
		}
	}
}
