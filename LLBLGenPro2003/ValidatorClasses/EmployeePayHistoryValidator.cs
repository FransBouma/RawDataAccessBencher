...
{
	/// <summary>
	/// Implementation of the EmployeePayHistory Validator class. This class formulates validation rules for the
	/// EmployeePayHistoryEntity class. It is plugged into an instance of the EmployeePayHistoryEntity class using the Strategy
	...
	/// EmployeePayHistoryEntity class instead of an instance of this class. The EmployeePayHistoryEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class EmployeePayHistoryValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public EmployeePayHistoryValidator()
		{
		}
		...
		{
			// TODO:  Add EmployeePayHistoryValidator.Validate implementation
			return true;
		}
	}
}
