...
{
	/// <summary>
	/// Implementation of the ProductModelProductDescriptionCulture Validator class. This class formulates validation rules for the
	/// ProductModelProductDescriptionCultureEntity class. It is plugged into an instance of the ProductModelProductDescriptionCultureEntity class using the Strategy
	...
	/// ProductModelProductDescriptionCultureEntity class instead of an instance of this class. The ProductModelProductDescriptionCultureEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class ProductModelProductDescriptionCultureValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ProductModelProductDescriptionCultureValidator()
		{
		}
		...
		{
			// TODO:  Add ProductModelProductDescriptionCultureValidator.Validate implementation
			return true;
		}
	}
}
