...
{
	/// <summary>
	/// Implementation of the Vendor Validator class. This class formulates validation rules for the
	/// VendorEntity class. It is plugged into an instance of the VendorEntity class using the Strategy
	...
	/// VendorEntity class instead of an instance of this class. The VendorEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class VendorValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		{
			// TODO:  Add VendorValidator.Validate implementation
			return true;
		}
	}
}
