...
{
	/// <summary>
	/// Implementation of the ProductModelIllustration Validator class. This class formulates validation rules for the
	/// ProductModelIllustrationEntity class. It is plugged into an instance of the ProductModelIllustrationEntity class using the Strategy
	...
	/// ProductModelIllustrationEntity class instead of an instance of this class. The ProductModelIllustrationEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class ProductModelIllustrationValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ProductModelIllustrationValidator()
		{
		}
		...
		{
			// TODO:  Add ProductModelIllustrationValidator.Validate implementation
			return true;
		}
	}
}
