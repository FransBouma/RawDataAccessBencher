...
{
	/// <summary>
	/// Implementation of the Currency Validator class. This class formulates validation rules for the
	/// CurrencyEntity class. It is plugged into an instance of the CurrencyEntity class using the Strategy
	...
	/// CurrencyEntity class instead of an instance of this class. The CurrencyEntity code will then call your
	...
	public class CurrencyValidator : IValidator
	{
		...
		{
			// TODO:  Add CurrencyValidator.Validate implementation
			return true;
		}
	}
}
