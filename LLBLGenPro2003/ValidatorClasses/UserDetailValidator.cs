...
{
	/// <summary>
	/// Implementation of the UserDetail Validator class. This class formulates validation rules for the
	/// UserDetailEntity class. It is plugged into an instance of the UserDetailEntity class using the Strategy
	...
	/// UserDetailEntity class instead of an instance of this class. The UserDetailEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class UserDetailValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		{
			// TODO:  Add UserDetailValidator.Validate implementation
			return true;
		}
	}
}
