...
{
	/// <summary>
	/// Implementation of the TransactionHistory Validator class. This class formulates validation rules for the
	/// TransactionHistoryEntity class. It is plugged into an instance of the TransactionHistoryEntity class using the Strategy
	...
	/// TransactionHistoryEntity class instead of an instance of this class. The TransactionHistoryEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class TransactionHistoryValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		{
			// TODO:  Add TransactionHistoryValidator.Validate implementation
			return true;
		}
	}
}
