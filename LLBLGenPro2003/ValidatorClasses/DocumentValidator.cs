...
{
	/// <summary>
	/// Implementation of the Document Validator class. This class formulates validation rules for the
	/// DocumentEntity class. It is plugged into an instance of the DocumentEntity class using the Strategy
	...
	/// DocumentEntity class instead of an instance of this class. The DocumentEntity code will then call your
	...
	public class DocumentValidator : IValidator
	{
		...
		{
			// TODO:  Add DocumentValidator.Validate implementation
			return true;
		}
	}
}
