...
{
	/// <summary>
	/// Implementation of the SalesOrderHeaderSalesReason Validator class. This class formulates validation rules for the
	/// SalesOrderHeaderSalesReasonEntity class. It is plugged into an instance of the SalesOrderHeaderSalesReasonEntity class using the Strategy
	...
	/// SalesOrderHeaderSalesReasonEntity class instead of an instance of this class. The SalesOrderHeaderSalesReasonEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class SalesOrderHeaderSalesReasonValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public SalesOrderHeaderSalesReasonValidator()
		{
		}
		...
		{
			// TODO:  Add SalesOrderHeaderSalesReasonValidator.Validate implementation
			return true;
		}
	}
}
