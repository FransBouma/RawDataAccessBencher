...
{
	/// <summary>
	/// Implementation of the ProductDescription Validator class. This class formulates validation rules for the
	/// ProductDescriptionEntity class. It is plugged into an instance of the ProductDescriptionEntity class using the Strategy
	...
	/// ProductDescriptionEntity class instead of an instance of this class. The ProductDescriptionEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class ProductDescriptionValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		{
			// TODO:  Add ProductDescriptionValidator.Validate implementation
			return true;
		}
	}
}
