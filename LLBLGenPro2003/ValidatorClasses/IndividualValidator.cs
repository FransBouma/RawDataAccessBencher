...
{
	/// <summary>
	/// Implementation of the Individual Validator class. This class formulates validation rules for the
	/// IndividualEntity class. It is plugged into an instance of the IndividualEntity class using the Strategy
	...
	/// IndividualEntity class instead of an instance of this class. The IndividualEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class IndividualValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		{
			// TODO:  Add IndividualValidator.Validate implementation
			return true;
		}
	}
}
