...
{
	/// <summary>
	/// Implementation of the PurchaseOrderDetail Validator class. This class formulates validation rules for the
	/// PurchaseOrderDetailEntity class. It is plugged into an instance of the PurchaseOrderDetailEntity class using the Strategy
	...
	/// PurchaseOrderDetailEntity class instead of an instance of this class. The PurchaseOrderDetailEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class PurchaseOrderDetailValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		{
			// TODO:  Add PurchaseOrderDetailValidator.Validate implementation
			return true;
		}
	}
}
