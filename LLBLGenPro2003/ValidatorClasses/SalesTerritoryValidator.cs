...
{
	/// <summary>
	/// Implementation of the SalesTerritory Validator class. This class formulates validation rules for the
	/// SalesTerritoryEntity class. It is plugged into an instance of the SalesTerritoryEntity class using the Strategy
	...
	/// SalesTerritoryEntity class instead of an instance of this class. The SalesTerritoryEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class SalesTerritoryValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		{
			// TODO:  Add SalesTerritoryValidator.Validate implementation
			return true;
		}
	}
}
