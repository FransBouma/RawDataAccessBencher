...
{
	/// <summary>
	/// Implementation of the EmployeeDepartmentHistory Validator class. This class formulates validation rules for the
	/// EmployeeDepartmentHistoryEntity class. It is plugged into an instance of the EmployeeDepartmentHistoryEntity class using the Strategy
	...
	/// EmployeeDepartmentHistoryEntity class instead of an instance of this class. The EmployeeDepartmentHistoryEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class EmployeeDepartmentHistoryValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public EmployeeDepartmentHistoryValidator()
		{
		}
		...
		{
			// TODO:  Add EmployeeDepartmentHistoryValidator.Validate implementation
			return true;
		}
	}
}
