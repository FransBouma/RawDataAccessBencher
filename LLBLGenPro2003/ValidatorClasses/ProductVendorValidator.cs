...
{
	/// <summary>
	/// Implementation of the ProductVendor Validator class. This class formulates validation rules for the
	/// ProductVendorEntity class. It is plugged into an instance of the ProductVendorEntity class using the Strategy
	...
	/// ProductVendorEntity class instead of an instance of this class. The ProductVendorEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class ProductVendorValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ProductVendorValidator()
		{
		}
		...
		{
			// TODO:  Add ProductVendorValidator.Validate implementation
			return true;
		}
	}
}
