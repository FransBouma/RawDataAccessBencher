...
{
	/// <summary>
	/// Implementation of the NonPresentTimeHeader Validator class. This class formulates validation rules for the
	/// NonPresentTimeHeaderEntity class. It is plugged into an instance of the NonPresentTimeHeaderEntity class using the Strategy
	...
	/// NonPresentTimeHeaderEntity class instead of an instance of this class. The NonPresentTimeHeaderEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class NonPresentTimeHeaderValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public NonPresentTimeHeaderValidator()
		{
		}
		...
		{
			// TODO:  Add NonPresentTimeHeaderValidator.Validate implementation
			return true;
		}
	}
}
