...
{
	/// <summary>
	/// Implementation of the AddressType Validator class. This class formulates validation rules for the
	/// AddressTypeEntity class. It is plugged into an instance of the AddressTypeEntity class using the Strategy
	...
	/// AddressTypeEntity class instead of an instance of this class. The AddressTypeEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class AddressTypeValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		{
			// TODO:  Add AddressTypeValidator.Validate implementation
			return true;
		}
	}
}
