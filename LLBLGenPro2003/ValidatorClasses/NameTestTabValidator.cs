...
{
	/// <summary>
	/// Implementation of the NameTestTab Validator class. This class formulates validation rules for the
	/// NameTestTabEntity class. It is plugged into an instance of the NameTestTabEntity class using the Strategy
	...
	/// NameTestTabEntity class instead of an instance of this class. The NameTestTabEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class NameTestTabValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public NameTestTabValidator()
		{
		}
		...
		{
			// TODO:  Add NameTestTabValidator.Validate implementation
			return true;
		}
	}
}
