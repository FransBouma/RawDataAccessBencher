...
{
	/// <summary>
	/// Implementation of the ProductDocument Validator class. This class formulates validation rules for the
	/// ProductDocumentEntity class. It is plugged into an instance of the ProductDocumentEntity class using the Strategy
	...
	/// ProductDocumentEntity class instead of an instance of this class. The ProductDocumentEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class ProductDocumentValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		{
			// TODO:  Add ProductDocumentValidator.Validate implementation
			return true;
		}
	}
}
