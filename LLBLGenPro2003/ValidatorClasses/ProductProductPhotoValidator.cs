...
{
	/// <summary>
	/// Implementation of the ProductProductPhoto Validator class. This class formulates validation rules for the
	/// ProductProductPhotoEntity class. It is plugged into an instance of the ProductProductPhotoEntity class using the Strategy
	...
	/// ProductProductPhotoEntity class instead of an instance of this class. The ProductProductPhotoEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class ProductProductPhotoValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ProductProductPhotoValidator()
		{
		}
		...
		{
			// TODO:  Add ProductProductPhotoValidator.Validate implementation
			return true;
		}
	}
}
