...
{
	/// <summary>
	/// Implementation of the ContactType Validator class. This class formulates validation rules for the
	/// ContactTypeEntity class. It is plugged into an instance of the ContactTypeEntity class using the Strategy
	...
	/// ContactTypeEntity class instead of an instance of this class. The ContactTypeEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class ContactTypeValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		{
			// TODO:  Add ContactTypeValidator.Validate implementation
			return true;
		}
	}
}
