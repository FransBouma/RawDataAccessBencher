...
{
	/// <summary>
	/// Implementation of the SequentialIDSubType Validator class. This class formulates validation rules for the
	/// SequentialIDSubTypeEntity class. It is plugged into an instance of the SequentialIDSubTypeEntity class using the Strategy
	...
	/// SequentialIDSubTypeEntity class instead of an instance of this class. The SequentialIDSubTypeEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class SequentialIDSubTypeValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public SequentialIDSubTypeValidator()
		{
		}
		...
		{
			// TODO:  Add SequentialIDSubTypeValidator.Validate implementation
			return true;
		}
	}
}
