...
{
	/// <summary>
	/// Implementation of the ContactCreditCard Validator class. This class formulates validation rules for the
	/// ContactCreditCardEntity class. It is plugged into an instance of the ContactCreditCardEntity class using the Strategy
	...
	/// ContactCreditCardEntity class instead of an instance of this class. The ContactCreditCardEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class ContactCreditCardValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ContactCreditCardValidator()
		{
		}
		...
		{
			// TODO:  Add ContactCreditCardValidator.Validate implementation
			return true;
		}
	}
}
