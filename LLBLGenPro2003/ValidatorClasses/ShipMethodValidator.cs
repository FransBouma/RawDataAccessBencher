...
{
	/// <summary>
	/// Implementation of the ShipMethod Validator class. This class formulates validation rules for the
	/// ShipMethodEntity class. It is plugged into an instance of the ShipMethodEntity class using the Strategy
	...
	/// ShipMethodEntity class instead of an instance of this class. The ShipMethodEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class ShipMethodValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ShipMethodValidator()
		{
		}
		...
		{
			// TODO:  Add ShipMethodValidator.Validate implementation
			return true;
		}
	}
}
