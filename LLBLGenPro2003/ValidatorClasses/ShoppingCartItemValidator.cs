...
{
	/// <summary>
	/// Implementation of the ShoppingCartItem Validator class. This class formulates validation rules for the
	/// ShoppingCartItemEntity class. It is plugged into an instance of the ShoppingCartItemEntity class using the Strategy
	...
	/// ShoppingCartItemEntity class instead of an instance of this class. The ShoppingCartItemEntity code will then call your
	...
	public class ShoppingCartItemValidator : IValidator
	{
		...
		{
			// TODO:  Add ShoppingCartItemValidator.Validate implementation
			return true;
		}
	}
}
