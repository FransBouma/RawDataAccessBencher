...
{
	/// <summary>
	/// Implementation of the ProductCategory Validator class. This class formulates validation rules for the
	/// ProductCategoryEntity class. It is plugged into an instance of the ProductCategoryEntity class using the Strategy
	...
	/// ProductCategoryEntity class instead of an instance of this class. The ProductCategoryEntity code will then call your
	...
	public class ProductCategoryValidator : IValidator
	{
		...
		{
			// TODO:  Add ProductCategoryValidator.Validate implementation
			return true;
		}
	}
}
