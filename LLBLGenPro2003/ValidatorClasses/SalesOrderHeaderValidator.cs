...
{
	/// <summary>
	/// Implementation of the SalesOrderHeader Validator class. This class formulates validation rules for the
	/// SalesOrderHeaderEntity class. It is plugged into an instance of the SalesOrderHeaderEntity class using the Strategy
	...
	/// SalesOrderHeaderEntity class instead of an instance of this class. The SalesOrderHeaderEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class SalesOrderHeaderValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public SalesOrderHeaderValidator()
		{
		}
		...
		{
			// TODO:  Add SalesOrderHeaderValidator.Validate implementation
			return true;
		}
	}
}
