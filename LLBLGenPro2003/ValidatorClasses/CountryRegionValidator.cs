...
{
	/// <summary>
	/// Implementation of the CountryRegion Validator class. This class formulates validation rules for the
	/// CountryRegionEntity class. It is plugged into an instance of the CountryRegionEntity class using the Strategy
	...
	/// CountryRegionEntity class instead of an instance of this class. The CountryRegionEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public class CountryRegionValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public CountryRegionValidator()
		{
		}
		...
		{
			// TODO:  Add CountryRegionValidator.Validate implementation
			return true;
		}
	}
}
