...
{
	/// <summary>
	/// Implementation of the Address Validator class. This class formulates validation rules for the
	/// AddressEntity class. It is plugged into an instance of the AddressEntity class using the Strategy
	...
	/// AddressEntity class instead of an instance of this class. The AddressEntity code will then call your
	...
	public class AddressValidator : IValidator
	{
		...
		{
			// TODO:  Add AddressValidator.Validate implementation
			return true;
		}
	}
}
