...
{
	/// <summary>
	/// Implementation of the CustomerAddress Validator class. This class formulates validation rules for the
	/// CustomerAddressEntity class. It is plugged into an instance of the CustomerAddressEntity class using the Strategy
	...
	/// CustomerAddressEntity class instead of an instance of this class. The CustomerAddressEntity code will then call your
	...
	public class CustomerAddressValidator : IValidator
	{
		...
		{
			// TODO:  Add CustomerAddressValidator.Validate implementation
			return true;
		}
	}
}
