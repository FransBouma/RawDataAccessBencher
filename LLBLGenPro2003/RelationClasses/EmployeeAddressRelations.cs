...
namespace LLBL2003.AdventureWorks2008.RelationClasses
{
	...
	public class EmployeeAddressRelations
	{
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between EmployeeAddressEntity and AddressEntity over the m:1 relation they have,
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between EmployeeAddressEntity and EmployeeEntity over the m:1 relation they have,
		/// using the relation between the fields:
