...
{
	/// <summary>
	/// Implements the static Relations variant for the entity: ProductListPriceHistory.
	/// This class is generated. Do not modify.
	/// </summary>
	public class ProductListPriceHistoryRelations
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between ProductListPriceHistoryEntity and ProductEntity over the m:1 relation they have,
