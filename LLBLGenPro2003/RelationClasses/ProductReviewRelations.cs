...
{
	/// <summary>
	/// Implements the static Relations variant for the entity: ProductReview.
	/// This class is generated. Do not modify.
	/// </summary>
	public class ProductReviewRelations
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between ProductReviewEntity and ProductEntity over the m:1 relation they have,
