...
{
	/// <summary>
	/// Implements the static Relations variant for the entity: ShoppingCartItem.
	/// This class is generated. Do not modify.
	/// </summary>
	public class ShoppingCartItemRelations
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between ShoppingCartItemEntity and ProductEntity over the m:1 relation they have,
