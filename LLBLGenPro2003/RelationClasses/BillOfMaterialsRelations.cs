...
{
	/// <summary>
	/// Implements the static Relations variant for the entity: BillOfMaterials.
	/// This class is generated. Do not modify.
	/// </summary>
	public class BillOfMaterialsRelations
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between BillOfMaterialsEntity and ProductEntity over the m:1 relation they have,
		/// using the relation between the fields:
		/// BillOfMaterials.ComponentID - Product.ProductID
		/// </summary>
		public IEntityRelation ProductEntityUsingComponentID
		{
			get
			{
		...
		/// </summary>
		public IEntityRelation ProductEntityUsingProductAssemblyID
		{
			get
			{
				IEntityRelation relation = new EntityRelation(RelationType.ManyToOne);
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between BillOfMaterialsEntity and UnitMeasureEntity over the m:1 relation they have,
		/// using the relation between the fields:
