...
{
	/// <summary>
	/// Implements the static Relations variant for the entity: PurchaseOrderDetail.
	/// This class is generated. Do not modify.
	/// </summary>
	public class PurchaseOrderDetailRelations
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between PurchaseOrderDetailEntity and ProductEntity over the m:1 relation they have,
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between PurchaseOrderDetailEntity and PurchaseOrderHeaderEntity over the m:1 relation they have,
		/// using the relation between the fields:
		/// PurchaseOrderDetail.PurchaseOrderID - PurchaseOrderHeader.PurchaseOrderID
		/// </summary>
		public IEntityRelation PurchaseOrderHeaderEntityUsingPurchaseOrderID
		{
			get
			{
				IEntityRelation relation = new EntityRelation(RelationType.ManyToOne);
