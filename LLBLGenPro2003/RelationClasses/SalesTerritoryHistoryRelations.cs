...
{
	/// <summary>
	/// Implements the static Relations variant for the entity: SalesTerritoryHistory.
	/// This class is generated. Do not modify.
	/// </summary>
	public class SalesTerritoryHistoryRelations
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between SalesTerritoryHistoryEntity and SalesPersonEntity over the m:1 relation they have,
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between SalesTerritoryHistoryEntity and SalesTerritoryEntity over the m:1 relation they have,
		/// using the relation between the fields:
