...
namespace LLBL2003.AdventureWorks2008.RelationClasses
{
	...
	public class SpecialOfferProductRelations
	{
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between SpecialOfferProductEntity and SalesOrderDetailEntity over the 1:n relation they have,
		...
		/// </summary>
		public IEntityRelation SalesOrderDetailEntityUsingSpecialOfferIDProductID
		{
			get
			{
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between SpecialOfferProductEntity and ProductEntity over the m:1 relation they have,
		/// using the relation between the fields:
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between SpecialOfferProductEntity and SpecialOfferEntity over the m:1 relation they have,
		/// using the relation between the fields:
		/// SpecialOfferProduct.SpecialOfferID - SpecialOffer.SpecialOfferID
		/// </summary>
		public IEntityRelation SpecialOfferEntityUsingSpecialOfferID
		{
			get
			{
				IEntityRelation relation = new EntityRelation(RelationType.ManyToOne);
				
				relation.AddEntityFieldPair(EntityFieldFactory.Create(SpecialOfferFieldIndex.SpecialOfferID), 
						EntityFieldFactory.Create(SpecialOfferProductFieldIndex.SpecialOfferID));
