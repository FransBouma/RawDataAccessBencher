...
namespace LLBL2003.AdventureWorks2008.RelationClasses
{
	...
	public class IndividualRelations
	{
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between IndividualEntity and CustomerEntity over the 1:1 relation they have,
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between IndividualEntity and ContactEntity over the m:1 relation they have,
		/// using the relation between the fields:
