...
namespace LLBL2003.AdventureWorks2008.RelationClasses
{
	...
	public class ShipMethodRelations
	{
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between ShipMethodEntity and PurchaseOrderHeaderEntity over the 1:n relation they have,
		/// using the relation between the fields:
		/// ShipMethod.ShipMethodID - PurchaseOrderHeader.ShipMethodID
		/// </summary>
		public IEntityRelation PurchaseOrderHeaderEntityUsingShipMethodID
		{
			get
			{
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between ShipMethodEntity and SalesOrderHeaderEntity over the 1:n relation they have,
		/// using the relation between the fields:
		/// ShipMethod.ShipMethodID - SalesOrderHeader.ShipMethodID
		/// </summary>
		public IEntityRelation SalesOrderHeaderEntityUsingShipMethodID
		{
			get
			{
				IEntityRelation relation = new EntityRelation(RelationType.OneToMany);
