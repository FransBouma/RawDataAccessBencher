...
{
	/// <summary>
	/// Implements the static Relations variant for the entity: Shift.
	/// This class is generated. Do not modify.
	/// </summary>
	public class ShiftRelations
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between ShiftEntity and EmployeeDepartmentHistoryEntity over the 1:n relation they have,
		/// using the relation between the fields:
		/// Shift.ShiftID - EmployeeDepartmentHistory.ShiftID
		/// </summary>
		public IEntityRelation EmployeeDepartmentHistoryEntityUsingShiftID
		{
			get
			{
