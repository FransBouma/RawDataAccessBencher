...
{
	/// <summary>
	/// Implements the static Relations variant for the entity: EmployeePayHistory.
	/// This class is generated. Do not modify.
	/// </summary>
	public class EmployeePayHistoryRelations
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between EmployeePayHistoryEntity and EmployeeEntity over the m:1 relation they have,
