...
{
	/// <summary>
	/// Implements the static Relations variant for the entity: ContactCreditCard.
	/// This class is generated. Do not modify.
	/// </summary>
	public class ContactCreditCardRelations
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between ContactCreditCardEntity and ContactEntity over the m:1 relation they have,
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between ContactCreditCardEntity and CreditCardEntity over the m:1 relation they have,
		/// using the relation between the fields:
