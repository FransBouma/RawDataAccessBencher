...
{
	/// <summary>
	/// Implements the static Relations variant for the entity: SalesPersonQuotaHistory.
	/// This class is generated. Do not modify.
	/// </summary>
	public class SalesPersonQuotaHistoryRelations
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between SalesPersonQuotaHistoryEntity and SalesPersonEntity over the m:1 relation they have,
