...
{
	/// <summary>
	/// Implements the static Relations variant for the entity: TransactionHistory.
	/// This class is generated. Do not modify.
	/// </summary>
	public class TransactionHistoryRelations
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between TransactionHistoryEntity and ProductEntity over the m:1 relation they have,
