...
{
	/// <summary>
	/// Implements the static Relations variant for the entity: StoreContact.
	/// This class is generated. Do not modify.
	/// </summary>
	public class StoreContactRelations
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between StoreContactEntity and ContactEntity over the m:1 relation they have,
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between StoreContactEntity and ContactTypeEntity over the m:1 relation they have,
		/// using the relation between the fields:
		...
		public IEntityRelation ContactTypeEntityUsingContactTypeID
		{
			get
			{
				...
				relation.AddEntityFieldPair(EntityFieldFactory.Create(ContactTypeFieldIndex.ContactTypeID), 
						EntityFieldFactory.Create(StoreContactFieldIndex.ContactTypeID));
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between StoreContactEntity and StoreEntity over the m:1 relation they have,
		/// using the relation between the fields:
		...
		public IEntityRelation StoreEntityUsingCustomerID
		{
			get
			{
				...
				relation.AddEntityFieldPair(EntityFieldFactory.Create(StoreFieldIndex.CustomerID), 
						EntityFieldFactory.Create(StoreContactFieldIndex.CustomerID));
