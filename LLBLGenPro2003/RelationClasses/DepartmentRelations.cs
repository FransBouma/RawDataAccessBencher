...
{
	/// <summary>
	/// Implements the static Relations variant for the entity: Department.
	...
	public class DepartmentRelations
	{
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between DepartmentEntity and EmployeeDepartmentHistoryEntity over the 1:n relation they have,
		/// using the relation between the fields:
		/// Department.DepartmentID - EmployeeDepartmentHistory.DepartmentID
		/// </summary>
		public IEntityRelation EmployeeDepartmentHistoryEntityUsingDepartmentID
		{
			get
			{
