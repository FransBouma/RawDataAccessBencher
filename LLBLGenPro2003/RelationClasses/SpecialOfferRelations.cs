...
namespace LLBL2003.AdventureWorks2008.RelationClasses
{
	...
	public class SpecialOfferRelations
	{
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between SpecialOfferEntity and SpecialOfferProductEntity over the 1:n relation they have,
		/// using the relation between the fields:
		/// SpecialOffer.SpecialOfferID - SpecialOfferProduct.SpecialOfferID
		/// </summary>
		public IEntityRelation SpecialOfferProductEntityUsingSpecialOfferID
		{
			get
			{
