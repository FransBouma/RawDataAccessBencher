...
{
	/// <summary>
	/// Implements the static Relations variant for the entity: ProductVendor.
	/// This class is generated. Do not modify.
	/// </summary>
	public class ProductVendorRelations
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between ProductVendorEntity and ProductEntity over the m:1 relation they have,
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between ProductVendorEntity and UnitMeasureEntity over the m:1 relation they have,
		/// using the relation between the fields:
		/// ProductVendor.UnitMeasureCode - UnitMeasure.UnitMeasureCode
		/// </summary>
		public IEntityRelation UnitMeasureEntityUsingUnitMeasureCode
		{
			get
			{
				IEntityRelation relation = new EntityRelation(RelationType.ManyToOne);
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between ProductVendorEntity and VendorEntity over the m:1 relation they have,
		/// using the relation between the fields:
