...
{
	/// <summary>
	/// Implements the static Relations variant for the entity: Store.
	/// This class is generated. Do not modify.
	/// </summary>
	public class StoreRelations
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between StoreEntity and StoreContactEntity over the 1:n relation they have,
		/// using the relation between the fields:
		/// Store.CustomerID - StoreContact.CustomerID
		/// </summary>
		public IEntityRelation StoreContactEntityUsingCustomerID
		{
			get
			{
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between StoreEntity and CustomerEntity over the 1:1 relation they have,
		/// using the relation between the fields:
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between StoreEntity and SalesPersonEntity over the m:1 relation they have,
		/// using the relation between the fields:
