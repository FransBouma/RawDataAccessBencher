...
{
	/// <summary>
	/// Implements the static Relations variant for the entity: JobCandidate.
	/// This class is generated. Do not modify.
	/// </summary>
	public class JobCandidateRelations
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between JobCandidateEntity and EmployeeEntity over the m:1 relation they have,
