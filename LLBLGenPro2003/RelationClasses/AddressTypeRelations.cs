...
namespace LLBL2003.AdventureWorks2008.RelationClasses
{
	...
	public class AddressTypeRelations
	{
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between AddressTypeEntity and VendorAddressEntity over the 1:n relation they have,
		/// using the relation between the fields:
		/// AddressType.AddressTypeID - VendorAddress.AddressTypeID
		/// </summary>
		public IEntityRelation VendorAddressEntityUsingAddressTypeID
		{
			get
			{
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between AddressTypeEntity and CustomerAddressEntity over the 1:n relation they have,
		/// using the relation between the fields:
		/// AddressType.AddressTypeID - CustomerAddress.AddressTypeID
		/// </summary>
		public IEntityRelation CustomerAddressEntityUsingAddressTypeID
		{
			get
			{
				IEntityRelation relation = new EntityRelation(RelationType.OneToMany);
