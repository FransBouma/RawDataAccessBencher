...
{
	/// <summary>
	/// Implements the static Relations variant for the entity: ProductPhoto.
	/// This class is generated. Do not modify.
	/// </summary>
	public class ProductPhotoRelations
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between ProductPhotoEntity and ProductProductPhotoEntity over the 1:n relation they have,
		/// using the relation between the fields:
		/// ProductPhoto.ProductPhotoID - ProductProductPhoto.ProductPhotoID
		/// </summary>
		public IEntityRelation ProductProductPhotoEntityUsingProductPhotoID
		{
			get
			{
