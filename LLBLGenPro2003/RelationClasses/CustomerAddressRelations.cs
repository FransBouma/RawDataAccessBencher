...
namespace LLBL2003.AdventureWorks2008.RelationClasses
{
	...
	public class CustomerAddressRelations
	{
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between CustomerAddressEntity and AddressEntity over the m:1 relation they have,
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between CustomerAddressEntity and AddressTypeEntity over the m:1 relation they have,
		/// using the relation between the fields:
		...
		public IEntityRelation AddressTypeEntityUsingAddressTypeID
		{
			get
			{
				...
				relation.AddEntityFieldPair(EntityFieldFactory.Create(AddressTypeFieldIndex.AddressTypeID), 
						EntityFieldFactory.Create(CustomerAddressFieldIndex.AddressTypeID));
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between CustomerAddressEntity and CustomerEntity over the m:1 relation they have,
		/// using the relation between the fields:
