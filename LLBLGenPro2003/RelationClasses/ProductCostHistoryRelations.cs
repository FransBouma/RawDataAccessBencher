...
{
	/// <summary>
	/// Implements the static Relations variant for the entity: ProductCostHistory.
	/// This class is generated. Do not modify.
	/// </summary>
	public class ProductCostHistoryRelations
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		/// <summary>
		/// Returns a new IEntityRelation object, between ProductCostHistoryEntity and ProductEntity over the m:1 relation they have,
