...
{
	/// <summary>
	/// Entity class which represents the entity 'TransactionHistory' in the 'AdventureWorks' database.
	/// </summary>
	[Serializable]
	public class TransactionHistoryEntity : EntityBase, ISerializable
	{
		...
		{
			InitClassEmpty(new PropertyDescriptorFactory(), new TransactionHistoryEntityFactory());
		}
		...
		{
			InitClassFetch(transactionID, new TransactionHistoryValidator(), new PropertyDescriptorFactory(), new TransactionHistoryEntityFactory());
		}
		...
		public TransactionHistoryEntity(System.Int32 transactionID, TransactionHistoryValidator validator)
		{
			InitClassFetch(transactionID, validator, new PropertyDescriptorFactory(), new TransactionHistoryEntityFactory());
		}
		...
		public TransactionHistoryEntity(System.Int32 transactionID, TransactionHistoryValidator validator, IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
		...
		/// <param name="propertyDescriptorFactoryToUse">PropertyDescriptor factory to use in GetItemProperties method of contained collections. Complex databinding related.</param>
		/// <param name="entityFactoryToUse">The EntityFactory to use when creating entity objects during a GetMulti() call.</param>
		public TransactionHistoryEntity(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
		...
		private TransactionHistoryEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			return base.ToXml("TransactionHistoryEntity");
		}
		...
		public override bool Delete(IPredicate deleteRestriction)
		{
			...
			bool wasSuccesful = dao.DeleteTransactionHistory(base.Fields, base.Transaction, deleteRestriction);
			if(wasSuccesful)
			{
		...
		public bool TestOriginalFieldValueForNull(TransactionHistoryFieldIndex fieldIndex)
		{
		...
		{
			TransactionHistoryDAO dao = DAOFactory.CreateTransactionHistoryDAO();
			return dao.AddTransactionHistory(base.Fields, base.Transaction);
		}
		...
		{
			TransactionHistoryDAO dao = DAOFactory.CreateTransactionHistoryDAO();
			return dao.UpdateTransactionHistory(base.Fields, base.Transaction);
		}
		...
		{
			TransactionHistoryDAO dao = DAOFactory.CreateTransactionHistoryDAO();
			return dao.UpdateTransactionHistory(base.Fields, base.Transaction, updateRestriction);
		}
		...
		private void InitClassEmpty(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			...
			base.Fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.TransactionHistoryEntity);
			base.IsNew=true;
			base.EntityFactoryToUse = entityFactoryToUse;
			base.Validator = new TransactionHistoryValidator();
		}
		...
		private void InitClassFetch(System.Int32 transactionID, TransactionHistoryValidator validator, IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			InitClassMembers(propertyDescriptorFactoryToUse, entityFactoryToUse);
			base.Fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.TransactionHistoryEntity);
		...
		private void DesetupSyncProduct(bool signalRelatedEntity)
		{
			if(_product != null)
			{
				...
				{
					_product.UnsetRelatedEntity(this, "TransactionHistory");
				}
				base.UnsetEntitySyncInformation("Product", _product, TransactionHistoryEntity.Relations.ProductEntityUsingProductID);
				_product = null;
			}
		}
		...
		private void SetupSyncProduct(IEntity relatedEntity)
		{
			...
			if(relatedEntity!=null)
			{
				...
				_product.AfterSave+=new EventHandler(OnEntityAfterSave);
				base.SetEntitySyncInformation("Product", _product, TransactionHistoryEntity.Relations.ProductEntityUsingProductID);
				if(!_product.IsNew)
				{
					// sync now
					base.SyncFKFields(TransactionHistoryEntity.Relations.ProductEntityUsingProductID, _product);
				}
			}
		...
		private bool Fetch(System.Int32 transactionID)
		{
			...
			// Load EntityFields of TransactionHistory
			dao.FetchTransactionHistory(base.Fields, base.Transaction, transactionID);
		...
		/// </summary>
		public static TransactionHistoryRelations Relations
		{
			get	{ return new TransactionHistoryRelations(); }
		}

	
		/// <summary>
		/// The TransactionID property of the Entity TransactionHistory
		/// </summary>
		public virtual System.Int32 TransactionID
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)TransactionHistoryFieldIndex.TransactionID);
			...
			set
			{
				if(base.SetNewFieldValue((int)TransactionHistoryFieldIndex.TransactionID, value))
				{
		...
		/// <summary>
		/// The ProductID property of the Entity TransactionHistory
		/// </summary>
		public virtual System.Int32 ProductID
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)TransactionHistoryFieldIndex.ProductID);
				if(valueToReturn == null)
				{
			...
			set
			{
				if(base.SetNewFieldValue((int)TransactionHistoryFieldIndex.ProductID, value))
				{
					OnProductIDChanged();
				}
			}
		...
		/// <summary>
		/// The ReferenceOrderID property of the Entity TransactionHistory
		/// </summary>
		public virtual System.Int32 ReferenceOrderID
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)TransactionHistoryFieldIndex.ReferenceOrderID);
				if(valueToReturn == null)
				{
			...
			set
			{
				if(base.SetNewFieldValue((int)TransactionHistoryFieldIndex.ReferenceOrderID, value))
				{
		...
		/// <summary>
		/// The ReferenceOrderLineID property of the Entity TransactionHistory
		/// </summary>
		public virtual System.Int32 ReferenceOrderLineID
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)TransactionHistoryFieldIndex.ReferenceOrderLineID);
				if(valueToReturn == null)
				{
			...
			set
			{
				if(base.SetNewFieldValue((int)TransactionHistoryFieldIndex.ReferenceOrderLineID, value))
				{
		...
		/// <summary>
		/// The TransactionDate property of the Entity TransactionHistory
		/// </summary>
		public virtual System.DateTime TransactionDate
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)TransactionHistoryFieldIndex.TransactionDate);
				if(valueToReturn == null)
				{
			...
			set
			{
				if(base.SetNewFieldValue((int)TransactionHistoryFieldIndex.TransactionDate, value))
				{
		...
		/// <summary>
		/// The TransactionType property of the Entity TransactionHistory
		/// </summary>
		public virtual System.String TransactionType
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)TransactionHistoryFieldIndex.TransactionType);
				if(valueToReturn == null)
				{
			...
			set
			{
				if(base.SetNewFieldValue((int)TransactionHistoryFieldIndex.TransactionType, value))
				{
		...
		/// <summary>
		/// The Quantity property of the Entity TransactionHistory
		/// </summary>
		public virtual System.Int32 Quantity
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)TransactionHistoryFieldIndex.Quantity);
				if(valueToReturn == null)
				{
			...
			set
			{
				if(base.SetNewFieldValue((int)TransactionHistoryFieldIndex.Quantity, value))
				{
					OnQuantityChanged();
				}
			}
		...
		public virtual System.Decimal ActualCost
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)TransactionHistoryFieldIndex.ActualCost);
				if(valueToReturn == null)
				{
			...
			set
			{
				if(base.SetNewFieldValue((int)TransactionHistoryFieldIndex.ActualCost, value))
				{
					OnActualCostChanged();
				}
			}
		...
		/// <summary>
		/// The ModifiedDate property of the Entity TransactionHistory
		/// </summary>
		public virtual System.DateTime ModifiedDate
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)TransactionHistoryFieldIndex.ModifiedDate);
				if(valueToReturn == null)
				{
			...
			set
			{
				if(base.SetNewFieldValue((int)TransactionHistoryFieldIndex.ModifiedDate, value))
				{
			...
			set
			{
				...
				else
				{
					...
					else
					{
						...
						((IEntity)value).SetRelatedEntity(this, "TransactionHistory");
					}
				}
			}
		}
