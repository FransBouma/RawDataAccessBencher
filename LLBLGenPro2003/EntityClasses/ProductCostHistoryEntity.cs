...
{
	/// <summary>
	/// Entity class which represents the entity 'ProductCostHistory' in the 'AdventureWorks' database.
	/// </summary>
	[Serializable]
	public class ProductCostHistoryEntity : EntityBase, ISerializable
	{
		...
		{
			InitClassEmpty(new PropertyDescriptorFactory(), new ProductCostHistoryEntityFactory());
		}
		...
		{
			InitClassFetch(productID, startDate, new ProductCostHistoryValidator(), new PropertyDescriptorFactory(), new ProductCostHistoryEntityFactory());
		}
		...
		public ProductCostHistoryEntity(System.Int32 productID, System.DateTime startDate, ProductCostHistoryValidator validator)
		{
			InitClassFetch(productID, startDate, validator, new PropertyDescriptorFactory(), new ProductCostHistoryEntityFactory());
		}
		...
		public ProductCostHistoryEntity(System.Int32 productID, System.DateTime startDate, ProductCostHistoryValidator validator, IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
		...
		/// <param name="propertyDescriptorFactoryToUse">PropertyDescriptor factory to use in GetItemProperties method of contained collections. Complex databinding related.</param>
		/// <param name="entityFactoryToUse">The EntityFactory to use when creating entity objects during a GetMulti() call.</param>
		public ProductCostHistoryEntity(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
		...
		private ProductCostHistoryEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			return base.ToXml("ProductCostHistoryEntity");
		}
		...
		{
			ProductCostHistoryDAO dao = DAOFactory.CreateProductCostHistoryDAO();
			bool wasSuccesful = dao.DeleteProductCostHistory(base.Fields, base.Transaction, deleteRestriction);
			if(wasSuccesful)
			{
		...
		public bool TestOriginalFieldValueForNull(ProductCostHistoryFieldIndex fieldIndex)
		{
		...
		{
			ProductCostHistoryDAO dao = DAOFactory.CreateProductCostHistoryDAO();
			return dao.AddProductCostHistory(base.Fields, base.Transaction);
		}
		...
		{
			ProductCostHistoryDAO dao = DAOFactory.CreateProductCostHistoryDAO();
			return dao.UpdateProductCostHistory(base.Fields, base.Transaction);
		}
		...
		{
			ProductCostHistoryDAO dao = DAOFactory.CreateProductCostHistoryDAO();
			return dao.UpdateProductCostHistory(base.Fields, base.Transaction, updateRestriction);
		}
		...
		private void InitClassEmpty(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			...
			base.Fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductCostHistoryEntity);
			base.IsNew=true;
			base.EntityFactoryToUse = entityFactoryToUse;
			base.Validator = new ProductCostHistoryValidator();
		}
		...
		private void InitClassFetch(System.Int32 productID, System.DateTime startDate, ProductCostHistoryValidator validator, IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			InitClassMembers(propertyDescriptorFactoryToUse, entityFactoryToUse);
			base.Fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductCostHistoryEntity);
		...
		private void DesetupSyncProduct(bool signalRelatedEntity)
		{
			if(_product != null)
			{
				...
				{
					_product.UnsetRelatedEntity(this, "ProductCostHistory");
				}
				base.UnsetEntitySyncInformation("Product", _product, ProductCostHistoryEntity.Relations.ProductEntityUsingProductID);
				_product = null;
			}
		}
		...
		private void SetupSyncProduct(IEntity relatedEntity)
		{
			...
			if(relatedEntity!=null)
			{
				...
				_product.AfterSave+=new EventHandler(OnEntityAfterSave);
				base.SetEntitySyncInformation("Product", _product, ProductCostHistoryEntity.Relations.ProductEntityUsingProductID);
				if(!_product.IsNew)
				{
					// sync now
					base.SyncFKFields(ProductCostHistoryEntity.Relations.ProductEntityUsingProductID, _product);
				}
			}
		...
		private bool Fetch(System.Int32 productID, System.DateTime startDate)
		{
			...
			// Load EntityFields of ProductCostHistory
			dao.FetchProductCostHistory(base.Fields, base.Transaction, productID, startDate);
		...
		/// </summary>
		public static ProductCostHistoryRelations Relations
		{
			get	{ return new ProductCostHistoryRelations(); }
		}

	
		/// <summary>
		/// The ProductID property of the Entity ProductCostHistory
		/// </summary>
		public virtual System.Int32 ProductID
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ProductCostHistoryFieldIndex.ProductID);
			...
			set
			{
				if(base.SetNewFieldValue((int)ProductCostHistoryFieldIndex.ProductID, value))
				{
					OnProductIDChanged();
				}
			}
		...
		/// <summary>
		/// The StartDate property of the Entity ProductCostHistory
		/// </summary>
		public virtual System.DateTime StartDate
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ProductCostHistoryFieldIndex.StartDate);
				if(valueToReturn == null)
				{
			...
			set
			{
				if(base.SetNewFieldValue((int)ProductCostHistoryFieldIndex.StartDate, value))
				{
					OnStartDateChanged();
				}
			}
		...
		public virtual System.DateTime EndDate
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ProductCostHistoryFieldIndex.EndDate);
				if(valueToReturn == null)
				{
			...
			set
			{
				if(base.SetNewFieldValue((int)ProductCostHistoryFieldIndex.EndDate, value))
				{
					OnEndDateChanged();
				}
			}
		...
		/// <summary>
		/// The StandardCost property of the Entity ProductCostHistory
		/// </summary>
		public virtual System.Decimal StandardCost
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ProductCostHistoryFieldIndex.StandardCost);
				if(valueToReturn == null)
				{
			...
			set
			{
				if(base.SetNewFieldValue((int)ProductCostHistoryFieldIndex.StandardCost, value))
				{
		...
		/// <summary>
		/// The ModifiedDate property of the Entity ProductCostHistory
		/// </summary>
		public virtual System.DateTime ModifiedDate
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ProductCostHistoryFieldIndex.ModifiedDate);
				if(valueToReturn == null)
				{
			...
			set
			{
				if(base.SetNewFieldValue((int)ProductCostHistoryFieldIndex.ModifiedDate, value))
				{
			...
			set
			{
				...
				else
				{
					...
					else
					{
						...
						((IEntity)value).SetRelatedEntity(this, "ProductCostHistory");
					}
				}
			}
		}
