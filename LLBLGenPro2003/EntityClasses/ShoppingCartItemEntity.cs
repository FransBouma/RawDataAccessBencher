...
{
	/// <summary>
	/// Entity class which represents the entity 'ShoppingCartItem' in the 'AdventureWorks' database.
	/// </summary>
	[Serializable]
	public class ShoppingCartItemEntity : EntityBase, ISerializable
	{
		...
		/// <summary>
		/// Event which is thrown when ShoppingCartItemID changes value. Databinding related.
		/// </summary>
		public event EventHandler ShoppingCartItemIDChanged;

		/// <summary>
		/// Event which is thrown when ShoppingCartID changes value. Databinding related.
		/// </summary>
		public event EventHandler ShoppingCartIDChanged;
		...
		/// <summary>
		/// Event which is thrown when DateCreated changes value. Databinding related.
		/// </summary>
		...
		{
			InitClassEmpty(new PropertyDescriptorFactory(), new ShoppingCartItemEntityFactory());
		}
		...
		{
			InitClassFetch(shoppingCartItemID, new ShoppingCartItemValidator(), new PropertyDescriptorFactory(), new ShoppingCartItemEntityFactory());
		}
		...
		public ShoppingCartItemEntity(System.Int32 shoppingCartItemID, ShoppingCartItemValidator validator)
		{
			InitClassFetch(shoppingCartItemID, validator, new PropertyDescriptorFactory(), new ShoppingCartItemEntityFactory());
		}
		...
		public ShoppingCartItemEntity(System.Int32 shoppingCartItemID, ShoppingCartItemValidator validator, IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			InitClassFetch(shoppingCartItemID, validator, propertyDescriptorFactoryToUse, entityFactoryToUse);
		}
		...
		/// <param name="propertyDescriptorFactoryToUse">PropertyDescriptor factory to use in GetItemProperties method of contained collections. Complex databinding related.</param>
		/// <param name="entityFactoryToUse">The EntityFactory to use when creating entity objects during a GetMulti() call.</param>
		public ShoppingCartItemEntity(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
		...
		private ShoppingCartItemEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			return base.ToXml("ShoppingCartItemEntity");
		}
		...
		public bool FetchUsingPK(System.Int32 shoppingCartItemID)
		{
			return Fetch(shoppingCartItemID);
		}
		...
		{
			return Fetch(this.ShoppingCartItemID);
		}
		...
		{
			ShoppingCartItemDAO dao = DAOFactory.CreateShoppingCartItemDAO();
			bool wasSuccesful = dao.DeleteShoppingCartItem(base.Fields, base.Transaction, deleteRestriction);
			if(wasSuccesful)
			{
		...
		public bool TestOriginalFieldValueForNull(ShoppingCartItemFieldIndex fieldIndex)
		{
		...
		/// <summary>
		/// Event thrower for the ShoppingCartItemIDChanged event, which is thrown when ShoppingCartItemID changes value.
		/// Databinding related.
		/// </summary>
		protected virtual void OnShoppingCartItemIDChanged()
		{
			if(ShoppingCartItemIDChanged!=null)
			{
				ShoppingCartItemIDChanged(this, new EventArgs());
			}
		}
	
		/// <summary>
		/// Event thrower for the ShoppingCartIDChanged event, which is thrown when ShoppingCartID changes value.
		/// Databinding related.
		/// </summary>
		protected virtual void OnShoppingCartIDChanged()
		{
			if(ShoppingCartIDChanged!=null)
			{
				ShoppingCartIDChanged(this, new EventArgs());
			}
		}
		...
		/// <summary>
		/// Event thrower for the DateCreatedChanged event, which is thrown when DateCreated changes value.
		/// Databinding related.
		/// </summary>
		protected virtual void OnDateCreatedChanged()
		{
			if(DateCreatedChanged!=null)
			{
				DateCreatedChanged(this, new EventArgs());
			}
		}
		...
		{
			ShoppingCartItemDAO dao = DAOFactory.CreateShoppingCartItemDAO();
			return dao.AddShoppingCartItem(base.Fields, base.Transaction);
		}
		...
		{
			ShoppingCartItemDAO dao = DAOFactory.CreateShoppingCartItemDAO();
			return dao.UpdateShoppingCartItem(base.Fields, base.Transaction);
		}
		...
		{
			ShoppingCartItemDAO dao = DAOFactory.CreateShoppingCartItemDAO();
			return dao.UpdateShoppingCartItem(base.Fields, base.Transaction, updateRestriction);
		}
		...
		private void InitClassEmpty(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			...
			base.Fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ShoppingCartItemEntity);
			base.IsNew=true;
			base.EntityFactoryToUse = entityFactoryToUse;
			base.Validator = new ShoppingCartItemValidator();
		}
		...
		private void InitClassFetch(System.Int32 shoppingCartItemID, ShoppingCartItemValidator validator, IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			InitClassMembers(propertyDescriptorFactoryToUse, entityFactoryToUse);
			base.Fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ShoppingCartItemEntity);
			bool wasSuccesful = Fetch(shoppingCartItemID);
		...
		private void DesetupSyncProduct(bool signalRelatedEntity)
		{
			if(_product != null)
			{
				...
				{
					_product.UnsetRelatedEntity(this, "ShoppingCartItem");
				}
				base.UnsetEntitySyncInformation("Product", _product, ShoppingCartItemEntity.Relations.ProductEntityUsingProductID);
				_product = null;
			}
		}
		...
		private void SetupSyncProduct(IEntity relatedEntity)
		{
			...
			if(relatedEntity!=null)
			{
				...
				_product.AfterSave+=new EventHandler(OnEntityAfterSave);
				base.SetEntitySyncInformation("Product", _product, ShoppingCartItemEntity.Relations.ProductEntityUsingProductID);
				if(!_product.IsNew)
				{
					// sync now
					base.SyncFKFields(ShoppingCartItemEntity.Relations.ProductEntityUsingProductID, _product);
				}
			}
		...
		/// <param name="shoppingCartItemID">PK value for ShoppingCartItem which data should be fetched into this ShoppingCartItem object</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		private bool Fetch(System.Int32 shoppingCartItemID)
		{
			ShoppingCartItemDAO dao = DAOFactory.CreateShoppingCartItemDAO();

			// Load EntityFields of ShoppingCartItem
			dao.FetchShoppingCartItem(base.Fields, base.Transaction, shoppingCartItemID);
		...
		/// </summary>
		public static ShoppingCartItemRelations Relations
		{
			get	{ return new ShoppingCartItemRelations(); }
		}

	
		/// <summary>
		/// The ShoppingCartItemID property of the Entity ShoppingCartItem
		/// </summary>
		public virtual System.Int32 ShoppingCartItemID
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ShoppingCartItemFieldIndex.ShoppingCartItemID);
				if(valueToReturn == null)
				{
					throw new ORMFieldIsNullException("Cannot get the value for ShoppingCartItemID because it is set to NULL.");
				}
				return (System.Int32)valueToReturn;
			}
			set
			{
				if(base.SetNewFieldValue((int)ShoppingCartItemFieldIndex.ShoppingCartItemID, value))
				{
		...
		/// <summary>
		/// The ShoppingCartID property of the Entity ShoppingCartItem
		/// </summary>
		public virtual System.String ShoppingCartID
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ShoppingCartItemFieldIndex.ShoppingCartID);
				if(valueToReturn == null)
				{
					throw new ORMFieldIsNullException("Cannot get the value for ShoppingCartID because it is set to NULL.");
				}
				return (System.String)valueToReturn;
			}
			set
			{
				if(base.SetNewFieldValue((int)ShoppingCartItemFieldIndex.ShoppingCartID, value))
				{
		...
		/// <summary>
		/// The Quantity property of the Entity ShoppingCartItem
		/// </summary>
		public virtual System.Int32 Quantity
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ShoppingCartItemFieldIndex.Quantity);
				if(valueToReturn == null)
				{
			...
			set
			{
				if(base.SetNewFieldValue((int)ShoppingCartItemFieldIndex.Quantity, value))
				{
					OnQuantityChanged();
				}
			}
		...
		/// <summary>
		/// The ProductID property of the Entity ShoppingCartItem
		/// </summary>
		public virtual System.Int32 ProductID
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ShoppingCartItemFieldIndex.ProductID);
				if(valueToReturn == null)
				{
			...
			set
			{
				if(base.SetNewFieldValue((int)ShoppingCartItemFieldIndex.ProductID, value))
				{
					OnProductIDChanged();
				}
			}
		...
		public virtual System.DateTime DateCreated
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ShoppingCartItemFieldIndex.DateCreated);
				if(valueToReturn == null)
				{
					throw new ORMFieldIsNullException("Cannot get the value for DateCreated because it is set to NULL.");
				}
				return (System.DateTime)valueToReturn;
			}
			set
			{
				if(base.SetNewFieldValue((int)ShoppingCartItemFieldIndex.DateCreated, value))
				{
		...
		/// <summary>
		/// The ModifiedDate property of the Entity ShoppingCartItem
		/// </summary>
		public virtual System.DateTime ModifiedDate
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ShoppingCartItemFieldIndex.ModifiedDate);
				if(valueToReturn == null)
				{
			...
			set
			{
				if(base.SetNewFieldValue((int)ShoppingCartItemFieldIndex.ModifiedDate, value))
				{
			...
			set
			{
				...
				else
				{
					...
					else
					{
						...
						((IEntity)value).SetRelatedEntity(this, "ShoppingCartItem");
					}
				}
			}
		}
