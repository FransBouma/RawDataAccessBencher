...
{
	/// <summary>
	/// Entity class which represents the entity 'ProductDocument' in the 'AdventureWorks' database.
	/// </summary>
	[Serializable]
	public class ProductDocumentEntity : EntityBase, ISerializable
	{
		...
		{
			InitClassEmpty(new PropertyDescriptorFactory(), new ProductDocumentEntityFactory());
		}
		...
		{
			InitClassFetch(productID, documentID, new ProductDocumentValidator(), new PropertyDescriptorFactory(), new ProductDocumentEntityFactory());
		}
		...
		public ProductDocumentEntity(System.Int32 productID, System.Int32 documentID, ProductDocumentValidator validator)
		{
			InitClassFetch(productID, documentID, validator, new PropertyDescriptorFactory(), new ProductDocumentEntityFactory());
		}
		...
		public ProductDocumentEntity(System.Int32 productID, System.Int32 documentID, ProductDocumentValidator validator, IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			InitClassFetch(productID, documentID, validator, propertyDescriptorFactoryToUse, entityFactoryToUse);
		}
		...
		/// <param name="propertyDescriptorFactoryToUse">PropertyDescriptor factory to use in GetItemProperties method of contained collections. Complex databinding related.</param>
		/// <param name="entityFactoryToUse">The EntityFactory to use when creating entity objects during a GetMulti() call.</param>
		public ProductDocumentEntity(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
		...
		private ProductDocumentEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			return base.ToXml("ProductDocumentEntity");
		}
		...
		{
			return Fetch(productID, documentID);
		}
		...
		{
			return Fetch(this.ProductID, this.DocumentID);
		}
		...
		{
			ProductDocumentDAO dao = DAOFactory.CreateProductDocumentDAO();
			bool wasSuccesful = dao.DeleteProductDocument(base.Fields, base.Transaction, deleteRestriction);
			if(wasSuccesful)
			{
		...
		/// <summary>
		/// Retrieves the related entity of type 'DocumentEntity', using a relation of type 'n:1'
		/// </summary>
		/// <returns>A fetched entity of type 'DocumentEntity' which is related to this entity.</returns>
		public virtual DocumentEntity GetSingleDocument()
		{
		...
		public virtual DocumentEntity GetSingleDocument(bool forceFetch)
		{
 			if( ( !_alreadyFetchedDocument || forceFetch || _alwaysFetchDocument) && !base.IsSerializing && !base.IsDeserializing )
			{
				...
				newEntity.FetchUsingPK(this.DocumentID);
		...
		{
			ProductDocumentDAO dao = DAOFactory.CreateProductDocumentDAO();
			return dao.AddProductDocument(base.Fields, base.Transaction);
		}
		...
		{
			ProductDocumentDAO dao = DAOFactory.CreateProductDocumentDAO();
			return dao.UpdateProductDocument(base.Fields, base.Transaction);
		}
		...
		{
			ProductDocumentDAO dao = DAOFactory.CreateProductDocumentDAO();
			return dao.UpdateProductDocument(base.Fields, base.Transaction, updateRestriction);
		}
		...
		private void InitClassEmpty(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			...
			base.Fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductDocumentEntity);
			base.IsNew=true;
			base.EntityFactoryToUse = entityFactoryToUse;
			base.Validator = new ProductDocumentValidator();
		}
		...
		private void InitClassFetch(System.Int32 productID, System.Int32 documentID, ProductDocumentValidator validator, IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			InitClassMembers(propertyDescriptorFactoryToUse, entityFactoryToUse);
			base.Fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductDocumentEntity);
			bool wasSuccesful = Fetch(productID, documentID);
		...
		/// <summary>
		/// Removes the sync logic for member _document
		/// </summary>
		/// <param name="signalRelatedEntity">If set to true, it will call the related entity's UnsetRelatedEntity method</param>
		private void DesetupSyncDocument(bool signalRelatedEntity)
		{
			if(_document != null)
			{
				...
				base.UnsetEntitySyncInformation("Document", _document, ProductDocumentEntity.Relations.DocumentEntityUsingDocumentID);
				_document = null;
			}
		}
		...
		/// <summary>
		/// setups the sync logic for member _document
		/// </summary>
		/// <param name="relatedEntity">Instance to set as the related entity of type entityType</param>
		private void SetupSyncDocument(IEntity relatedEntity)
		{
			DesetupSyncDocument(true);
			
			if(relatedEntity!=null)
			{
				_document = (DocumentEntity)relatedEntity;
				_document.AfterSave+=new EventHandler(OnEntityAfterSave);
				base.SetEntitySyncInformation("Document", _document, ProductDocumentEntity.Relations.DocumentEntityUsingDocumentID);
				if(!_document.IsNew)
				{
					// sync now
					base.SyncFKFields(ProductDocumentEntity.Relations.DocumentEntityUsingDocumentID, _document);
				}
			}

			_alreadyFetchedDocument = (relatedEntity != null);
		}
		...
		private void DesetupSyncProduct(bool signalRelatedEntity)
		{
			if(_product != null)
			{
				...
				base.UnsetEntitySyncInformation("Product", _product, ProductDocumentEntity.Relations.ProductEntityUsingProductID);
				_product = null;
			}
		}
		...
		private void SetupSyncProduct(IEntity relatedEntity)
		{
			...
			if(relatedEntity!=null)
			{
				...
				_product.AfterSave+=new EventHandler(OnEntityAfterSave);
				base.SetEntitySyncInformation("Product", _product, ProductDocumentEntity.Relations.ProductEntityUsingProductID);
				if(!_product.IsNew)
				{
					// sync now
					base.SyncFKFields(ProductDocumentEntity.Relations.ProductEntityUsingProductID, _product);
				}
			}
		...
		/// <param name="documentID">PK value for ProductDocument which data should be fetched into this ProductDocument object</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		private bool Fetch(System.Int32 productID, System.Int32 documentID)
		{
			ProductDocumentDAO dao = DAOFactory.CreateProductDocumentDAO();

			// Load EntityFields of ProductDocument
			dao.FetchProductDocument(base.Fields, base.Transaction, productID, documentID);
		...
		/// <summary>
		/// The ProductID property of the Entity ProductDocument
		/// </summary>
		public virtual System.Int32 ProductID
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ProductDocumentFieldIndex.ProductID);
			...
			set
			{
				if(base.SetNewFieldValue((int)ProductDocumentFieldIndex.ProductID, value))
				{
					OnProductIDChanged();
				}
			}
		...
		/// <summary>
		/// The DocumentID property of the Entity ProductDocument
		/// </summary>
		public virtual System.Int32 DocumentID
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ProductDocumentFieldIndex.DocumentID);
				if(valueToReturn == null)
				{
			...
			set
			{
				if(base.SetNewFieldValue((int)ProductDocumentFieldIndex.DocumentID, value))
				{
					OnDocumentIDChanged();
				}
			}
		...
		/// <summary>
		/// The ModifiedDate property of the Entity ProductDocument
		/// </summary>
		public virtual System.DateTime ModifiedDate
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ProductDocumentFieldIndex.ModifiedDate);
				if(valueToReturn == null)
				{
			...
			set
			{
				if(base.SetNewFieldValue((int)ProductDocumentFieldIndex.ModifiedDate, value))
				{
		...
		/// <summary>
		/// Gets / sets related entity of type 'DocumentEntity'. This property is not visible in databinded grids.
		...
		/// a forced fetch by calling GetSingleDocument(true).
		/// </summary>
		[Browsable(false)]
