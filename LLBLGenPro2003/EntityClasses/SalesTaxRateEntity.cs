...
{
	/// <summary>
	/// Entity class which represents the entity 'SalesTaxRate' in the 'AdventureWorks' database.
	/// </summary>
	[Serializable]
	public class SalesTaxRateEntity : EntityBase, ISerializable
	{
		...
		/// <summary>
		/// Event which is thrown when SalesTaxRateID changes value. Databinding related.
		/// </summary>
		public event EventHandler SalesTaxRateIDChanged;
		...
		/// <summary>
		/// Event which is thrown when TaxType changes value. Databinding related.
		/// </summary>
		public event EventHandler TaxTypeChanged;

		/// <summary>
		/// Event which is thrown when TaxRate changes value. Databinding related.
		/// </summary>
		public event EventHandler TaxRateChanged;
		...
		{
			InitClassEmpty(new PropertyDescriptorFactory(), new SalesTaxRateEntityFactory());
		}
		...
		{
			InitClassFetch(salesTaxRateID, new SalesTaxRateValidator(), new PropertyDescriptorFactory(), new SalesTaxRateEntityFactory());
		}
		...
		public SalesTaxRateEntity(System.Int32 salesTaxRateID, SalesTaxRateValidator validator)
		{
			InitClassFetch(salesTaxRateID, validator, new PropertyDescriptorFactory(), new SalesTaxRateEntityFactory());
		}
		...
		public SalesTaxRateEntity(System.Int32 salesTaxRateID, SalesTaxRateValidator validator, IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			InitClassFetch(salesTaxRateID, validator, propertyDescriptorFactoryToUse, entityFactoryToUse);
		}
		...
		/// <param name="propertyDescriptorFactoryToUse">PropertyDescriptor factory to use in GetItemProperties method of contained collections. Complex databinding related.</param>
		/// <param name="entityFactoryToUse">The EntityFactory to use when creating entity objects during a GetMulti() call.</param>
		public SalesTaxRateEntity(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
		...
		private SalesTaxRateEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			return base.ToXml("SalesTaxRateEntity");
		}
		...
		{
			return Fetch(this.SalesTaxRateID);
		}
		...
		public override bool Delete(IPredicate deleteRestriction)
		{
			...
			bool wasSuccesful = dao.DeleteSalesTaxRate(base.Fields, base.Transaction, deleteRestriction);
			if(wasSuccesful)
			{
		...
		/// <summary>
		/// Event thrower for the SalesTaxRateIDChanged event, which is thrown when SalesTaxRateID changes value.
		/// Databinding related.
		/// </summary>
		protected virtual void OnSalesTaxRateIDChanged()
		{
			if(SalesTaxRateIDChanged!=null)
			{
				SalesTaxRateIDChanged(this, new EventArgs());
			}
		}
		...
		/// <summary>
		/// Event thrower for the TaxTypeChanged event, which is thrown when TaxType changes value.
		/// Databinding related.
		/// </summary>
		protected virtual void OnTaxTypeChanged()
		{
			if(TaxTypeChanged!=null)
			{
				TaxTypeChanged(this, new EventArgs());
			}
		}
	
		/// <summary>
		/// Event thrower for the TaxRateChanged event, which is thrown when TaxRate changes value.
		/// Databinding related.
		/// </summary>
		protected virtual void OnTaxRateChanged()
		{
			if(TaxRateChanged!=null)
			{
				TaxRateChanged(this, new EventArgs());
			}
		}
		...
		{
			SalesTaxRateDAO dao = DAOFactory.CreateSalesTaxRateDAO();
			return dao.AddSalesTaxRate(base.Fields, base.Transaction);
		}
		...
		{
			SalesTaxRateDAO dao = DAOFactory.CreateSalesTaxRateDAO();
			return dao.UpdateSalesTaxRate(base.Fields, base.Transaction);
		}
		...
		{
			SalesTaxRateDAO dao = DAOFactory.CreateSalesTaxRateDAO();
			return dao.UpdateSalesTaxRate(base.Fields, base.Transaction, updateRestriction);
		}
		...
		private void InitClassEmpty(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			...
			base.Fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.SalesTaxRateEntity);
			base.IsNew=true;
			base.EntityFactoryToUse = entityFactoryToUse;
			base.Validator = new SalesTaxRateValidator();
		}
		...
		private void InitClassFetch(System.Int32 salesTaxRateID, SalesTaxRateValidator validator, IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			InitClassMembers(propertyDescriptorFactoryToUse, entityFactoryToUse);
			base.Fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.SalesTaxRateEntity);
			bool wasSuccesful = Fetch(salesTaxRateID);
		...
		private void DesetupSyncStateProvince(bool signalRelatedEntity)
		{
			if(_stateProvince != null)
			{
				...
				base.UnsetEntitySyncInformation("StateProvince", _stateProvince, SalesTaxRateEntity.Relations.StateProvinceEntityUsingStateProvinceID);
				_stateProvince = null;
			}
		}
		...
		private void SetupSyncStateProvince(IEntity relatedEntity)
		{
			...
			if(relatedEntity!=null)
			{
				...
				_stateProvince.AfterSave+=new EventHandler(OnEntityAfterSave);
				base.SetEntitySyncInformation("StateProvince", _stateProvince, SalesTaxRateEntity.Relations.StateProvinceEntityUsingStateProvinceID);
				if(!_stateProvince.IsNew)
				{
					// sync now
					base.SyncFKFields(SalesTaxRateEntity.Relations.StateProvinceEntityUsingStateProvinceID, _stateProvince);
				}
			}
		...
		/// <param name="salesTaxRateID">PK value for SalesTaxRate which data should be fetched into this SalesTaxRate object</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		private bool Fetch(System.Int32 salesTaxRateID)
		{
			SalesTaxRateDAO dao = DAOFactory.CreateSalesTaxRateDAO();

			// Load EntityFields of SalesTaxRate
			dao.FetchSalesTaxRate(base.Fields, base.Transaction, salesTaxRateID);
		...
		/// <summary>
		/// The SalesTaxRateID property of the Entity SalesTaxRate
		/// </summary>
		public virtual System.Int32 SalesTaxRateID
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)SalesTaxRateFieldIndex.SalesTaxRateID);
				if(valueToReturn == null)
				{
					throw new ORMFieldIsNullException("Cannot get the value for SalesTaxRateID because it is set to NULL.");
				}
				return (System.Int32)valueToReturn;
			}
			set
			{
				if(base.SetNewFieldValue((int)SalesTaxRateFieldIndex.SalesTaxRateID, value))
				{
		...
		/// <summary>
		/// The StateProvinceID property of the Entity SalesTaxRate
		/// </summary>
		public virtual System.Int32 StateProvinceID
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)SalesTaxRateFieldIndex.StateProvinceID);
				if(valueToReturn == null)
				{
			...
			set
			{
				if(base.SetNewFieldValue((int)SalesTaxRateFieldIndex.StateProvinceID, value))
				{
		...
		/// <summary>
		/// The TaxType property of the Entity SalesTaxRate
		/// </summary>
		public virtual System.Byte TaxType
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)SalesTaxRateFieldIndex.TaxType);
				if(valueToReturn == null)
				{
					throw new ORMFieldIsNullException("Cannot get the value for TaxType because it is set to NULL.");
				}
				return (System.Byte)valueToReturn;
			}
			set
			{
				if(base.SetNewFieldValue((int)SalesTaxRateFieldIndex.TaxType, value))
				{
					OnTaxTypeChanged();
				}
			}
		...
		/// <summary>
		/// The TaxRate property of the Entity SalesTaxRate
		/// </summary>
		public virtual System.Decimal TaxRate
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)SalesTaxRateFieldIndex.TaxRate);
				if(valueToReturn == null)
				{
					throw new ORMFieldIsNullException("Cannot get the value for TaxRate because it is set to NULL.");
				}
				return (System.Decimal)valueToReturn;
			}
			set
			{
				if(base.SetNewFieldValue((int)SalesTaxRateFieldIndex.TaxRate, value))
				{
					OnTaxRateChanged();
				}
			}
		...
		/// <summary>
		/// The Name property of the Entity SalesTaxRate
		/// </summary>
		public virtual System.String Name
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)SalesTaxRateFieldIndex.Name);
				if(valueToReturn == null)
				{
			...
			set
			{
				if(base.SetNewFieldValue((int)SalesTaxRateFieldIndex.Name, value))
				{
					OnNameChanged();
				}
			}
		...
		/// <summary>
		/// The Rowguid property of the Entity SalesTaxRate
		/// </summary>
		public virtual System.Guid Rowguid
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)SalesTaxRateFieldIndex.Rowguid);
				if(valueToReturn == null)
				{
			...
			set
			{
				if(base.SetNewFieldValue((int)SalesTaxRateFieldIndex.Rowguid, value))
				{
					OnRowguidChanged();
				}
			}
		...
		/// <summary>
		/// The ModifiedDate property of the Entity SalesTaxRate
		/// </summary>
		public virtual System.DateTime ModifiedDate
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)SalesTaxRateFieldIndex.ModifiedDate);
				if(valueToReturn == null)
				{
			...
			set
			{
				if(base.SetNewFieldValue((int)SalesTaxRateFieldIndex.ModifiedDate, value))
				{
