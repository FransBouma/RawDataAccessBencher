...
{
	/// <summary>
	/// Entity class which represents the entity 'EmployeeAddress' in the 'AdventureWorks' database.
	/// </summary>
	[Serializable]
	public class EmployeeAddressEntity : EntityBase, ISerializable
	{
		...
		{
			InitClassEmpty(new PropertyDescriptorFactory(), new EmployeeAddressEntityFactory());
		}
		...
		{
			InitClassFetch(employeeID, addressID, new EmployeeAddressValidator(), new PropertyDescriptorFactory(), new EmployeeAddressEntityFactory());
		}
		...
		public EmployeeAddressEntity(System.Int32 employeeID, System.Int32 addressID, EmployeeAddressValidator validator)
		{
			InitClassFetch(employeeID, addressID, validator, new PropertyDescriptorFactory(), new EmployeeAddressEntityFactory());
		}
		...
		public EmployeeAddressEntity(System.Int32 employeeID, System.Int32 addressID, EmployeeAddressValidator validator, IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			InitClassFetch(employeeID, addressID, validator, propertyDescriptorFactoryToUse, entityFactoryToUse);
		}
		...
		/// <param name="propertyDescriptorFactoryToUse">PropertyDescriptor factory to use in GetItemProperties method of contained collections. Complex databinding related.</param>
		/// <param name="entityFactoryToUse">The EntityFactory to use when creating entity objects during a GetMulti() call.</param>
		public EmployeeAddressEntity(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
		...
		private EmployeeAddressEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			return base.ToXml("EmployeeAddressEntity");
		}
		...
		{
			return Fetch(employeeID, addressID);
		}
		...
		{
			return Fetch(this.EmployeeID, this.AddressID);
		}
		...
		public override bool Delete(IPredicate deleteRestriction)
		{
			...
			bool wasSuccesful = dao.DeleteEmployeeAddress(base.Fields, base.Transaction, deleteRestriction);
			if(wasSuccesful)
			{
		...
		{
			EmployeeAddressDAO dao = DAOFactory.CreateEmployeeAddressDAO();
			return dao.AddEmployeeAddress(base.Fields, base.Transaction);
		}
		...
		{
			EmployeeAddressDAO dao = DAOFactory.CreateEmployeeAddressDAO();
			return dao.UpdateEmployeeAddress(base.Fields, base.Transaction);
		}
		...
		{
			EmployeeAddressDAO dao = DAOFactory.CreateEmployeeAddressDAO();
			return dao.UpdateEmployeeAddress(base.Fields, base.Transaction, updateRestriction);
		}
		...
		private void InitClassEmpty(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			...
			base.Fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.EmployeeAddressEntity);
			base.IsNew=true;
			base.EntityFactoryToUse = entityFactoryToUse;
			base.Validator = new EmployeeAddressValidator();
		}
		...
		private void InitClassFetch(System.Int32 employeeID, System.Int32 addressID, EmployeeAddressValidator validator, IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			InitClassMembers(propertyDescriptorFactoryToUse, entityFactoryToUse);
			base.Fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.EmployeeAddressEntity);
			bool wasSuccesful = Fetch(employeeID, addressID);
		...
		private void SetupSyncAddress(IEntity relatedEntity)
		{
			...
			if(relatedEntity!=null)
			{
				...
				{
					// sync now
					base.SyncFKFields(EmployeeAddressEntity.Relations.AddressEntityUsingAddressID, _address);
				}
			}
		...
		private void SetupSyncEmployee(IEntity relatedEntity)
		{
			...
			if(relatedEntity!=null)
			{
				...
				{
					// sync now
					base.SyncFKFields(EmployeeAddressEntity.Relations.EmployeeEntityUsingEmployeeID, _employee);
				}
			}
		...
		/// <param name="addressID">PK value for EmployeeAddress which data should be fetched into this EmployeeAddress object</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		private bool Fetch(System.Int32 employeeID, System.Int32 addressID)
		{
			EmployeeAddressDAO dao = DAOFactory.CreateEmployeeAddressDAO();

			// Load EntityFields of EmployeeAddress
			dao.FetchEmployeeAddress(base.Fields, base.Transaction, employeeID, addressID);
		...
		/// <summary>
		/// The EmployeeID property of the Entity EmployeeAddress
		/// </summary>
		public virtual System.Int32 EmployeeID
		{
			...
			set
			{
				if(base.SetNewFieldValue((int)EmployeeAddressFieldIndex.EmployeeID, value))
				{
					OnEmployeeIDChanged();
				}
			}
		...
		/// <summary>
		/// The AddressID property of the Entity EmployeeAddress
		/// </summary>
		public virtual System.Int32 AddressID
		{
			...
			set
			{
				if(base.SetNewFieldValue((int)EmployeeAddressFieldIndex.AddressID, value))
				{
					OnAddressIDChanged();
				}
			}
		...
		/// <summary>
		/// The Rowguid property of the Entity EmployeeAddress
		/// </summary>
		public virtual System.Guid Rowguid
		{
			...
			set
			{
				if(base.SetNewFieldValue((int)EmployeeAddressFieldIndex.Rowguid, value))
				{
					OnRowguidChanged();
				}
			}
		...
		/// <summary>
		/// The ModifiedDate property of the Entity EmployeeAddress
		/// </summary>
		public virtual System.DateTime ModifiedDate
		{
			...
			set
			{
				if(base.SetNewFieldValue((int)EmployeeAddressFieldIndex.ModifiedDate, value))
				{
