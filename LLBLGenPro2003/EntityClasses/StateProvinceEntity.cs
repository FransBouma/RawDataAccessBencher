...
{
	/// <summary>
	/// Entity class which represents the entity 'StateProvince' in the 'AdventureWorks' database.
	/// </summary>
	[Serializable]
	public class StateProvinceEntity : EntityBase, ISerializable
	{
		#region Class Member Declarations
		private AddressCollection	_address;
		private bool	_alwaysFetchAddress, _alreadyFetchedAddress;
		private SalesTaxRateCollection	_salesTaxRate;
		...
		/// <summary>
		/// Event which is thrown when StateProvinceCode changes value. Databinding related.
		/// </summary>
		...
		/// <summary>
		/// Event which is thrown when IsOnlyStateProvinceFlag changes value. Databinding related.
		/// </summary>
		...
		{
			InitClassEmpty(new PropertyDescriptorFactory(), new StateProvinceEntityFactory());
		}
		...
		{
			InitClassFetch(stateProvinceID, new StateProvinceValidator(), new PropertyDescriptorFactory(), new StateProvinceEntityFactory());
		}
		...
		{
			InitClassFetch(stateProvinceID, validator, new PropertyDescriptorFactory(), new StateProvinceEntityFactory());
		}
		...
		{
			InitClassFetch(stateProvinceID, validator, propertyDescriptorFactoryToUse, entityFactoryToUse);
		}
		...
		private StateProvinceEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			...
			_salesTaxRate = (SalesTaxRateCollection)info.GetValue("_salesTaxRate", typeof(SalesTaxRateCollection));
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			...
			info.AddValue("_salesTaxRate", _salesTaxRate);
		...
		public override void SetRelatedEntity(IEntity relatedEntity, string fieldName)
		{
			switch(fieldName)
			{
				...
				case "SalesTaxRate":
					// add it to the collection as well. If it's already present, the Add() will not add it again.
					_salesTaxRate.Add(relatedEntity);
					break;
		...
		public override void UnsetRelatedEntity(IEntity relatedEntity, string fieldName)
		{
			switch(fieldName)
			{
				...
				case "SalesTaxRate":
					// Remove it from the collection.
					_salesTaxRate.Remove(relatedEntity);
					break;
		...
		{
			return base.ToXml("StateProvinceEntity");
		}
		...
		{
			return Fetch(this.StateProvinceID);
		}
		...
		public override bool Delete(IPredicate deleteRestriction)
		{
			...
			bool wasSuccesful = dao.DeleteStateProvince(base.Fields, base.Transaction, deleteRestriction);
			if(wasSuccesful)
			{
		...
		/// <summary>
		/// Retrieves all related entities of type 'AddressEntity' using a relation of type '1:n'.
		/// </summary>
		...
		public virtual AddressCollection GetMultiAddress(bool forceFetch)
		{
 			if( ( !_alreadyFetchedAddress || forceFetch || _alwaysFetchAddress) && !base.IsSerializing && !base.IsDeserializing )
			{
				...
				_address.GetMultiManyToOne(this);
		...
		/// <returns>Filled collection with all related entities of type 'AddressEntity'</returns>
		public virtual AddressCollection GetMultiAddress(bool forceFetch, IPredicateExpression filter)
		{
 			if( ( !_alreadyFetchedAddress || forceFetch || _alwaysFetchAddress) && !base.IsSerializing && !base.IsDeserializing )
			{
				// refetch it.
		...
		/// <param name="filter">Extra filter to limit the resultset.</param>
		/// <returns>Filled collection with all related entities of the type constructed by the passed in entity factory</returns>
		public virtual AddressCollection GetMultiAddress(bool forceFetch, IEntityFactory entityFactoryToUse, IPredicateExpression filter)
		{
 			if( ( !_alreadyFetchedAddress || forceFetch || _alwaysFetchAddress) && !base.IsSerializing && !base.IsDeserializing )
			{
				// refetch it.
		...
		/// <summary>
		/// Retrieves all related entities of type 'SalesTaxRateEntity' using a relation of type '1:n'.
		/// </summary>
		/// <param name="forceFetch">if true, it will discard any changes currently in the collection and will rerun the complete query instead</param>
		/// <returns>Filled collection with all related entities of type 'SalesTaxRateEntity'</returns>
		public virtual SalesTaxRateCollection GetMultiSalesTaxRate(bool forceFetch)
		{
 			if( ( !_alreadyFetchedSalesTaxRate || forceFetch || _alwaysFetchSalesTaxRate) && !base.IsSerializing && !base.IsDeserializing )
			{
				// refetch it.
				if(base.ParticipatesInTransaction)
				{
				...
				_salesTaxRate.GetMultiManyToOne(this);
		...
		/// <param name="filter">Extra filter to limit the resultset.</param>
		/// <returns>Filled collection with all related entities of type 'SalesTaxRateEntity'</returns>
		public virtual SalesTaxRateCollection GetMultiSalesTaxRate(bool forceFetch, IPredicateExpression filter)
		{
 			if( ( !_alreadyFetchedSalesTaxRate || forceFetch || _alwaysFetchSalesTaxRate) && !base.IsSerializing && !base.IsDeserializing )
			{
				// refetch it.
		...
		/// <param name="entityFactoryToUse">The entity factory to use for the GetMultiManyToOne() routine.</param>
		/// <returns>Filled collection with all related entities of the type constructed by the passed in entity factory</returns>
		public virtual SalesTaxRateCollection GetMultiSalesTaxRate(bool forceFetch, IEntityFactory entityFactoryToUse)
		{
 			if( ( !_alreadyFetchedSalesTaxRate || forceFetch || _alwaysFetchSalesTaxRate) && !base.IsSerializing && !base.IsDeserializing )
			{
				// refetch it.
		...
		/// <param name="filter">Extra filter to limit the resultset.</param>
		/// <returns>Filled collection with all related entities of the type constructed by the passed in entity factory</returns>
		public virtual SalesTaxRateCollection GetMultiSalesTaxRate(bool forceFetch, IEntityFactory entityFactoryToUse, IPredicateExpression filter)
		{
 			if( ( !_alreadyFetchedSalesTaxRate || forceFetch || _alwaysFetchSalesTaxRate) && !base.IsSerializing && !base.IsDeserializing )
			{
				// refetch it.
		...
		/// <summary>
		/// Sets the collection parameters for the collection for 'SalesTaxRate'. These settings will be taken into account
		/// when the property SalesTaxRate is requested or GetMultiSalesTaxRate is called.
		/// </summary>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return. When set to 0, this parameter is ignored</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified (null), no sorting is applied.</param>
		...
		/// <summary>
		/// Event thrower for the StateProvinceCodeChanged event, which is thrown when StateProvinceCode changes value.
		/// Databinding related.
		/// </summary>
		...
		/// <summary>
		/// Event thrower for the IsOnlyStateProvinceFlagChanged event, which is thrown when IsOnlyStateProvinceFlag changes value.
		/// Databinding related.
		/// </summary>
		...
		{
			StateProvinceDAO dao = DAOFactory.CreateStateProvinceDAO();
			return dao.AddStateProvince(base.Fields, base.Transaction);
		}
		...
		{
			StateProvinceDAO dao = DAOFactory.CreateStateProvinceDAO();
			return dao.UpdateStateProvince(base.Fields, base.Transaction);
		}
		...
		{
			StateProvinceDAO dao = DAOFactory.CreateStateProvinceDAO();
			return dao.UpdateStateProvince(base.Fields, base.Transaction, updateRestriction);
		}
		...
		private void InitClassEmpty(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			...
			base.Fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.StateProvinceEntity);
			base.IsNew=true;
			base.EntityFactoryToUse = entityFactoryToUse;
			base.Validator = new StateProvinceValidator();
		}
		...
		private void InitClassFetch(System.Int32 stateProvinceID, StateProvinceValidator validator, IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			InitClassMembers(propertyDescriptorFactoryToUse, entityFactoryToUse);
			base.Fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.StateProvinceEntity);
			bool wasSuccesful = Fetch(stateProvinceID);
		...
		private void InitClassMembers(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			...
			_salesTaxRate = new SalesTaxRateCollection(propertyDescriptorFactoryToUse, new SalesTaxRateEntityFactory());
		...
		private void SetupSyncCountryRegion(IEntity relatedEntity)
		{
			...
			if(relatedEntity!=null)
			{
				...
				{
					// sync now
					base.SyncFKFields(StateProvinceEntity.Relations.CountryRegionEntityUsingCountryRegionCode, _countryRegion);
				}
			}
		...
		private void DesetupSyncSalesTerritory(bool signalRelatedEntity)
		{
			if(_salesTerritory != null)
			{
				...
				base.UnsetEntitySyncInformation("SalesTerritory", _salesTerritory, StateProvinceEntity.Relations.SalesTerritoryEntityUsingTerritoryID);
				_salesTerritory = null;
			}
		}
		...
		private void SetupSyncSalesTerritory(IEntity relatedEntity)
		{
			...
			if(relatedEntity!=null)
			{
				...
				_salesTerritory.AfterSave+=new EventHandler(OnEntityAfterSave);
				base.SetEntitySyncInformation("SalesTerritory", _salesTerritory, StateProvinceEntity.Relations.SalesTerritoryEntityUsingTerritoryID);
				if(!_salesTerritory.IsNew)
				{
					// sync now
					base.SyncFKFields(StateProvinceEntity.Relations.SalesTerritoryEntityUsingTerritoryID, _salesTerritory);
				}
			}
		...
		/// <param name="stateProvinceID">PK value for StateProvince which data should be fetched into this StateProvince object</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		private bool Fetch(System.Int32 stateProvinceID)
		{
			StateProvinceDAO dao = DAOFactory.CreateStateProvinceDAO();

			// Load EntityFields of StateProvince
			dao.FetchStateProvince(base.Fields, base.Transaction, stateProvinceID);
		...
		/// <summary>
		/// The StateProvinceID property of the Entity StateProvince
		/// </summary>
		public virtual System.Int32 StateProvinceID
		{
			...
			set
			{
				if(base.SetNewFieldValue((int)StateProvinceFieldIndex.StateProvinceID, value))
				{
		...
		/// <summary>
		/// The StateProvinceCode property of the Entity StateProvince
		/// </summary>
		public virtual System.String StateProvinceCode
		{
			get
			{
				...
				if(valueToReturn == null)
				{
					throw new ORMFieldIsNullException("Cannot get the value for StateProvinceCode because it is set to NULL.");
				}
				return (System.String)valueToReturn;
			}
			set
			{
				if(base.SetNewFieldValue((int)StateProvinceFieldIndex.StateProvinceCode, value))
				{
		...
		public virtual System.String CountryRegionCode
		{
			...
			set
			{
				if(base.SetNewFieldValue((int)StateProvinceFieldIndex.CountryRegionCode, value))
				{
		...
		/// <summary>
		/// The IsOnlyStateProvinceFlag property of the Entity StateProvince
		/// </summary>
		public virtual System.Boolean IsOnlyStateProvinceFlag
		{
			get
			{
				...
				if(valueToReturn == null)
				{
					throw new ORMFieldIsNullException("Cannot get the value for IsOnlyStateProvinceFlag because it is set to NULL.");
				}
				return (System.Boolean)valueToReturn;
			}
			set
			{
				if(base.SetNewFieldValue((int)StateProvinceFieldIndex.IsOnlyStateProvinceFlag, value))
				{
		...
		/// <summary>
		/// The Name property of the Entity StateProvince
		/// </summary>
		public virtual System.String Name
		{
			...
			set
			{
				if(base.SetNewFieldValue((int)StateProvinceFieldIndex.Name, value))
				{
					OnNameChanged();
				}
			}
		...
		/// <summary>
		/// The TerritoryID property of the Entity StateProvince
		/// </summary>
		public virtual System.Int32 TerritoryID
		{
			...
			set
			{
				if(base.SetNewFieldValue((int)StateProvinceFieldIndex.TerritoryID, value))
				{
		...
		/// <summary>
		/// The Rowguid property of the Entity StateProvince
		/// </summary>
		public virtual System.Guid Rowguid
		{
			...
			set
			{
				if(base.SetNewFieldValue((int)StateProvinceFieldIndex.Rowguid, value))
				{
					OnRowguidChanged();
				}
			}
		...
		/// <summary>
		/// The ModifiedDate property of the Entity StateProvince
		/// </summary>
		public virtual System.DateTime ModifiedDate
		{
			...
			set
			{
				if(base.SetNewFieldValue((int)StateProvinceFieldIndex.ModifiedDate, value))
				{
		...
		/// this property is rather expensive and a method tells the user to cache the result when it has to be used more than once in the
		/// same scope.</remarks>
		public virtual SalesTaxRateCollection SalesTaxRate
		{
			get
			{
				return GetMultiSalesTaxRate(false);
			}
		}

		/// <summary>
		/// Gets / sets the lazy loading flag for SalesTaxRate. When set to true, SalesTaxRate is always refetched from the 
		...
		/// a forced fetch by calling GetMultiSalesTaxRate(true).
		/// </summary>
		[Browsable(false)]
		public bool AlwaysFetchSalesTaxRate
		{
			get
			{
				return _alwaysFetchSalesTaxRate;
			}
			set
			{
				_alwaysFetchSalesTaxRate = value;
			}	
		}
