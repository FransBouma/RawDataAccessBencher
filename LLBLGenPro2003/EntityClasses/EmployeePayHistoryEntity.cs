...
{
	/// <summary>
	/// Entity class which represents the entity 'EmployeePayHistory' in the 'AdventureWorks' database.
	/// </summary>
	[Serializable]
	public class EmployeePayHistoryEntity : EntityBase, ISerializable
	{
		...
		/// <summary>
		/// Event which is thrown when RateChangeDate changes value. Databinding related.
		/// </summary>
		public event EventHandler RateChangeDateChanged;

		/// <summary>
		/// Event which is thrown when Rate changes value. Databinding related.
		/// </summary>
		public event EventHandler RateChanged;

		/// <summary>
		/// Event which is thrown when PayFrequency changes value. Databinding related.
		/// </summary>
		public event EventHandler PayFrequencyChanged;
		...
		{
			InitClassEmpty(new PropertyDescriptorFactory(), new EmployeePayHistoryEntityFactory());
		}
		...
		{
			InitClassFetch(employeeID, rateChangeDate, new EmployeePayHistoryValidator(), new PropertyDescriptorFactory(), new EmployeePayHistoryEntityFactory());
		}
		...
		public EmployeePayHistoryEntity(System.Int32 employeeID, System.DateTime rateChangeDate, EmployeePayHistoryValidator validator)
		{
			InitClassFetch(employeeID, rateChangeDate, validator, new PropertyDescriptorFactory(), new EmployeePayHistoryEntityFactory());
		}
		...
		public EmployeePayHistoryEntity(System.Int32 employeeID, System.DateTime rateChangeDate, EmployeePayHistoryValidator validator, IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			InitClassFetch(employeeID, rateChangeDate, validator, propertyDescriptorFactoryToUse, entityFactoryToUse);
		}
		...
		/// <param name="propertyDescriptorFactoryToUse">PropertyDescriptor factory to use in GetItemProperties method of contained collections. Complex databinding related.</param>
		/// <param name="entityFactoryToUse">The EntityFactory to use when creating entity objects during a GetMulti() call.</param>
		public EmployeePayHistoryEntity(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
		...
		private EmployeePayHistoryEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			return base.ToXml("EmployeePayHistoryEntity");
		}
		...
		{
			return Fetch(employeeID, rateChangeDate);
		}
		...
		{
			return Fetch(this.EmployeeID, this.RateChangeDate);
		}
		...
		{
			EmployeePayHistoryDAO dao = DAOFactory.CreateEmployeePayHistoryDAO();
			bool wasSuccesful = dao.DeleteEmployeePayHistory(base.Fields, base.Transaction, deleteRestriction);
			if(wasSuccesful)
			{
		...
		public bool TestOriginalFieldValueForNull(EmployeePayHistoryFieldIndex fieldIndex)
		{
		...
		/// <summary>
		/// Event thrower for the RateChangeDateChanged event, which is thrown when RateChangeDate changes value.
		/// Databinding related.
		/// </summary>
		protected virtual void OnRateChangeDateChanged()
		{
			if(RateChangeDateChanged!=null)
			{
				RateChangeDateChanged(this, new EventArgs());
			}
		}
	
		/// <summary>
		/// Event thrower for the RateChanged event, which is thrown when Rate changes value.
		/// Databinding related.
		/// </summary>
		...
		/// <summary>
		/// Event thrower for the PayFrequencyChanged event, which is thrown when PayFrequency changes value.
		/// Databinding related.
		/// </summary>
		protected virtual void OnPayFrequencyChanged()
		{
			if(PayFrequencyChanged!=null)
			{
				PayFrequencyChanged(this, new EventArgs());
			}
		}
		...
		{
			EmployeePayHistoryDAO dao = DAOFactory.CreateEmployeePayHistoryDAO();
			return dao.AddEmployeePayHistory(base.Fields, base.Transaction);
		}
		...
		{
			EmployeePayHistoryDAO dao = DAOFactory.CreateEmployeePayHistoryDAO();
			return dao.UpdateEmployeePayHistory(base.Fields, base.Transaction);
		}
		...
		{
			EmployeePayHistoryDAO dao = DAOFactory.CreateEmployeePayHistoryDAO();
			return dao.UpdateEmployeePayHistory(base.Fields, base.Transaction, updateRestriction);
		}
		...
		private void InitClassEmpty(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			...
			base.Fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.EmployeePayHistoryEntity);
			base.IsNew=true;
			base.EntityFactoryToUse = entityFactoryToUse;
			base.Validator = new EmployeePayHistoryValidator();
		}
		...
		private void InitClassFetch(System.Int32 employeeID, System.DateTime rateChangeDate, EmployeePayHistoryValidator validator, IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			InitClassMembers(propertyDescriptorFactoryToUse, entityFactoryToUse);
			base.Fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.EmployeePayHistoryEntity);
			bool wasSuccesful = Fetch(employeeID, rateChangeDate);
		...
		private void DesetupSyncEmployee(bool signalRelatedEntity)
		{
			if(_employee != null)
			{
				...
				{
					_employee.UnsetRelatedEntity(this, "EmployeePayHistory");
				}
				base.UnsetEntitySyncInformation("Employee", _employee, EmployeePayHistoryEntity.Relations.EmployeeEntityUsingEmployeeID);
				_employee = null;
			}
		}
		...
		private void SetupSyncEmployee(IEntity relatedEntity)
		{
			...
			if(relatedEntity!=null)
			{
				...
				_employee.AfterSave+=new EventHandler(OnEntityAfterSave);
				base.SetEntitySyncInformation("Employee", _employee, EmployeePayHistoryEntity.Relations.EmployeeEntityUsingEmployeeID);
				if(!_employee.IsNew)
				{
					// sync now
					base.SyncFKFields(EmployeePayHistoryEntity.Relations.EmployeeEntityUsingEmployeeID, _employee);
				}
			}
		...
		/// <param name="rateChangeDate">PK value for EmployeePayHistory which data should be fetched into this EmployeePayHistory object</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		private bool Fetch(System.Int32 employeeID, System.DateTime rateChangeDate)
		{
			EmployeePayHistoryDAO dao = DAOFactory.CreateEmployeePayHistoryDAO();

			// Load EntityFields of EmployeePayHistory
			dao.FetchEmployeePayHistory(base.Fields, base.Transaction, employeeID, rateChangeDate);
		...
		public virtual System.Int32 EmployeeID
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)EmployeePayHistoryFieldIndex.EmployeeID);
			...
			set
			{
				if(base.SetNewFieldValue((int)EmployeePayHistoryFieldIndex.EmployeeID, value))
				{
					OnEmployeeIDChanged();
				}
			}
		...
		/// <summary>
		/// The RateChangeDate property of the Entity EmployeePayHistory
		/// </summary>
		public virtual System.DateTime RateChangeDate
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)EmployeePayHistoryFieldIndex.RateChangeDate);
				if(valueToReturn == null)
				{
					throw new ORMFieldIsNullException("Cannot get the value for RateChangeDate because it is set to NULL.");
				}
				return (System.DateTime)valueToReturn;
			}
			set
			{
				if(base.SetNewFieldValue((int)EmployeePayHistoryFieldIndex.RateChangeDate, value))
				{
		...
		/// <summary>
		/// The Rate property of the Entity EmployeePayHistory
		/// </summary>
		public virtual System.Decimal Rate
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)EmployeePayHistoryFieldIndex.Rate);
				if(valueToReturn == null)
				{
					throw new ORMFieldIsNullException("Cannot get the value for Rate because it is set to NULL.");
				}
				return (System.Decimal)valueToReturn;
			}
			set
			{
				if(base.SetNewFieldValue((int)EmployeePayHistoryFieldIndex.Rate, value))
				{
					OnRateChanged();
				}
			}
		...
		/// <summary>
		/// The PayFrequency property of the Entity EmployeePayHistory
		/// </summary>
		public virtual System.Byte PayFrequency
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)EmployeePayHistoryFieldIndex.PayFrequency);
				if(valueToReturn == null)
				{
					throw new ORMFieldIsNullException("Cannot get the value for PayFrequency because it is set to NULL.");
				}
				return (System.Byte)valueToReturn;
			}
			set
			{
				if(base.SetNewFieldValue((int)EmployeePayHistoryFieldIndex.PayFrequency, value))
				{
		...
		/// <summary>
		/// The ModifiedDate property of the Entity EmployeePayHistory
		/// </summary>
		public virtual System.DateTime ModifiedDate
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)EmployeePayHistoryFieldIndex.ModifiedDate);
				if(valueToReturn == null)
				{
			...
			set
			{
				if(base.SetNewFieldValue((int)EmployeePayHistoryFieldIndex.ModifiedDate, value))
				{
			...
			set
			{
				...
				else
				{
					...
					else
					{
						...
						((IEntity)value).SetRelatedEntity(this, "EmployeePayHistory");
					}
				}
			}
		}
