...
{
	/// <summary>
	/// Entity class which represents the entity 'Individual' in the 'AdventureWorks' database.
	/// </summary>
	[Serializable]
	public class IndividualEntity : EntityBase, ISerializable
	{
		...
		{
			InitClassEmpty(new PropertyDescriptorFactory(), new IndividualEntityFactory());
		}
		...
		{
			InitClassFetch(customerID, new IndividualValidator(), new PropertyDescriptorFactory(), new IndividualEntityFactory());
		}
		...
		{
			InitClassFetch(customerID, validator, new PropertyDescriptorFactory(), new IndividualEntityFactory());
		}
		...
		private IndividualEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			return base.ToXml("IndividualEntity");
		}
		...
		public override bool Delete(IPredicate deleteRestriction)
		{
			...
			bool wasSuccesful = dao.DeleteIndividual(base.Fields, base.Transaction, deleteRestriction);
			if(wasSuccesful)
			{
		...
		{
			IndividualDAO dao = DAOFactory.CreateIndividualDAO();
			return dao.AddIndividual(base.Fields, base.Transaction);
		}
		...
		{
			IndividualDAO dao = DAOFactory.CreateIndividualDAO();
			return dao.UpdateIndividual(base.Fields, base.Transaction);
		}
		...
		{
			IndividualDAO dao = DAOFactory.CreateIndividualDAO();
			return dao.UpdateIndividual(base.Fields, base.Transaction, updateRestriction);
		}
		...
		private void InitClassEmpty(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			...
			base.Fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.IndividualEntity);
			base.IsNew=true;
			base.EntityFactoryToUse = entityFactoryToUse;
			base.Validator = new IndividualValidator();
		}
		...
		private void InitClassFetch(System.Int32 customerID, IndividualValidator validator, IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			InitClassMembers(propertyDescriptorFactoryToUse, entityFactoryToUse);
			base.Fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.IndividualEntity);
		...
		private void SetupSyncContact(IEntity relatedEntity)
		{
			...
			if(relatedEntity!=null)
			{
				...
				{
					// sync now
					base.SyncFKFields(IndividualEntity.Relations.ContactEntityUsingContactID, _contact);
				}
			}
		...
		private void SetupSyncCustomer(IEntity relatedEntity)
		{
			...
			if(relatedEntity!=null)
			{
				...
				{
					// sync now
					base.SyncFKFields(IndividualEntity.Relations.CustomerEntityUsingCustomerID, _customer);
				}
		...
		private bool Fetch(System.Int32 customerID)
		{
			...
			// Load EntityFields of Individual
			dao.FetchIndividual(base.Fields, base.Transaction, customerID);
		...
		/// <summary>
		/// The CustomerID property of the Entity Individual
		/// </summary>
		public virtual System.Int32 CustomerID
		{
			...
			set
			{
				if(base.SetNewFieldValue((int)IndividualFieldIndex.CustomerID, value))
				{
					OnCustomerIDChanged();
				}
			}
		...
		/// <summary>
		/// The ContactID property of the Entity Individual
		/// </summary>
		public virtual System.Int32 ContactID
		{
			...
			set
			{
				if(base.SetNewFieldValue((int)IndividualFieldIndex.ContactID, value))
				{
					OnContactIDChanged();
				}
			}
		...
		/// <summary>
		/// The Demographics property of the Entity Individual
		/// </summary>
		public virtual System.String Demographics
		{
			...
			set
			{
				if(base.SetNewFieldValue((int)IndividualFieldIndex.Demographics, value))
				{
		...
		/// <summary>
		/// The ModifiedDate property of the Entity Individual
		/// </summary>
		public virtual System.DateTime ModifiedDate
		{
			...
			set
			{
				if(base.SetNewFieldValue((int)IndividualFieldIndex.ModifiedDate, value))
				{
