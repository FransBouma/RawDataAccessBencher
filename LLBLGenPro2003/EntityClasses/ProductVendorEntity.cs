...
{
	/// <summary>
	/// Entity class which represents the entity 'ProductVendor' in the 'AdventureWorks' database.
	/// </summary>
	[Serializable]
	public class ProductVendorEntity : EntityBase, ISerializable
	{
		...
		/// <summary>
		/// Event which is thrown when AverageLeadTime changes value. Databinding related.
		/// </summary>
		public event EventHandler AverageLeadTimeChanged;

		/// <summary>
		/// Event which is thrown when StandardPrice changes value. Databinding related.
		/// </summary>
		public event EventHandler StandardPriceChanged;

		/// <summary>
		/// Event which is thrown when LastReceiptCost changes value. Databinding related.
		/// </summary>
		public event EventHandler LastReceiptCostChanged;

		/// <summary>
		/// Event which is thrown when LastReceiptDate changes value. Databinding related.
		/// </summary>
		public event EventHandler LastReceiptDateChanged;

		/// <summary>
		/// Event which is thrown when MinOrderQty changes value. Databinding related.
		/// </summary>
		public event EventHandler MinOrderQtyChanged;

		/// <summary>
		/// Event which is thrown when MaxOrderQty changes value. Databinding related.
		/// </summary>
		public event EventHandler MaxOrderQtyChanged;

		/// <summary>
		/// Event which is thrown when OnOrderQty changes value. Databinding related.
		/// </summary>
		public event EventHandler OnOrderQtyChanged;
		...
		{
			InitClassEmpty(new PropertyDescriptorFactory(), new ProductVendorEntityFactory());
		}
		...
		{
			InitClassFetch(productID, vendorID, new ProductVendorValidator(), new PropertyDescriptorFactory(), new ProductVendorEntityFactory());
		}
		...
		public ProductVendorEntity(System.Int32 productID, System.Int32 vendorID, ProductVendorValidator validator)
		{
			InitClassFetch(productID, vendorID, validator, new PropertyDescriptorFactory(), new ProductVendorEntityFactory());
		}
		...
		public ProductVendorEntity(System.Int32 productID, System.Int32 vendorID, ProductVendorValidator validator, IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			InitClassFetch(productID, vendorID, validator, propertyDescriptorFactoryToUse, entityFactoryToUse);
		}
		...
		/// <param name="propertyDescriptorFactoryToUse">PropertyDescriptor factory to use in GetItemProperties method of contained collections. Complex databinding related.</param>
		/// <param name="entityFactoryToUse">The EntityFactory to use when creating entity objects during a GetMulti() call.</param>
		public ProductVendorEntity(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
		...
		private ProductVendorEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			return base.ToXml("ProductVendorEntity");
		}
		...
		{
			return Fetch(productID, vendorID);
		}
		...
		{
			return Fetch(this.ProductID, this.VendorID);
		}
		...
		{
			ProductVendorDAO dao = DAOFactory.CreateProductVendorDAO();
			bool wasSuccesful = dao.DeleteProductVendor(base.Fields, base.Transaction, deleteRestriction);
			if(wasSuccesful)
			{
		...
		/// <summary>
		/// Event thrower for the AverageLeadTimeChanged event, which is thrown when AverageLeadTime changes value.
		/// Databinding related.
		/// </summary>
		protected virtual void OnAverageLeadTimeChanged()
		{
			if(AverageLeadTimeChanged!=null)
			{
				AverageLeadTimeChanged(this, new EventArgs());
			}
		}
	
		/// <summary>
		/// Event thrower for the StandardPriceChanged event, which is thrown when StandardPrice changes value.
		/// Databinding related.
		/// </summary>
		protected virtual void OnStandardPriceChanged()
		{
			if(StandardPriceChanged!=null)
			{
				StandardPriceChanged(this, new EventArgs());
			}
		}
	
		/// <summary>
		/// Event thrower for the LastReceiptCostChanged event, which is thrown when LastReceiptCost changes value.
		/// Databinding related.
		/// </summary>
		protected virtual void OnLastReceiptCostChanged()
		{
			if(LastReceiptCostChanged!=null)
			{
				LastReceiptCostChanged(this, new EventArgs());
			}
		}
	
		/// <summary>
		/// Event thrower for the LastReceiptDateChanged event, which is thrown when LastReceiptDate changes value.
		/// Databinding related.
		/// </summary>
		protected virtual void OnLastReceiptDateChanged()
		{
			if(LastReceiptDateChanged!=null)
			{
				LastReceiptDateChanged(this, new EventArgs());
			}
		}
	
		/// <summary>
		/// Event thrower for the MinOrderQtyChanged event, which is thrown when MinOrderQty changes value.
		/// Databinding related.
		/// </summary>
		protected virtual void OnMinOrderQtyChanged()
		{
			if(MinOrderQtyChanged!=null)
			{
				MinOrderQtyChanged(this, new EventArgs());
			}
		}
	
		/// <summary>
		/// Event thrower for the MaxOrderQtyChanged event, which is thrown when MaxOrderQty changes value.
		/// Databinding related.
		/// </summary>
		protected virtual void OnMaxOrderQtyChanged()
		{
			if(MaxOrderQtyChanged!=null)
			{
				MaxOrderQtyChanged(this, new EventArgs());
			}
		}
	
		/// <summary>
		/// Event thrower for the OnOrderQtyChanged event, which is thrown when OnOrderQty changes value.
		/// Databinding related.
		/// </summary>
		protected virtual void OnOnOrderQtyChanged()
		{
			if(OnOrderQtyChanged!=null)
			{
				OnOrderQtyChanged(this, new EventArgs());
			}
		}
		...
		{
			ProductVendorDAO dao = DAOFactory.CreateProductVendorDAO();
			return dao.AddProductVendor(base.Fields, base.Transaction);
		}
		...
		{
			ProductVendorDAO dao = DAOFactory.CreateProductVendorDAO();
			return dao.UpdateProductVendor(base.Fields, base.Transaction);
		}
		...
		{
			ProductVendorDAO dao = DAOFactory.CreateProductVendorDAO();
			return dao.UpdateProductVendor(base.Fields, base.Transaction, updateRestriction);
		}
		...
		private void InitClassEmpty(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			...
			base.Fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductVendorEntity);
			base.IsNew=true;
			base.EntityFactoryToUse = entityFactoryToUse;
			base.Validator = new ProductVendorValidator();
		}
		...
		private void InitClassFetch(System.Int32 productID, System.Int32 vendorID, ProductVendorValidator validator, IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			InitClassMembers(propertyDescriptorFactoryToUse, entityFactoryToUse);
			base.Fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ProductVendorEntity);
			bool wasSuccesful = Fetch(productID, vendorID);
		...
		private void DesetupSyncProduct(bool signalRelatedEntity)
		{
			if(_product != null)
			{
				...
				base.UnsetEntitySyncInformation("Product", _product, ProductVendorEntity.Relations.ProductEntityUsingProductID);
				_product = null;
			}
		}
		...
		private void SetupSyncProduct(IEntity relatedEntity)
		{
			...
			if(relatedEntity!=null)
			{
				...
				_product.AfterSave+=new EventHandler(OnEntityAfterSave);
				base.SetEntitySyncInformation("Product", _product, ProductVendorEntity.Relations.ProductEntityUsingProductID);
				if(!_product.IsNew)
				{
					// sync now
					base.SyncFKFields(ProductVendorEntity.Relations.ProductEntityUsingProductID, _product);
				}
			}
		...
		private void DesetupSyncUnitMeasure(bool signalRelatedEntity)
		{
			if(_unitMeasure != null)
			{
				...
				base.UnsetEntitySyncInformation("UnitMeasure", _unitMeasure, ProductVendorEntity.Relations.UnitMeasureEntityUsingUnitMeasureCode);
				_unitMeasure = null;
			}
		}
		...
		private void SetupSyncUnitMeasure(IEntity relatedEntity)
		{
			...
			if(relatedEntity!=null)
			{
				...
				_unitMeasure.AfterSave+=new EventHandler(OnEntityAfterSave);
				base.SetEntitySyncInformation("UnitMeasure", _unitMeasure, ProductVendorEntity.Relations.UnitMeasureEntityUsingUnitMeasureCode);
				if(!_unitMeasure.IsNew)
				{
					// sync now
					base.SyncFKFields(ProductVendorEntity.Relations.UnitMeasureEntityUsingUnitMeasureCode, _unitMeasure);
				}
			}
		...
		private void DesetupSyncVendor(bool signalRelatedEntity)
		{
			if(_vendor != null)
			{
				...
				base.UnsetEntitySyncInformation("Vendor", _vendor, ProductVendorEntity.Relations.VendorEntityUsingVendorID);
				_vendor = null;
			}
		}
		...
		private void SetupSyncVendor(IEntity relatedEntity)
		{
			...
			if(relatedEntity!=null)
			{
				...
				_vendor.AfterSave+=new EventHandler(OnEntityAfterSave);
				base.SetEntitySyncInformation("Vendor", _vendor, ProductVendorEntity.Relations.VendorEntityUsingVendorID);
				if(!_vendor.IsNew)
				{
					// sync now
					base.SyncFKFields(ProductVendorEntity.Relations.VendorEntityUsingVendorID, _vendor);
				}
			}
		...
		/// <param name="vendorID">PK value for ProductVendor which data should be fetched into this ProductVendor object</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		private bool Fetch(System.Int32 productID, System.Int32 vendorID)
		{
			ProductVendorDAO dao = DAOFactory.CreateProductVendorDAO();

			// Load EntityFields of ProductVendor
			dao.FetchProductVendor(base.Fields, base.Transaction, productID, vendorID);
		...
		/// <summary>
		/// The ProductID property of the Entity ProductVendor
		/// </summary>
		public virtual System.Int32 ProductID
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ProductVendorFieldIndex.ProductID);
			...
			set
			{
				if(base.SetNewFieldValue((int)ProductVendorFieldIndex.ProductID, value))
				{
					OnProductIDChanged();
				}
			}
		...
		/// <summary>
		/// The VendorID property of the Entity ProductVendor
		/// </summary>
		public virtual System.Int32 VendorID
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ProductVendorFieldIndex.VendorID);
				if(valueToReturn == null)
				{
			...
			set
			{
				if(base.SetNewFieldValue((int)ProductVendorFieldIndex.VendorID, value))
				{
					OnVendorIDChanged();
				}
			}
		...
		public virtual System.Int32 AverageLeadTime
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ProductVendorFieldIndex.AverageLeadTime);
				if(valueToReturn == null)
				{
					throw new ORMFieldIsNullException("Cannot get the value for AverageLeadTime because it is set to NULL.");
				}
				return (System.Int32)valueToReturn;
			}
			set
			{
				if(base.SetNewFieldValue((int)ProductVendorFieldIndex.AverageLeadTime, value))
				{
		...
		/// <summary>
		/// The StandardPrice property of the Entity ProductVendor
		/// </summary>
		public virtual System.Decimal StandardPrice
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ProductVendorFieldIndex.StandardPrice);
				if(valueToReturn == null)
				{
					throw new ORMFieldIsNullException("Cannot get the value for StandardPrice because it is set to NULL.");
				}
				return (System.Decimal)valueToReturn;
			}
			set
			{
				if(base.SetNewFieldValue((int)ProductVendorFieldIndex.StandardPrice, value))
				{
		...
		/// <summary>
		/// The LastReceiptCost property of the Entity ProductVendor
		/// </summary>
		public virtual System.Decimal LastReceiptCost
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ProductVendorFieldIndex.LastReceiptCost);
				if(valueToReturn == null)
				{
					throw new ORMFieldIsNullException("Cannot get the value for LastReceiptCost because it is set to NULL.");
				}
				return (System.Decimal)valueToReturn;
			}
			set
			{
				if(base.SetNewFieldValue((int)ProductVendorFieldIndex.LastReceiptCost, value))
				{
		...
		/// <summary>
		/// The LastReceiptDate property of the Entity ProductVendor
		/// </summary>
		public virtual System.DateTime LastReceiptDate
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ProductVendorFieldIndex.LastReceiptDate);
				if(valueToReturn == null)
				{
					throw new ORMFieldIsNullException("Cannot get the value for LastReceiptDate because it is set to NULL.");
				}
				return (System.DateTime)valueToReturn;
			}
			set
			{
				if(base.SetNewFieldValue((int)ProductVendorFieldIndex.LastReceiptDate, value))
				{
		...
		/// <summary>
		/// The MinOrderQty property of the Entity ProductVendor
		/// </summary>
		public virtual System.Int32 MinOrderQty
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ProductVendorFieldIndex.MinOrderQty);
				if(valueToReturn == null)
				{
					throw new ORMFieldIsNullException("Cannot get the value for MinOrderQty because it is set to NULL.");
				}
				return (System.Int32)valueToReturn;
			}
			set
			{
				if(base.SetNewFieldValue((int)ProductVendorFieldIndex.MinOrderQty, value))
				{
		...
		/// <summary>
		/// The MaxOrderQty property of the Entity ProductVendor
		/// </summary>
		public virtual System.Int32 MaxOrderQty
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ProductVendorFieldIndex.MaxOrderQty);
				if(valueToReturn == null)
				{
					throw new ORMFieldIsNullException("Cannot get the value for MaxOrderQty because it is set to NULL.");
				}
				return (System.Int32)valueToReturn;
			}
			set
			{
				if(base.SetNewFieldValue((int)ProductVendorFieldIndex.MaxOrderQty, value))
				{
		...
		/// <summary>
		/// The OnOrderQty property of the Entity ProductVendor
		/// </summary>
		public virtual System.Int32 OnOrderQty
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ProductVendorFieldIndex.OnOrderQty);
				if(valueToReturn == null)
				{
					throw new ORMFieldIsNullException("Cannot get the value for OnOrderQty because it is set to NULL.");
				}
				return (System.Int32)valueToReturn;
			}
			set
			{
				if(base.SetNewFieldValue((int)ProductVendorFieldIndex.OnOrderQty, value))
				{
					OnOnOrderQtyChanged();
				}
			}
		...
		/// <summary>
		/// The UnitMeasureCode property of the Entity ProductVendor
		/// </summary>
		public virtual System.String UnitMeasureCode
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ProductVendorFieldIndex.UnitMeasureCode);
				if(valueToReturn == null)
				{
			...
			set
			{
				if(base.SetNewFieldValue((int)ProductVendorFieldIndex.UnitMeasureCode, value))
				{
		...
		/// <summary>
		/// The ModifiedDate property of the Entity ProductVendor
		/// </summary>
		public virtual System.DateTime ModifiedDate
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ProductVendorFieldIndex.ModifiedDate);
				if(valueToReturn == null)
				{
			...
			set
			{
				if(base.SetNewFieldValue((int)ProductVendorFieldIndex.ModifiedDate, value))
				{
