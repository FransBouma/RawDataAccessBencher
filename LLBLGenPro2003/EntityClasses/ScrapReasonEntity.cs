...
{
	/// <summary>
	/// Entity class which represents the entity 'ScrapReason' in the 'AdventureWorks' database.
	/// </summary>
	[Serializable]
	public class ScrapReasonEntity : EntityBase, ISerializable
	{
		...
		{
			InitClassEmpty(new PropertyDescriptorFactory(), new ScrapReasonEntityFactory());
		}
		...
		{
			InitClassFetch(scrapReasonID, new ScrapReasonValidator(), new PropertyDescriptorFactory(), new ScrapReasonEntityFactory());
		}
		...
		public ScrapReasonEntity(System.Int16 scrapReasonID, ScrapReasonValidator validator)
		{
			InitClassFetch(scrapReasonID, validator, new PropertyDescriptorFactory(), new ScrapReasonEntityFactory());
		}
		...
		public ScrapReasonEntity(System.Int16 scrapReasonID, ScrapReasonValidator validator, IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			InitClassFetch(scrapReasonID, validator, propertyDescriptorFactoryToUse, entityFactoryToUse);
		}
		...
		/// <param name="propertyDescriptorFactoryToUse">PropertyDescriptor factory to use in GetItemProperties method of contained collections. Complex databinding related.</param>
		/// <param name="entityFactoryToUse">The EntityFactory to use when creating entity objects during a GetMulti() call.</param>
		public ScrapReasonEntity(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
		...
		private ScrapReasonEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			return base.ToXml("ScrapReasonEntity");
		}
		...
		{
			return Fetch(this.ScrapReasonID);
		}
		...
		{
			ScrapReasonDAO dao = DAOFactory.CreateScrapReasonDAO();
			bool wasSuccesful = dao.DeleteScrapReason(base.Fields, base.Transaction, deleteRestriction);
			if(wasSuccesful)
			{
		...
		public virtual WorkOrderCollection GetMultiWorkOrder(bool forceFetch)
		{
 			if( ( !_alreadyFetchedWorkOrder || forceFetch || _alwaysFetchWorkOrder) && !base.IsSerializing && !base.IsDeserializing )
			{
				...
				_workOrder.GetMultiManyToOne(null, this);
		...
		public virtual ProductCollection GetMultiProduct(bool forceFetch)
		{
 			if( ( !_alreadyFetchedProduct || forceFetch || _alwaysFetchProduct) && !base.IsSerializing && !base.IsDeserializing )
			{
				...
				_product.GetMultiManyToManyUsingScrapReason(this);
		...
		{
			ScrapReasonDAO dao = DAOFactory.CreateScrapReasonDAO();
			return dao.AddScrapReason(base.Fields, base.Transaction);
		}
		...
		{
			ScrapReasonDAO dao = DAOFactory.CreateScrapReasonDAO();
			return dao.UpdateScrapReason(base.Fields, base.Transaction);
		}
		...
		{
			ScrapReasonDAO dao = DAOFactory.CreateScrapReasonDAO();
			return dao.UpdateScrapReason(base.Fields, base.Transaction, updateRestriction);
		}
		...
		private void InitClassEmpty(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			...
			base.Fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ScrapReasonEntity);
			base.IsNew=true;
			base.EntityFactoryToUse = entityFactoryToUse;
			base.Validator = new ScrapReasonValidator();
		}
		...
		private void InitClassFetch(System.Int16 scrapReasonID, ScrapReasonValidator validator, IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			InitClassMembers(propertyDescriptorFactoryToUse, entityFactoryToUse);
			base.Fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.ScrapReasonEntity);
			bool wasSuccesful = Fetch(scrapReasonID);
		...
		/// <param name="scrapReasonID">PK value for ScrapReason which data should be fetched into this ScrapReason object</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		private bool Fetch(System.Int16 scrapReasonID)
		{
			ScrapReasonDAO dao = DAOFactory.CreateScrapReasonDAO();

			// Load EntityFields of ScrapReason
			dao.FetchScrapReason(base.Fields, base.Transaction, scrapReasonID);
		...
		/// <summary>
		/// The ScrapReasonID property of the Entity ScrapReason
		/// </summary>
		public virtual System.Int16 ScrapReasonID
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ScrapReasonFieldIndex.ScrapReasonID);
			...
			set
			{
				if(base.SetNewFieldValue((int)ScrapReasonFieldIndex.ScrapReasonID, value))
				{
		...
		/// <summary>
		/// The Name property of the Entity ScrapReason
		/// </summary>
		public virtual System.String Name
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ScrapReasonFieldIndex.Name);
				if(valueToReturn == null)
				{
			...
			set
			{
				if(base.SetNewFieldValue((int)ScrapReasonFieldIndex.Name, value))
				{
					OnNameChanged();
				}
			}
		...
		/// <summary>
		/// The ModifiedDate property of the Entity ScrapReason
		/// </summary>
		public virtual System.DateTime ModifiedDate
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ScrapReasonFieldIndex.ModifiedDate);
				if(valueToReturn == null)
				{
			...
			set
			{
				if(base.SetNewFieldValue((int)ScrapReasonFieldIndex.ModifiedDate, value))
				{
