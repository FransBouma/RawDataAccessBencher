...
{
	/// <summary>
	/// Entity class which represents the entity 'Currency' in the 'AdventureWorks' database.
	/// </summary>
	[Serializable]
	public class CurrencyEntity : EntityBase, ISerializable
	{
		...
		{
			InitClassEmpty(new PropertyDescriptorFactory(), new CurrencyEntityFactory());
		}
		...
		{
			InitClassFetch(currencyCode, new CurrencyValidator(), new PropertyDescriptorFactory(), new CurrencyEntityFactory());
		}
		...
		public CurrencyEntity(System.String currencyCode, CurrencyValidator validator)
		{
			InitClassFetch(currencyCode, validator, new PropertyDescriptorFactory(), new CurrencyEntityFactory());
		}
		...
		public CurrencyEntity(System.String currencyCode, CurrencyValidator validator, IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			InitClassFetch(currencyCode, validator, propertyDescriptorFactoryToUse, entityFactoryToUse);
		}
		...
		/// <param name="propertyDescriptorFactoryToUse">PropertyDescriptor factory to use in GetItemProperties method of contained collections. Complex databinding related.</param>
		/// <param name="entityFactoryToUse">The EntityFactory to use when creating entity objects during a GetMulti() call.</param>
		public CurrencyEntity(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
		...
		private CurrencyEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		public override void SetRelatedEntity(IEntity relatedEntity, string fieldName)
		{
			switch(fieldName)
			{
				...
				case "CurrencyRate":
					// add it to the collection as well. If it's already present, the Add() will not add it again.
					_currencyRate.Add(relatedEntity);
					break;
				case "CurrencyRate_":
					// add it to the collection as well. If it's already present, the Add() will not add it again.
					_currencyRate_.Add(relatedEntity);
					break;
		...
		public override void UnsetRelatedEntity(IEntity relatedEntity, string fieldName)
		{
			switch(fieldName)
			{
				...
				case "CurrencyRate":
					// Remove it from the collection.
					_currencyRate.Remove(relatedEntity);
					break;
				case "CurrencyRate_":
					// Remove it from the collection.
					_currencyRate_.Remove(relatedEntity);
					break;
		...
		{
			return base.ToXml("CurrencyEntity");
		}
		...
		{
			return Fetch(this.CurrencyCode);
		}
		...
		public override bool Delete(IPredicate deleteRestriction)
		{
			...
			bool wasSuccesful = dao.DeleteCurrency(base.Fields, base.Transaction, deleteRestriction);
			if(wasSuccesful)
			{
		...
		public virtual CountryRegionCurrencyCollection GetMultiCountryRegionCurrency(bool forceFetch)
		{
 			if( ( !_alreadyFetchedCountryRegionCurrency || forceFetch || _alwaysFetchCountryRegionCurrency) && !base.IsSerializing && !base.IsDeserializing )
			{
				...
				_countryRegionCurrency.GetMultiManyToOne(null, this);
		...
		/// <summary>
		/// Retrieves all related entities of type 'CurrencyRateEntity' using a relation of type '1:n'.
		/// </summary>
		/// <param name="forceFetch">if true, it will discard any changes currently in the collection and will rerun the complete query instead</param>
		...
		public virtual CurrencyRateCollection GetMultiCurrencyRate(bool forceFetch)
		{
 			if( ( !_alreadyFetchedCurrencyRate || forceFetch || _alwaysFetchCurrencyRate) && !base.IsSerializing && !base.IsDeserializing )
			{
				...
				_currencyRate.GetMultiManyToOne(this, null);
		...
		/// <param name="filter">Extra filter to limit the resultset.</param>
		/// <returns>Filled collection with all related entities of type 'CurrencyRateEntity'</returns>
		public virtual CurrencyRateCollection GetMultiCurrencyRate(bool forceFetch, IPredicateExpression filter)
		{
 			if( ( !_alreadyFetchedCurrencyRate || forceFetch || _alwaysFetchCurrencyRate) && !base.IsSerializing && !base.IsDeserializing )
			{
				// refetch it.
				...
				_currencyRate.SuppressClearInGetMulti=!forceFetch;
				_currencyRate.GetMultiManyToOne(this, null, filter);
				_currencyRate.SuppressClearInGetMulti=false;
				_alreadyFetchedCurrencyRate = true;
			}
			return _currencyRate;
		...
		/// <param name="filter">Extra filter to limit the resultset.</param>
		/// <returns>Filled collection with all related entities of the type constructed by the passed in entity factory</returns>
		public virtual CurrencyRateCollection GetMultiCurrencyRate(bool forceFetch, IEntityFactory entityFactoryToUse, IPredicateExpression filter)
		{
 			if( ( !_alreadyFetchedCurrencyRate || forceFetch || _alwaysFetchCurrencyRate) && !base.IsSerializing && !base.IsDeserializing )
			{
				// refetch it.
		...
		public virtual CurrencyRateCollection GetMultiCurrencyRate_(bool forceFetch)
		{
 			if( ( !_alreadyFetchedCurrencyRate_ || forceFetch || _alwaysFetchCurrencyRate_) && !base.IsSerializing && !base.IsDeserializing )
			{
				...
				_currencyRate_.GetMultiManyToOne(null, this);
		...
		/// <param name="filter">Extra filter to limit the resultset.</param>
		/// <returns>Filled collection with all related entities of type 'CurrencyRateEntity'</returns>
		public virtual CurrencyRateCollection GetMultiCurrencyRate_(bool forceFetch, IPredicateExpression filter)
		{
 			if( ( !_alreadyFetchedCurrencyRate_ || forceFetch || _alwaysFetchCurrencyRate_) && !base.IsSerializing && !base.IsDeserializing )
			{
				// refetch it.
				...
				_currencyRate_.SuppressClearInGetMulti=!forceFetch;
				_currencyRate_.GetMultiManyToOne(null, this, filter);
				_currencyRate_.SuppressClearInGetMulti=false;
				_alreadyFetchedCurrencyRate_ = true;
			}
			return _currencyRate_;
		...
		/// <param name="filter">Extra filter to limit the resultset.</param>
		/// <returns>Filled collection with all related entities of the type constructed by the passed in entity factory</returns>
		public virtual CurrencyRateCollection GetMultiCurrencyRate_(bool forceFetch, IEntityFactory entityFactoryToUse, IPredicateExpression filter)
		{
 			if( ( !_alreadyFetchedCurrencyRate_ || forceFetch || _alwaysFetchCurrencyRate_) && !base.IsSerializing && !base.IsDeserializing )
			{
				// refetch it.
		...
		public virtual CountryRegionCollection GetMultiCountryRegion(bool forceFetch)
		{
 			if( ( !_alreadyFetchedCountryRegion || forceFetch || _alwaysFetchCountryRegion) && !base.IsSerializing && !base.IsDeserializing )
			{
				...
				_countryRegion.GetMultiManyToManyUsingCurrency(this);
		...
		{
			CurrencyDAO dao = DAOFactory.CreateCurrencyDAO();
			return dao.AddCurrency(base.Fields, base.Transaction);
		}
		...
		{
			CurrencyDAO dao = DAOFactory.CreateCurrencyDAO();
			return dao.UpdateCurrency(base.Fields, base.Transaction);
		}
		...
		{
			CurrencyDAO dao = DAOFactory.CreateCurrencyDAO();
			return dao.UpdateCurrency(base.Fields, base.Transaction, updateRestriction);
		}
		...
		private void InitClassEmpty(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			...
			base.Fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.CurrencyEntity);
			base.IsNew=true;
			base.EntityFactoryToUse = entityFactoryToUse;
			base.Validator = new CurrencyValidator();
		}
		...
		private void InitClassFetch(System.String currencyCode, CurrencyValidator validator, IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			InitClassMembers(propertyDescriptorFactoryToUse, entityFactoryToUse);
			base.Fields = EntityFieldsFactory.CreateEntityFieldsObject(EntityType.CurrencyEntity);
			bool wasSuccesful = Fetch(currencyCode);
		...
		private void InitClassMembers(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			...
			_currencyRate.SetContainingEntityInfo(this, "Currency");
			...
			_currencyRate_.SetContainingEntityInfo(this, "Currency_");
		...
		/// <param name="currencyCode">PK value for Currency which data should be fetched into this Currency object</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		private bool Fetch(System.String currencyCode)
		{
			CurrencyDAO dao = DAOFactory.CreateCurrencyDAO();

			// Load EntityFields of Currency
			dao.FetchCurrency(base.Fields, base.Transaction, currencyCode);
		...
		public virtual System.String CurrencyCode
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)CurrencyFieldIndex.CurrencyCode);
			...
			set
			{
				if(base.SetNewFieldValue((int)CurrencyFieldIndex.CurrencyCode, value))
				{
		...
		/// <summary>
		/// The Name property of the Entity Currency
		/// </summary>
		public virtual System.String Name
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)CurrencyFieldIndex.Name);
				if(valueToReturn == null)
				{
			...
			set
			{
				if(base.SetNewFieldValue((int)CurrencyFieldIndex.Name, value))
				{
					OnNameChanged();
				}
			}
		...
		/// <summary>
		/// The ModifiedDate property of the Entity Currency
		/// </summary>
		public virtual System.DateTime ModifiedDate
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)CurrencyFieldIndex.ModifiedDate);
				if(valueToReturn == null)
				{
			...
			set
			{
				if(base.SetNewFieldValue((int)CurrencyFieldIndex.ModifiedDate, value))
				{
