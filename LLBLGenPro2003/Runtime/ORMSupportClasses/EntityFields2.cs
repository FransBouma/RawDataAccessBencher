...
namespace SD.LLBLGen.Pro.ORMSupportClasses2003
{
	...
	/// </summary>
	[Serializable]
	public class EntityFields2 : IEntityFields2, ICloneable
	{
		...
		public EntityFields2(int amount)
		{
		...
		public override bool Equals(object obj)
		{
			...
			if(_primaryKeyFields.Count>0)
			{
				...
				{
					theSame&=(((IEntityField2)_primaryKeyFields[i]).CurrentValue.Equals( ((IEntityField2)passedIn.PrimaryKeyFields[i]).CurrentValue) );
					if(!theSame)
					{
		...
		public IEntityField2 this [int index] 
		{
			...
			set
			{
				...
				_entityFieldReferences.Add(value.Alias, value);
		...
		public IEntityField2 this [string name] 
		{
			get
			{
				...
				return (IEntityField2)(_entityFieldReferences[name]);
			}
		}
