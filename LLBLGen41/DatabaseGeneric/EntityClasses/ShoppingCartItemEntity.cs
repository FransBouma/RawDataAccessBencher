...
namespace AdventureWorks.Dal.Adapter.v41.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public ShoppingCartItemEntity():base("ShoppingCartItemEntity")
		{
		...
		public ShoppingCartItemEntity(IValidator validator):base("ShoppingCartItemEntity")
		{
		...
		public ShoppingCartItemEntity(System.Int32 shoppingCartItemId):base("ShoppingCartItemEntity")
		{
			InitClassEmpty(null, null);
		...
		/// <param name="validator">The custom validator object for this ShoppingCartItemEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ShoppingCartItemEntity(System.Int32 shoppingCartItemId, IValidator validator):base("ShoppingCartItemEntity")
		{
			InitClassEmpty(validator, null);
			this.ShoppingCartItemId = shoppingCartItemId;
		}
		...
		{
			switch((ShoppingCartItemFieldIndex)fieldIndex)
			{
		...
		{
			return new ShoppingCartItemRelations().GetAllRelations();
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(ShoppingCartItemEntityFactory));
		}
#if !CF
		...
		{
			this.PerformDesetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", AdventureWorks.Dal.Adapter.v41.RelationClasses.StaticShoppingCartItemRelations.ProductEntityUsingProductIdStatic, true, signalRelatedEntity, "ShoppingCartItems", resetFKFields, new int[] { (int)ShoppingCartItemFieldIndex.ProductId } );
			_product = null;
		}
		...
		private void SetupSyncProduct(IEntityCore relatedEntity)
		{
			if(_product!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", AdventureWorks.Dal.Adapter.v41.RelationClasses.StaticShoppingCartItemRelations.ProductEntityUsingProductIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))),	(IEntityRelation)GetRelationsForField("Product")[0], (int)AdventureWorks.Dal.Adapter.v41.EntityType.ShoppingCartItemEntity, (int)AdventureWorks.Dal.Adapter.v41.EntityType.ProductEntity, 0, null, null, null, null, "Product", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		public virtual ProductEntity Product
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "ShoppingCartItems", "Product", _product, true); 
				}
			}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v41.EntityType.ShoppingCartItemEntity; }
		}
