...
namespace AdventureWorks.Dal.Adapter.v41.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'VendorAddress'.<br/><br/></summary>
	[Serializable]
			...
			
	{
		...
		public VendorAddressEntity(IEntityFields2 fields):base("VendorAddressEntity")
		{
		...
		public VendorAddressEntity(IValidator validator):base("VendorAddressEntity")
		{
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(VendorAddressEntityFactory));
		}
#if !CF
		...
		{
			this.PerformDesetupSyncRelatedEntity( _address, new PropertyChangedEventHandler( OnAddressPropertyChanged ), "Address", AdventureWorks.Dal.Adapter.v41.RelationClasses.StaticVendorAddressRelations.AddressEntityUsingAddressIdStatic, true, signalRelatedEntity, "VendorAddresses", resetFKFields, new int[] { (int)VendorAddressFieldIndex.AddressId } );
			_address = null;
		}
		...
		private void SetupSyncAddress(IEntityCore relatedEntity)
		{
			if(_address!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _address, new PropertyChangedEventHandler( OnAddressPropertyChanged ), "Address", AdventureWorks.Dal.Adapter.v41.RelationClasses.StaticVendorAddressRelations.AddressEntityUsingAddressIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _addressType, new PropertyChangedEventHandler( OnAddressTypePropertyChanged ), "AddressType", AdventureWorks.Dal.Adapter.v41.RelationClasses.StaticVendorAddressRelations.AddressTypeEntityUsingAddressTypeIdStatic, true, signalRelatedEntity, "VendorAddresses", resetFKFields, new int[] { (int)VendorAddressFieldIndex.AddressTypeId } );
			_addressType = null;
		}
		...
		private void SetupSyncAddressType(IEntityCore relatedEntity)
		{
			if(_addressType!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _addressType, new PropertyChangedEventHandler( OnAddressTypePropertyChanged ), "AddressType", AdventureWorks.Dal.Adapter.v41.RelationClasses.StaticVendorAddressRelations.AddressTypeEntityUsingAddressTypeIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncVendor(IEntityCore relatedEntity)
		{
			if(_vendor!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _vendor, new PropertyChangedEventHandler( OnVendorPropertyChanged ), "Vendor", AdventureWorks.Dal.Adapter.v41.RelationClasses.StaticVendorAddressRelations.VendorEntityUsingVendorIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AddressEntityFactory))),	(IEntityRelation)GetRelationsForField("Address")[0], (int)AdventureWorks.Dal.Adapter.v41.EntityType.VendorAddressEntity, (int)AdventureWorks.Dal.Adapter.v41.EntityType.AddressEntity, 0, null, null, null, null, "Address", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AddressTypeEntityFactory))),	(IEntityRelation)GetRelationsForField("AddressType")[0], (int)AdventureWorks.Dal.Adapter.v41.EntityType.VendorAddressEntity, (int)AdventureWorks.Dal.Adapter.v41.EntityType.AddressTypeEntity, 0, null, null, null, null, "AddressType", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(VendorEntityFactory))),	(IEntityRelation)GetRelationsForField("Vendor")[0], (int)AdventureWorks.Dal.Adapter.v41.EntityType.VendorAddressEntity, (int)AdventureWorks.Dal.Adapter.v41.EntityType.VendorEntity, 0, null, null, null, null, "Vendor", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v41.EntityType.VendorAddressEntity; }
		}
