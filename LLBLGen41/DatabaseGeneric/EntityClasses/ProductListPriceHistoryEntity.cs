...
namespace AdventureWorks.Dal.Adapter.v41.EntityClasses
{
			...
			
	{
		...
		public ProductListPriceHistoryEntity():base("ProductListPriceHistoryEntity")
		{
		...
		public ProductListPriceHistoryEntity(IEntityFields2 fields):base("ProductListPriceHistoryEntity")
		{
		...
		public ProductListPriceHistoryEntity(IValidator validator):base("ProductListPriceHistoryEntity")
		{
		...
		public ProductListPriceHistoryEntity(System.Int32 productId, System.DateTime startDate):base("ProductListPriceHistoryEntity")
		{
			InitClassEmpty(null, null);
		...
		/// <param name="validator">The custom validator object for this ProductListPriceHistoryEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ProductListPriceHistoryEntity(System.Int32 productId, System.DateTime startDate, IValidator validator):base("ProductListPriceHistoryEntity")
		{
			InitClassEmpty(validator, null);
			this.ProductId = productId;
			this.StartDate = startDate;
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(ProductListPriceHistoryEntityFactory));
		}
#if !CF
		...
		{
			this.PerformDesetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", AdventureWorks.Dal.Adapter.v41.RelationClasses.StaticProductListPriceHistoryRelations.ProductEntityUsingProductIdStatic, true, signalRelatedEntity, "ProductListPriceHistories", resetFKFields, new int[] { (int)ProductListPriceHistoryFieldIndex.ProductId } );
			_product = null;
		}
		...
		private void SetupSyncProduct(IEntityCore relatedEntity)
		{
			if(_product!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", AdventureWorks.Dal.Adapter.v41.RelationClasses.StaticProductListPriceHistoryRelations.ProductEntityUsingProductIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))),	(IEntityRelation)GetRelationsForField("Product")[0], (int)AdventureWorks.Dal.Adapter.v41.EntityType.ProductListPriceHistoryEntity, (int)AdventureWorks.Dal.Adapter.v41.EntityType.ProductEntity, 0, null, null, null, null, "Product", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v41.EntityType.ProductListPriceHistoryEntity; }
		}
