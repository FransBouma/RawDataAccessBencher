...
namespace AdventureWorks.Dal.Adapter.v41.EntityClasses
{
			...
			
	{
		...
		public ShiftEntity(IEntityFields2 fields):base("ShiftEntity")
		{
		...
		public ShiftEntity(IValidator validator):base("ShiftEntity")
		{
		...
		public ShiftEntity(System.Byte shiftId):base("ShiftEntity")
		{
			InitClassEmpty(null, null);
		...
		/// <param name="validator">The custom validator object for this ShiftEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ShiftEntity(System.Byte shiftId, IValidator validator):base("ShiftEntity")
		{
			InitClassEmpty(validator, null);
			this.ShiftId = shiftId;
		}
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "EmployeeDepartmentHistories":
					toReturn.Add(Relations.EmployeeDepartmentHistoryEntityUsingShiftId);
					break;
				default:
					break;				
			}
		...
		public virtual IRelationPredicateBucket GetRelationInfoEmployeeDepartmentHistories()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(EmployeeDepartmentHistoryFields.ShiftId, null, ComparisonOperator.Equal, this.ShiftId));
			return bucket;
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(ShiftEntityFactory));
		}
#if !CF
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<EmployeeDepartmentHistoryEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeDepartmentHistoryEntityFactory))), (IEntityRelation)GetRelationsForField("EmployeeDepartmentHistories")[0], (int)AdventureWorks.Dal.Adapter.v41.EntityType.ShiftEntity, (int)AdventureWorks.Dal.Adapter.v41.EntityType.EmployeeDepartmentHistoryEntity, 0, null, null, null, null, "EmployeeDepartmentHistories", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get { return GetOrCreateEntityCollection<EmployeeDepartmentHistoryEntity, EmployeeDepartmentHistoryEntityFactory>("Shift", true, false, ref _employeeDepartmentHistories);	}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v41.EntityType.ShiftEntity; }
		}
