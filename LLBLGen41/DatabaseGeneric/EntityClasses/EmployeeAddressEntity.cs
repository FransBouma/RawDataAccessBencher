...
namespace AdventureWorks.Dal.Adapter.v41.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'EmployeeAddress'.<br/><br/></summary>
	[Serializable]
			...
			
	{
		...
		public EmployeeAddressEntity(IEntityFields2 fields):base("EmployeeAddressEntity")
		{
		...
		public EmployeeAddressEntity(IValidator validator):base("EmployeeAddressEntity")
		{
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(EmployeeAddressEntityFactory));
		}
#if !CF
		...
		{
			this.PerformDesetupSyncRelatedEntity( _address, new PropertyChangedEventHandler( OnAddressPropertyChanged ), "Address", AdventureWorks.Dal.Adapter.v41.RelationClasses.StaticEmployeeAddressRelations.AddressEntityUsingAddressIdStatic, true, signalRelatedEntity, "EmployeeAddresses", resetFKFields, new int[] { (int)EmployeeAddressFieldIndex.AddressId } );
			_address = null;
		}
		...
		private void SetupSyncAddress(IEntityCore relatedEntity)
		{
			if(_address!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _address, new PropertyChangedEventHandler( OnAddressPropertyChanged ), "Address", AdventureWorks.Dal.Adapter.v41.RelationClasses.StaticEmployeeAddressRelations.AddressEntityUsingAddressIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", AdventureWorks.Dal.Adapter.v41.RelationClasses.StaticEmployeeAddressRelations.EmployeeEntityUsingEmployeeIdStatic, true, signalRelatedEntity, "EmployeeAddresses", resetFKFields, new int[] { (int)EmployeeAddressFieldIndex.EmployeeId } );
			_employee = null;
		}
		...
		private void SetupSyncEmployee(IEntityCore relatedEntity)
		{
			if(_employee!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", AdventureWorks.Dal.Adapter.v41.RelationClasses.StaticEmployeeAddressRelations.EmployeeEntityUsingEmployeeIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AddressEntityFactory))),	(IEntityRelation)GetRelationsForField("Address")[0], (int)AdventureWorks.Dal.Adapter.v41.EntityType.EmployeeAddressEntity, (int)AdventureWorks.Dal.Adapter.v41.EntityType.AddressEntity, 0, null, null, null, null, "Address", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeEntityFactory))),	(IEntityRelation)GetRelationsForField("Employee")[0], (int)AdventureWorks.Dal.Adapter.v41.EntityType.EmployeeAddressEntity, (int)AdventureWorks.Dal.Adapter.v41.EntityType.EmployeeEntity, 0, null, null, null, null, "Employee", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v41.EntityType.EmployeeAddressEntity; }
		}
