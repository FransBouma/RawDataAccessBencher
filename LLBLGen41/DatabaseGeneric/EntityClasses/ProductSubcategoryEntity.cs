			...
			
	{
		...
		private void SetupSyncProductCategory(IEntityCore relatedEntity)
		{
			if(_productCategory!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _productCategory, new PropertyChangedEventHandler( OnProductCategoryPropertyChanged ), "ProductCategory", AdventureWorks.Dal.Adapter.v41.RelationClasses.StaticProductSubcategoryRelations.ProductCategoryEntityUsingProductCategoryIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ProductEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))), (IEntityRelation)GetRelationsForField("Products")[0], (int)AdventureWorks.Dal.Adapter.v41.EntityType.ProductSubcategoryEntity, (int)AdventureWorks.Dal.Adapter.v41.EntityType.ProductEntity, 0, null, null, null, null, "Products", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductCategoryEntityFactory))),	(IEntityRelation)GetRelationsForField("ProductCategory")[0], (int)AdventureWorks.Dal.Adapter.v41.EntityType.ProductSubcategoryEntity, (int)AdventureWorks.Dal.Adapter.v41.EntityType.ProductCategoryEntity, 0, null, null, null, null, "ProductCategory", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v41.EntityType.ProductSubcategoryEntity; }
		}
