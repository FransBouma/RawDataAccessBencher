...
namespace AdventureWorks.Dal.Adapter.v41.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public CultureEntity(IEntityFields2 fields):base("CultureEntity")
		{
		...
		public CultureEntity(IValidator validator):base("CultureEntity")
		{
		...
		public virtual IRelationPredicateBucket GetRelationInfoProductModelProductDescriptionCultures()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ProductModelProductDescriptionCultureFields.CultureId, null, ComparisonOperator.Equal, this.CultureId));
			return bucket;
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(CultureEntityFactory));
		}
#if !CF
		...
		{
			get { return GetOrCreateEntityCollection<ProductModelProductDescriptionCultureEntity, ProductModelProductDescriptionCultureEntityFactory>("Culture", true, false, ref _productModelProductDescriptionCultures);	}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v41.EntityType.CultureEntity; }
		}
