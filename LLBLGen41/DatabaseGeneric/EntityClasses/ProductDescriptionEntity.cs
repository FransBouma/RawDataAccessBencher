...
namespace AdventureWorks.Dal.Adapter.v41.EntityClasses
{
			...
			
	{
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v41.EntityType.ProductDescriptionEntity; }
		}
