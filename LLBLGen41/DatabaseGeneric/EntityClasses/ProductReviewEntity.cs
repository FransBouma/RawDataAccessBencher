...
namespace AdventureWorks.Dal.Adapter.v41.EntityClasses
{
			...
			
	{
		...
		{
			this.PerformDesetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", AdventureWorks.Dal.Adapter.v41.RelationClasses.StaticProductReviewRelations.ProductEntityUsingProductIdStatic, true, signalRelatedEntity, "ProductReviews", resetFKFields, new int[] { (int)ProductReviewFieldIndex.ProductId } );
			_product = null;
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))),	(IEntityRelation)GetRelationsForField("Product")[0], (int)AdventureWorks.Dal.Adapter.v41.EntityType.ProductReviewEntity, (int)AdventureWorks.Dal.Adapter.v41.EntityType.ProductEntity, 0, null, null, null, null, "Product", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v41.EntityType.ProductReviewEntity; }
		}
