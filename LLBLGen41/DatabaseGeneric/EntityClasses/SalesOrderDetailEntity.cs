			...
			
	{
		...
		private void SetupSyncSpecialOfferProduct(IEntityCore relatedEntity)
		{
			if(_specialOfferProduct!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _specialOfferProduct, new PropertyChangedEventHandler( OnSpecialOfferProductPropertyChanged ), "SpecialOfferProduct", AdventureWorks.Dal.Adapter.v41.RelationClasses.StaticSalesOrderDetailRelations.SpecialOfferProductEntityUsingProductIdSpecialOfferIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(SpecialOfferProductEntityFactory))),	(IEntityRelation)GetRelationsForField("SpecialOfferProduct")[0], (int)AdventureWorks.Dal.Adapter.v41.EntityType.SalesOrderDetailEntity, (int)AdventureWorks.Dal.Adapter.v41.EntityType.SpecialOfferProductEntity, 0, null, null, null, null, "SpecialOfferProduct", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v41.EntityType.SalesOrderDetailEntity; }
		}
