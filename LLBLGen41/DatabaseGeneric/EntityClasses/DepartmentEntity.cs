...
namespace AdventureWorks.Dal.Adapter.v41.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public DepartmentEntity():base("DepartmentEntity")
		{
		...
		public DepartmentEntity(IEntityFields2 fields):base("DepartmentEntity")
		{
		...
		public DepartmentEntity(IValidator validator):base("DepartmentEntity")
		{
		...
		public DepartmentEntity(System.Int16 departmentId):base("DepartmentEntity")
		{
			InitClassEmpty(null, null);
		...
		/// <param name="validator">The custom validator object for this DepartmentEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public DepartmentEntity(System.Int16 departmentId, IValidator validator):base("DepartmentEntity")
		{
			InitClassEmpty(validator, null);
			this.DepartmentId = departmentId;
		}
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "EmployeeDepartmentHistories":
					toReturn.Add(Relations.EmployeeDepartmentHistoryEntityUsingDepartmentId);
					break;
				default:
					break;				
			}
		...
		public virtual IRelationPredicateBucket GetRelationInfoEmployeeDepartmentHistories()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(EmployeeDepartmentHistoryFields.DepartmentId, null, ComparisonOperator.Equal, this.DepartmentId));
			return bucket;
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(DepartmentEntityFactory));
		}
#if !CF
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<EmployeeDepartmentHistoryEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeDepartmentHistoryEntityFactory))), (IEntityRelation)GetRelationsForField("EmployeeDepartmentHistories")[0], (int)AdventureWorks.Dal.Adapter.v41.EntityType.DepartmentEntity, (int)AdventureWorks.Dal.Adapter.v41.EntityType.EmployeeDepartmentHistoryEntity, 0, null, null, null, null, "EmployeeDepartmentHistories", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get { return GetOrCreateEntityCollection<EmployeeDepartmentHistoryEntity, EmployeeDepartmentHistoryEntityFactory>("Department", true, false, ref _employeeDepartmentHistories);	}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v41.EntityType.DepartmentEntity; }
		}
