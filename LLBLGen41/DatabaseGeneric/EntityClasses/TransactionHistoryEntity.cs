...
namespace AdventureWorks.Dal.Adapter.v41.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public TransactionHistoryEntity():base("TransactionHistoryEntity")
		{
		...
		public TransactionHistoryEntity(IValidator validator):base("TransactionHistoryEntity")
		{
		...
		public TransactionHistoryEntity(System.Int32 transactionId):base("TransactionHistoryEntity")
		{
			InitClassEmpty(null, null);
		...
		/// <param name="validator">The custom validator object for this TransactionHistoryEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public TransactionHistoryEntity(System.Int32 transactionId, IValidator validator):base("TransactionHistoryEntity")
		{
			InitClassEmpty(validator, null);
			this.TransactionId = transactionId;
		}
		...
		{
			switch((TransactionHistoryFieldIndex)fieldIndex)
			{
		...
		{
			return new TransactionHistoryRelations().GetAllRelations();
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(TransactionHistoryEntityFactory));
		}
#if !CF
		...
		{
			this.PerformDesetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", AdventureWorks.Dal.Adapter.v41.RelationClasses.StaticTransactionHistoryRelations.ProductEntityUsingProductIdStatic, true, signalRelatedEntity, "TransactionHistories", resetFKFields, new int[] { (int)TransactionHistoryFieldIndex.ProductId } );
			_product = null;
		}
		...
		private void SetupSyncProduct(IEntityCore relatedEntity)
		{
			if(_product!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", AdventureWorks.Dal.Adapter.v41.RelationClasses.StaticTransactionHistoryRelations.ProductEntityUsingProductIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))),	(IEntityRelation)GetRelationsForField("Product")[0], (int)AdventureWorks.Dal.Adapter.v41.EntityType.TransactionHistoryEntity, (int)AdventureWorks.Dal.Adapter.v41.EntityType.ProductEntity, 0, null, null, null, null, "Product", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		public virtual ProductEntity Product
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "TransactionHistories", "Product", _product, true); 
				}
			}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v41.EntityType.TransactionHistoryEntity; }
		}
