...
namespace AdventureWorks.Dal.Adapter.v53.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			SetupSync(relatedEntity, ref _countryRegion, new PropertyChangedEventHandler( OnCountryRegionPropertyChanged ), "CountryRegion", "SalesTerritories", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticSalesTerritoryRelations.CountryRegionEntityUsingCountryRegionCodeStatic, true, new string[] {  }, new int[] { (int)SalesTerritoryFieldIndex.CountryRegionCode }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<SalesPersonEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SalesPersonEntityFactory))), (IEntityRelation)GetRelationsForField("SalesPeople")[0], (int)AdventureWorks.Dal.Adapter.v53.EntityType.SalesTerritoryEntity, (int)AdventureWorks.Dal.Adapter.v53.EntityType.SalesPersonEntity, 0, null, null, null, null, "SalesPeople", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v53.EntityType.SalesTerritoryEntity; }
		}
