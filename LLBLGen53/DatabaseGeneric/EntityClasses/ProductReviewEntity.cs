...
namespace AdventureWorks.Dal.Adapter.v53.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public ProductReviewEntity():base("ProductReviewEntity")
		{
		...
		public ProductReviewEntity(IValidator validator):base("ProductReviewEntity")
		{
		...
		public ProductReviewEntity(System.Int32 productReviewId):base("ProductReviewEntity")
		{
			InitClassEmpty(null, null);
		...
		/// <param name="validator">The custom validator object for this ProductReviewEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ProductReviewEntity(System.Int32 productReviewId, IValidator validator):base("ProductReviewEntity")
		{
			InitClassEmpty(validator, null);
			this.ProductReviewId = productReviewId;
		}
		...
		{
			switch((ProductReviewFieldIndex)fieldIndex)
			{
		...
		{
			return new ProductReviewRelations().GetAllRelations();
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(ProductReviewEntityFactory));
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _product, new PropertyChangedEventHandler(OnProductPropertyChanged), "Product", "ProductReviews", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticProductReviewRelations.ProductEntityUsingProductIdStatic, true, new int[] { (int)ProductReviewFieldIndex.ProductId });
		}
		...
		{
			SetupSync(relatedEntity, ref _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", "ProductReviews", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticProductReviewRelations.ProductEntityUsingProductIdStatic, true, new string[] {  }, new int[] { (int)ProductReviewFieldIndex.ProductId }); 
		}
		...
		public virtual ProductEntity Product
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "ProductReviews", "Product", _product, true); 
				}
			}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v53.EntityType.ProductReviewEntity; }
		}
