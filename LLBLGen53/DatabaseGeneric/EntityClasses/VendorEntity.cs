...
namespace AdventureWorks.Dal.Adapter.v53.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			DesetupSync(signalRelatedEntity, false, ref _businessEntity, new PropertyChangedEventHandler(OnBusinessEntityPropertyChanged), "BusinessEntity", "Vendor", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticVendorRelations.BusinessEntityEntityUsingVendorIdStatic, true, new int[] { (int)VendorFieldIndex.VendorId });
		}
		...
		{
			SetupSync(relatedEntity, ref _businessEntity, new PropertyChangedEventHandler( OnBusinessEntityPropertyChanged ), "BusinessEntity", "Vendor", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticVendorRelations.BusinessEntityEntityUsingVendorIdStatic, true, new string[] {  }, new int[] { (int)VendorFieldIndex.VendorId }); 
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v53.EntityType.VendorEntity; }
		}
