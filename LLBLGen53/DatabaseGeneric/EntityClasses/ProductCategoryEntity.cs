...
namespace AdventureWorks.Dal.Adapter.v53.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ProductSubcategoryEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductSubcategoryEntityFactory))), (IEntityRelation)GetRelationsForField("ProductSubcategories")[0], (int)AdventureWorks.Dal.Adapter.v53.EntityType.ProductCategoryEntity, (int)AdventureWorks.Dal.Adapter.v53.EntityType.ProductSubcategoryEntity, 0, null, null, null, null, "ProductSubcategories", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v53.EntityType.ProductCategoryEntity; }
		}
