...
namespace AdventureWorks.Dal.Adapter.v53.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _countryRegion, new PropertyChangedEventHandler(OnCountryRegionPropertyChanged), "CountryRegion", "StateProvinces", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticStateProvinceRelations.CountryRegionEntityUsingCountryRegionCodeStatic, true, new int[] { (int)StateProvinceFieldIndex.CountryRegionCode });
		}
		...
		{
			SetupSync(relatedEntity, ref _countryRegion, new PropertyChangedEventHandler( OnCountryRegionPropertyChanged ), "CountryRegion", "StateProvinces", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticStateProvinceRelations.CountryRegionEntityUsingCountryRegionCodeStatic, true, new string[] {  }, new int[] { (int)StateProvinceFieldIndex.CountryRegionCode }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<SalesTaxRateEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SalesTaxRateEntityFactory))), (IEntityRelation)GetRelationsForField("SalesTaxRates")[0], (int)AdventureWorks.Dal.Adapter.v53.EntityType.StateProvinceEntity, (int)AdventureWorks.Dal.Adapter.v53.EntityType.SalesTaxRateEntity, 0, null, null, null, null, "SalesTaxRates", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CountryRegionEntityFactory))),	(IEntityRelation)GetRelationsForField("CountryRegion")[0], (int)AdventureWorks.Dal.Adapter.v53.EntityType.StateProvinceEntity, (int)AdventureWorks.Dal.Adapter.v53.EntityType.CountryRegionEntity, 0, null, null, null, null, "CountryRegion", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v53.EntityType.StateProvinceEntity; }
		}
