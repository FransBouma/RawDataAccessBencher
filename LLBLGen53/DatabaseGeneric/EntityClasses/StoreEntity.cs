...
namespace AdventureWorks.Dal.Adapter.v53.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _salesPerson, new PropertyChangedEventHandler(OnSalesPersonPropertyChanged), "SalesPerson", "Stores", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticStoreRelations.SalesPersonEntityUsingSalesPersonIdStatic, true, new int[] { (int)StoreFieldIndex.SalesPersonId });
		}
		...
		{
			SetupSync(relatedEntity, ref _salesPerson, new PropertyChangedEventHandler( OnSalesPersonPropertyChanged ), "SalesPerson", "Stores", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticStoreRelations.SalesPersonEntityUsingSalesPersonIdStatic, true, new string[] {  }, new int[] { (int)StoreFieldIndex.SalesPersonId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, false, ref _businessEntity, new PropertyChangedEventHandler(OnBusinessEntityPropertyChanged), "BusinessEntity", "Store", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticStoreRelations.BusinessEntityEntityUsingCustomerIdStatic, true, new int[] { (int)StoreFieldIndex.CustomerId });
		}
		...
		{
			SetupSync(relatedEntity, ref _businessEntity, new PropertyChangedEventHandler( OnBusinessEntityPropertyChanged ), "BusinessEntity", "Store", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticStoreRelations.BusinessEntityEntityUsingCustomerIdStatic, true, new string[] {  }, new int[] { (int)StoreFieldIndex.CustomerId }); 
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v53.EntityType.StoreEntity; }
		}
