...
namespace AdventureWorks.Dal.Adapter.v53.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			SetupSync(relatedEntity, ref _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", "ProductListPriceHistories", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticProductListPriceHistoryRelations.ProductEntityUsingProductIdStatic, true, new string[] {  }, new int[] { (int)ProductListPriceHistoryFieldIndex.ProductId }); 
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v53.EntityType.ProductListPriceHistoryEntity; }
		}
