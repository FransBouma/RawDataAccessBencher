...
namespace AdventureWorks.Dal.Adapter.v53.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _vendor, new PropertyChangedEventHandler(OnVendorPropertyChanged), "Vendor", "PurchaseOrderHeaders", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticPurchaseOrderHeaderRelations.VendorEntityUsingVendorIdStatic, true, new int[] { (int)PurchaseOrderHeaderFieldIndex.VendorId });
		}
		...
		{
			SetupSync(relatedEntity, ref _vendor, new PropertyChangedEventHandler( OnVendorPropertyChanged ), "Vendor", "PurchaseOrderHeaders", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticPurchaseOrderHeaderRelations.VendorEntityUsingVendorIdStatic, true, new string[] {  }, new int[] { (int)PurchaseOrderHeaderFieldIndex.VendorId }); 
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v53.EntityType.PurchaseOrderHeaderEntity; }
		}
