...
namespace AdventureWorks.Dal.Adapter.v53.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public TransactionHistoryArchiveEntity(IEntityFields2 fields):base("TransactionHistoryArchiveEntity")
		{
		...
		public TransactionHistoryArchiveEntity(IValidator validator):base("TransactionHistoryArchiveEntity")
		{
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(TransactionHistoryArchiveEntityFactory));
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v53.EntityType.TransactionHistoryArchiveEntity; }
		}
