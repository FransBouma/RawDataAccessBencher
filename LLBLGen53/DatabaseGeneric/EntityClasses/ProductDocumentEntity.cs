...
namespace AdventureWorks.Dal.Adapter.v53.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _document, new PropertyChangedEventHandler(OnDocumentPropertyChanged), "Document", "ProductDocuments", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticProductDocumentRelations.DocumentEntityUsingDocumentNodeStatic, true, new int[] { (int)ProductDocumentFieldIndex.DocumentNode });
		}
		...
		{
			SetupSync(relatedEntity, ref _document, new PropertyChangedEventHandler( OnDocumentPropertyChanged ), "Document", "ProductDocuments", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticProductDocumentRelations.DocumentEntityUsingDocumentNodeStatic, true, new string[] {  }, new int[] { (int)ProductDocumentFieldIndex.DocumentNode }); 
		}
		...
		{
			SetupSync(relatedEntity, ref _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", "ProductDocuments", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticProductDocumentRelations.ProductEntityUsingProductIdStatic, true, new string[] {  }, new int[] { (int)ProductDocumentFieldIndex.ProductId }); 
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v53.EntityType.ProductDocumentEntity; }
		}
