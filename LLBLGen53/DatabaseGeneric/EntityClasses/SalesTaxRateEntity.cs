...
namespace AdventureWorks.Dal.Adapter.v53.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			SetupSync(relatedEntity, ref _stateProvince, new PropertyChangedEventHandler( OnStateProvincePropertyChanged ), "StateProvince", "SalesTaxRates", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticSalesTaxRateRelations.StateProvinceEntityUsingStateProvinceIdStatic, true, new string[] {  }, new int[] { (int)SalesTaxRateFieldIndex.StateProvinceId }); 
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v53.EntityType.SalesTaxRateEntity; }
		}
