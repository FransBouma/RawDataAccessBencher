...
namespace AdventureWorks.Dal.Adapter.v53.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			DesetupSync(signalRelatedEntity, false, ref _businessEntity, new PropertyChangedEventHandler(OnBusinessEntityPropertyChanged), "BusinessEntity", "Person", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticPersonRelations.BusinessEntityEntityUsingBusinessEntityIdStatic, true, new int[] { (int)PersonFieldIndex.BusinessEntityId });
		}
		...
		{
			SetupSync(relatedEntity, ref _businessEntity, new PropertyChangedEventHandler( OnBusinessEntityPropertyChanged ), "BusinessEntity", "Person", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticPersonRelations.BusinessEntityEntityUsingBusinessEntityIdStatic, true, new string[] {  }, new int[] { (int)PersonFieldIndex.BusinessEntityId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, false, ref _employee, new PropertyChangedEventHandler(OnEmployeePropertyChanged), "Employee", "Person", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticPersonRelations.EmployeeEntityUsingEmployeeIdStatic, false, new int[] { (int)PersonFieldIndex.BusinessEntityId });
		}
		...
		{
			SetupSync(relatedEntity, ref _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", "Person", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticPersonRelations.EmployeeEntityUsingEmployeeIdStatic, false, new string[] {  }, new int[] { (int)PersonFieldIndex.BusinessEntityId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, false, ref _password, new PropertyChangedEventHandler(OnPasswordPropertyChanged), "Password", "Person", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticPersonRelations.PasswordEntityUsingBusinessEntityIdStatic, false, new int[] { (int)PersonFieldIndex.BusinessEntityId });
		}
		...
		{
			SetupSync(relatedEntity, ref _password, new PropertyChangedEventHandler( OnPasswordPropertyChanged ), "Password", "Person", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticPersonRelations.PasswordEntityUsingBusinessEntityIdStatic, false, new string[] {  }, new int[] { (int)PersonFieldIndex.BusinessEntityId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<CustomerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CustomerEntityFactory))), (IEntityRelation)GetRelationsForField("Customers")[0], (int)AdventureWorks.Dal.Adapter.v53.EntityType.PersonEntity, (int)AdventureWorks.Dal.Adapter.v53.EntityType.CustomerEntity, 0, null, null, null, null, "Customers", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<EmailAddressEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmailAddressEntityFactory))), (IEntityRelation)GetRelationsForField("EmailAddresses")[0], (int)AdventureWorks.Dal.Adapter.v53.EntityType.PersonEntity, (int)AdventureWorks.Dal.Adapter.v53.EntityType.EmailAddressEntity, 0, null, null, null, null, "EmailAddresses", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get { return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(PasswordEntityFactory))), (IEntityRelation)GetRelationsForField("Password")[0], (int)AdventureWorks.Dal.Adapter.v53.EntityType.PersonEntity, (int)AdventureWorks.Dal.Adapter.v53.EntityType.PasswordEntity, 0, null, null, null, null, "Password", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);	}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v53.EntityType.PersonEntity; }
		}
