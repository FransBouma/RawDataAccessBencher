...
namespace AdventureWorks.Dal.Adapter.v53.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			SetupSync(relatedEntity, ref _person, new PropertyChangedEventHandler( OnPersonPropertyChanged ), "Person", "ContactCreditCards", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticContactCreditCardRelations.PersonEntityUsingContactIdStatic, true, new string[] {  }, new int[] { (int)ContactCreditCardFieldIndex.ContactId }); 
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v53.EntityType.ContactCreditCardEntity; }
		}
