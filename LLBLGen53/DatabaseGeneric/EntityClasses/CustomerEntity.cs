...
namespace AdventureWorks.Dal.Adapter.v53.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _person, new PropertyChangedEventHandler(OnPersonPropertyChanged), "Person", "Customers", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticCustomerRelations.PersonEntityUsingPersonIdStatic, true, new int[] { (int)CustomerFieldIndex.PersonId });
		}
		...
		{
			SetupSync(relatedEntity, ref _person, new PropertyChangedEventHandler( OnPersonPropertyChanged ), "Person", "Customers", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticCustomerRelations.PersonEntityUsingPersonIdStatic, true, new string[] {  }, new int[] { (int)CustomerFieldIndex.PersonId }); 
		}
		...
		{
			SetupSync(relatedEntity, ref _salesTerritory, new PropertyChangedEventHandler( OnSalesTerritoryPropertyChanged ), "SalesTerritory", "Customers", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticCustomerRelations.SalesTerritoryEntityUsingTerritoryIdStatic, true, new string[] {  }, new int[] { (int)CustomerFieldIndex.TerritoryId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _store, new PropertyChangedEventHandler(OnStorePropertyChanged), "Store", "Customers", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticCustomerRelations.StoreEntityUsingStoreIdStatic, true, new int[] { (int)CustomerFieldIndex.StoreId });
		}
		...
		{
			SetupSync(relatedEntity, ref _store, new PropertyChangedEventHandler( OnStorePropertyChanged ), "Store", "Customers", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticCustomerRelations.StoreEntityUsingStoreIdStatic, true, new string[] {  }, new int[] { (int)CustomerFieldIndex.StoreId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(StoreEntityFactory))),	(IEntityRelation)GetRelationsForField("Store")[0], (int)AdventureWorks.Dal.Adapter.v53.EntityType.CustomerEntity, (int)AdventureWorks.Dal.Adapter.v53.EntityType.StoreEntity, 0, null, null, null, null, "Store", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v53.EntityType.CustomerEntity; }
		}
