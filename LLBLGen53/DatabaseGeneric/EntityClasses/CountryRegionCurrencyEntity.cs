...
namespace AdventureWorks.Dal.Adapter.v53.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			SetupSync(relatedEntity, ref _countryRegion, new PropertyChangedEventHandler( OnCountryRegionPropertyChanged ), "CountryRegion", "CountryRegionCurrencies", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticCountryRegionCurrencyRelations.CountryRegionEntityUsingCountryRegionCodeStatic, true, new string[] {  }, new int[] { (int)CountryRegionCurrencyFieldIndex.CountryRegionCode }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _currency, new PropertyChangedEventHandler(OnCurrencyPropertyChanged), "Currency", "CountryRegionCurrencies", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticCountryRegionCurrencyRelations.CurrencyEntityUsingCurrencyCodeStatic, true, new int[] { (int)CountryRegionCurrencyFieldIndex.CurrencyCode });
		}
		...
		{
			SetupSync(relatedEntity, ref _currency, new PropertyChangedEventHandler( OnCurrencyPropertyChanged ), "Currency", "CountryRegionCurrencies", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticCountryRegionCurrencyRelations.CurrencyEntityUsingCurrencyCodeStatic, true, new string[] {  }, new int[] { (int)CountryRegionCurrencyFieldIndex.CurrencyCode }); 
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v53.EntityType.CountryRegionCurrencyEntity; }
		}
