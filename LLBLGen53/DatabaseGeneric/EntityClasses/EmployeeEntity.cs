...
namespace AdventureWorks.Dal.Adapter.v53.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			DesetupSync(signalRelatedEntity, false, ref _person, new PropertyChangedEventHandler(OnPersonPropertyChanged), "Person", "Employee", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticEmployeeRelations.PersonEntityUsingEmployeeIdStatic, true, new int[] { (int)EmployeeFieldIndex.EmployeeId });
		}
		...
		{
			SetupSync(relatedEntity, ref _person, new PropertyChangedEventHandler( OnPersonPropertyChanged ), "Person", "Employee", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticEmployeeRelations.PersonEntityUsingEmployeeIdStatic, true, new string[] {  }, new int[] { (int)EmployeeFieldIndex.EmployeeId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, false, ref _salesPerson, new PropertyChangedEventHandler(OnSalesPersonPropertyChanged), "SalesPerson", "Employee", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticEmployeeRelations.SalesPersonEntityUsingSalesPersonIdStatic, false, new int[] { (int)EmployeeFieldIndex.EmployeeId });
		}
		...
		{
			SetupSync(relatedEntity, ref _salesPerson, new PropertyChangedEventHandler( OnSalesPersonPropertyChanged ), "SalesPerson", "Employee", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticEmployeeRelations.SalesPersonEntityUsingSalesPersonIdStatic, false, new string[] {  }, new int[] { (int)EmployeeFieldIndex.EmployeeId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<JobCandidateEntity>(EntityFactoryCache2.GetEntityFactory(typeof(JobCandidateEntityFactory))), (IEntityRelation)GetRelationsForField("JobCandidates")[0], (int)AdventureWorks.Dal.Adapter.v53.EntityType.EmployeeEntity, (int)AdventureWorks.Dal.Adapter.v53.EntityType.JobCandidateEntity, 0, null, null, null, null, "JobCandidates", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v53.EntityType.EmployeeEntity; }
		}
