...
namespace AdventureWorks.Dal.Adapter.v53.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _businessEntity, new PropertyChangedEventHandler(OnBusinessEntityPropertyChanged), "BusinessEntity", "BusinessEntityContacts", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticBusinessEntityContactRelations.BusinessEntityEntityUsingBusinessEntityIdStatic, true, new int[] { (int)BusinessEntityContactFieldIndex.BusinessEntityId });
		}
		...
		{
			SetupSync(relatedEntity, ref _businessEntity, new PropertyChangedEventHandler( OnBusinessEntityPropertyChanged ), "BusinessEntity", "BusinessEntityContacts", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticBusinessEntityContactRelations.BusinessEntityEntityUsingBusinessEntityIdStatic, true, new string[] {  }, new int[] { (int)BusinessEntityContactFieldIndex.BusinessEntityId }); 
		}
		...
		{
			SetupSync(relatedEntity, ref _contactType, new PropertyChangedEventHandler( OnContactTypePropertyChanged ), "ContactType", "BusinessEntityContacts", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticBusinessEntityContactRelations.ContactTypeEntityUsingContactTypeIdStatic, true, new string[] {  }, new int[] { (int)BusinessEntityContactFieldIndex.ContactTypeId }); 
		}
		...
		{
			SetupSync(relatedEntity, ref _person, new PropertyChangedEventHandler( OnPersonPropertyChanged ), "Person", "BusinessEntityContacts", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticBusinessEntityContactRelations.PersonEntityUsingPersonIdStatic, true, new string[] {  }, new int[] { (int)BusinessEntityContactFieldIndex.PersonId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ContactTypeEntityFactory))),	(IEntityRelation)GetRelationsForField("ContactType")[0], (int)AdventureWorks.Dal.Adapter.v53.EntityType.BusinessEntityContactEntity, (int)AdventureWorks.Dal.Adapter.v53.EntityType.ContactTypeEntity, 0, null, null, null, null, "ContactType", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v53.EntityType.BusinessEntityContactEntity; }
		}
