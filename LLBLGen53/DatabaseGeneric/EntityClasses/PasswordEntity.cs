...
namespace AdventureWorks.Dal.Adapter.v53.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			DesetupSync(signalRelatedEntity, false, ref _person, new PropertyChangedEventHandler(OnPersonPropertyChanged), "Person", "Password", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticPasswordRelations.PersonEntityUsingBusinessEntityIdStatic, true, new int[] { (int)PasswordFieldIndex.BusinessEntityId });
		}
		...
		{
			SetupSync(relatedEntity, ref _person, new PropertyChangedEventHandler( OnPersonPropertyChanged ), "Person", "Password", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticPasswordRelations.PersonEntityUsingBusinessEntityIdStatic, true, new string[] {  }, new int[] { (int)PasswordFieldIndex.BusinessEntityId }); 
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v53.EntityType.PasswordEntity; }
		}
