...
namespace AdventureWorks.Dal.Adapter.v53.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			SetupSync(relatedEntity, ref _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", "SpecialOfferProducts", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticSpecialOfferProductRelations.ProductEntityUsingProductIdStatic, true, new string[] {  }, new int[] { (int)SpecialOfferProductFieldIndex.ProductId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _specialOffer, new PropertyChangedEventHandler(OnSpecialOfferPropertyChanged), "SpecialOffer", "SpecialOfferProducts", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticSpecialOfferProductRelations.SpecialOfferEntityUsingSpecialOfferIdStatic, true, new int[] { (int)SpecialOfferProductFieldIndex.SpecialOfferId });
		}
		...
		{
			SetupSync(relatedEntity, ref _specialOffer, new PropertyChangedEventHandler( OnSpecialOfferPropertyChanged ), "SpecialOffer", "SpecialOfferProducts", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticSpecialOfferProductRelations.SpecialOfferEntityUsingSpecialOfferIdStatic, true, new string[] {  }, new int[] { (int)SpecialOfferProductFieldIndex.SpecialOfferId }); 
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v53.EntityType.SpecialOfferProductEntity; }
		}
