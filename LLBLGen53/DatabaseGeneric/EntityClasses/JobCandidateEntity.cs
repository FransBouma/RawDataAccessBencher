...
namespace AdventureWorks.Dal.Adapter.v53.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			SetupSync(relatedEntity, ref _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", "JobCandidates", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticJobCandidateRelations.EmployeeEntityUsingEmployeeIdStatic, true, new string[] {  }, new int[] { (int)JobCandidateFieldIndex.EmployeeId }); 
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v53.EntityType.JobCandidateEntity; }
		}
