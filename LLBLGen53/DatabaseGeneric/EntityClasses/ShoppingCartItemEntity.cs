...
namespace AdventureWorks.Dal.Adapter.v53.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			SetupSync(relatedEntity, ref _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", "ShoppingCartItems", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticShoppingCartItemRelations.ProductEntityUsingProductIdStatic, true, new string[] {  }, new int[] { (int)ShoppingCartItemFieldIndex.ProductId }); 
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v53.EntityType.ShoppingCartItemEntity; }
		}
