...
namespace AdventureWorks.Dal.Adapter.v53.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			SetupSync(relatedEntity, ref _salesTerritory, new PropertyChangedEventHandler( OnSalesTerritoryPropertyChanged ), "SalesTerritory", "SalesPeople", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticSalesPersonRelations.SalesTerritoryEntityUsingTerritoryIdStatic, true, new string[] {  }, new int[] { (int)SalesPersonFieldIndex.TerritoryId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, false, ref _employee, new PropertyChangedEventHandler(OnEmployeePropertyChanged), "Employee", "SalesPerson", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticSalesPersonRelations.EmployeeEntityUsingSalesPersonIdStatic, true, new int[] { (int)SalesPersonFieldIndex.SalesPersonId });
		}
		...
		{
			SetupSync(relatedEntity, ref _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", "SalesPerson", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticSalesPersonRelations.EmployeeEntityUsingSalesPersonIdStatic, true, new string[] {  }, new int[] { (int)SalesPersonFieldIndex.SalesPersonId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<StoreEntity>(EntityFactoryCache2.GetEntityFactory(typeof(StoreEntityFactory))), (IEntityRelation)GetRelationsForField("Stores")[0], (int)AdventureWorks.Dal.Adapter.v53.EntityType.SalesPersonEntity, (int)AdventureWorks.Dal.Adapter.v53.EntityType.StoreEntity, 0, null, null, null, null, "Stores", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v53.EntityType.SalesPersonEntity; }
		}
