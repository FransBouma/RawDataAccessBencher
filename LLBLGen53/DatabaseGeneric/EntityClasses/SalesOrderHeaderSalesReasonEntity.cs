...
namespace AdventureWorks.Dal.Adapter.v53.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			SetupSync(relatedEntity, ref _salesOrderHeader, new PropertyChangedEventHandler( OnSalesOrderHeaderPropertyChanged ), "SalesOrderHeader", "SalesOrderHeaderSalesReasons", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticSalesOrderHeaderSalesReasonRelations.SalesOrderHeaderEntityUsingSalesOrderIdStatic, true, new string[] {  }, new int[] { (int)SalesOrderHeaderSalesReasonFieldIndex.SalesOrderId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _salesReason, new PropertyChangedEventHandler(OnSalesReasonPropertyChanged), "SalesReason", "SalesOrderHeaderSalesReasons", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticSalesOrderHeaderSalesReasonRelations.SalesReasonEntityUsingSalesReasonIdStatic, true, new int[] { (int)SalesOrderHeaderSalesReasonFieldIndex.SalesReasonId });
		}
		...
		{
			SetupSync(relatedEntity, ref _salesReason, new PropertyChangedEventHandler( OnSalesReasonPropertyChanged ), "SalesReason", "SalesOrderHeaderSalesReasons", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticSalesOrderHeaderSalesReasonRelations.SalesReasonEntityUsingSalesReasonIdStatic, true, new string[] {  }, new int[] { (int)SalesOrderHeaderSalesReasonFieldIndex.SalesReasonId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(SalesReasonEntityFactory))),	(IEntityRelation)GetRelationsForField("SalesReason")[0], (int)AdventureWorks.Dal.Adapter.v53.EntityType.SalesOrderHeaderSalesReasonEntity, (int)AdventureWorks.Dal.Adapter.v53.EntityType.SalesReasonEntity, 0, null, null, null, null, "SalesReason", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v53.EntityType.SalesOrderHeaderSalesReasonEntity; }
		}
