...
namespace AdventureWorks.Dal.Adapter.v53.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			SetupSync(relatedEntity, ref _illustration, new PropertyChangedEventHandler( OnIllustrationPropertyChanged ), "Illustration", "ProductModelIllustrations", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticProductModelIllustrationRelations.IllustrationEntityUsingIllustrationIdStatic, true, new string[] {  }, new int[] { (int)ProductModelIllustrationFieldIndex.IllustrationId }); 
		}
		...
		{
			SetupSync(relatedEntity, ref _productModel, new PropertyChangedEventHandler( OnProductModelPropertyChanged ), "ProductModel", "ProductModelIllustrations", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticProductModelIllustrationRelations.ProductModelEntityUsingProductModelIdStatic, true, new string[] {  }, new int[] { (int)ProductModelIllustrationFieldIndex.ProductModelId }); 
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v53.EntityType.ProductModelIllustrationEntity; }
		}
