...
namespace AdventureWorks.Dal.Adapter.v53.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			SetupSync(relatedEntity, ref _person, new PropertyChangedEventHandler( OnPersonPropertyChanged ), "Person", "BusinessEntity", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticBusinessEntityRelations.PersonEntityUsingBusinessEntityIdStatic, false, new string[] {  }, new int[] { (int)BusinessEntityFieldIndex.BusinessEntityId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, false, ref _store, new PropertyChangedEventHandler(OnStorePropertyChanged), "Store", "BusinessEntity", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticBusinessEntityRelations.StoreEntityUsingCustomerIdStatic, false, new int[] { (int)BusinessEntityFieldIndex.BusinessEntityId });
		}
		...
		{
			SetupSync(relatedEntity, ref _store, new PropertyChangedEventHandler( OnStorePropertyChanged ), "Store", "BusinessEntity", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticBusinessEntityRelations.StoreEntityUsingCustomerIdStatic, false, new string[] {  }, new int[] { (int)BusinessEntityFieldIndex.BusinessEntityId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, false, ref _vendor, new PropertyChangedEventHandler(OnVendorPropertyChanged), "Vendor", "BusinessEntity", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticBusinessEntityRelations.VendorEntityUsingVendorIdStatic, false, new int[] { (int)BusinessEntityFieldIndex.BusinessEntityId });
		}
		...
		{
			SetupSync(relatedEntity, ref _vendor, new PropertyChangedEventHandler( OnVendorPropertyChanged ), "Vendor", "BusinessEntity", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticBusinessEntityRelations.VendorEntityUsingVendorIdStatic, false, new string[] {  }, new int[] { (int)BusinessEntityFieldIndex.BusinessEntityId }); 
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v53.EntityType.BusinessEntityEntity; }
		}
