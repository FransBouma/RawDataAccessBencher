...
namespace AdventureWorks.Dal.Adapter.v53.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _productModel, new PropertyChangedEventHandler(OnProductModelPropertyChanged), "ProductModel", "Products", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticProductRelations.ProductModelEntityUsingProductModelIdStatic, true, new int[] { (int)ProductFieldIndex.ProductModelId });
		}
		...
		{
			SetupSync(relatedEntity, ref _productModel, new PropertyChangedEventHandler( OnProductModelPropertyChanged ), "ProductModel", "Products", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticProductRelations.ProductModelEntityUsingProductModelIdStatic, true, new string[] {  }, new int[] { (int)ProductFieldIndex.ProductModelId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _productSubcategory, new PropertyChangedEventHandler(OnProductSubcategoryPropertyChanged), "ProductSubcategory", "Products", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticProductRelations.ProductSubcategoryEntityUsingProductSubcategoryIdStatic, true, new int[] { (int)ProductFieldIndex.ProductSubcategoryId });
		}
		...
		{
			SetupSync(relatedEntity, ref _productSubcategory, new PropertyChangedEventHandler( OnProductSubcategoryPropertyChanged ), "ProductSubcategory", "Products", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticProductRelations.ProductSubcategoryEntityUsingProductSubcategoryIdStatic, true, new string[] {  }, new int[] { (int)ProductFieldIndex.ProductSubcategoryId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _unitMeasure_, new PropertyChangedEventHandler(OnUnitMeasure_PropertyChanged), "UnitMeasure_", "Products_", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticProductRelations.UnitMeasureEntityUsingWeightUnitMeasureCodeStatic, true, new int[] { (int)ProductFieldIndex.WeightUnitMeasureCode });
		}
		...
		{
			SetupSync(relatedEntity, ref _unitMeasure_, new PropertyChangedEventHandler( OnUnitMeasure_PropertyChanged ), "UnitMeasure_", "Products_", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticProductRelations.UnitMeasureEntityUsingWeightUnitMeasureCodeStatic, true, new string[] {  }, new int[] { (int)ProductFieldIndex.WeightUnitMeasureCode }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ProductProductPhotoEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductProductPhotoEntityFactory))), (IEntityRelation)GetRelationsForField("ProductProductPhotos")[0], (int)AdventureWorks.Dal.Adapter.v53.EntityType.ProductEntity, (int)AdventureWorks.Dal.Adapter.v53.EntityType.ProductProductPhotoEntity, 0, null, null, null, null, "ProductProductPhotos", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ProductReviewEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductReviewEntityFactory))), (IEntityRelation)GetRelationsForField("ProductReviews")[0], (int)AdventureWorks.Dal.Adapter.v53.EntityType.ProductEntity, (int)AdventureWorks.Dal.Adapter.v53.EntityType.ProductReviewEntity, 0, null, null, null, null, "ProductReviews", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductSubcategoryEntityFactory))),	(IEntityRelation)GetRelationsForField("ProductSubcategory")[0], (int)AdventureWorks.Dal.Adapter.v53.EntityType.ProductEntity, (int)AdventureWorks.Dal.Adapter.v53.EntityType.ProductSubcategoryEntity, 0, null, null, null, null, "ProductSubcategory", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(UnitMeasureEntityFactory))),	(IEntityRelation)GetRelationsForField("UnitMeasure")[0], (int)AdventureWorks.Dal.Adapter.v53.EntityType.ProductEntity, (int)AdventureWorks.Dal.Adapter.v53.EntityType.UnitMeasureEntity, 0, null, null, null, null, "UnitMeasure", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(UnitMeasureEntityFactory))),	(IEntityRelation)GetRelationsForField("UnitMeasure_")[0], (int)AdventureWorks.Dal.Adapter.v53.EntityType.ProductEntity, (int)AdventureWorks.Dal.Adapter.v53.EntityType.UnitMeasureEntity, 0, null, null, null, null, "UnitMeasure_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v53.EntityType.ProductEntity; }
		}
