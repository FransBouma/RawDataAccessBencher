...
namespace AdventureWorks.Dal.Adapter.v53.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			SetupSync(relatedEntity, ref _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", "TransactionHistories", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticTransactionHistoryRelations.ProductEntityUsingProductIdStatic, true, new string[] {  }, new int[] { (int)TransactionHistoryFieldIndex.ProductId }); 
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v53.EntityType.TransactionHistoryEntity; }
		}
