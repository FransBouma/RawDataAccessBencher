...
namespace AdventureWorks.Dal.Adapter.v53.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _product, new PropertyChangedEventHandler(OnProductPropertyChanged), "Product", "ProductVendors", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticProductVendorRelations.ProductEntityUsingProductIdStatic, true, new int[] { (int)ProductVendorFieldIndex.ProductId });
		}
		...
		{
			SetupSync(relatedEntity, ref _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", "ProductVendors", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticProductVendorRelations.ProductEntityUsingProductIdStatic, true, new string[] {  }, new int[] { (int)ProductVendorFieldIndex.ProductId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _vendor, new PropertyChangedEventHandler(OnVendorPropertyChanged), "Vendor", "ProductVendors", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticProductVendorRelations.VendorEntityUsingVendorIdStatic, true, new int[] { (int)ProductVendorFieldIndex.VendorId });
		}
		...
		{
			SetupSync(relatedEntity, ref _vendor, new PropertyChangedEventHandler( OnVendorPropertyChanged ), "Vendor", "ProductVendors", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticProductVendorRelations.VendorEntityUsingVendorIdStatic, true, new string[] {  }, new int[] { (int)ProductVendorFieldIndex.VendorId }); 
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v53.EntityType.ProductVendorEntity; }
		}
