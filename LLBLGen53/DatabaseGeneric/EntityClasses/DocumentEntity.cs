...
namespace AdventureWorks.Dal.Adapter.v53.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public IPredicateExpression ConstructFilterForUCRowguid()
		{
			...
			filter.Add(AdventureWorks.Dal.Adapter.v53.HelperClasses.DocumentFields.Rowguid == this.Fields.GetCurrentValue((int)DocumentFieldIndex.Rowguid));
 			return filter;
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _employee, new PropertyChangedEventHandler(OnEmployeePropertyChanged), "Employee", "Documents", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticDocumentRelations.EmployeeEntityUsingOwnerStatic, true, new int[] { (int)DocumentFieldIndex.Owner });
		}
		...
		{
			SetupSync(relatedEntity, ref _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", "Documents", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticDocumentRelations.EmployeeEntityUsingOwnerStatic, true, new string[] {  }, new int[] { (int)DocumentFieldIndex.Owner }); 
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v53.EntityType.DocumentEntity; }
		}
