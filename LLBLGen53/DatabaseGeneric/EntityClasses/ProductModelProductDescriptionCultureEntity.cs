...
namespace AdventureWorks.Dal.Adapter.v53.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _culture, new PropertyChangedEventHandler(OnCulturePropertyChanged), "Culture", "ProductModelProductDescriptionCultures", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticProductModelProductDescriptionCultureRelations.CultureEntityUsingCultureIdStatic, true, new int[] { (int)ProductModelProductDescriptionCultureFieldIndex.CultureId });
		}
		...
		{
			SetupSync(relatedEntity, ref _culture, new PropertyChangedEventHandler( OnCulturePropertyChanged ), "Culture", "ProductModelProductDescriptionCultures", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticProductModelProductDescriptionCultureRelations.CultureEntityUsingCultureIdStatic, true, new string[] {  }, new int[] { (int)ProductModelProductDescriptionCultureFieldIndex.CultureId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _productDescription, new PropertyChangedEventHandler(OnProductDescriptionPropertyChanged), "ProductDescription", "ProductModelProductDescriptionCultures", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticProductModelProductDescriptionCultureRelations.ProductDescriptionEntityUsingProductDescriptionIdStatic, true, new int[] { (int)ProductModelProductDescriptionCultureFieldIndex.ProductDescriptionId });
		}
		...
		{
			SetupSync(relatedEntity, ref _productDescription, new PropertyChangedEventHandler( OnProductDescriptionPropertyChanged ), "ProductDescription", "ProductModelProductDescriptionCultures", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticProductModelProductDescriptionCultureRelations.ProductDescriptionEntityUsingProductDescriptionIdStatic, true, new string[] {  }, new int[] { (int)ProductModelProductDescriptionCultureFieldIndex.ProductDescriptionId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CultureEntityFactory))),	(IEntityRelation)GetRelationsForField("Culture")[0], (int)AdventureWorks.Dal.Adapter.v53.EntityType.ProductModelProductDescriptionCultureEntity, (int)AdventureWorks.Dal.Adapter.v53.EntityType.CultureEntity, 0, null, null, null, null, "Culture", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v53.EntityType.ProductModelProductDescriptionCultureEntity; }
		}
