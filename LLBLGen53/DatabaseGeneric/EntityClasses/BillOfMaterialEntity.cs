...
namespace AdventureWorks.Dal.Adapter.v53.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			SetupSync(relatedEntity, ref _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", "BillOfMaterials", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticBillOfMaterialRelations.ProductEntityUsingComponentIdStatic, true, new string[] {  }, new int[] { (int)BillOfMaterialFieldIndex.ComponentId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _product_, new PropertyChangedEventHandler(OnProduct_PropertyChanged), "Product_", "BillOfMaterials_", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticBillOfMaterialRelations.ProductEntityUsingProductAssemblyIdStatic, true, new int[] { (int)BillOfMaterialFieldIndex.ProductAssemblyId });
		}
		...
		{
			SetupSync(relatedEntity, ref _product_, new PropertyChangedEventHandler( OnProduct_PropertyChanged ), "Product_", "BillOfMaterials_", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticBillOfMaterialRelations.ProductEntityUsingProductAssemblyIdStatic, true, new string[] {  }, new int[] { (int)BillOfMaterialFieldIndex.ProductAssemblyId }); 
		}
		...
		{
			SetupSync(relatedEntity, ref _unitMeasure, new PropertyChangedEventHandler( OnUnitMeasurePropertyChanged ), "UnitMeasure", "BillOfMaterials", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticBillOfMaterialRelations.UnitMeasureEntityUsingUnitMeasureCodeStatic, true, new string[] {  }, new int[] { (int)BillOfMaterialFieldIndex.UnitMeasureCode }); 
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v53.EntityType.BillOfMaterialEntity; }
		}
