...
namespace AdventureWorks.Dal.Adapter.v53.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _address, new PropertyChangedEventHandler(OnAddressPropertyChanged), "Address", "SalesOrderHeaders", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticSalesOrderHeaderRelations.AddressEntityUsingBillToAddressIdStatic, true, new int[] { (int)SalesOrderHeaderFieldIndex.BillToAddressId });
		}
		...
		{
			SetupSync(relatedEntity, ref _address, new PropertyChangedEventHandler( OnAddressPropertyChanged ), "Address", "SalesOrderHeaders", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticSalesOrderHeaderRelations.AddressEntityUsingBillToAddressIdStatic, true, new string[] {  }, new int[] { (int)SalesOrderHeaderFieldIndex.BillToAddressId }); 
		}
		...
		{
			SetupSync(relatedEntity, ref _creditCard, new PropertyChangedEventHandler( OnCreditCardPropertyChanged ), "CreditCard", "SalesOrderHeaders", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticSalesOrderHeaderRelations.CreditCardEntityUsingCreditCardIdStatic, true, new string[] {  }, new int[] { (int)SalesOrderHeaderFieldIndex.CreditCardId }); 
		}
		...
		{
			SetupSync(relatedEntity, ref _currencyRate, new PropertyChangedEventHandler( OnCurrencyRatePropertyChanged ), "CurrencyRate", "SalesOrderHeaders", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticSalesOrderHeaderRelations.CurrencyRateEntityUsingCurrencyRateIdStatic, true, new string[] {  }, new int[] { (int)SalesOrderHeaderFieldIndex.CurrencyRateId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _customer, new PropertyChangedEventHandler(OnCustomerPropertyChanged), "Customer", "SalesOrderHeaders", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticSalesOrderHeaderRelations.CustomerEntityUsingCustomerIdStatic, true, new int[] { (int)SalesOrderHeaderFieldIndex.CustomerId });
		}
		...
		{
			SetupSync(relatedEntity, ref _customer, new PropertyChangedEventHandler( OnCustomerPropertyChanged ), "Customer", "SalesOrderHeaders", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticSalesOrderHeaderRelations.CustomerEntityUsingCustomerIdStatic, true, new string[] {  }, new int[] { (int)SalesOrderHeaderFieldIndex.CustomerId }); 
		}
		...
		{
			SetupSync(relatedEntity, ref _salesTerritory, new PropertyChangedEventHandler( OnSalesTerritoryPropertyChanged ), "SalesTerritory", "SalesOrderHeaders", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticSalesOrderHeaderRelations.SalesTerritoryEntityUsingTerritoryIdStatic, true, new string[] {  }, new int[] { (int)SalesOrderHeaderFieldIndex.TerritoryId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _shipMethod, new PropertyChangedEventHandler(OnShipMethodPropertyChanged), "ShipMethod", "SalesOrderHeaders", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticSalesOrderHeaderRelations.ShipMethodEntityUsingShipMethodIdStatic, true, new int[] { (int)SalesOrderHeaderFieldIndex.ShipMethodId });
		}
		...
		{
			SetupSync(relatedEntity, ref _shipMethod, new PropertyChangedEventHandler( OnShipMethodPropertyChanged ), "ShipMethod", "SalesOrderHeaders", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticSalesOrderHeaderRelations.ShipMethodEntityUsingShipMethodIdStatic, true, new string[] {  }, new int[] { (int)SalesOrderHeaderFieldIndex.ShipMethodId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<SalesOrderDetailEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SalesOrderDetailEntityFactory))), (IEntityRelation)GetRelationsForField("SalesOrderDetails")[0], (int)AdventureWorks.Dal.Adapter.v53.EntityType.SalesOrderHeaderEntity, (int)AdventureWorks.Dal.Adapter.v53.EntityType.SalesOrderDetailEntity, 0, null, null, null, null, "SalesOrderDetails", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AddressEntityFactory))),	(IEntityRelation)GetRelationsForField("Address")[0], (int)AdventureWorks.Dal.Adapter.v53.EntityType.SalesOrderHeaderEntity, (int)AdventureWorks.Dal.Adapter.v53.EntityType.AddressEntity, 0, null, null, null, null, "Address", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CustomerEntityFactory))),	(IEntityRelation)GetRelationsForField("Customer")[0], (int)AdventureWorks.Dal.Adapter.v53.EntityType.SalesOrderHeaderEntity, (int)AdventureWorks.Dal.Adapter.v53.EntityType.CustomerEntity, 0, null, null, null, null, "Customer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(SalesPersonEntityFactory))),	(IEntityRelation)GetRelationsForField("SalesPerson")[0], (int)AdventureWorks.Dal.Adapter.v53.EntityType.SalesOrderHeaderEntity, (int)AdventureWorks.Dal.Adapter.v53.EntityType.SalesPersonEntity, 0, null, null, null, null, "SalesPerson", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(SalesTerritoryEntityFactory))),	(IEntityRelation)GetRelationsForField("SalesTerritory")[0], (int)AdventureWorks.Dal.Adapter.v53.EntityType.SalesOrderHeaderEntity, (int)AdventureWorks.Dal.Adapter.v53.EntityType.SalesTerritoryEntity, 0, null, null, null, null, "SalesTerritory", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ShipMethodEntityFactory))),	(IEntityRelation)GetRelationsForField("ShipMethod")[0], (int)AdventureWorks.Dal.Adapter.v53.EntityType.SalesOrderHeaderEntity, (int)AdventureWorks.Dal.Adapter.v53.EntityType.ShipMethodEntity, 0, null, null, null, null, "ShipMethod", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v53.EntityType.SalesOrderHeaderEntity; }
		}
