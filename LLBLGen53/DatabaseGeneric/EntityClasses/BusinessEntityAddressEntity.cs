...
namespace AdventureWorks.Dal.Adapter.v53.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			SetupSync(relatedEntity, ref _address, new PropertyChangedEventHandler( OnAddressPropertyChanged ), "Address", "BusinessEntityAddresses", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticBusinessEntityAddressRelations.AddressEntityUsingAddressIdStatic, true, new string[] {  }, new int[] { (int)BusinessEntityAddressFieldIndex.AddressId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _addressType, new PropertyChangedEventHandler(OnAddressTypePropertyChanged), "AddressType", "BusinessEntityAddresses", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticBusinessEntityAddressRelations.AddressTypeEntityUsingAddressTypeIdStatic, true, new int[] { (int)BusinessEntityAddressFieldIndex.AddressTypeId });
		}
		...
		{
			SetupSync(relatedEntity, ref _addressType, new PropertyChangedEventHandler( OnAddressTypePropertyChanged ), "AddressType", "BusinessEntityAddresses", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticBusinessEntityAddressRelations.AddressTypeEntityUsingAddressTypeIdStatic, true, new string[] {  }, new int[] { (int)BusinessEntityAddressFieldIndex.AddressTypeId }); 
		}
		...
		{
			SetupSync(relatedEntity, ref _businessEntity, new PropertyChangedEventHandler( OnBusinessEntityPropertyChanged ), "BusinessEntity", "BusinessEntityAddresses", AdventureWorks.Dal.Adapter.v53.RelationClasses.StaticBusinessEntityAddressRelations.BusinessEntityEntityUsingBusinessEntityIdStatic, true, new string[] {  }, new int[] { (int)BusinessEntityAddressFieldIndex.BusinessEntityId }); 
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v53.EntityType.BusinessEntityAddressEntity; }
		}
