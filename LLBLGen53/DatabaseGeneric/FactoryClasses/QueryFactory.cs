...
namespace AdventureWorks.Dal.Adapter.v53.FactoryClasses
{
	...
	public partial class QueryFactory
	{
		...
		public DynamicQuery<AdventureWorks.Dal.Adapter.v53.TypedViewClasses.SohQuerySpecPocoRow> SohQuerySpecPoco
		{
			get { return this.Create().Select<AdventureWorks.Dal.Adapter.v53.TypedViewClasses.SohQuerySpecPocoRow, AdventureWorks.Dal.Adapter.v53.HelperClasses.SohQuerySpecPocoFields>(); }
		}
