...
namespace AdventureWorks.Dal.Adapter.v50.FactoryClasses
{
	...
	public partial class QueryFactory
	{
		...
		public DynamicQuery<AdventureWorks.Dal.Adapter.v50.TypedViewClasses.SohQuerySpecPocoRow> SohQuerySpecPoco
		{
			get { return this.Create().Select<AdventureWorks.Dal.Adapter.v50.TypedViewClasses.SohQuerySpecPocoRow, AdventureWorks.Dal.Adapter.v50.HelperClasses.SohQuerySpecPocoFields>(); }
		}
