		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private void SetupSyncIllustration(IEntityCore relatedEntity)
		{
			if(_illustration!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _illustration, new PropertyChangedEventHandler( OnIllustrationPropertyChanged ), "Illustration", AdventureWorks.Dal.Adapter.v50.RelationClasses.StaticProductModelIllustrationRelations.IllustrationEntityUsingIllustrationIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncProductModel(IEntityCore relatedEntity)
		{
			if(_productModel!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _productModel, new PropertyChangedEventHandler( OnProductModelPropertyChanged ), "ProductModel", AdventureWorks.Dal.Adapter.v50.RelationClasses.StaticProductModelIllustrationRelations.ProductModelEntityUsingProductModelIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(IllustrationEntityFactory))),	(IEntityRelation)GetRelationsForField("Illustration")[0], (int)AdventureWorks.Dal.Adapter.v50.EntityType.ProductModelIllustrationEntity, (int)AdventureWorks.Dal.Adapter.v50.EntityType.IllustrationEntity, 0, null, null, null, null, "Illustration", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v50.EntityType.ProductModelIllustrationEntity; }
		}
