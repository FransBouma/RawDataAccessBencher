...
namespace AdventureWorks.Dal.Adapter.v50.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v50.EntityType.SalesPersonQuotaHistoryEntity; }
		}
