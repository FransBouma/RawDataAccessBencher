...
namespace AdventureWorks.Dal.Adapter.v50.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			this.PerformDesetupSyncRelatedEntity( _salesReason, new PropertyChangedEventHandler( OnSalesReasonPropertyChanged ), "SalesReason", AdventureWorks.Dal.Adapter.v50.RelationClasses.StaticSalesOrderHeaderSalesReasonRelations.SalesReasonEntityUsingSalesReasonIdStatic, true, signalRelatedEntity, "SalesOrderHeaderSalesReasons", resetFKFields, new int[] { (int)SalesOrderHeaderSalesReasonFieldIndex.SalesReasonId } );
			_salesReason = null;
		}
		...
		private void SetupSyncSalesReason(IEntityCore relatedEntity)
		{
			if(_salesReason!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _salesReason, new PropertyChangedEventHandler( OnSalesReasonPropertyChanged ), "SalesReason", AdventureWorks.Dal.Adapter.v50.RelationClasses.StaticSalesOrderHeaderSalesReasonRelations.SalesReasonEntityUsingSalesReasonIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(SalesReasonEntityFactory))),	(IEntityRelation)GetRelationsForField("SalesReason")[0], (int)AdventureWorks.Dal.Adapter.v50.EntityType.SalesOrderHeaderSalesReasonEntity, (int)AdventureWorks.Dal.Adapter.v50.EntityType.SalesReasonEntity, 0, null, null, null, null, "SalesReason", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v50.EntityType.SalesOrderHeaderSalesReasonEntity; }
		}
