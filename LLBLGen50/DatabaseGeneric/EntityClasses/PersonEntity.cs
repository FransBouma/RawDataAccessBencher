...
namespace AdventureWorks.Dal.Adapter.v50.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			this.PerformDesetupSyncRelatedEntity( _businessEntity, new PropertyChangedEventHandler( OnBusinessEntityPropertyChanged ), "BusinessEntity", AdventureWorks.Dal.Adapter.v50.RelationClasses.StaticPersonRelations.BusinessEntityEntityUsingBusinessEntityIdStatic, true, signalRelatedEntity, "Person", false, new int[] { (int)PersonFieldIndex.BusinessEntityId } );
		...
		private void SetupSyncBusinessEntity(IEntityCore relatedEntity)
		{
			if(_businessEntity!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _businessEntity, new PropertyChangedEventHandler( OnBusinessEntityPropertyChanged ), "BusinessEntity", AdventureWorks.Dal.Adapter.v50.RelationClasses.StaticPersonRelations.BusinessEntityEntityUsingBusinessEntityIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncEmployee(IEntityCore relatedEntity)
		{
			if(_employee!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", AdventureWorks.Dal.Adapter.v50.RelationClasses.StaticPersonRelations.EmployeeEntityUsingEmployeeIdStatic, false, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _password, new PropertyChangedEventHandler( OnPasswordPropertyChanged ), "Password", AdventureWorks.Dal.Adapter.v50.RelationClasses.StaticPersonRelations.PasswordEntityUsingBusinessEntityIdStatic, false, signalRelatedEntity, "Person", false, new int[] { (int)PersonFieldIndex.BusinessEntityId } );
			_password = null;
		}
		...
		private void SetupSyncPassword(IEntityCore relatedEntity)
		{
			if(_password!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _password, new PropertyChangedEventHandler( OnPasswordPropertyChanged ), "Password", AdventureWorks.Dal.Adapter.v50.RelationClasses.StaticPersonRelations.PasswordEntityUsingBusinessEntityIdStatic, false, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<EmailAddressEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmailAddressEntityFactory))), (IEntityRelation)GetRelationsForField("EmailAddresses")[0], (int)AdventureWorks.Dal.Adapter.v50.EntityType.PersonEntity, (int)AdventureWorks.Dal.Adapter.v50.EntityType.EmailAddressEntity, 0, null, null, null, null, "EmailAddresses", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get { return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(PasswordEntityFactory))), (IEntityRelation)GetRelationsForField("Password")[0], (int)AdventureWorks.Dal.Adapter.v50.EntityType.PersonEntity, (int)AdventureWorks.Dal.Adapter.v50.EntityType.PasswordEntity, 0, null, null, null, null, "Password", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);	}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v50.EntityType.PersonEntity; }
		}
