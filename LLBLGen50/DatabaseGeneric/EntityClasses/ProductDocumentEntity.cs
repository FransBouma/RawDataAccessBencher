		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private void SetupSyncDocument(IEntityCore relatedEntity)
		{
			if(_document!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _document, new PropertyChangedEventHandler( OnDocumentPropertyChanged ), "Document", AdventureWorks.Dal.Adapter.v50.RelationClasses.StaticProductDocumentRelations.DocumentEntityUsingDocumentNodeStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncProduct(IEntityCore relatedEntity)
		{
			if(_product!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", AdventureWorks.Dal.Adapter.v50.RelationClasses.StaticProductDocumentRelations.ProductEntityUsingProductIdStatic, true, new string[] {  } );
			}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v50.EntityType.ProductDocumentEntity; }
		}
