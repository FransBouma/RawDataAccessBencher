		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private void SetupSyncCurrency(IEntityCore relatedEntity)
		{
			if(_currency!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _currency, new PropertyChangedEventHandler( OnCurrencyPropertyChanged ), "Currency", AdventureWorks.Dal.Adapter.v50.RelationClasses.StaticCurrencyRateRelations.CurrencyEntityUsingFromCurrencyCodeStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncCurrency_(IEntityCore relatedEntity)
		{
			if(_currency_!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _currency_, new PropertyChangedEventHandler( OnCurrency_PropertyChanged ), "Currency_", AdventureWorks.Dal.Adapter.v50.RelationClasses.StaticCurrencyRateRelations.CurrencyEntityUsingToCurrencyCodeStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CurrencyEntityFactory))),	(IEntityRelation)GetRelationsForField("Currency")[0], (int)AdventureWorks.Dal.Adapter.v50.EntityType.CurrencyRateEntity, (int)AdventureWorks.Dal.Adapter.v50.EntityType.CurrencyEntity, 0, null, null, null, null, "Currency", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CurrencyEntityFactory))),	(IEntityRelation)GetRelationsForField("Currency_")[0], (int)AdventureWorks.Dal.Adapter.v50.EntityType.CurrencyRateEntity, (int)AdventureWorks.Dal.Adapter.v50.EntityType.CurrencyEntity, 0, null, null, null, null, "Currency_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v50.EntityType.CurrencyRateEntity; }
		}
