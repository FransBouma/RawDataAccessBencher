		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private void SetupSyncProduct(IEntityCore relatedEntity)
		{
			if(_product!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", AdventureWorks.Dal.Adapter.v50.RelationClasses.StaticProductProductPhotoRelations.ProductEntityUsingProductIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncProductPhoto(IEntityCore relatedEntity)
		{
			if(_productPhoto!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _productPhoto, new PropertyChangedEventHandler( OnProductPhotoPropertyChanged ), "ProductPhoto", AdventureWorks.Dal.Adapter.v50.RelationClasses.StaticProductProductPhotoRelations.ProductPhotoEntityUsingProductPhotoIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductPhotoEntityFactory))),	(IEntityRelation)GetRelationsForField("ProductPhoto")[0], (int)AdventureWorks.Dal.Adapter.v50.EntityType.ProductProductPhotoEntity, (int)AdventureWorks.Dal.Adapter.v50.EntityType.ProductPhotoEntity, 0, null, null, null, null, "ProductPhoto", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v50.EntityType.ProductProductPhotoEntity; }
		}
