		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private void SetupSyncStateProvince(IEntityCore relatedEntity)
		{
			if(_stateProvince!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _stateProvince, new PropertyChangedEventHandler( OnStateProvincePropertyChanged ), "StateProvince", AdventureWorks.Dal.Adapter.v50.RelationClasses.StaticAddressRelations.StateProvinceEntityUsingStateProvinceIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<SalesOrderHeaderEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SalesOrderHeaderEntityFactory))), (IEntityRelation)GetRelationsForField("SalesOrderHeaders_")[0], (int)AdventureWorks.Dal.Adapter.v50.EntityType.AddressEntity, (int)AdventureWorks.Dal.Adapter.v50.EntityType.SalesOrderHeaderEntity, 0, null, null, null, null, "SalesOrderHeaders_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(StateProvinceEntityFactory))),	(IEntityRelation)GetRelationsForField("StateProvince")[0], (int)AdventureWorks.Dal.Adapter.v50.EntityType.AddressEntity, (int)AdventureWorks.Dal.Adapter.v50.EntityType.StateProvinceEntity, 0, null, null, null, null, "StateProvince", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v50.EntityType.AddressEntity; }
		}
