...
namespace AdventureWorks.Dal.Adapter.v42.Linq
{
	...
	public partial class LinqMetaData: ILinqMetaData
	{
		...
		public IDataSource GetQueryableForEntity(int typeOfEntity)
		{
			...
			switch((AdventureWorks.Dal.Adapter.v42.EntityType)typeOfEntity)
			{
		...
		public DataSource2<AdventureWorks.Dal.Adapter.v42.TypedViewClasses.SohLinqPocoRow> SohLinqPoco
		{
			get { return new DataSource2<AdventureWorks.Dal.Adapter.v42.TypedViewClasses.SohLinqPocoRow>(_adapterToUse, new ElementCreator(), _customFunctionMappings, _contextToUse) { TypedViewEnumTypeValue=(int)TypedViewType.SohLinqPocoTypedView }; }
		}
