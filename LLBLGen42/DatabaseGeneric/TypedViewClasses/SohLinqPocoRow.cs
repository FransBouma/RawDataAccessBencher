...
namespace AdventureWorks.Dal.Adapter.v42.TypedViewClasses
{
	...
	/// <remarks>This class is a result class for a query, which is produced with the method <see cref="AdventureWorks.Dal.Adapter.v42.Linq.LinqMetaData.GetSohLinqPocoTypedView"/>.
