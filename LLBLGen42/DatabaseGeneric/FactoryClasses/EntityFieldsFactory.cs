...
namespace AdventureWorks.Dal.Adapter.v42.FactoryClasses
{
	...
	{
		private static readonly Dictionary<AdventureWorks.Dal.Adapter.v42.EntityType, string> _entityTypeNamesCache = new Dictionary<AdventureWorks.Dal.Adapter.v42.EntityType, string>();

		/// <summary>static ctor which initializes the static entity type cache.</summary>
		static EntityFieldsFactory()
		{
			foreach(AdventureWorks.Dal.Adapter.v42.EntityType value in Enum.GetValues(typeof(AdventureWorks.Dal.Adapter.v42.EntityType)))
			{
				_entityTypeNamesCache.Add(value, Enum.GetName(typeof(AdventureWorks.Dal.Adapter.v42.EntityType), value));
			}
		}	
