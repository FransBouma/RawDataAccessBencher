...
namespace AdventureWorks.Dal.Adapter.v42.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public ProductCategoryEntity(IValidator validator):base("ProductCategoryEntity")
		{
		...
		protected override void SetRelatedEntity(IEntityCore relatedEntity, string fieldName)
		{
			...
			{
				case "ProductSubcategories":
					this.ProductSubcategories.Add((ProductSubcategoryEntity)relatedEntity);
					break;
				default:
					break;
			}
		...
		protected override void UnsetRelatedEntity(IEntityCore relatedEntity, string fieldName, bool signalRelatedEntityManyToOne)
		{
			...
			{
				case "ProductSubcategories":
					this.PerformRelatedEntityRemoval(this.ProductSubcategories, relatedEntity, signalRelatedEntityManyToOne);
					break;
				default:
					break;
			}
		...
		protected override List<IEntityCollection2> GetMemberEntityCollections()
		{
			...
			toReturn.Add(this.ProductSubcategories);
			return toReturn;
		}
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				info.AddValue("_productSubcategories", ((_productSubcategories!=null) && (_productSubcategories.Count>0) && !this.MarkedForDeletion)?_productSubcategories:null);
			}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoProductSubcategories()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ProductSubcategoryFields.ProductCategoryId, null, ComparisonOperator.Equal, this.ProductCategoryId));
			return bucket;
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(ProductCategoryEntityFactory));
		}
#if !CF
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._productSubcategories);
		}
		...
		{
			bool toReturn = false;
			toReturn |=(this._productSubcategories != null);
		...
		public static IPrefetchPathElement2 PrefetchPathProductSubcategories
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ProductSubcategoryEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductSubcategoryEntityFactory))), (IEntityRelation)GetRelationsForField("ProductSubcategories")[0], (int)AdventureWorks.Dal.Adapter.v42.EntityType.ProductCategoryEntity, (int)AdventureWorks.Dal.Adapter.v42.EntityType.ProductSubcategoryEntity, 0, null, null, null, null, "ProductSubcategories", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		public virtual EntityCollection<ProductSubcategoryEntity> ProductSubcategories
		{
			get { return GetOrCreateEntityCollection<ProductSubcategoryEntity, ProductSubcategoryEntityFactory>("ProductCategory", true, false, ref _productSubcategories);	}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v42.EntityType.ProductCategoryEntity; }
		}
