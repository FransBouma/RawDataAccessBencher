...
namespace AdventureWorks.Dal.Adapter.v42.EntityClasses
{
			...
			
	{
		...
		public JobCandidateEntity(IEntityFields2 fields):base("JobCandidateEntity")
		{
		...
		public JobCandidateEntity(IValidator validator):base("JobCandidateEntity")
		{
		...
		{
			switch((JobCandidateFieldIndex)fieldIndex)
			{
		...
		{
			return new JobCandidateRelations().GetAllRelations();
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(JobCandidateEntityFactory));
		}
#if !CF
		...
		{
			this.PerformDesetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", AdventureWorks.Dal.Adapter.v42.RelationClasses.StaticJobCandidateRelations.EmployeeEntityUsingEmployeeIdStatic, true, signalRelatedEntity, "JobCandidates", resetFKFields, new int[] { (int)JobCandidateFieldIndex.EmployeeId } );
			_employee = null;
		}
		...
		private void SetupSyncEmployee(IEntityCore relatedEntity)
		{
			if(_employee!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", AdventureWorks.Dal.Adapter.v42.RelationClasses.StaticJobCandidateRelations.EmployeeEntityUsingEmployeeIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeEntityFactory))),	(IEntityRelation)GetRelationsForField("Employee")[0], (int)AdventureWorks.Dal.Adapter.v42.EntityType.JobCandidateEntity, (int)AdventureWorks.Dal.Adapter.v42.EntityType.EmployeeEntity, 0, null, null, null, null, "Employee", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <remarks>Mapped on  table field: "JobCandidate"."BusinessEntityID"<br/>
		...
		public virtual EmployeeEntity Employee
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "JobCandidates", "Employee", _employee, true); 
				}
			}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v42.EntityType.JobCandidateEntity; }
		}
