...
namespace AdventureWorks.Dal.Adapter.v42.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public ProductCostHistoryEntity():base("ProductCostHistoryEntity")
		{
		...
		public ProductCostHistoryEntity(System.Int32 productId, System.DateTime startDate):base("ProductCostHistoryEntity")
		{
			InitClassEmpty(null, null);
		...
		{
			switch((ProductCostHistoryFieldIndex)fieldIndex)
			{
		...
		{
			return new ProductCostHistoryRelations().GetAllRelations();
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(ProductCostHistoryEntityFactory));
		}
#if !CF
		...
		{
			this.PerformDesetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", AdventureWorks.Dal.Adapter.v42.RelationClasses.StaticProductCostHistoryRelations.ProductEntityUsingProductIdStatic, true, signalRelatedEntity, "ProductCostHistories", resetFKFields, new int[] { (int)ProductCostHistoryFieldIndex.ProductId } );
			_product = null;
		}
		...
		private void SetupSyncProduct(IEntityCore relatedEntity)
		{
			if(_product!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", AdventureWorks.Dal.Adapter.v42.RelationClasses.StaticProductCostHistoryRelations.ProductEntityUsingProductIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))),	(IEntityRelation)GetRelationsForField("Product")[0], (int)AdventureWorks.Dal.Adapter.v42.EntityType.ProductCostHistoryEntity, (int)AdventureWorks.Dal.Adapter.v42.EntityType.ProductEntity, 0, null, null, null, null, "Product", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		public virtual ProductEntity Product
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "ProductCostHistories", "Product", _product, true); 
				}
			}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v42.EntityType.ProductCostHistoryEntity; }
		}
