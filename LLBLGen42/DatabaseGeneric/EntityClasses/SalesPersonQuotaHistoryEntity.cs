...
namespace AdventureWorks.Dal.Adapter.v42.EntityClasses
{
			...
			
	{
		...
		public SalesPersonQuotaHistoryEntity(IValidator validator):base("SalesPersonQuotaHistoryEntity")
		{
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(SalesPersonQuotaHistoryEntityFactory));
		}
#if !CF
		...
		private void SetupSyncSalesPerson(IEntityCore relatedEntity)
		{
			if(_salesPerson!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _salesPerson, new PropertyChangedEventHandler( OnSalesPersonPropertyChanged ), "SalesPerson", AdventureWorks.Dal.Adapter.v42.RelationClasses.StaticSalesPersonQuotaHistoryRelations.SalesPersonEntityUsingSalesPersonIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(SalesPersonEntityFactory))),	(IEntityRelation)GetRelationsForField("SalesPerson")[0], (int)AdventureWorks.Dal.Adapter.v42.EntityType.SalesPersonQuotaHistoryEntity, (int)AdventureWorks.Dal.Adapter.v42.EntityType.SalesPersonEntity, 0, null, null, null, null, "SalesPerson", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <remarks>Mapped on  table field: "SalesPersonQuotaHistory"."BusinessEntityID"<br/>
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v42.EntityType.SalesPersonQuotaHistoryEntity; }
		}
