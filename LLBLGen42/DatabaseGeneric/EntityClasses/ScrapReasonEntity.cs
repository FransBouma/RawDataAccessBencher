...
namespace AdventureWorks.Dal.Adapter.v42.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<WorkOrderEntity>(EntityFactoryCache2.GetEntityFactory(typeof(WorkOrderEntityFactory))), (IEntityRelation)GetRelationsForField("WorkOrders")[0], (int)AdventureWorks.Dal.Adapter.v42.EntityType.ScrapReasonEntity, (int)AdventureWorks.Dal.Adapter.v42.EntityType.WorkOrderEntity, 0, null, null, null, null, "WorkOrders", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v42.EntityType.ScrapReasonEntity; }
		}
