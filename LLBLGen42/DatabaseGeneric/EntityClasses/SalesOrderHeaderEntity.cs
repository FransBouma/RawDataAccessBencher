...
namespace AdventureWorks.Dal.Adapter.v42.EntityClasses
{
			...
			
	{
		...
		{
			this.PerformDesetupSyncRelatedEntity( _address, new PropertyChangedEventHandler( OnAddressPropertyChanged ), "Address", AdventureWorks.Dal.Adapter.v42.RelationClasses.StaticSalesOrderHeaderRelations.AddressEntityUsingBillToAddressIdStatic, true, signalRelatedEntity, "SalesOrderHeaders", resetFKFields, new int[] { (int)SalesOrderHeaderFieldIndex.BillToAddressId } );
			_address = null;
		}
		...
		private void SetupSyncAddress(IEntityCore relatedEntity)
		{
			if(_address!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _address, new PropertyChangedEventHandler( OnAddressPropertyChanged ), "Address", AdventureWorks.Dal.Adapter.v42.RelationClasses.StaticSalesOrderHeaderRelations.AddressEntityUsingBillToAddressIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncCreditCard(IEntityCore relatedEntity)
		{
			if(_creditCard!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _creditCard, new PropertyChangedEventHandler( OnCreditCardPropertyChanged ), "CreditCard", AdventureWorks.Dal.Adapter.v42.RelationClasses.StaticSalesOrderHeaderRelations.CreditCardEntityUsingCreditCardIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncCurrencyRate(IEntityCore relatedEntity)
		{
			if(_currencyRate!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _currencyRate, new PropertyChangedEventHandler( OnCurrencyRatePropertyChanged ), "CurrencyRate", AdventureWorks.Dal.Adapter.v42.RelationClasses.StaticSalesOrderHeaderRelations.CurrencyRateEntityUsingCurrencyRateIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _customer, new PropertyChangedEventHandler( OnCustomerPropertyChanged ), "Customer", AdventureWorks.Dal.Adapter.v42.RelationClasses.StaticSalesOrderHeaderRelations.CustomerEntityUsingCustomerIdStatic, true, signalRelatedEntity, "SalesOrderHeaders", resetFKFields, new int[] { (int)SalesOrderHeaderFieldIndex.CustomerId } );
			_customer = null;
		}
		...
		private void SetupSyncCustomer(IEntityCore relatedEntity)
		{
			if(_customer!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _customer, new PropertyChangedEventHandler( OnCustomerPropertyChanged ), "Customer", AdventureWorks.Dal.Adapter.v42.RelationClasses.StaticSalesOrderHeaderRelations.CustomerEntityUsingCustomerIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncSalesPerson(IEntityCore relatedEntity)
		{
			if(_salesPerson!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _salesPerson, new PropertyChangedEventHandler( OnSalesPersonPropertyChanged ), "SalesPerson", AdventureWorks.Dal.Adapter.v42.RelationClasses.StaticSalesOrderHeaderRelations.SalesPersonEntityUsingSalesPersonIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncSalesTerritory(IEntityCore relatedEntity)
		{
			if(_salesTerritory!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _salesTerritory, new PropertyChangedEventHandler( OnSalesTerritoryPropertyChanged ), "SalesTerritory", AdventureWorks.Dal.Adapter.v42.RelationClasses.StaticSalesOrderHeaderRelations.SalesTerritoryEntityUsingTerritoryIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _shipMethod, new PropertyChangedEventHandler( OnShipMethodPropertyChanged ), "ShipMethod", AdventureWorks.Dal.Adapter.v42.RelationClasses.StaticSalesOrderHeaderRelations.ShipMethodEntityUsingShipMethodIdStatic, true, signalRelatedEntity, "SalesOrderHeaders", resetFKFields, new int[] { (int)SalesOrderHeaderFieldIndex.ShipMethodId } );
			_shipMethod = null;
		}
		...
		private void SetupSyncShipMethod(IEntityCore relatedEntity)
		{
			if(_shipMethod!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _shipMethod, new PropertyChangedEventHandler( OnShipMethodPropertyChanged ), "ShipMethod", AdventureWorks.Dal.Adapter.v42.RelationClasses.StaticSalesOrderHeaderRelations.ShipMethodEntityUsingShipMethodIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<SalesOrderDetailEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SalesOrderDetailEntityFactory))), (IEntityRelation)GetRelationsForField("SalesOrderDetails")[0], (int)AdventureWorks.Dal.Adapter.v42.EntityType.SalesOrderHeaderEntity, (int)AdventureWorks.Dal.Adapter.v42.EntityType.SalesOrderDetailEntity, 0, null, null, null, null, "SalesOrderDetails", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<SalesOrderHeaderSalesReasonEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SalesOrderHeaderSalesReasonEntityFactory))), (IEntityRelation)GetRelationsForField("SalesOrderHeaderSalesReasons")[0], (int)AdventureWorks.Dal.Adapter.v42.EntityType.SalesOrderHeaderEntity, (int)AdventureWorks.Dal.Adapter.v42.EntityType.SalesOrderHeaderSalesReasonEntity, 0, null, null, null, null, "SalesOrderHeaderSalesReasons", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AddressEntityFactory))),	(IEntityRelation)GetRelationsForField("Address")[0], (int)AdventureWorks.Dal.Adapter.v42.EntityType.SalesOrderHeaderEntity, (int)AdventureWorks.Dal.Adapter.v42.EntityType.AddressEntity, 0, null, null, null, null, "Address", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AddressEntityFactory))),	(IEntityRelation)GetRelationsForField("Address_")[0], (int)AdventureWorks.Dal.Adapter.v42.EntityType.SalesOrderHeaderEntity, (int)AdventureWorks.Dal.Adapter.v42.EntityType.AddressEntity, 0, null, null, null, null, "Address_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CreditCardEntityFactory))),	(IEntityRelation)GetRelationsForField("CreditCard")[0], (int)AdventureWorks.Dal.Adapter.v42.EntityType.SalesOrderHeaderEntity, (int)AdventureWorks.Dal.Adapter.v42.EntityType.CreditCardEntity, 0, null, null, null, null, "CreditCard", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CurrencyRateEntityFactory))),	(IEntityRelation)GetRelationsForField("CurrencyRate")[0], (int)AdventureWorks.Dal.Adapter.v42.EntityType.SalesOrderHeaderEntity, (int)AdventureWorks.Dal.Adapter.v42.EntityType.CurrencyRateEntity, 0, null, null, null, null, "CurrencyRate", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CustomerEntityFactory))),	(IEntityRelation)GetRelationsForField("Customer")[0], (int)AdventureWorks.Dal.Adapter.v42.EntityType.SalesOrderHeaderEntity, (int)AdventureWorks.Dal.Adapter.v42.EntityType.CustomerEntity, 0, null, null, null, null, "Customer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(SalesPersonEntityFactory))),	(IEntityRelation)GetRelationsForField("SalesPerson")[0], (int)AdventureWorks.Dal.Adapter.v42.EntityType.SalesOrderHeaderEntity, (int)AdventureWorks.Dal.Adapter.v42.EntityType.SalesPersonEntity, 0, null, null, null, null, "SalesPerson", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(SalesTerritoryEntityFactory))),	(IEntityRelation)GetRelationsForField("SalesTerritory")[0], (int)AdventureWorks.Dal.Adapter.v42.EntityType.SalesOrderHeaderEntity, (int)AdventureWorks.Dal.Adapter.v42.EntityType.SalesTerritoryEntity, 0, null, null, null, null, "SalesTerritory", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ShipMethodEntityFactory))),	(IEntityRelation)GetRelationsForField("ShipMethod")[0], (int)AdventureWorks.Dal.Adapter.v42.EntityType.SalesOrderHeaderEntity, (int)AdventureWorks.Dal.Adapter.v42.EntityType.ShipMethodEntity, 0, null, null, null, null, "ShipMethod", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v42.EntityType.SalesOrderHeaderEntity; }
		}
