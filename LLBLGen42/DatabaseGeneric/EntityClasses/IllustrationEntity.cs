...
namespace AdventureWorks.Dal.Adapter.v42.EntityClasses
{
			...
			
	{
		...
		public IllustrationEntity(IEntityFields2 fields):base("IllustrationEntity")
		{
		...
		public IllustrationEntity(IValidator validator):base("IllustrationEntity")
		{
		...
		public virtual IRelationPredicateBucket GetRelationInfoProductModelIllustrations()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ProductModelIllustrationFields.IllustrationId, null, ComparisonOperator.Equal, this.IllustrationId));
			return bucket;
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(IllustrationEntityFactory));
		}
#if !CF
		...
		{
			get { return GetOrCreateEntityCollection<ProductModelIllustrationEntity, ProductModelIllustrationEntityFactory>("Illustration", true, false, ref _productModelIllustrations);	}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v42.EntityType.IllustrationEntity; }
		}
