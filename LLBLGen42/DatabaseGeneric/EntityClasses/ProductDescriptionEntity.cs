...
namespace AdventureWorks.Dal.Adapter.v42.EntityClasses
{
			...
			
	{
		...
		{ 
			get { return (int)AdventureWorks.Dal.Adapter.v42.EntityType.ProductDescriptionEntity; }
		}
