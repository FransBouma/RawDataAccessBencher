...
namespace AdventureWorks.Dal.Adapter.v54.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class PhoneNumberTypeEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("PhoneNumberTypeEntity", InheritanceHierarchyType.None, false, (int)AdventureWorks.Dal.Adapter.v54.EntityType.PhoneNumberTypeEntity, typeof(PhoneNumberTypeEntity), typeof(PhoneNumberTypeEntityFactory), false);
				AddNavigatorMetaData<PhoneNumberTypeEntity, EntityCollection<PersonPhoneEntity>>("PersonPhones", a => a._personPhones, (a, b) => a._personPhones = b, a => a.PersonPhones, () => new PhoneNumberTypeRelations().PersonPhoneEntityUsingPhoneNumberTypeId, typeof(PersonPhoneEntity), (int)AdventureWorks.Dal.Adapter.v54.EntityType.PersonPhoneEntity);
			}
		}
