...
namespace AdventureWorks.Dal.Adapter.v54.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class SalesReasonEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("SalesReasonEntity", InheritanceHierarchyType.None, false, (int)AdventureWorks.Dal.Adapter.v54.EntityType.SalesReasonEntity, typeof(SalesReasonEntity), typeof(SalesReasonEntityFactory), false);
				AddNavigatorMetaData<SalesReasonEntity, EntityCollection<SalesOrderHeaderSalesReasonEntity>>("SalesOrderHeaderSalesReasons", a => a._salesOrderHeaderSalesReasons, (a, b) => a._salesOrderHeaderSalesReasons = b, a => a.SalesOrderHeaderSalesReasons, () => new SalesReasonRelations().SalesOrderHeaderSalesReasonEntityUsingSalesReasonId, typeof(SalesOrderHeaderSalesReasonEntity), (int)AdventureWorks.Dal.Adapter.v54.EntityType.SalesOrderHeaderSalesReasonEntity);
			}
		}
