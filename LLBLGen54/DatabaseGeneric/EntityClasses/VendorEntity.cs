...
namespace AdventureWorks.Dal.Adapter.v54.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class VendorEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("VendorEntity", InheritanceHierarchyType.None, false, (int)AdventureWorks.Dal.Adapter.v54.EntityType.VendorEntity, typeof(VendorEntity), typeof(VendorEntityFactory), false);
				AddNavigatorMetaData<VendorEntity, EntityCollection<ProductVendorEntity>>("ProductVendors", a => a._productVendors, (a, b) => a._productVendors = b, a => a.ProductVendors, () => new VendorRelations().ProductVendorEntityUsingVendorId, typeof(ProductVendorEntity), (int)AdventureWorks.Dal.Adapter.v54.EntityType.ProductVendorEntity);
				AddNavigatorMetaData<VendorEntity, EntityCollection<PurchaseOrderHeaderEntity>>("PurchaseOrderHeaders", a => a._purchaseOrderHeaders, (a, b) => a._purchaseOrderHeaders = b, a => a.PurchaseOrderHeaders, () => new VendorRelations().PurchaseOrderHeaderEntityUsingVendorId, typeof(PurchaseOrderHeaderEntity), (int)AdventureWorks.Dal.Adapter.v54.EntityType.PurchaseOrderHeaderEntity);
				AddNavigatorMetaData<VendorEntity, BusinessEntityEntity>("BusinessEntity", "Vendor", (a, b) => a._businessEntity = b, a => a._businessEntity, (a, b) => a.BusinessEntity = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticVendorRelations.BusinessEntityEntityUsingVendorIdStatic, ()=>new VendorRelations().BusinessEntityEntityUsingVendorId, null, new int[] { (int)VendorFieldIndex.VendorId }, null, false, (int)AdventureWorks.Dal.Adapter.v54.EntityType.BusinessEntityEntity);
			}
		}
