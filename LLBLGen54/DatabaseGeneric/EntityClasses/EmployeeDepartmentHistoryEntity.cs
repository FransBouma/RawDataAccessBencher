...
namespace AdventureWorks.Dal.Adapter.v54.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class EmployeeDepartmentHistoryEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("EmployeeDepartmentHistoryEntity", InheritanceHierarchyType.None, false, (int)AdventureWorks.Dal.Adapter.v54.EntityType.EmployeeDepartmentHistoryEntity, typeof(EmployeeDepartmentHistoryEntity), typeof(EmployeeDepartmentHistoryEntityFactory), false);
				AddNavigatorMetaData<EmployeeDepartmentHistoryEntity, DepartmentEntity>("Department", "EmployeeDepartmentHistories", (a, b) => a._department = b, a => a._department, (a, b) => a.Department = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticEmployeeDepartmentHistoryRelations.DepartmentEntityUsingDepartmentIdStatic, ()=>new EmployeeDepartmentHistoryRelations().DepartmentEntityUsingDepartmentId, null, new int[] { (int)EmployeeDepartmentHistoryFieldIndex.DepartmentId }, null, true, (int)AdventureWorks.Dal.Adapter.v54.EntityType.DepartmentEntity);
				AddNavigatorMetaData<EmployeeDepartmentHistoryEntity, EmployeeEntity>("Employee", "EmployeeDepartmentHistories", (a, b) => a._employee = b, a => a._employee, (a, b) => a.Employee = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticEmployeeDepartmentHistoryRelations.EmployeeEntityUsingEmployeeIdStatic, ()=>new EmployeeDepartmentHistoryRelations().EmployeeEntityUsingEmployeeId, null, new int[] { (int)EmployeeDepartmentHistoryFieldIndex.EmployeeId }, null, true, (int)AdventureWorks.Dal.Adapter.v54.EntityType.EmployeeEntity);
				AddNavigatorMetaData<EmployeeDepartmentHistoryEntity, ShiftEntity>("Shift", "EmployeeDepartmentHistories", (a, b) => a._shift = b, a => a._shift, (a, b) => a.Shift = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticEmployeeDepartmentHistoryRelations.ShiftEntityUsingShiftIdStatic, ()=>new EmployeeDepartmentHistoryRelations().ShiftEntityUsingShiftId, null, new int[] { (int)EmployeeDepartmentHistoryFieldIndex.ShiftId }, null, true, (int)AdventureWorks.Dal.Adapter.v54.EntityType.ShiftEntity);
			}
		}
