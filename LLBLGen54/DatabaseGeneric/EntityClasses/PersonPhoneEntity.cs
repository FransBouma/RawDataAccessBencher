...
namespace AdventureWorks.Dal.Adapter.v54.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class PersonPhoneEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("PersonPhoneEntity", InheritanceHierarchyType.None, false, (int)AdventureWorks.Dal.Adapter.v54.EntityType.PersonPhoneEntity, typeof(PersonPhoneEntity), typeof(PersonPhoneEntityFactory), false);
				AddNavigatorMetaData<PersonPhoneEntity, PersonEntity>("Person", "PersonPhones", (a, b) => a._person = b, a => a._person, (a, b) => a.Person = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticPersonPhoneRelations.PersonEntityUsingBusinessEntityIdStatic, ()=>new PersonPhoneRelations().PersonEntityUsingBusinessEntityId, null, new int[] { (int)PersonPhoneFieldIndex.BusinessEntityId }, null, true, (int)AdventureWorks.Dal.Adapter.v54.EntityType.PersonEntity);
				AddNavigatorMetaData<PersonPhoneEntity, PhoneNumberTypeEntity>("PhoneNumberType", "PersonPhones", (a, b) => a._phoneNumberType = b, a => a._phoneNumberType, (a, b) => a.PhoneNumberType = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticPersonPhoneRelations.PhoneNumberTypeEntityUsingPhoneNumberTypeIdStatic, ()=>new PersonPhoneRelations().PhoneNumberTypeEntityUsingPhoneNumberTypeId, null, new int[] { (int)PersonPhoneFieldIndex.PhoneNumberTypeId }, null, true, (int)AdventureWorks.Dal.Adapter.v54.EntityType.PhoneNumberTypeEntity);
			}
		}
