...
namespace AdventureWorks.Dal.Adapter.v54.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class ProductModelProductDescriptionCultureEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("ProductModelProductDescriptionCultureEntity", InheritanceHierarchyType.None, false, (int)AdventureWorks.Dal.Adapter.v54.EntityType.ProductModelProductDescriptionCultureEntity, typeof(ProductModelProductDescriptionCultureEntity), typeof(ProductModelProductDescriptionCultureEntityFactory), false);
				AddNavigatorMetaData<ProductModelProductDescriptionCultureEntity, CultureEntity>("Culture", "ProductModelProductDescriptionCultures", (a, b) => a._culture = b, a => a._culture, (a, b) => a.Culture = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticProductModelProductDescriptionCultureRelations.CultureEntityUsingCultureIdStatic, ()=>new ProductModelProductDescriptionCultureRelations().CultureEntityUsingCultureId, null, new int[] { (int)ProductModelProductDescriptionCultureFieldIndex.CultureId }, null, true, (int)AdventureWorks.Dal.Adapter.v54.EntityType.CultureEntity);
				AddNavigatorMetaData<ProductModelProductDescriptionCultureEntity, ProductDescriptionEntity>("ProductDescription", "ProductModelProductDescriptionCultures", (a, b) => a._productDescription = b, a => a._productDescription, (a, b) => a.ProductDescription = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticProductModelProductDescriptionCultureRelations.ProductDescriptionEntityUsingProductDescriptionIdStatic, ()=>new ProductModelProductDescriptionCultureRelations().ProductDescriptionEntityUsingProductDescriptionId, null, new int[] { (int)ProductModelProductDescriptionCultureFieldIndex.ProductDescriptionId }, null, true, (int)AdventureWorks.Dal.Adapter.v54.EntityType.ProductDescriptionEntity);
				AddNavigatorMetaData<ProductModelProductDescriptionCultureEntity, ProductModelEntity>("ProductModel", "ProductModelProductDescriptionCultures", (a, b) => a._productModel = b, a => a._productModel, (a, b) => a.ProductModel = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticProductModelProductDescriptionCultureRelations.ProductModelEntityUsingProductModelIdStatic, ()=>new ProductModelProductDescriptionCultureRelations().ProductModelEntityUsingProductModelId, null, new int[] { (int)ProductModelProductDescriptionCultureFieldIndex.ProductModelId }, null, true, (int)AdventureWorks.Dal.Adapter.v54.EntityType.ProductModelEntity);
			}
		}
