...
namespace AdventureWorks.Dal.Adapter.v54.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class TransactionHistoryArchiveEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("TransactionHistoryArchiveEntity", InheritanceHierarchyType.None, false, (int)AdventureWorks.Dal.Adapter.v54.EntityType.TransactionHistoryArchiveEntity, typeof(TransactionHistoryArchiveEntity), typeof(TransactionHistoryArchiveEntityFactory), false);
			}
		}
