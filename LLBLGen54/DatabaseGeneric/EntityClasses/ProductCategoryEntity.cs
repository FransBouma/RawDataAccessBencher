...
namespace AdventureWorks.Dal.Adapter.v54.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class ProductCategoryEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("ProductCategoryEntity", InheritanceHierarchyType.None, false, (int)AdventureWorks.Dal.Adapter.v54.EntityType.ProductCategoryEntity, typeof(ProductCategoryEntity), typeof(ProductCategoryEntityFactory), false);
				AddNavigatorMetaData<ProductCategoryEntity, EntityCollection<ProductSubcategoryEntity>>("ProductSubcategories", a => a._productSubcategories, (a, b) => a._productSubcategories = b, a => a.ProductSubcategories, () => new ProductCategoryRelations().ProductSubcategoryEntityUsingProductCategoryId, typeof(ProductSubcategoryEntity), (int)AdventureWorks.Dal.Adapter.v54.EntityType.ProductSubcategoryEntity);
			}
		}
