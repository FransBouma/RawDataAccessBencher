...
namespace AdventureWorks.Dal.Adapter.v54.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class ProductEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("ProductEntity", InheritanceHierarchyType.None, false, (int)AdventureWorks.Dal.Adapter.v54.EntityType.ProductEntity, typeof(ProductEntity), typeof(ProductEntityFactory), false);
				AddNavigatorMetaData<ProductEntity, EntityCollection<BillOfMaterialEntity>>("BillOfMaterials", a => a._billOfMaterials, (a, b) => a._billOfMaterials = b, a => a.BillOfMaterials, () => new ProductRelations().BillOfMaterialEntityUsingComponentId, typeof(BillOfMaterialEntity), (int)AdventureWorks.Dal.Adapter.v54.EntityType.BillOfMaterialEntity);
				AddNavigatorMetaData<ProductEntity, EntityCollection<BillOfMaterialEntity>>("BillOfMaterials_", a => a._billOfMaterials_, (a, b) => a._billOfMaterials_ = b, a => a.BillOfMaterials_, () => new ProductRelations().BillOfMaterialEntityUsingProductAssemblyId, typeof(BillOfMaterialEntity), (int)AdventureWorks.Dal.Adapter.v54.EntityType.BillOfMaterialEntity);
				AddNavigatorMetaData<ProductEntity, EntityCollection<ProductCostHistoryEntity>>("ProductCostHistories", a => a._productCostHistories, (a, b) => a._productCostHistories = b, a => a.ProductCostHistories, () => new ProductRelations().ProductCostHistoryEntityUsingProductId, typeof(ProductCostHistoryEntity), (int)AdventureWorks.Dal.Adapter.v54.EntityType.ProductCostHistoryEntity);
				...
				AddNavigatorMetaData<ProductEntity, EntityCollection<ProductInventoryEntity>>("ProductInventories", a => a._productInventories, (a, b) => a._productInventories = b, a => a.ProductInventories, () => new ProductRelations().ProductInventoryEntityUsingProductId, typeof(ProductInventoryEntity), (int)AdventureWorks.Dal.Adapter.v54.EntityType.ProductInventoryEntity);
				AddNavigatorMetaData<ProductEntity, EntityCollection<ProductListPriceHistoryEntity>>("ProductListPriceHistories", a => a._productListPriceHistories, (a, b) => a._productListPriceHistories = b, a => a.ProductListPriceHistories, () => new ProductRelations().ProductListPriceHistoryEntityUsingProductId, typeof(ProductListPriceHistoryEntity), (int)AdventureWorks.Dal.Adapter.v54.EntityType.ProductListPriceHistoryEntity);
				AddNavigatorMetaData<ProductEntity, EntityCollection<ProductProductPhotoEntity>>("ProductProductPhotos", a => a._productProductPhotos, (a, b) => a._productProductPhotos = b, a => a.ProductProductPhotos, () => new ProductRelations().ProductProductPhotoEntityUsingProductId, typeof(ProductProductPhotoEntity), (int)AdventureWorks.Dal.Adapter.v54.EntityType.ProductProductPhotoEntity);
				AddNavigatorMetaData<ProductEntity, EntityCollection<ProductReviewEntity>>("ProductReviews", a => a._productReviews, (a, b) => a._productReviews = b, a => a.ProductReviews, () => new ProductRelations().ProductReviewEntityUsingProductId, typeof(ProductReviewEntity), (int)AdventureWorks.Dal.Adapter.v54.EntityType.ProductReviewEntity);
				AddNavigatorMetaData<ProductEntity, EntityCollection<ProductVendorEntity>>("ProductVendors", a => a._productVendors, (a, b) => a._productVendors = b, a => a.ProductVendors, () => new ProductRelations().ProductVendorEntityUsingProductId, typeof(ProductVendorEntity), (int)AdventureWorks.Dal.Adapter.v54.EntityType.ProductVendorEntity);
				AddNavigatorMetaData<ProductEntity, EntityCollection<PurchaseOrderDetailEntity>>("PurchaseOrderDetails", a => a._purchaseOrderDetails, (a, b) => a._purchaseOrderDetails = b, a => a.PurchaseOrderDetails, () => new ProductRelations().PurchaseOrderDetailEntityUsingProductId, typeof(PurchaseOrderDetailEntity), (int)AdventureWorks.Dal.Adapter.v54.EntityType.PurchaseOrderDetailEntity);
				AddNavigatorMetaData<ProductEntity, EntityCollection<ShoppingCartItemEntity>>("ShoppingCartItems", a => a._shoppingCartItems, (a, b) => a._shoppingCartItems = b, a => a.ShoppingCartItems, () => new ProductRelations().ShoppingCartItemEntityUsingProductId, typeof(ShoppingCartItemEntity), (int)AdventureWorks.Dal.Adapter.v54.EntityType.ShoppingCartItemEntity);
				AddNavigatorMetaData<ProductEntity, EntityCollection<SpecialOfferProductEntity>>("SpecialOfferProducts", a => a._specialOfferProducts, (a, b) => a._specialOfferProducts = b, a => a.SpecialOfferProducts, () => new ProductRelations().SpecialOfferProductEntityUsingProductId, typeof(SpecialOfferProductEntity), (int)AdventureWorks.Dal.Adapter.v54.EntityType.SpecialOfferProductEntity);
				AddNavigatorMetaData<ProductEntity, EntityCollection<TransactionHistoryEntity>>("TransactionHistories", a => a._transactionHistories, (a, b) => a._transactionHistories = b, a => a.TransactionHistories, () => new ProductRelations().TransactionHistoryEntityUsingProductId, typeof(TransactionHistoryEntity), (int)AdventureWorks.Dal.Adapter.v54.EntityType.TransactionHistoryEntity);
				AddNavigatorMetaData<ProductEntity, EntityCollection<WorkOrderEntity>>("WorkOrders", a => a._workOrders, (a, b) => a._workOrders = b, a => a.WorkOrders, () => new ProductRelations().WorkOrderEntityUsingProductId, typeof(WorkOrderEntity), (int)AdventureWorks.Dal.Adapter.v54.EntityType.WorkOrderEntity);
				AddNavigatorMetaData<ProductEntity, ProductModelEntity>("ProductModel", "Products", (a, b) => a._productModel = b, a => a._productModel, (a, b) => a.ProductModel = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticProductRelations.ProductModelEntityUsingProductModelIdStatic, ()=>new ProductRelations().ProductModelEntityUsingProductModelId, null, new int[] { (int)ProductFieldIndex.ProductModelId }, null, true, (int)AdventureWorks.Dal.Adapter.v54.EntityType.ProductModelEntity);
				AddNavigatorMetaData<ProductEntity, ProductSubcategoryEntity>("ProductSubcategory", "Products", (a, b) => a._productSubcategory = b, a => a._productSubcategory, (a, b) => a.ProductSubcategory = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticProductRelations.ProductSubcategoryEntityUsingProductSubcategoryIdStatic, ()=>new ProductRelations().ProductSubcategoryEntityUsingProductSubcategoryId, null, new int[] { (int)ProductFieldIndex.ProductSubcategoryId }, null, true, (int)AdventureWorks.Dal.Adapter.v54.EntityType.ProductSubcategoryEntity);
				AddNavigatorMetaData<ProductEntity, UnitMeasureEntity>("UnitMeasure", "Products", (a, b) => a._unitMeasure = b, a => a._unitMeasure, (a, b) => a.UnitMeasure = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticProductRelations.UnitMeasureEntityUsingSizeUnitMeasureCodeStatic, ()=>new ProductRelations().UnitMeasureEntityUsingSizeUnitMeasureCode, null, new int[] { (int)ProductFieldIndex.SizeUnitMeasureCode }, null, true, (int)AdventureWorks.Dal.Adapter.v54.EntityType.UnitMeasureEntity);
				AddNavigatorMetaData<ProductEntity, UnitMeasureEntity>("UnitMeasure_", "Products_", (a, b) => a._unitMeasure_ = b, a => a._unitMeasure_, (a, b) => a.UnitMeasure_ = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticProductRelations.UnitMeasureEntityUsingWeightUnitMeasureCodeStatic, ()=>new ProductRelations().UnitMeasureEntityUsingWeightUnitMeasureCode, null, new int[] { (int)ProductFieldIndex.WeightUnitMeasureCode }, null, true, (int)AdventureWorks.Dal.Adapter.v54.EntityType.UnitMeasureEntity);
			}
		}
