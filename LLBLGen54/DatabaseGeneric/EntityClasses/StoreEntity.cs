...
namespace AdventureWorks.Dal.Adapter.v54.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class StoreEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("StoreEntity", InheritanceHierarchyType.None, false, (int)AdventureWorks.Dal.Adapter.v54.EntityType.StoreEntity, typeof(StoreEntity), typeof(StoreEntityFactory), false);
				AddNavigatorMetaData<StoreEntity, EntityCollection<CustomerEntity>>("Customers", a => a._customers, (a, b) => a._customers = b, a => a.Customers, () => new StoreRelations().CustomerEntityUsingStoreId, typeof(CustomerEntity), (int)AdventureWorks.Dal.Adapter.v54.EntityType.CustomerEntity);
				AddNavigatorMetaData<StoreEntity, SalesPersonEntity>("SalesPerson", "Stores", (a, b) => a._salesPerson = b, a => a._salesPerson, (a, b) => a.SalesPerson = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticStoreRelations.SalesPersonEntityUsingSalesPersonIdStatic, ()=>new StoreRelations().SalesPersonEntityUsingSalesPersonId, null, new int[] { (int)StoreFieldIndex.SalesPersonId }, null, true, (int)AdventureWorks.Dal.Adapter.v54.EntityType.SalesPersonEntity);
				AddNavigatorMetaData<StoreEntity, BusinessEntityEntity>("BusinessEntity", "Store", (a, b) => a._businessEntity = b, a => a._businessEntity, (a, b) => a.BusinessEntity = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticStoreRelations.BusinessEntityEntityUsingCustomerIdStatic, ()=>new StoreRelations().BusinessEntityEntityUsingCustomerId, null, new int[] { (int)StoreFieldIndex.CustomerId }, null, false, (int)AdventureWorks.Dal.Adapter.v54.EntityType.BusinessEntityEntity);
			}
		}
