...
namespace AdventureWorks.Dal.Adapter.v54.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class UnitMeasureEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("UnitMeasureEntity", InheritanceHierarchyType.None, false, (int)AdventureWorks.Dal.Adapter.v54.EntityType.UnitMeasureEntity, typeof(UnitMeasureEntity), typeof(UnitMeasureEntityFactory), false);
				AddNavigatorMetaData<UnitMeasureEntity, EntityCollection<BillOfMaterialEntity>>("BillOfMaterials", a => a._billOfMaterials, (a, b) => a._billOfMaterials = b, a => a.BillOfMaterials, () => new UnitMeasureRelations().BillOfMaterialEntityUsingUnitMeasureCode, typeof(BillOfMaterialEntity), (int)AdventureWorks.Dal.Adapter.v54.EntityType.BillOfMaterialEntity);
				AddNavigatorMetaData<UnitMeasureEntity, EntityCollection<ProductEntity>>("Products", a => a._products, (a, b) => a._products = b, a => a.Products, () => new UnitMeasureRelations().ProductEntityUsingSizeUnitMeasureCode, typeof(ProductEntity), (int)AdventureWorks.Dal.Adapter.v54.EntityType.ProductEntity);
				AddNavigatorMetaData<UnitMeasureEntity, EntityCollection<ProductEntity>>("Products_", a => a._products_, (a, b) => a._products_ = b, a => a.Products_, () => new UnitMeasureRelations().ProductEntityUsingWeightUnitMeasureCode, typeof(ProductEntity), (int)AdventureWorks.Dal.Adapter.v54.EntityType.ProductEntity);
				AddNavigatorMetaData<UnitMeasureEntity, EntityCollection<ProductVendorEntity>>("ProductVendors", a => a._productVendors, (a, b) => a._productVendors = b, a => a.ProductVendors, () => new UnitMeasureRelations().ProductVendorEntityUsingUnitMeasureCode, typeof(ProductVendorEntity), (int)AdventureWorks.Dal.Adapter.v54.EntityType.ProductVendorEntity);
			}
		}
