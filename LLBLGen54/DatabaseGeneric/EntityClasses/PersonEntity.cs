...
namespace AdventureWorks.Dal.Adapter.v54.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class PersonEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("PersonEntity", InheritanceHierarchyType.None, false, (int)AdventureWorks.Dal.Adapter.v54.EntityType.PersonEntity, typeof(PersonEntity), typeof(PersonEntityFactory), false);
				AddNavigatorMetaData<PersonEntity, EntityCollection<BusinessEntityContactEntity>>("BusinessEntityContacts", a => a._businessEntityContacts, (a, b) => a._businessEntityContacts = b, a => a.BusinessEntityContacts, () => new PersonRelations().BusinessEntityContactEntityUsingPersonId, typeof(BusinessEntityContactEntity), (int)AdventureWorks.Dal.Adapter.v54.EntityType.BusinessEntityContactEntity);
				...
				AddNavigatorMetaData<PersonEntity, EntityCollection<CustomerEntity>>("Customers", a => a._customers, (a, b) => a._customers = b, a => a.Customers, () => new PersonRelations().CustomerEntityUsingPersonId, typeof(CustomerEntity), (int)AdventureWorks.Dal.Adapter.v54.EntityType.CustomerEntity);
				AddNavigatorMetaData<PersonEntity, EntityCollection<EmailAddressEntity>>("EmailAddresses", a => a._emailAddresses, (a, b) => a._emailAddresses = b, a => a.EmailAddresses, () => new PersonRelations().EmailAddressEntityUsingBusinessEntityId, typeof(EmailAddressEntity), (int)AdventureWorks.Dal.Adapter.v54.EntityType.EmailAddressEntity);
				AddNavigatorMetaData<PersonEntity, EntityCollection<PersonPhoneEntity>>("PersonPhones", a => a._personPhones, (a, b) => a._personPhones = b, a => a.PersonPhones, () => new PersonRelations().PersonPhoneEntityUsingBusinessEntityId, typeof(PersonPhoneEntity), (int)AdventureWorks.Dal.Adapter.v54.EntityType.PersonPhoneEntity);
				AddNavigatorMetaData<PersonEntity, BusinessEntityEntity>("BusinessEntity", "Person", (a, b) => a._businessEntity = b, a => a._businessEntity, (a, b) => a.BusinessEntity = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticPersonRelations.BusinessEntityEntityUsingBusinessEntityIdStatic, ()=>new PersonRelations().BusinessEntityEntityUsingBusinessEntityId, null, new int[] { (int)PersonFieldIndex.BusinessEntityId }, null, false, (int)AdventureWorks.Dal.Adapter.v54.EntityType.BusinessEntityEntity);
				AddNavigatorMetaData<PersonEntity, EmployeeEntity>("Employee", "Person", (a, b) => a._employee = b, a => a._employee, (a, b) => a.Employee = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticPersonRelations.EmployeeEntityUsingEmployeeIdStatic, ()=>new PersonRelations().EmployeeEntityUsingEmployeeId, null, new int[] { (int)PersonFieldIndex.BusinessEntityId }, null, true, (int)AdventureWorks.Dal.Adapter.v54.EntityType.EmployeeEntity);
				AddNavigatorMetaData<PersonEntity, PasswordEntity>("Password", "Person", (a, b) => a._password = b, a => a._password, (a, b) => a.Password = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticPersonRelations.PasswordEntityUsingBusinessEntityIdStatic, ()=>new PersonRelations().PasswordEntityUsingBusinessEntityId, null, new int[] { (int)PersonFieldIndex.BusinessEntityId }, null, true, (int)AdventureWorks.Dal.Adapter.v54.EntityType.PasswordEntity);
			}
		}
