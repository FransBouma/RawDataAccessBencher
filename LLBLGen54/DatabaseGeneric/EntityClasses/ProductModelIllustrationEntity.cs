...
namespace AdventureWorks.Dal.Adapter.v54.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class ProductModelIllustrationEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("ProductModelIllustrationEntity", InheritanceHierarchyType.None, false, (int)AdventureWorks.Dal.Adapter.v54.EntityType.ProductModelIllustrationEntity, typeof(ProductModelIllustrationEntity), typeof(ProductModelIllustrationEntityFactory), false);
				AddNavigatorMetaData<ProductModelIllustrationEntity, IllustrationEntity>("Illustration", "ProductModelIllustrations", (a, b) => a._illustration = b, a => a._illustration, (a, b) => a.Illustration = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticProductModelIllustrationRelations.IllustrationEntityUsingIllustrationIdStatic, ()=>new ProductModelIllustrationRelations().IllustrationEntityUsingIllustrationId, null, new int[] { (int)ProductModelIllustrationFieldIndex.IllustrationId }, null, true, (int)AdventureWorks.Dal.Adapter.v54.EntityType.IllustrationEntity);
				AddNavigatorMetaData<ProductModelIllustrationEntity, ProductModelEntity>("ProductModel", "ProductModelIllustrations", (a, b) => a._productModel = b, a => a._productModel, (a, b) => a.ProductModel = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticProductModelIllustrationRelations.ProductModelEntityUsingProductModelIdStatic, ()=>new ProductModelIllustrationRelations().ProductModelEntityUsingProductModelId, null, new int[] { (int)ProductModelIllustrationFieldIndex.ProductModelId }, null, true, (int)AdventureWorks.Dal.Adapter.v54.EntityType.ProductModelEntity);
			}
		}
