...
namespace AdventureWorks.Dal.Adapter.v54.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class SalesOrderHeaderSalesReasonEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("SalesOrderHeaderSalesReasonEntity", InheritanceHierarchyType.None, false, (int)AdventureWorks.Dal.Adapter.v54.EntityType.SalesOrderHeaderSalesReasonEntity, typeof(SalesOrderHeaderSalesReasonEntity), typeof(SalesOrderHeaderSalesReasonEntityFactory), false);
				AddNavigatorMetaData<SalesOrderHeaderSalesReasonEntity, SalesOrderHeaderEntity>("SalesOrderHeader", "SalesOrderHeaderSalesReasons", (a, b) => a._salesOrderHeader = b, a => a._salesOrderHeader, (a, b) => a.SalesOrderHeader = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticSalesOrderHeaderSalesReasonRelations.SalesOrderHeaderEntityUsingSalesOrderIdStatic, ()=>new SalesOrderHeaderSalesReasonRelations().SalesOrderHeaderEntityUsingSalesOrderId, null, new int[] { (int)SalesOrderHeaderSalesReasonFieldIndex.SalesOrderId }, null, true, (int)AdventureWorks.Dal.Adapter.v54.EntityType.SalesOrderHeaderEntity);
				AddNavigatorMetaData<SalesOrderHeaderSalesReasonEntity, SalesReasonEntity>("SalesReason", "SalesOrderHeaderSalesReasons", (a, b) => a._salesReason = b, a => a._salesReason, (a, b) => a.SalesReason = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticSalesOrderHeaderSalesReasonRelations.SalesReasonEntityUsingSalesReasonIdStatic, ()=>new SalesOrderHeaderSalesReasonRelations().SalesReasonEntityUsingSalesReasonId, null, new int[] { (int)SalesOrderHeaderSalesReasonFieldIndex.SalesReasonId }, null, true, (int)AdventureWorks.Dal.Adapter.v54.EntityType.SalesReasonEntity);
			}
		}
