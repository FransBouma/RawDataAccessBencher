...
namespace AdventureWorks.Dal.Adapter.v54.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class StateProvinceEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("StateProvinceEntity", InheritanceHierarchyType.None, false, (int)AdventureWorks.Dal.Adapter.v54.EntityType.StateProvinceEntity, typeof(StateProvinceEntity), typeof(StateProvinceEntityFactory), false);
				AddNavigatorMetaData<StateProvinceEntity, EntityCollection<AddressEntity>>("Addresses", a => a._addresses, (a, b) => a._addresses = b, a => a.Addresses, () => new StateProvinceRelations().AddressEntityUsingStateProvinceId, typeof(AddressEntity), (int)AdventureWorks.Dal.Adapter.v54.EntityType.AddressEntity);
				...
				AddNavigatorMetaData<StateProvinceEntity, CountryRegionEntity>("CountryRegion", "StateProvinces", (a, b) => a._countryRegion = b, a => a._countryRegion, (a, b) => a.CountryRegion = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticStateProvinceRelations.CountryRegionEntityUsingCountryRegionCodeStatic, ()=>new StateProvinceRelations().CountryRegionEntityUsingCountryRegionCode, null, new int[] { (int)StateProvinceFieldIndex.CountryRegionCode }, null, true, (int)AdventureWorks.Dal.Adapter.v54.EntityType.CountryRegionEntity);
