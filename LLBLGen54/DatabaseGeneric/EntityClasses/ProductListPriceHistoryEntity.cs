...
namespace AdventureWorks.Dal.Adapter.v54.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class ProductListPriceHistoryEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("ProductListPriceHistoryEntity", InheritanceHierarchyType.None, false, (int)AdventureWorks.Dal.Adapter.v54.EntityType.ProductListPriceHistoryEntity, typeof(ProductListPriceHistoryEntity), typeof(ProductListPriceHistoryEntityFactory), false);
				AddNavigatorMetaData<ProductListPriceHistoryEntity, ProductEntity>("Product", "ProductListPriceHistories", (a, b) => a._product = b, a => a._product, (a, b) => a.Product = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticProductListPriceHistoryRelations.ProductEntityUsingProductIdStatic, ()=>new ProductListPriceHistoryRelations().ProductEntityUsingProductId, null, new int[] { (int)ProductListPriceHistoryFieldIndex.ProductId }, null, true, (int)AdventureWorks.Dal.Adapter.v54.EntityType.ProductEntity);
			}
		}
