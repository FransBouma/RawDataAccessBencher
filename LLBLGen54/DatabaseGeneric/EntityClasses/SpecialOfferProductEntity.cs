...
namespace AdventureWorks.Dal.Adapter.v54.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class SpecialOfferProductEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("SpecialOfferProductEntity", InheritanceHierarchyType.None, false, (int)AdventureWorks.Dal.Adapter.v54.EntityType.SpecialOfferProductEntity, typeof(SpecialOfferProductEntity), typeof(SpecialOfferProductEntityFactory), false);
				AddNavigatorMetaData<SpecialOfferProductEntity, EntityCollection<SalesOrderDetailEntity>>("SalesOrderDetails", a => a._salesOrderDetails, (a, b) => a._salesOrderDetails = b, a => a.SalesOrderDetails, () => new SpecialOfferProductRelations().SalesOrderDetailEntityUsingProductIdSpecialOfferId, typeof(SalesOrderDetailEntity), (int)AdventureWorks.Dal.Adapter.v54.EntityType.SalesOrderDetailEntity);
				AddNavigatorMetaData<SpecialOfferProductEntity, ProductEntity>("Product", "SpecialOfferProducts", (a, b) => a._product = b, a => a._product, (a, b) => a.Product = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticSpecialOfferProductRelations.ProductEntityUsingProductIdStatic, ()=>new SpecialOfferProductRelations().ProductEntityUsingProductId, null, new int[] { (int)SpecialOfferProductFieldIndex.ProductId }, null, true, (int)AdventureWorks.Dal.Adapter.v54.EntityType.ProductEntity);
				AddNavigatorMetaData<SpecialOfferProductEntity, SpecialOfferEntity>("SpecialOffer", "SpecialOfferProducts", (a, b) => a._specialOffer = b, a => a._specialOffer, (a, b) => a.SpecialOffer = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticSpecialOfferProductRelations.SpecialOfferEntityUsingSpecialOfferIdStatic, ()=>new SpecialOfferProductRelations().SpecialOfferEntityUsingSpecialOfferId, null, new int[] { (int)SpecialOfferProductFieldIndex.SpecialOfferId }, null, true, (int)AdventureWorks.Dal.Adapter.v54.EntityType.SpecialOfferEntity);
			}
		}
