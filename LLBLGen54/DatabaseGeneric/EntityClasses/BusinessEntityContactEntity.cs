...
namespace AdventureWorks.Dal.Adapter.v54.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class BusinessEntityContactEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("BusinessEntityContactEntity", InheritanceHierarchyType.None, false, (int)AdventureWorks.Dal.Adapter.v54.EntityType.BusinessEntityContactEntity, typeof(BusinessEntityContactEntity), typeof(BusinessEntityContactEntityFactory), false);
				AddNavigatorMetaData<BusinessEntityContactEntity, BusinessEntityEntity>("BusinessEntity", "BusinessEntityContacts", (a, b) => a._businessEntity = b, a => a._businessEntity, (a, b) => a.BusinessEntity = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticBusinessEntityContactRelations.BusinessEntityEntityUsingBusinessEntityIdStatic, ()=>new BusinessEntityContactRelations().BusinessEntityEntityUsingBusinessEntityId, null, new int[] { (int)BusinessEntityContactFieldIndex.BusinessEntityId }, null, true, (int)AdventureWorks.Dal.Adapter.v54.EntityType.BusinessEntityEntity);
				AddNavigatorMetaData<BusinessEntityContactEntity, ContactTypeEntity>("ContactType", "BusinessEntityContacts", (a, b) => a._contactType = b, a => a._contactType, (a, b) => a.ContactType = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticBusinessEntityContactRelations.ContactTypeEntityUsingContactTypeIdStatic, ()=>new BusinessEntityContactRelations().ContactTypeEntityUsingContactTypeId, null, new int[] { (int)BusinessEntityContactFieldIndex.ContactTypeId }, null, true, (int)AdventureWorks.Dal.Adapter.v54.EntityType.ContactTypeEntity);
				AddNavigatorMetaData<BusinessEntityContactEntity, PersonEntity>("Person", "BusinessEntityContacts", (a, b) => a._person = b, a => a._person, (a, b) => a.Person = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticBusinessEntityContactRelations.PersonEntityUsingPersonIdStatic, ()=>new BusinessEntityContactRelations().PersonEntityUsingPersonId, null, new int[] { (int)BusinessEntityContactFieldIndex.PersonId }, null, true, (int)AdventureWorks.Dal.Adapter.v54.EntityType.PersonEntity);
			}
		}
