...
namespace AdventureWorks.Dal.Adapter.v54.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class ScrapReasonEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("ScrapReasonEntity", InheritanceHierarchyType.None, false, (int)AdventureWorks.Dal.Adapter.v54.EntityType.ScrapReasonEntity, typeof(ScrapReasonEntity), typeof(ScrapReasonEntityFactory), false);
				AddNavigatorMetaData<ScrapReasonEntity, EntityCollection<WorkOrderEntity>>("WorkOrders", a => a._workOrders, (a, b) => a._workOrders = b, a => a.WorkOrders, () => new ScrapReasonRelations().WorkOrderEntityUsingScrapReasonId, typeof(WorkOrderEntity), (int)AdventureWorks.Dal.Adapter.v54.EntityType.WorkOrderEntity);
			}
		}
