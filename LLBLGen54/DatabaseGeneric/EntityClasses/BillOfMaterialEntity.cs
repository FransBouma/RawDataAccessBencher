...
namespace AdventureWorks.Dal.Adapter.v54.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class BillOfMaterialEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("BillOfMaterialEntity", InheritanceHierarchyType.None, false, (int)AdventureWorks.Dal.Adapter.v54.EntityType.BillOfMaterialEntity, typeof(BillOfMaterialEntity), typeof(BillOfMaterialEntityFactory), false);
				AddNavigatorMetaData<BillOfMaterialEntity, ProductEntity>("Product", "BillOfMaterials", (a, b) => a._product = b, a => a._product, (a, b) => a.Product = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticBillOfMaterialRelations.ProductEntityUsingComponentIdStatic, ()=>new BillOfMaterialRelations().ProductEntityUsingComponentId, null, new int[] { (int)BillOfMaterialFieldIndex.ComponentId }, null, true, (int)AdventureWorks.Dal.Adapter.v54.EntityType.ProductEntity);
				AddNavigatorMetaData<BillOfMaterialEntity, ProductEntity>("Product_", "BillOfMaterials_", (a, b) => a._product_ = b, a => a._product_, (a, b) => a.Product_ = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticBillOfMaterialRelations.ProductEntityUsingProductAssemblyIdStatic, ()=>new BillOfMaterialRelations().ProductEntityUsingProductAssemblyId, null, new int[] { (int)BillOfMaterialFieldIndex.ProductAssemblyId }, null, true, (int)AdventureWorks.Dal.Adapter.v54.EntityType.ProductEntity);
				AddNavigatorMetaData<BillOfMaterialEntity, UnitMeasureEntity>("UnitMeasure", "BillOfMaterials", (a, b) => a._unitMeasure = b, a => a._unitMeasure, (a, b) => a.UnitMeasure = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticBillOfMaterialRelations.UnitMeasureEntityUsingUnitMeasureCodeStatic, ()=>new BillOfMaterialRelations().UnitMeasureEntityUsingUnitMeasureCode, null, new int[] { (int)BillOfMaterialFieldIndex.UnitMeasureCode }, null, true, (int)AdventureWorks.Dal.Adapter.v54.EntityType.UnitMeasureEntity);
			}
		}
