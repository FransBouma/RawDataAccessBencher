...
namespace AdventureWorks.Dal.Adapter.v54.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class CurrencyEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("CurrencyEntity", InheritanceHierarchyType.None, false, (int)AdventureWorks.Dal.Adapter.v54.EntityType.CurrencyEntity, typeof(CurrencyEntity), typeof(CurrencyEntityFactory), false);
				AddNavigatorMetaData<CurrencyEntity, EntityCollection<CountryRegionCurrencyEntity>>("CountryRegionCurrencies", a => a._countryRegionCurrencies, (a, b) => a._countryRegionCurrencies = b, a => a.CountryRegionCurrencies, () => new CurrencyRelations().CountryRegionCurrencyEntityUsingCurrencyCode, typeof(CountryRegionCurrencyEntity), (int)AdventureWorks.Dal.Adapter.v54.EntityType.CountryRegionCurrencyEntity);
				AddNavigatorMetaData<CurrencyEntity, EntityCollection<CurrencyRateEntity>>("CurrencyRates", a => a._currencyRates, (a, b) => a._currencyRates = b, a => a.CurrencyRates, () => new CurrencyRelations().CurrencyRateEntityUsingFromCurrencyCode, typeof(CurrencyRateEntity), (int)AdventureWorks.Dal.Adapter.v54.EntityType.CurrencyRateEntity);
				AddNavigatorMetaData<CurrencyEntity, EntityCollection<CurrencyRateEntity>>("CurrencyRates_", a => a._currencyRates_, (a, b) => a._currencyRates_ = b, a => a.CurrencyRates_, () => new CurrencyRelations().CurrencyRateEntityUsingToCurrencyCode, typeof(CurrencyRateEntity), (int)AdventureWorks.Dal.Adapter.v54.EntityType.CurrencyRateEntity);
			}
		}
