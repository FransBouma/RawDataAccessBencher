...
namespace AdventureWorks.Dal.Adapter.v54.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class WorkOrderRoutingEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("WorkOrderRoutingEntity", InheritanceHierarchyType.None, false, (int)AdventureWorks.Dal.Adapter.v54.EntityType.WorkOrderRoutingEntity, typeof(WorkOrderRoutingEntity), typeof(WorkOrderRoutingEntityFactory), false);
				AddNavigatorMetaData<WorkOrderRoutingEntity, LocationEntity>("Location", "WorkOrderRoutings", (a, b) => a._location = b, a => a._location, (a, b) => a.Location = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticWorkOrderRoutingRelations.LocationEntityUsingLocationIdStatic, ()=>new WorkOrderRoutingRelations().LocationEntityUsingLocationId, null, new int[] { (int)WorkOrderRoutingFieldIndex.LocationId }, null, true, (int)AdventureWorks.Dal.Adapter.v54.EntityType.LocationEntity);
				AddNavigatorMetaData<WorkOrderRoutingEntity, WorkOrderEntity>("WorkOrder", "WorkOrderRoutings", (a, b) => a._workOrder = b, a => a._workOrder, (a, b) => a.WorkOrder = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticWorkOrderRoutingRelations.WorkOrderEntityUsingWorkOrderIdStatic, ()=>new WorkOrderRoutingRelations().WorkOrderEntityUsingWorkOrderId, null, new int[] { (int)WorkOrderRoutingFieldIndex.WorkOrderId }, null, true, (int)AdventureWorks.Dal.Adapter.v54.EntityType.WorkOrderEntity);
			}
		}
