...
namespace AdventureWorks.Dal.Adapter.v54.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class PurchaseOrderHeaderEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("PurchaseOrderHeaderEntity", InheritanceHierarchyType.None, false, (int)AdventureWorks.Dal.Adapter.v54.EntityType.PurchaseOrderHeaderEntity, typeof(PurchaseOrderHeaderEntity), typeof(PurchaseOrderHeaderEntityFactory), false);
				...
				AddNavigatorMetaData<PurchaseOrderHeaderEntity, EmployeeEntity>("Employee", "PurchaseOrderHeaders", (a, b) => a._employee = b, a => a._employee, (a, b) => a.Employee = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticPurchaseOrderHeaderRelations.EmployeeEntityUsingEmployeeIdStatic, ()=>new PurchaseOrderHeaderRelations().EmployeeEntityUsingEmployeeId, null, new int[] { (int)PurchaseOrderHeaderFieldIndex.EmployeeId }, null, true, (int)AdventureWorks.Dal.Adapter.v54.EntityType.EmployeeEntity);
				AddNavigatorMetaData<PurchaseOrderHeaderEntity, ShipMethodEntity>("ShipMethod", "PurchaseOrderHeaders", (a, b) => a._shipMethod = b, a => a._shipMethod, (a, b) => a.ShipMethod = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticPurchaseOrderHeaderRelations.ShipMethodEntityUsingShipMethodIdStatic, ()=>new PurchaseOrderHeaderRelations().ShipMethodEntityUsingShipMethodId, null, new int[] { (int)PurchaseOrderHeaderFieldIndex.ShipMethodId }, null, true, (int)AdventureWorks.Dal.Adapter.v54.EntityType.ShipMethodEntity);
				AddNavigatorMetaData<PurchaseOrderHeaderEntity, VendorEntity>("Vendor", "PurchaseOrderHeaders", (a, b) => a._vendor = b, a => a._vendor, (a, b) => a.Vendor = b, AdventureWorks.Dal.Adapter.v54.RelationClasses.StaticPurchaseOrderHeaderRelations.VendorEntityUsingVendorIdStatic, ()=>new PurchaseOrderHeaderRelations().VendorEntityUsingVendorId, null, new int[] { (int)PurchaseOrderHeaderFieldIndex.VendorId }, null, true, (int)AdventureWorks.Dal.Adapter.v54.EntityType.VendorEntity);
			}
		}
