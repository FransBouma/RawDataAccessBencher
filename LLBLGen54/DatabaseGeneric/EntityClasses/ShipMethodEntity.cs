...
namespace AdventureWorks.Dal.Adapter.v54.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class ShipMethodEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("ShipMethodEntity", InheritanceHierarchyType.None, false, (int)AdventureWorks.Dal.Adapter.v54.EntityType.ShipMethodEntity, typeof(ShipMethodEntity), typeof(ShipMethodEntityFactory), false);
				AddNavigatorMetaData<ShipMethodEntity, EntityCollection<PurchaseOrderHeaderEntity>>("PurchaseOrderHeaders", a => a._purchaseOrderHeaders, (a, b) => a._purchaseOrderHeaders = b, a => a.PurchaseOrderHeaders, () => new ShipMethodRelations().PurchaseOrderHeaderEntityUsingShipMethodId, typeof(PurchaseOrderHeaderEntity), (int)AdventureWorks.Dal.Adapter.v54.EntityType.PurchaseOrderHeaderEntity);
				AddNavigatorMetaData<ShipMethodEntity, EntityCollection<SalesOrderHeaderEntity>>("SalesOrderHeaders", a => a._salesOrderHeaders, (a, b) => a._salesOrderHeaders = b, a => a.SalesOrderHeaders, () => new ShipMethodRelations().SalesOrderHeaderEntityUsingShipMethodId, typeof(SalesOrderHeaderEntity), (int)AdventureWorks.Dal.Adapter.v54.EntityType.SalesOrderHeaderEntity);
			}
		}
