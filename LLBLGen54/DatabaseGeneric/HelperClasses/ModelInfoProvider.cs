...
namespace AdventureWorks.Dal.Adapter.v54.HelperClasses
{
	...
	internal class ModelInfoProviderCore : ModelInfoProviderBase
	{
		...
		private void Init()
		{
			...
			InitBusinessEntityEntityInfo();
			InitBusinessEntityAddressEntityInfo();
			InitBusinessEntityContactEntityInfo();
			...
			InitPersonPhoneEntityInfo();
			InitPhoneNumberTypeEntityInfo();
			...
			InitSohTypedViewInfo();
			InitSohLinqPocoTypedViewInfo();
			InitSohQuerySpecPocoTypedViewInfo();
		...
		/// <summary>Inits BusinessEntityEntity's info objects</summary>
		private void InitBusinessEntityEntityInfo()
		{
		...
		/// <summary>Inits BusinessEntityAddressEntity's info objects</summary>
		private void InitBusinessEntityAddressEntityInfo()
		{
		...
		/// <summary>Inits BusinessEntityContactEntity's info objects</summary>
		private void InitBusinessEntityContactEntityInfo()
		{
		...
		/// <summary>Inits EmailAddressEntity's info objects</summary>
		private void InitEmailAddressEntityInfo()
		{
		...
		/// <summary>Inits PasswordEntity's info objects</summary>
		private void InitPasswordEntityInfo()
		{
		...
		/// <summary>Inits PersonPhoneEntity's info objects</summary>
		private void InitPersonPhoneEntityInfo()
		{
		...
		/// <summary>Inits PhoneNumberTypeEntity's info objects</summary>
		private void InitPhoneNumberTypeEntityInfo()
		{
		...
		/// <summary>Inits SohView's info objects</summary>
		private void InitSohTypedViewInfo()
		{
		...
		/// <summary>Inits SohLinqPocoView's info objects</summary>
		private void InitSohLinqPocoTypedViewInfo()
		{
		...
		/// <summary>Inits SohQuerySpecPocoView's info objects</summary>
		private void InitSohQuerySpecPocoTypedViewInfo()
		{
