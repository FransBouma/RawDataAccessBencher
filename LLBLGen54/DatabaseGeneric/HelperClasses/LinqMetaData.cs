...
namespace AdventureWorks.Dal.Adapter.v54.Linq
{
	...
	public partial class LinqMetaData: ILinqMetaData
	{
		...
		{
			switch((AdventureWorks.Dal.Adapter.v54.EntityType)typeOfEntity)
			{
		...
		public DataSource2<AdventureWorks.Dal.Adapter.v54.TypedViewClasses.SohLinqPocoRow> SohLinqPoco
		{
			get { return new DataSource2<AdventureWorks.Dal.Adapter.v54.TypedViewClasses.SohLinqPocoRow>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse) { TypedViewEnumTypeValue=(int)TypedViewType.SohLinqPocoTypedView }; }
		}
