...
namespace AdventureWorks.Dal.Adapter.v54.TypedViewClasses
{
	...
	/// <remarks>This class is a result class for a query, which is produced with the property <see cref="AdventureWorks.Dal.Adapter.v54.FactoryClasses.QueryFactory.SohQuerySpecPoco"/>. </remarks>
	[Serializable]
