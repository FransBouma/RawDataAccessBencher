...
namespace AdventureWorks.Dal.Adapter.v54.TypedViewClasses
{
	/// <summary>Class which represents a row in the typed view 'SohLinqPoco'.</summary>
	/// <remarks>This class is a result class for a query, which is produced with the property <see cref="AdventureWorks.Dal.Adapter.v54.Linq.LinqMetaData.SohLinqPoco"/>. </remarks>
	[Serializable]
