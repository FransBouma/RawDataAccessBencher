...
namespace AdventureWorks.Dal.Adapter.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class ProductModelEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("ProductModelEntity", InheritanceHierarchyType.None, false, (int)AdventureWorks.Dal.Adapter.EntityType.ProductModelEntity, typeof(ProductModelEntity), typeof(ProductModelEntityFactory), false);
				AddNavigatorMetaData<ProductModelEntity, EntityCollection<ProductEntity>>("Products", a => a._products, (a, b) => a._products = b, a => a.Products, () => new ProductModelRelations().ProductEntityUsingProductModelId, typeof(ProductEntity), (int)AdventureWorks.Dal.Adapter.EntityType.ProductEntity);
