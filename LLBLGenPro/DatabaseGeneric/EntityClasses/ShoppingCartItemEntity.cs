...
namespace AdventureWorks.Dal.Adapter.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class ShoppingCartItemEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("ShoppingCartItemEntity", InheritanceHierarchyType.None, false, (int)AdventureWorks.Dal.Adapter.EntityType.ShoppingCartItemEntity, typeof(ShoppingCartItemEntity), typeof(ShoppingCartItemEntityFactory), false);
				AddNavigatorMetaData<ShoppingCartItemEntity, ProductEntity>("Product", "ShoppingCartItems", (a, b) => a._product = b, a => a._product, (a, b) => a.Product = b, AdventureWorks.Dal.Adapter.RelationClasses.StaticShoppingCartItemRelations.ProductEntityUsingProductIdStatic, ()=>new ShoppingCartItemRelations().ProductEntityUsingProductId, null, new int[] { (int)ShoppingCartItemFieldIndex.ProductId }, null, true, (int)AdventureWorks.Dal.Adapter.EntityType.ProductEntity);
			}
		}
