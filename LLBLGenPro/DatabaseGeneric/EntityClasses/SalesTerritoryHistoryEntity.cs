...
namespace AdventureWorks.Dal.Adapter.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class SalesTerritoryHistoryEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("SalesTerritoryHistoryEntity", InheritanceHierarchyType.None, false, (int)AdventureWorks.Dal.Adapter.EntityType.SalesTerritoryHistoryEntity, typeof(SalesTerritoryHistoryEntity), typeof(SalesTerritoryHistoryEntityFactory), false);
				AddNavigatorMetaData<SalesTerritoryHistoryEntity, SalesPersonEntity>("SalesPerson", "SalesTerritoryHistories", (a, b) => a._salesPerson = b, a => a._salesPerson, (a, b) => a.SalesPerson = b, AdventureWorks.Dal.Adapter.RelationClasses.StaticSalesTerritoryHistoryRelations.SalesPersonEntityUsingSalesPersonIdStatic, ()=>new SalesTerritoryHistoryRelations().SalesPersonEntityUsingSalesPersonId, null, new int[] { (int)SalesTerritoryHistoryFieldIndex.SalesPersonId }, null, true, (int)AdventureWorks.Dal.Adapter.EntityType.SalesPersonEntity);
				AddNavigatorMetaData<SalesTerritoryHistoryEntity, SalesTerritoryEntity>("SalesTerritory", "SalesTerritoryHistories", (a, b) => a._salesTerritory = b, a => a._salesTerritory, (a, b) => a.SalesTerritory = b, AdventureWorks.Dal.Adapter.RelationClasses.StaticSalesTerritoryHistoryRelations.SalesTerritoryEntityUsingTerritoryIdStatic, ()=>new SalesTerritoryHistoryRelations().SalesTerritoryEntityUsingTerritoryId, null, new int[] { (int)SalesTerritoryHistoryFieldIndex.TerritoryId }, null, true, (int)AdventureWorks.Dal.Adapter.EntityType.SalesTerritoryEntity);
			}
		}
