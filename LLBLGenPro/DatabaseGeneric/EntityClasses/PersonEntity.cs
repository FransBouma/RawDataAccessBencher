		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class PersonEntityStaticMetaData : EntityStaticMetaDataBase
		{
			public PersonEntityStaticMetaData()
			{
				...
				AddNavigatorMetaData<PersonEntity, EmployeeEntity>("Employee", "Person", (a, b) => a._employee = b, a => a._employee, (a, b) => a.Employee = b, AdventureWorks.Dal.Adapter.RelationClasses.StaticPersonRelations.EmployeeEntityUsingEmployeeIdStatic, ()=>new PersonRelations().EmployeeEntityUsingEmployeeId, null, new int[] { (int)PersonFieldIndex.BusinessEntityId }, null, true, (int)AdventureWorks.Dal.Adapter.EntityType.EmployeeEntity);
				AddNavigatorMetaData<PersonEntity, PasswordEntity>("Password", "Person", (a, b) => a._password = b, a => a._password, (a, b) => a.Password = b, AdventureWorks.Dal.Adapter.RelationClasses.StaticPersonRelations.PasswordEntityUsingBusinessEntityIdStatic, ()=>new PersonRelations().PasswordEntityUsingBusinessEntityId, null, new int[] { (int)PersonFieldIndex.BusinessEntityId }, null, true, (int)AdventureWorks.Dal.Adapter.EntityType.PasswordEntity);
			}
		}
