...
namespace AdventureWorks.Dal.Adapter.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class EmployeePayHistoryEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("EmployeePayHistoryEntity", InheritanceHierarchyType.None, false, (int)AdventureWorks.Dal.Adapter.EntityType.EmployeePayHistoryEntity, typeof(EmployeePayHistoryEntity), typeof(EmployeePayHistoryEntityFactory), false);
				AddNavigatorMetaData<EmployeePayHistoryEntity, EmployeeEntity>("Employee", "EmployeePayHistories", (a, b) => a._employee = b, a => a._employee, (a, b) => a.Employee = b, AdventureWorks.Dal.Adapter.RelationClasses.StaticEmployeePayHistoryRelations.EmployeeEntityUsingEmployeeIdStatic, ()=>new EmployeePayHistoryRelations().EmployeeEntityUsingEmployeeId, null, new int[] { (int)EmployeePayHistoryFieldIndex.EmployeeId }, null, true, (int)AdventureWorks.Dal.Adapter.EntityType.EmployeeEntity);
			}
		}
