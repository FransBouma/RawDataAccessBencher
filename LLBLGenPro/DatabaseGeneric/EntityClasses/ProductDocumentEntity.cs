...
namespace AdventureWorks.Dal.Adapter.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class ProductDocumentEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("ProductDocumentEntity", InheritanceHierarchyType.None, false, (int)AdventureWorks.Dal.Adapter.EntityType.ProductDocumentEntity, typeof(ProductDocumentEntity), typeof(ProductDocumentEntityFactory), false);
				AddNavigatorMetaData<ProductDocumentEntity, DocumentEntity>("Document", "ProductDocuments", (a, b) => a._document = b, a => a._document, (a, b) => a.Document = b, AdventureWorks.Dal.Adapter.RelationClasses.StaticProductDocumentRelations.DocumentEntityUsingDocumentNodeStatic, ()=>new ProductDocumentRelations().DocumentEntityUsingDocumentNode, null, new int[] { (int)ProductDocumentFieldIndex.DocumentNode }, null, true, (int)AdventureWorks.Dal.Adapter.EntityType.DocumentEntity);
				AddNavigatorMetaData<ProductDocumentEntity, ProductEntity>("Product", "ProductDocuments", (a, b) => a._product = b, a => a._product, (a, b) => a.Product = b, AdventureWorks.Dal.Adapter.RelationClasses.StaticProductDocumentRelations.ProductEntityUsingProductIdStatic, ()=>new ProductDocumentRelations().ProductEntityUsingProductId, null, new int[] { (int)ProductDocumentFieldIndex.ProductId }, null, true, (int)AdventureWorks.Dal.Adapter.EntityType.ProductEntity);
			}
		}
