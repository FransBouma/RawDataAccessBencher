...
{
	/// <summary>Class which represents the entity 'TransactionHistoryArchive', mapped on table 'AdventureWorks.Production.TransactionHistoryArchive'.</summary>
	...
	public partial class TransactionHistoryArchive : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		[Column(Name="TransactionID", Storage="_transactionId", CanBeNull=false, DbType="int NOT NULL", IsPrimaryKey=true)]
